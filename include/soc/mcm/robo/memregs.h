 ...
 *
 * $Id: memregs.h,v 1.48.2.1 2011/03/17 08:30:15 kliao Exp $
...
MEM_ENTRY(cfp_act_pol_entry_t, 9);
...
#define REG_READ_AGEOUT_EN_VIDr(unit, rvp) \
	ROBO_REG_READ(unit, AGEOUT_EN_VIDr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_AGEOUT_EN_VIDr(unit, rv) \
	ROBO_REG_WRITE(unit, AGEOUT_EN_VIDr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_ARLA_ENTRYr(unit, rvp) \
	ROBO_REG_READ(unit, ARLA_ENTRYr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_ARLA_ENTRYr(unit, rv) \
	ROBO_REG_WRITE(unit, ARLA_ENTRYr, REG_PORT_ANY, 0, rv)

#define REG_READ_ARLA_ENTRY0r(unit, rvp) \
	ROBO_REG_READ(unit, ARLA_ENTRY0r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_ARLA_ENTRY0r(unit, rv) \
	ROBO_REG_WRITE(unit, ARLA_ENTRY0r, REG_PORT_ANY, 0, rv)

#define REG_READ_ARLA_ENTRY1r(unit, rvp) \
	ROBO_REG_READ(unit, ARLA_ENTRY1r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_ARLA_ENTRY1r(unit, rv) \
	ROBO_REG_WRITE(unit, ARLA_ENTRY1r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_ARLA_VID_ENTRYr(unit, rvp) \
	ROBO_REG_READ(unit, ARLA_VID_ENTRYr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_ARLA_VID_ENTRYr(unit, rv) \
	ROBO_REG_WRITE(unit, ARLA_VID_ENTRYr, REG_PORT_ANY, 0, rv)

#define REG_READ_ARLA_VID_ENTRY0r(unit, rvp) \
	ROBO_REG_READ(unit, ARLA_VID_ENTRY0r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_ARLA_VID_ENTRY0r(unit, rv) \
	ROBO_REG_WRITE(unit, ARLA_VID_ENTRY0r, REG_PORT_ANY, 0, rv)

#define REG_READ_ARLA_VID_ENTRY1r(unit, rvp) \
	ROBO_REG_READ(unit, ARLA_VID_ENTRY1r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_ARLA_VID_ENTRY1r(unit, rv) \
	ROBO_REG_WRITE(unit, ARLA_VID_ENTRY1r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_ARL_SPAREREG0r(unit, rvp) \
	ROBO_REG_READ(unit, ARL_SPAREREG0r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_ARL_SPAREREG0r(unit, rv) \
	ROBO_REG_WRITE(unit, ARL_SPAREREG0r, REG_PORT_ANY, 0, rv)

#define REG_READ_ARL_SPAREREG1r(unit, rvp) \
	ROBO_REG_READ(unit, ARL_SPAREREG1r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_ARL_SPAREREG1r(unit, rv) \
	ROBO_REG_WRITE(unit, ARL_SPAREREG1r, REG_PORT_ANY, 0, rv)

#define REG_READ_ARL_SPAREREG2r(unit, rvp) \
	ROBO_REG_READ(unit, ARL_SPAREREG2r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_ARL_SPAREREG2r(unit, rv) \
	ROBO_REG_WRITE(unit, ARL_SPAREREG2r, REG_PORT_ANY, 0, rv)

#define REG_READ_ARL_SPAREREG3r(unit, rvp) \
	ROBO_REG_READ(unit, ARL_SPAREREG3r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_ARL_SPAREREG3r(unit, rv) \
	ROBO_REG_WRITE(unit, ARL_SPAREREG3r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_BOND_DIRECT_PINr(unit, idx, rvp) \
	ROBO_REG_READ(unit, BOND_DIRECT_PINr, REG_PORT_ANY, idx, rvp)
#define REG_WRITE_BOND_DIRECT_PINr(unit, idx, rv) \
	ROBO_REG_WRITE(unit, BOND_DIRECT_PINr, REG_PORT_ANY, idx, rv)
...
#define REG_READ_BRCM_TAG_CTRLr(unit, rvp) \
	ROBO_REG_READ(unit, BRCM_TAG_CTRLr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_BRCM_TAG_CTRLr(unit, rv) \
	ROBO_REG_WRITE(unit, BRCM_TAG_CTRLr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_CFP_TESTr(unit, rvp) \
	ROBO_REG_READ(unit, CFP_TESTr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_CFP_TESTr(unit, rv) \
	ROBO_REG_WRITE(unit, CFP_TESTr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_CFP_UNLCKr(unit, rvp) \
	ROBO_REG_READ(unit, CFP_UNLCKr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_CFP_UNLCKr(unit, rv) \
	ROBO_REG_WRITE(unit, CFP_UNLCKr, REG_PORT_ANY, 0, rv)

#define REG_READ_CHIP0_PORT_AGEr(unit, rvp) \
	ROBO_REG_READ(unit, CHIP0_PORT_AGEr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_CHIP0_PORT_AGEr(unit, rv) \
	ROBO_REG_WRITE(unit, CHIP0_PORT_AGEr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_DOU_TAG_TPIDr(unit, rvp) \
	ROBO_REG_READ(unit, DOU_TAG_TPIDr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_DOU_TAG_TPIDr(unit, rv) \
	ROBO_REG_WRITE(unit, DOU_TAG_TPIDr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_EGRESS_NRESE_PKT_TC2PCP_MAPr(unit, idx, rvp) \
	ROBO_REG_READ(unit, EGRESS_NRESE_PKT_TC2PCP_MAPr, REG_PORT_ANY, idx, rvp)
#define REG_WRITE_EGRESS_NRESE_PKT_TC2PCP_MAPr(unit, idx, rv) \
	ROBO_REG_WRITE(unit, EGRESS_NRESE_PKT_TC2PCP_MAPr, REG_PORT_ANY, idx, rv)

#define REG_READ_EGRESS_NRESE_PKT_TC2PCP_MAP_8r(unit, rvp) \
	ROBO_REG_READ(unit, EGRESS_NRESE_PKT_TC2PCP_MAP_8r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_EGRESS_NRESE_PKT_TC2PCP_MAP_8r(unit, rv) \
	ROBO_REG_WRITE(unit, EGRESS_NRESE_PKT_TC2PCP_MAP_8r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_EXT_ACTLSTSr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_ACTLSTSr, port, 0, rvp)
#define REG_WRITE_EXT_ACTLSTSr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_ACTLSTSr, port, 0, rv)

#define REG_READ_EXT_AEGSTSr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_AEGSTSr, port, 0, rvp)
#define REG_WRITE_EXT_AEGSTSr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_AEGSTSr, port, 0, rv)

#define REG_READ_EXT_AMODE2r(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_AMODE2r, port, 0, rvp)
#define REG_WRITE_EXT_AMODE2r(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_AMODE2r, port, 0, rv)

#define REG_READ_EXT_AMPHYr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_AMPHYr, port, 0, rvp)
#define REG_WRITE_EXT_AMPHYr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_AMPHYr, port, 0, rv)

#define REG_READ_EXT_ANADVr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_ANADVr, port, 0, rvp)
#define REG_WRITE_EXT_ANADVr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_ANADVr, port, 0, rv)

#define REG_READ_EXT_ANEXPr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_ANEXPr, port, 0, rvp)
#define REG_WRITE_EXT_ANEXPr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_ANEXPr, port, 0, rv)

#define REG_READ_EXT_ANLPAr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_ANLPAr, port, 0, rvp)
#define REG_WRITE_EXT_ANLPAr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_ANLPAr, port, 0, rv)

#define REG_READ_EXT_ANNXPr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_ANNXPr, port, 0, rvp)
#define REG_WRITE_EXT_ANNXPr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_ANNXPr, port, 0, rv)

#define REG_READ_EXT_ASTSSUMr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_ASTSSUMr, port, 0, rvp)
#define REG_WRITE_EXT_ASTSSUMr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_ASTSSUMr, port, 0, rv)

#define REG_READ_EXT_BRCMTSTr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_BRCMTSTr, port, 0, rvp)
#define REG_WRITE_EXT_BRCMTSTr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_BRCMTSTr, port, 0, rv)

#define REG_READ_EXT_HNDRD_ACTLr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_HNDRD_ACTLr, port, 0, rvp)
#define REG_WRITE_EXT_HNDRD_ACTLr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_HNDRD_ACTLr, port, 0, rv)

#define REG_READ_EXT_HNDRD_ASTSr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_HNDRD_ASTSr, port, 0, rvp)
#define REG_WRITE_EXT_HNDRD_ASTSr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_HNDRD_ASTSr, port, 0, rv)

#define REG_READ_EXT_HNDRD_FCSCNTr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_HNDRD_FCSCNTr, port, 0, rvp)
#define REG_WRITE_EXT_HNDRD_FCSCNTr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_HNDRD_FCSCNTr, port, 0, rv)

#define REG_READ_EXT_HNDRD_RECNTr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_HNDRD_RECNTr, port, 0, rvp)
#define REG_WRITE_EXT_HNDRD_RECNTr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_HNDRD_RECNTr, port, 0, rv)

#define REG_READ_EXT_LPNXPr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_LPNXPr, port, 0, rvp)
#define REG_WRITE_EXT_LPNXPr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_LPNXPr, port, 0, rv)

#define REG_READ_EXT_MIICTLr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_MIICTLr, port, 0, rvp)
#define REG_WRITE_EXT_MIICTLr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_MIICTLr, port, 0, rv)

#define REG_READ_EXT_MIISTSr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_MIISTSr, port, 0, rvp)
#define REG_WRITE_EXT_MIISTSr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_MIISTSr, port, 0, rv)

#define REG_READ_EXT_PHYIDHr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_PHYIDHr, port, 0, rvp)
#define REG_WRITE_EXT_PHYIDHr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_PHYIDHr, port, 0, rv)

#define REG_READ_EXT_PHYIDLr(unit, port, rvp) \
	ROBO_REG_READ(unit, EXT_PHYIDLr, port, 0, rvp)
#define REG_WRITE_EXT_PHYIDLr(unit, port, rv) \
	ROBO_REG_WRITE(unit, EXT_PHYIDLr, port, 0, rv)

#define REG_READ_E_ACTLSTSr(unit, port, rvp) \
	ROBO_REG_READ(unit, E_ACTLSTSr, port, 0, rvp)
#define REG_WRITE_E_ACTLSTSr(unit, port, rv) \
	ROBO_REG_WRITE(unit, E_ACTLSTSr, port, 0, rv)

#define REG_READ_E_AEGSTSr(unit, port, rvp) \
	ROBO_REG_READ(unit, E_AEGSTSr, port, 0, rvp)
#define REG_WRITE_E_AEGSTSr(unit, port, rv) \
	ROBO_REG_WRITE(unit, E_AEGSTSr, port, 0, rv)

#define REG_READ_E_AMODE2r(unit, port, rvp) \
	ROBO_REG_READ(unit, E_AMODE2r, port, 0, rvp)
#define REG_WRITE_E_AMODE2r(unit, port, rv) \
	ROBO_REG_WRITE(unit, E_AMODE2r, port, 0, rv)

#define REG_READ_E_AMPHYr(unit, port, rvp) \
	ROBO_REG_READ(unit, E_AMPHYr, port, 0, rvp)
#define REG_WRITE_E_AMPHYr(unit, port, rv) \
	ROBO_REG_WRITE(unit, E_AMPHYr, port, 0, rv)
...
#define REG_READ_E_ASTSSUMr(unit, port, rvp) \
	ROBO_REG_READ(unit, E_ASTSSUMr, port, 0, rvp)
#define REG_WRITE_E_ASTSSUMr(unit, port, rv) \
	ROBO_REG_WRITE(unit, E_ASTSSUMr, port, 0, rv)

#define REG_READ_E_BRCMTSTr(unit, port, rvp) \
	ROBO_REG_READ(unit, E_BRCMTSTr, port, 0, rvp)
#define REG_WRITE_E_BRCMTSTr(unit, port, rv) \
	ROBO_REG_WRITE(unit, E_BRCMTSTr, port, 0, rv)

#define REG_READ_E_HNDRD_ACTLr(unit, port, rvp) \
	ROBO_REG_READ(unit, E_HNDRD_ACTLr, port, 0, rvp)
#define REG_WRITE_E_HNDRD_ACTLr(unit, port, rv) \
	ROBO_REG_WRITE(unit, E_HNDRD_ACTLr, port, 0, rv)

#define REG_READ_E_HNDRD_ASTSr(unit, port, rvp) \
	ROBO_REG_READ(unit, E_HNDRD_ASTSr, port, 0, rvp)
#define REG_WRITE_E_HNDRD_ASTSr(unit, port, rv) \
	ROBO_REG_WRITE(unit, E_HNDRD_ASTSr, port, 0, rv)

#define REG_READ_E_HNDRD_FCSCNTr(unit, port, rvp) \
	ROBO_REG_READ(unit, E_HNDRD_FCSCNTr, port, 0, rvp)
#define REG_WRITE_E_HNDRD_FCSCNTr(unit, port, rv) \
	ROBO_REG_WRITE(unit, E_HNDRD_FCSCNTr, port, 0, rv)

#define REG_READ_E_HNDRD_RECNTr(unit, port, rvp) \
	ROBO_REG_READ(unit, E_HNDRD_RECNTr, port, 0, rvp)
#define REG_WRITE_E_HNDRD_RECNTr(unit, port, rv) \
	ROBO_REG_WRITE(unit, E_HNDRD_RECNTr, port, 0, rv)
...
#define REG_READ_FCON_FLOWCON_STATUS0r(unit, rvp) \
	ROBO_REG_READ(unit, FCON_FLOWCON_STATUS0r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_FCON_FLOWCON_STATUS0r(unit, rv) \
	ROBO_REG_WRITE(unit, FCON_FLOWCON_STATUS0r, REG_PORT_ANY, 0, rv)

#define REG_READ_FCON_FLOWCON_STATUS1r(unit, rvp) \
	ROBO_REG_READ(unit, FCON_FLOWCON_STATUS1r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_FCON_FLOWCON_STATUS1r(unit, rv) \
	ROBO_REG_WRITE(unit, FCON_FLOWCON_STATUS1r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_FCON_FLOWCON_STATUS6r(unit, rvp) \
	ROBO_REG_READ(unit, FCON_FLOWCON_STATUS6r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_FCON_FLOWCON_STATUS6r(unit, rv) \
	ROBO_REG_WRITE(unit, FCON_FLOWCON_STATUS6r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_FCON_FLOWCON_STATUS8r(unit, rvp) \
	ROBO_REG_READ(unit, FCON_FLOWCON_STATUS8r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_FCON_FLOWCON_STATUS8r(unit, rv) \
	ROBO_REG_WRITE(unit, FCON_FLOWCON_STATUS8r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_FCON_FLOWCON_STATUS13r(unit, rvp) \
	ROBO_REG_READ(unit, FCON_FLOWCON_STATUS13r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_FCON_FLOWCON_STATUS13r(unit, rv) \
	ROBO_REG_WRITE(unit, FCON_FLOWCON_STATUS13r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_FCON_STRICT_HIQ_PRE_CTRL0r(unit, rvp) \
	ROBO_REG_READ(unit, FCON_STRICT_HIQ_PRE_CTRL0r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_FCON_STRICT_HIQ_PRE_CTRL0r(unit, rv) \
	ROBO_REG_WRITE(unit, FCON_STRICT_HIQ_PRE_CTRL0r, REG_PORT_ANY, 0, rv)

#define REG_READ_FCON_STRICT_HIQ_PRE_CTRL1r(unit, rvp) \
	ROBO_REG_READ(unit, FCON_STRICT_HIQ_PRE_CTRL1r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_FCON_STRICT_HIQ_PRE_CTRL1r(unit, rv) \
	ROBO_REG_WRITE(unit, FCON_STRICT_HIQ_PRE_CTRL1r, REG_PORT_ANY, 0, rv)

#define REG_READ_FCON_STRICT_HIQ_PRE_CTRL2r(unit, rvp) \
	ROBO_REG_READ(unit, FCON_STRICT_HIQ_PRE_CTRL2r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_FCON_STRICT_HIQ_PRE_CTRL2r(unit, rv) \
	ROBO_REG_WRITE(unit, FCON_STRICT_HIQ_PRE_CTRL2r, REG_PORT_ANY, 0, rv)

#define REG_READ_FCON_STRICT_HIQ_PRE_CTRL3r(unit, rvp) \
	ROBO_REG_READ(unit, FCON_STRICT_HIQ_PRE_CTRL3r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_FCON_STRICT_HIQ_PRE_CTRL3r(unit, rv) \
	ROBO_REG_WRITE(unit, FCON_STRICT_HIQ_PRE_CTRL3r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_GENMEM_DATAr(unit, rvp) \
	ROBO_REG_READ(unit, GENMEM_DATAr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GENMEM_DATAr(unit, rv) \
	ROBO_REG_WRITE(unit, GENMEM_DATAr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_GLB_ACTLSTSr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_ACTLSTSr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_ACTLSTSr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_ACTLSTSr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_AEGSTSr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_AEGSTSr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_AEGSTSr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_AEGSTSr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_AMODE2r(unit, rvp) \
	ROBO_REG_READ(unit, GLB_AMODE2r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_AMODE2r(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_AMODE2r, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_AMPHYr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_AMPHYr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_AMPHYr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_AMPHYr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_ANADVr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_ANADVr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_ANADVr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_ANADVr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_ANEXPr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_ANEXPr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_ANEXPr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_ANEXPr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_ANLPAr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_ANLPAr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_ANLPAr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_ANLPAr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_ANNXPr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_ANNXPr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_ANNXPr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_ANNXPr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_ASTSSUMr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_ASTSSUMr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_ASTSSUMr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_ASTSSUMr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_BRCMTSTr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_BRCMTSTr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_BRCMTSTr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_BRCMTSTr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_HNDRD_ACTLr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_HNDRD_ACTLr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_HNDRD_ACTLr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_HNDRD_ACTLr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_HNDRD_ASTSr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_HNDRD_ASTSr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_HNDRD_ASTSr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_HNDRD_ASTSr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_HNDRD_FCSCNTr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_HNDRD_FCSCNTr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_HNDRD_FCSCNTr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_HNDRD_FCSCNTr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_HNDRD_RECNTr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_HNDRD_RECNTr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_HNDRD_RECNTr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_HNDRD_RECNTr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_LPNXPr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_LPNXPr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_LPNXPr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_LPNXPr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_MIICTLr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_MIICTLr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_MIICTLr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_MIICTLr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_MIISTSr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_MIISTSr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_MIISTSr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_MIISTSr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_GLB_PHYIDHr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_PHYIDHr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_PHYIDHr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_PHYIDHr, REG_PORT_ANY, 0, rv)

#define REG_READ_GLB_PHYIDLr(unit, rvp) \
	ROBO_REG_READ(unit, GLB_PHYIDLr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_GLB_PHYIDLr(unit, rv) \
	ROBO_REG_WRITE(unit, GLB_PHYIDLr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_IEEE802P2_LLCr(unit, rvp) \
	ROBO_REG_READ(unit, IEEE802P2_LLCr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_IEEE802P2_LLCr(unit, rv) \
	ROBO_REG_WRITE(unit, IEEE802P2_LLCr, REG_PORT_ANY, 0, rv)

#define REG_READ_IEEE_802_2_LLCr(unit, rvp) \
	ROBO_REG_READ(unit, IEEE_802_2_LLCr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_IEEE_802_2_LLCr(unit, rv) \
	ROBO_REG_WRITE(unit, IEEE_802_2_LLCr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_ISP_PORT_SEL_PBMr(unit, rvp) \
	ROBO_REG_READ(unit, ISP_PORT_SEL_PBMr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_ISP_PORT_SEL_PBMr(unit, rv) \
	ROBO_REG_WRITE(unit, ISP_PORT_SEL_PBMr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_LD_FRM_SAr(unit, rvp) \
	ROBO_REG_READ(unit, LD_FRM_SAr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_LD_FRM_SAr(unit, rv) \
	ROBO_REG_WRITE(unit, LD_FRM_SAr, REG_PORT_ANY, 0, rv)

#define REG_READ_LED0_STr(unit, rvp) \
	ROBO_REG_READ(unit, LED0_STr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_LED0_STr(unit, rv) \
	ROBO_REG_WRITE(unit, LED0_STr, REG_PORT_ANY, 0, rv)

#define REG_READ_LED1_STr(unit, rvp) \
	ROBO_REG_READ(unit, LED1_STr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_LED1_STr(unit, rv) \
	ROBO_REG_WRITE(unit, LED1_STr, REG_PORT_ANY, 0, rv)

#define REG_READ_LED2_STr(unit, rvp) \
	ROBO_REG_READ(unit, LED2_STr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_LED2_STr(unit, rv) \
	ROBO_REG_WRITE(unit, LED2_STr, REG_PORT_ANY, 0, rv)

#define REG_READ_LED3_STr(unit, rvp) \
	ROBO_REG_READ(unit, LED3_STr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_LED3_STr(unit, rv) \
	ROBO_REG_WRITE(unit, LED3_STr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_MAC_SEC_CON0r(unit, rvp) \
	ROBO_REG_READ(unit, MAC_SEC_CON0r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_MAC_SEC_CON0r(unit, rv) \
	ROBO_REG_WRITE(unit, MAC_SEC_CON0r, REG_PORT_ANY, 0, rv)

#define REG_READ_MAC_SEC_CON1r(unit, rvp) \
	ROBO_REG_READ(unit, MAC_SEC_CON1r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_MAC_SEC_CON1r(unit, rv) \
	ROBO_REG_WRITE(unit, MAC_SEC_CON1r, REG_PORT_ANY, 0, rv)

#define REG_READ_MAC_SEC_CON2r(unit, rvp) \
	ROBO_REG_READ(unit, MAC_SEC_CON2r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_MAC_SEC_CON2r(unit, rv) \
	ROBO_REG_WRITE(unit, MAC_SEC_CON2r, REG_PORT_ANY, 0, rv)

#define REG_READ_MAC_SEC_CON3r(unit, rvp) \
	ROBO_REG_READ(unit, MAC_SEC_CON3r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_MAC_SEC_CON3r(unit, rv) \
	ROBO_REG_WRITE(unit, MAC_SEC_CON3r, REG_PORT_ANY, 0, rv)

#define REG_READ_MAC_SEC_CON4r(unit, rvp) \
	ROBO_REG_READ(unit, MAC_SEC_CON4r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_MAC_SEC_CON4r(unit, rv) \
	ROBO_REG_WRITE(unit, MAC_SEC_CON4r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_MCAST_SUP0r(unit, rvp) \
	ROBO_REG_READ(unit, MCAST_SUP0r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_MCAST_SUP0r(unit, rv) \
	ROBO_REG_WRITE(unit, MCAST_SUP0r, REG_PORT_ANY, 0, rv)

#define REG_READ_MCAST_SUP1r(unit, rvp) \
	ROBO_REG_READ(unit, MCAST_SUP1r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_MCAST_SUP1r(unit, rv) \
	ROBO_REG_WRITE(unit, MCAST_SUP1r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_MIBDIAG_PAGEr(unit, rvp) \
	ROBO_REG_READ(unit, MIBDIAG_PAGEr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_MIBDIAG_PAGEr(unit, rv) \
	ROBO_REG_WRITE(unit, MIBDIAG_PAGEr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_MLF_IMPC_FWD_MAPr(unit, rvp) \
	ROBO_REG_READ(unit, MLF_IMPC_FWD_MAPr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_MLF_IMPC_FWD_MAPr(unit, rv) \
	ROBO_REG_WRITE(unit, MLF_IMPC_FWD_MAPr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_MST_TABr(unit, rvp) \
	ROBO_REG_READ(unit, MST_TABr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_MST_TABr(unit, rv) \
	ROBO_REG_WRITE(unit, MST_TABr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_OTPROM_STATUSr(unit, rvp) \
	ROBO_REG_READ(unit, OTPROM_STATUSr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_OTPROM_STATUSr(unit, rv) \
	ROBO_REG_WRITE(unit, OTPROM_STATUSr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_PBPTRFIFOr(unit, rvp) \
	ROBO_REG_READ(unit, PBPTRFIFOr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_PBPTRFIFOr(unit, rv) \
	ROBO_REG_WRITE(unit, PBPTRFIFOr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_PLL_TESTr(unit, rvp) \
	ROBO_REG_READ(unit, PLL_TESTr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_PLL_TESTr(unit, rv) \
	ROBO_REG_WRITE(unit, PLL_TESTr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_PORT4_RGMII_CTL_GPr(unit, port, rvp) \
	ROBO_REG_READ(unit, PORT4_RGMII_CTL_GPr, port, 0, rvp)
#define REG_WRITE_PORT4_RGMII_CTL_GPr(unit, port, rv) \
	ROBO_REG_WRITE(unit, PORT4_RGMII_CTL_GPr, port, 0, rv)
...
#define REG_READ_PORT_EAP1_CONr(unit, idx, rvp) \
	ROBO_REG_READ(unit, PORT_EAP1_CONr, REG_PORT_ANY, idx, rvp)
#define REG_WRITE_PORT_EAP1_CONr(unit, idx, rv) \
	ROBO_REG_WRITE(unit, PORT_EAP1_CONr, REG_PORT_ANY, idx, rv)
...
#define REG_READ_PORT_IRC1_CONr(unit, idx, rvp) \
	ROBO_REG_READ(unit, PORT_IRC1_CONr, REG_PORT_ANY, idx, rvp)
#define REG_WRITE_PORT_IRC1_CONr(unit, idx, rv) \
	ROBO_REG_WRITE(unit, PORT_IRC1_CONr, REG_PORT_ANY, idx, rv)
...
#define REG_READ_PORT_VLAN1_CTLr(unit, idx, rvp) \
	ROBO_REG_READ(unit, PORT_VLAN1_CTLr, REG_PORT_ANY, idx, rvp)
#define REG_WRITE_PORT_VLAN1_CTLr(unit, idx, rv) \
	ROBO_REG_WRITE(unit, PORT_VLAN1_CTLr, REG_PORT_ANY, idx, rv)
...
#define REG_READ_QOS_D_TOS_THr(unit, rvp) \
	ROBO_REG_READ(unit, QOS_D_TOS_THr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_QOS_D_TOS_THr(unit, rv) \
	ROBO_REG_WRITE(unit, QOS_D_TOS_THr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_QOS_MIB_QUE_SELr(unit, rvp) \
	ROBO_REG_READ(unit, QOS_MIB_QUE_SELr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_QOS_MIB_QUE_SELr(unit, rv) \
	ROBO_REG_WRITE(unit, QOS_MIB_QUE_SELr, REG_PORT_ANY, 0, rv)

#define REG_READ_QOS_M_TOS_THr(unit, rvp) \
	ROBO_REG_READ(unit, QOS_M_TOS_THr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_QOS_M_TOS_THr(unit, rv) \
	ROBO_REG_WRITE(unit, QOS_M_TOS_THr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_QOS_R_TOS_THr(unit, rvp) \
	ROBO_REG_READ(unit, QOS_R_TOS_THr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_QOS_R_TOS_THr(unit, rv) \
	ROBO_REG_WRITE(unit, QOS_R_TOS_THr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_QOS_TOS_DIF_CTLr(unit, rvp) \
	ROBO_REG_READ(unit, QOS_TOS_DIF_CTLr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_QOS_TOS_DIF_CTLr(unit, rv) \
	ROBO_REG_WRITE(unit, QOS_TOS_DIF_CTLr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_QOS_T_TOS_THr(unit, rvp) \
	ROBO_REG_READ(unit, QOS_T_TOS_THr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_QOS_T_TOS_THr(unit, rv) \
	ROBO_REG_WRITE(unit, QOS_T_TOS_THr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_RGMII_CTL_GP48r(unit, port, rvp) \
	ROBO_REG_READ(unit, RGMII_CTL_GP48r, port, 0, rvp)
#define REG_WRITE_RGMII_CTL_GP48r(unit, port, rv) \
	ROBO_REG_WRITE(unit, RGMII_CTL_GP48r, port, 0, rv)
...
#define REG_READ_RGMII_TIME_DLY_GP48r(unit, port, rvp) \
	ROBO_REG_READ(unit, RGMII_TIME_DLY_GP48r, port, 0, rvp)
#define REG_WRITE_RGMII_TIME_DLY_GP48r(unit, port, rv) \
	ROBO_REG_WRITE(unit, RGMII_TIME_DLY_GP48r, port, 0, rv)
...
#define REG_READ_SEC_DPMSKr(unit, rvp) \
	ROBO_REG_READ(unit, SEC_DPMSKr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_SEC_DPMSKr(unit, rv) \
	ROBO_REG_WRITE(unit, SEC_DPMSKr, REG_PORT_ANY, 0, rv)

#define REG_READ_SEC_SPMSKr(unit, rvp) \
	ROBO_REG_READ(unit, SEC_SPMSKr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_SEC_SPMSKr(unit, rv) \
	ROBO_REG_WRITE(unit, SEC_SPMSKr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_SLICE_MAP_Pr(unit, port, rvp) \
	ROBO_REG_READ(unit, SLICE_MAP_Pr, port, 0, rvp)
#define REG_WRITE_SLICE_MAP_Pr(unit, port, rv) \
	ROBO_REG_WRITE(unit, SLICE_MAP_Pr, port, 0, rv)

#define REG_READ_SLICE_MAP_P8r(unit, port, rvp) \
	ROBO_REG_READ(unit, SLICE_MAP_P8r, port, 0, rvp)
#define REG_WRITE_SLICE_MAP_P8r(unit, port, rv) \
	ROBO_REG_WRITE(unit, SLICE_MAP_P8r, port, 0, rv)

#define REG_READ_SPARE_REG0r(unit, rvp) \
	ROBO_REG_READ(unit, SPARE_REG0r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_SPARE_REG0r(unit, rv) \
	ROBO_REG_WRITE(unit, SPARE_REG0r, REG_PORT_ANY, 0, rv)

#define REG_READ_SPARE_REG1r(unit, rvp) \
	ROBO_REG_READ(unit, SPARE_REG1r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_SPARE_REG1r(unit, rv) \
	ROBO_REG_WRITE(unit, SPARE_REG1r, REG_PORT_ANY, 0, rv)

#define REG_READ_SPARE_REG2r(unit, rvp) \
	ROBO_REG_READ(unit, SPARE_REG2r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_SPARE_REG2r(unit, rv) \
	ROBO_REG_WRITE(unit, SPARE_REG2r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_STS_OVERRIDE_P24r(unit, port, rvp) \
	ROBO_REG_READ(unit, STS_OVERRIDE_P24r, port, 0, rvp)
#define REG_WRITE_STS_OVERRIDE_P24r(unit, port, rv) \
	ROBO_REG_WRITE(unit, STS_OVERRIDE_P24r, port, 0, rv)

#define REG_READ_STS_OVERRIDE_WAN_Pr(unit, port, rvp) \
	ROBO_REG_READ(unit, STS_OVERRIDE_WAN_Pr, port, 0, rvp)
#define REG_WRITE_STS_OVERRIDE_WAN_Pr(unit, port, rv) \
	ROBO_REG_WRITE(unit, STS_OVERRIDE_WAN_Pr, port, 0, rv)
...
#define REG_READ_S_PKTS1024TO1522OCTETSr(unit, rvp) \
	ROBO_REG_READ(unit, S_PKTS1024TO1522OCTETSr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_S_PKTS1024TO1522OCTETSr(unit, rv) \
	ROBO_REG_WRITE(unit, S_PKTS1024TO1522OCTETSr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_S_PKTS1523TO2047r(unit, rvp) \
	ROBO_REG_READ(unit, S_PKTS1523TO2047r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_S_PKTS1523TO2047r(unit, rv) \
	ROBO_REG_WRITE(unit, S_PKTS1523TO2047r, REG_PORT_ANY, 0, rv)

#define REG_READ_S_PKTS2048TO4095r(unit, rvp) \
	ROBO_REG_READ(unit, S_PKTS2048TO4095r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_S_PKTS2048TO4095r(unit, rv) \
	ROBO_REG_WRITE(unit, S_PKTS2048TO4095r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_S_PKTS4096TO8191r(unit, rvp) \
	ROBO_REG_READ(unit, S_PKTS4096TO8191r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_S_PKTS4096TO8191r(unit, rv) \
	ROBO_REG_WRITE(unit, S_PKTS4096TO8191r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_S_PKTS8192TO9728r(unit, rvp) \
	ROBO_REG_READ(unit, S_PKTS8192TO9728r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_S_PKTS8192TO9728r(unit, rv) \
	ROBO_REG_WRITE(unit, S_PKTS8192TO9728r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_S_RXQOSOCTETSr(unit, rvp) \
	ROBO_REG_READ(unit, S_RXQOSOCTETSr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_S_RXQOSOCTETSr(unit, rv) \
	ROBO_REG_WRITE(unit, S_RXQOSOCTETSr, REG_PORT_ANY, 0, rv)

#define REG_READ_S_RXQOSPKTSr(unit, rvp) \
	ROBO_REG_READ(unit, S_RXQOSPKTSr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_S_RXQOSPKTSr(unit, rv) \
	ROBO_REG_WRITE(unit, S_RXQOSPKTSr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_S_TXQOSOCTETSr(unit, rvp) \
	ROBO_REG_READ(unit, S_TXQOSOCTETSr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_S_TXQOSOCTETSr(unit, rv) \
	ROBO_REG_WRITE(unit, S_TXQOSOCTETSr, REG_PORT_ANY, 0, rv)

#define REG_READ_S_TXQOSPKTSr(unit, rvp) \
	ROBO_REG_READ(unit, S_TXQOSPKTSr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_S_TXQOSPKTSr(unit, rv) \
	ROBO_REG_WRITE(unit, S_TXQOSPKTSr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_TCAM_BIST_CTLr(unit, rvp) \
	ROBO_REG_READ(unit, TCAM_BIST_CTLr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_TCAM_BIST_CTLr(unit, rv) \
	ROBO_REG_WRITE(unit, TCAM_BIST_CTLr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_TCAM_BIST_STS0r(unit, rvp) \
	ROBO_REG_READ(unit, TCAM_BIST_STS0r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_TCAM_BIST_STS0r(unit, rv) \
	ROBO_REG_WRITE(unit, TCAM_BIST_STS0r, REG_PORT_ANY, 0, rv)

#define REG_READ_TCAM_BIST_STS1r(unit, rvp) \
	ROBO_REG_READ(unit, TCAM_BIST_STS1r, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_TCAM_BIST_STS1r(unit, rv) \
	ROBO_REG_WRITE(unit, TCAM_BIST_STS1r, REG_PORT_ANY, 0, rv)
...
#define REG_READ_TRUNK_GRP0_CTLr(unit, rvp) \
	ROBO_REG_READ(unit, TRUNK_GRP0_CTLr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_TRUNK_GRP0_CTLr(unit, rv) \
	ROBO_REG_WRITE(unit, TRUNK_GRP0_CTLr, REG_PORT_ANY, 0, rv)

#define REG_READ_TRUNK_GRP1_CTLr(unit, rvp) \
	ROBO_REG_READ(unit, TRUNK_GRP1_CTLr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_TRUNK_GRP1_CTLr(unit, rv) \
	ROBO_REG_WRITE(unit, TRUNK_GRP1_CTLr, REG_PORT_ANY, 0, rv)

#define REG_READ_TRUNK_GRP2_CTLr(unit, rvp) \
	ROBO_REG_READ(unit, TRUNK_GRP2_CTLr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_TRUNK_GRP2_CTLr(unit, rv) \
	ROBO_REG_WRITE(unit, TRUNK_GRP2_CTLr, REG_PORT_ANY, 0, rv)

#define REG_READ_TRUNK_GRP3_CTLr(unit, rvp) \
	ROBO_REG_READ(unit, TRUNK_GRP3_CTLr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_TRUNK_GRP3_CTLr(unit, rv) \
	ROBO_REG_WRITE(unit, TRUNK_GRP3_CTLr, REG_PORT_ANY, 0, rv)
...
#define REG_READ_UDF_OFFSET0_Pr(unit, port, rvp) \
	ROBO_REG_READ(unit, UDF_OFFSET0_Pr, port, 0, rvp)
#define REG_WRITE_UDF_OFFSET0_Pr(unit, port, rv) \
	ROBO_REG_WRITE(unit, UDF_OFFSET0_Pr, port, 0, rv)

#define REG_READ_UDF_OFFSET0_P8r(unit, port, rvp) \
	ROBO_REG_READ(unit, UDF_OFFSET0_P8r, port, 0, rvp)
#define REG_WRITE_UDF_OFFSET0_P8r(unit, port, rv) \
	ROBO_REG_WRITE(unit, UDF_OFFSET0_P8r, port, 0, rv)

#define REG_READ_UDF_OFFSET2_Pr(unit, port, rvp) \
	ROBO_REG_READ(unit, UDF_OFFSET2_Pr, port, 0, rvp)
#define REG_WRITE_UDF_OFFSET2_Pr(unit, port, rv) \
	ROBO_REG_WRITE(unit, UDF_OFFSET2_Pr, port, 0, rv)

#define REG_READ_UDF_OFFSET3_Pr(unit, port, rvp) \
	ROBO_REG_READ(unit, UDF_OFFSET3_Pr, port, 0, rvp)
#define REG_WRITE_UDF_OFFSET3_Pr(unit, port, rv) \
	ROBO_REG_WRITE(unit, UDF_OFFSET3_Pr, port, 0, rv)

#define REG_READ_UDF_OFFSET4_EXPr(unit, idx, rvp) \
	ROBO_REG_READ(unit, UDF_OFFSET4_EXPr, REG_PORT_ANY, idx, rvp)
#define REG_WRITE_UDF_OFFSET4_EXPr(unit, idx, rv) \
	ROBO_REG_WRITE(unit, UDF_OFFSET4_EXPr, REG_PORT_ANY, idx, rv)

#define REG_READ_UDF_OFFSET4_GPr(unit, port, rvp) \
	ROBO_REG_READ(unit, UDF_OFFSET4_GPr, port, 0, rvp)
#define REG_WRITE_UDF_OFFSET4_GPr(unit, port, rv) \
	ROBO_REG_WRITE(unit, UDF_OFFSET4_GPr, port, 0, rv)

#define REG_READ_UDF_OFFSET4_IMPr(unit, port, rvp) \
	ROBO_REG_READ(unit, UDF_OFFSET4_IMPr, port, 0, rvp)
#define REG_WRITE_UDF_OFFSET4_IMPr(unit, port, rv) \
	ROBO_REG_WRITE(unit, UDF_OFFSET4_IMPr, port, 0, rv)

#define REG_READ_UDF_OFFSET4_Pr(unit, port, rvp) \
	ROBO_REG_READ(unit, UDF_OFFSET4_Pr, port, 0, rvp)
#define REG_WRITE_UDF_OFFSET4_Pr(unit, port, rv) \
	ROBO_REG_WRITE(unit, UDF_OFFSET4_Pr, port, 0, rv)

#define REG_READ_UDF_OFFSET4_P8r(unit, port, rvp) \
	ROBO_REG_READ(unit, UDF_OFFSET4_P8r, port, 0, rvp)
#define REG_WRITE_UDF_OFFSET4_P8r(unit, port, rv) \
	ROBO_REG_WRITE(unit, UDF_OFFSET4_P8r, port, 0, rv)

#define REG_READ_UDF_OFFSET5_Pr(unit, port, rvp) \
	ROBO_REG_READ(unit, UDF_OFFSET5_Pr, port, 0, rvp)
#define REG_WRITE_UDF_OFFSET5_Pr(unit, port, rv) \
	ROBO_REG_WRITE(unit, UDF_OFFSET5_Pr, port, 0, rv)

#define REG_READ_UDF_OFFSET5_P8r(unit, port, rvp) \
	ROBO_REG_READ(unit, UDF_OFFSET5_P8r, port, 0, rvp)
#define REG_WRITE_UDF_OFFSET5_P8r(unit, port, rv) \
	ROBO_REG_WRITE(unit, UDF_OFFSET5_P8r, port, 0, rv)
...
#define REG_READ_VLAN_MAC_ADDR_INDXr(unit, rvp) \
	ROBO_REG_READ(unit, VLAN_MAC_ADDR_INDXr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_VLAN_MAC_ADDR_INDXr(unit, rv) \
	ROBO_REG_WRITE(unit, VLAN_MAC_ADDR_INDXr, REG_PORT_ANY, 0, rv)

#define REG_READ_VLAN_MAC_CTRLr(unit, rvp) \
	ROBO_REG_READ(unit, VLAN_MAC_CTRLr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_VLAN_MAC_CTRLr(unit, rv) \
	ROBO_REG_WRITE(unit, VLAN_MAC_CTRLr, REG_PORT_ANY, 0, rv)

#define REG_READ_VLAN_MAC_HASHSELr(unit, rvp) \
	ROBO_REG_READ(unit, VLAN_MAC_HASHSELr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_VLAN_MAC_HASHSELr(unit, rv) \
	ROBO_REG_WRITE(unit, VLAN_MAC_HASHSELr, REG_PORT_ANY, 0, rv)

#define REG_READ_VLAN_MAC_TBL_ACSr(unit, rvp) \
	ROBO_REG_READ(unit, VLAN_MAC_TBL_ACSr, REG_PORT_ANY, 0, rvp)
#define REG_WRITE_VLAN_MAC_TBL_ACSr(unit, rv) \
	ROBO_REG_WRITE(unit, VLAN_MAC_TBL_ACSr, REG_PORT_ANY, 0, rv)

#define REG_READ_VLAN_MAC_TBL_DATAr(unit, idx, rvp) \
	ROBO_REG_READ(unit, VLAN_MAC_TBL_DATAr, REG_PORT_ANY, idx, rvp)
#define REG_WRITE_VLAN_MAC_TBL_DATAr(unit, idx, rv) \
	ROBO_REG_WRITE(unit, VLAN_MAC_TBL_DATAr, REG_PORT_ANY, idx, rv)
...
#define MEM_READ_CFP_TCAM_S3m(unit, index, data) \
	ROBO_MEM_READ(unit, CFP_TCAM_S3m, index, data)
#define MEM_WRITE_CFP_TCAM_S3m(unit, index, data) \
	ROBO_MEM_WRITE(unit, CFP_TCAM_S3m, index, data)

#define MEM_READ_CFP_TCAM_S4m(unit, index, data) \
	ROBO_MEM_READ(unit, CFP_TCAM_S4m, index, data)
#define MEM_WRITE_CFP_TCAM_S4m(unit, index, data) \
	ROBO_MEM_WRITE(unit, CFP_TCAM_S4m, index, data)

#define MEM_READ_CFP_TCAM_S5m(unit, index, data) \
	ROBO_MEM_READ(unit, CFP_TCAM_S5m, index, data)
#define MEM_WRITE_CFP_TCAM_S5m(unit, index, data) \
	ROBO_MEM_WRITE(unit, CFP_TCAM_S5m, index, data)
...
#define MEM_READ_STSEC_COUNTER0m(unit, index, data) \
	ROBO_MEM_READ(unit, STSEC_COUNTER0m, index, data)
#define MEM_WRITE_STSEC_COUNTER0m(unit, index, data) \
	ROBO_MEM_WRITE(unit, STSEC_COUNTER0m, index, data)

#define MEM_READ_STSEC_COUNTER1m(unit, index, data) \
	ROBO_MEM_READ(unit, STSEC_COUNTER1m, index, data)
#define MEM_WRITE_STSEC_COUNTER1m(unit, index, data) \
	ROBO_MEM_WRITE(unit, STSEC_COUNTER1m, index, data)

#define MEM_READ_STSEC_COUNTER2m(unit, index, data) \
	ROBO_MEM_READ(unit, STSEC_COUNTER2m, index, data)
#define MEM_WRITE_STSEC_COUNTER2m(unit, index, data) \
	ROBO_MEM_WRITE(unit, STSEC_COUNTER2m, index, data)

#define MEM_READ_STSEC_MAC0m(unit, index, data) \
	ROBO_MEM_READ(unit, STSEC_MAC0m, index, data)
#define MEM_WRITE_STSEC_MAC0m(unit, index, data) \
	ROBO_MEM_WRITE(unit, STSEC_MAC0m, index, data)

#define MEM_READ_STSEC_MAC1m(unit, index, data) \
	ROBO_MEM_READ(unit, STSEC_MAC1m, index, data)
#define MEM_WRITE_STSEC_MAC1m(unit, index, data) \
	ROBO_MEM_WRITE(unit, STSEC_MAC1m, index, data)

#define MEM_READ_STSEC_MAC2m(unit, index, data) \
	ROBO_MEM_READ(unit, STSEC_MAC2m, index, data)
#define MEM_WRITE_STSEC_MAC2m(unit, index, data) \
	ROBO_MEM_WRITE(unit, STSEC_MAC2m, index, data)
