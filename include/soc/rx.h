...
typedef enum soc_rx_reason_e {
    ...
    socRxReasonFlowTracker = _SHR_RX_FLOW_TRACKER, 
    socRxReasonProtectionDrop = _SHR_RX_PROTECTION_DROP, 
    socRxReasonTrillNickname = _SHR_RX_TRILL_NICKNAME, 
    socRxReasonWlanShimHdrError = _SHR_RX_WLAN_SHIM_HDR_ERROR, 
    socRxReasonMplsEntropyLabelRange = _SHR_RX_MPLS_ENTROPY_LABEL_RANGE, 
    socRxReasonQcnCnmPrp = _SHR_RX_QCN_CNM_PRP, 
    socRxReasonQcnCnmPrpDlf = _SHR_RX_QCN_CNM_PRP_DLF, 
    socRxReasonIcnm = _SHR_RX_ICNM, 
    socRxReasonMplsUnknownAch = _SHR_RX_MPLS_UNKNOWN_ACH, 
    socRxReasonMplsLookupsExceeded = _SHR_RX_MPLS_OUT_OF_LOOKUPS, 
    socRxReasonMplsReservedLabel = _SHR_RX_MPLS_ILLEGAL_RESERVED_LABEL, 
    socRxReasonMplsAlertLabel = _SHR_RX_MPLS_ALERT_LABEL, 
    socRxReasonNivPrune = _SHR_RX_NIV_PRUNE, 
    socRxReasonSplitHorizonPrune = _SHR_RX_SPLIT_HORIZON_PRUNE, 
    socRxReasonMultiDest = _SHR_RX_MULTI_DEST, 
    socRxReasonTrillPortMismatch = _SHR_RX_TRILL_PORT_MISMATCH, 
    socRxReasonSignatureMatch = _SHR_RX_SIGNATURE_MATCH, 
    socRxReasonWlanClientMove = _SHR_RX_WLAN_CLIENT_MOVE, 
    socRxReasonWlanSourcePortMiss = _SHR_RX_WLAN_SOURCE_PORT_MISS, 
    socRxReasonWlanDatabaseError = _SHR_RX_WLAN_DATABASE_ERROR, 
    socRxReasonWlanSourceMiss = _SHR_RX_WLAN_SOURCE_MISS, 
    socRxReasonWlanDestMiss = _SHR_RX_WLAN_DEST_MISS, 
