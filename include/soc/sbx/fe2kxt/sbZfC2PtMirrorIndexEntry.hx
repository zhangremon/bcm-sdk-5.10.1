...
/*
 * $Id: sbZfC2PtMirrorIndexEntry.hx 1.3.16.4 Broadcom SDK $
...
typedef struct _sbZfC2PtMirrorIndexEntry {
  ...
  uint32_t m_uHiGigHdr;
  uint32_t m_uDropSrcPkt;
  uint32_t m_uHdrPresent;
  uint32_t m_uMirrorQueue;
  uint32_t m_uHeaderData3;
  uint32_t m_uHeaderData2;
  uint32_t m_uHeaderData1;
  uint32_t m_uHeaderData0;
