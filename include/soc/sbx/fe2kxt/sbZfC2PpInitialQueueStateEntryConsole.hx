/*
 * $Id: sbZfC2PpInitialQueueStateEntryConsole.hx 1.3.16.4 Broadcom SDK $
...
#ifndef SB_ZF_C2PPINITIALQUEUESTATEENTRY_CONSOLE_H
#define SB_ZF_C2PPINITIALQUEUESTATEENTRY_CONSOLE_H
...
#endif /* ifndef SB_ZF_C2PPINITIALQUEUESTATEENTRY_CONSOLE_H */
