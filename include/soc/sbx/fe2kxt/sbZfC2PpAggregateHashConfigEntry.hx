...
/*
 * $Id: sbZfC2PpAggregateHashConfigEntry.hx,v 1.3.16.4 2011/05/22 05:38:30 iakramov Exp $
 * $Copyright (c) 2011 Broadcom Corporation
 * All rights reserved.$
 */


#ifndef SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_H
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_H

#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_SIZE_IN_BYTES 40
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_SIZE 40
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_M_UDATA9_BITS "319:288"
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_M_UDATA8_BITS "287:256"
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_M_UDATA7_BITS "255:224"
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_M_UDATA6_BITS "223:192"
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_M_UDATA5_BITS "191:160"
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_M_UDATA4_BITS "159:128"
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_M_UDATA3_BITS "127:96"
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_M_UDATA2_BITS "95:64"
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_M_UDATA1_BITS "63:32"
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_M_UDATA0_BITS "31:0"


typedef struct _sbZfC2PpAggregateHashConfigEntry {
  uint32_t m_uData9;
  uint32_t m_uData8;
  uint32_t m_uData7;
  uint32_t m_uData6;
  ...
  uint32_t m_uData1;
  uint32_t m_uData0;
} sbZfC2PpAggregateHashConfigEntry_t;
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_SET_DATA9(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_SET_DATA8(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_SET_DATA7(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_SET_DATA6(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_SET_DATA5(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_SET_DATA4(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_SET_DATA3(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_SET_DATA2(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_SET_DATA1(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_SET_DATA0(nFromData,pToData,nMaxToDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_GET_DATA9(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_GET_DATA8(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_GET_DATA7(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_GET_DATA6(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_GET_DATA5(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_GET_DATA4(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_GET_DATA3(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_GET_DATA2(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_GET_DATA1(nToData,pFromData,nMaxFromDataIndex) \
          do { \
...
#define SB_ZF_C2PPAGGREGATEHASHCONFIGENTRY_GET_DATA0(nToData,pFromData,nMaxFromDataIndex) \
          do { \
