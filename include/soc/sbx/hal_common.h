...
/*
 *$Id: hal_common.h 1.8 Broadcom SDK $
...
#define SAND_HAL_READ_OFFS_POLL(addr, offs) \
     (SOC_IS_RELOADING((int32)addr)) ? 0xffffffff: SAND_HAL_READ_OFFS(addr, offs)
#else
...
#define SAND_HAL_READ_POLL(addr, device, reg) \
     (SOC_IS_RELOADING((int32)addr)) ? 0xffffffff: SAND_HAL_READ_OFFS((addr), SAND_HAL_REG_OFFSET(device,reg))
#else
...
(SOC_IS_RELOADING((int32)addr)) ? 0xffffffff: SAND_HAL_READ_OFFS((addr),(id*SAND_HAL_##device##_##block##_INSTANCE_ADDR_STRIDE+SAND_HAL_REG_OFFSET(device,reg)))
#else
...
#if defined(BCM_EASY_RELOAD_SUPPORT)
#define SAND_HAL_WRITE(addr,device,reg,value) (SOC_IS_RELOADING((int32)addr)) ? 0 : SAND_HAL_WRITE_OFFS((addr),(SAND_HAL_REG_OFFSET(device,reg)),(value))
#else
...
#define SAND_HAL_WRITE_STRIDE(addr,device,block,id,reg,value) \
    (SOC_IS_RELOADING((int32)addr)) ? 0: SAND_HAL_WRITE_OFFS((addr),(id*SAND_HAL_##device##_##block##_INSTANCE_ADDR_STRIDE+SAND_HAL_REG_OFFSET(device,reg)),(value))
#else
...
#define SAND_HAL_WRITE_RAW(addr,device,reg,value) \
    (SOC_IS_RELOADING((int32)addr)) ? 0: SAND_HAL_WRITE_OFFS_RAW((addr),SAND_HAL_REG_OFFSET(device,reg),(value))
#else
...
#define SAND_HAL_WRITE_STRIDE_RAW(addr,device,block,id,reg,value) \
    (SOC_IS_RELOADING((int32)addr)) ? 0: SAND_HAL_WRITE_OFFS_RAW((addr),(id*SAND_HAL_##device##_##block##_INSTANCE_ADDR_STRIDE+SAND_HAL_REG_OFFSET_RAW(device,reg)),(value))
#else
...
#define SAND_HAL_WRITE_INDEX(addr,device,reg,index,value) \
    (SOC_IS_RELOADING((int32)addr)) ?  0: SAND_HAL_WRITE_OFFS((addr),SAND_HAL_REG_OFFSET(device,reg)+(index)*4,(value))
#else
...
#define SAND_HAL_WRITE_INDEX_RAW(addr,device,reg,index,value) \
    (SOC_IS_RELOADING((int32)addr)) ? 0: SAND_HAL_WRITE_OFFS_RAW((addr),SAND_HAL_REG_OFFSET(device,reg)+(index)*4,(value))
#else
...
#define SAND_HAL_WRITE_INDEX_STRIDE(addr,device,block,id,reg,index,value) \
    (SOC_IS_RELOADING((int32)addr)) ? 0:  SAND_HAL_WRITE_OFFS((addr),SAND_HAL_REG_OFFSET_STRIDE(device,block,id,reg)+(index)*4,(value))
#else
...
#define SAND_HAL_WRITE_INDEX_STRIDE_RAW(addr,device,block,id,reg,index,value) \
    (SOC_IS_RELOADING((int32)addr)) ? 0: SAND_HAL_WRITE_OFFS_RAW((addr),SAND_HAL_REG_OFFSET_STRIDE(device,block,id,reg)+(index)*4,(value))
#else
...
#ifndef SAND_HAL_ERROR
#ifndef VXWORKS
#endif /* !VXWORKS */
#define SAND_HAL_ERROR(x...) do{printf("ERROR: ");printf(x);printf("\n");}while(0)
#endif
