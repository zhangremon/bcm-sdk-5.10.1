...
/*
 * $Id: sbZfFabBm9600NmFullStatusEntry.hx 1.1.16.4 Broadcom SDK $
...
typedef struct _sbZfFabBm9600NmFullStatusEntry {
  uint32_t m_FullStatus8;
  uint32_t m_FullStatus7;
  uint32_t m_FullStatus6;
  uint32_t m_FullStatus5;
  uint32_t m_FullStatus4;
  uint32_t m_FullStatus3;
  uint32_t m_FullStatus2;
  uint32_t m_FullStatus1;
  uint32_t m_FullStatus0;
...
#define SB_ZF_FABBM9600NMFULLSTATUSENTRY_GET_FS8(nToData,pFromData,nMaxFromDataIndex) \
          do { \
           ...
           (nToData) |= (uint32_t) ((pFromData)[34] & 0x03) << 8; \
          } while(0)
...
#define SB_ZF_FABBM9600NMFULLSTATUSENTRY_GET_FS8(nToData,pFromData,nMaxFromDataIndex) \
          do { \
           ...
           (nToData) |= (uint32_t) ((pFromData)[33] & 0x03) << 8; \
          } while(0)
