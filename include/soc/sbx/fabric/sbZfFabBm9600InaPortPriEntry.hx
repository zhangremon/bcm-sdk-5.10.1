...
/*
 * $Id: sbZfFabBm9600InaPortPriEntry.hx 1.1.44.4 Broadcom SDK $
...
typedef struct _sbZfFabBm9600InaPortPriEntry {
  uint32_t m_uPri_15;
  uint32_t m_uNextpri_15;
  uint32_t m_uPri_14;
  uint32_t m_uNextpri_14;
  uint32_t m_uPri_13;
  uint32_t m_uNextpri_13;
  uint32_t m_uPri_12;
  uint32_t m_uNextpri_12;
  uint32_t m_uPri_11;
  uint32_t m_uNextpri_11;
  uint32_t m_uPri_10;
  uint32_t m_uNextpri_10;
  uint32_t m_uPri_9;
  uint32_t m_uNextpri_9;
  uint32_t m_uPri_8;
  uint32_t m_uNextpri_8;
  uint32_t m_uPri_7;
  uint32_t m_uNextpri_7;
  uint32_t m_uPri_6;
  uint32_t m_uNextpri_6;
  uint32_t m_uPri_5;
  uint32_t m_uNextpri_5;
  uint32_t m_uPri_4;
  uint32_t m_uNextpri_4;
  uint32_t m_uPri_3;
  uint32_t m_uNextpri_3;
  uint32_t m_uPri_2;
  uint32_t m_uNextpri_2;
  uint32_t m_uPri_1;
  uint32_t m_uNextpri_1;
  uint32_t m_uPri_0;
  uint32_t m_uNextpri_0;
...
#define SB_ZF_FABBM9600INAPORTPRIENTRY_GET_NEXTPRI_14(nToData,pFromData,nMaxFromDataIndex) \
          do { \
           (nToData) = (uint32_t) ((pFromData)[13]) & 0x0f; \
          } while(0)
...
#define SB_ZF_FABBM9600INAPORTPRIENTRY_GET_NEXTPRI_13(nToData,pFromData,nMaxFromDataIndex) \
          do { \
           (nToData) = (uint32_t) ((pFromData)[14]) & 0x0f; \
          } while(0)
