...
/*
 * $Id: sbZfFabBm3200BwPrtEntry.hx 1.1.28.4 Broadcom SDK $
...
#define SB_ZF_FABBM3200BWPRTENTRY_GET_SPGROUPS(nToData,pFromData,nMaxFromDataIndex) \
          do { \
           ...
           (nToData) |= (uint32_t) ((pFromData)[4] & 0x03) << 3; \
          } while(0)
...
#define SB_ZF_FABBM3200BWPRTENTRY_GET_SPGROUPS(nToData,pFromData,nMaxFromDataIndex) \
          do { \
           ...
           (nToData) |= (uint32_t) ((pFromData)[7] & 0x03) << 3; \
          } while(0)
...
#endif
/*
 * $Id: sbZfFabBm3200BwPrtEntry.hx,v 1.1.28.4 2011/05/22 05:37:52 iakramov Exp $
 * $Copyright: Copyright 2011 Broadcom Corporation.
 * This program is the proprietary software of Broadcom Corporation
 * and/or its licensors, and may only be used, duplicated, modified
 * or distributed pursuant to the terms and conditions of a separate,
