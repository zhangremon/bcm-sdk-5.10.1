 ...
 *
 * $Id: g2xx_pp.h 1.4.108.1 Broadcom SDK $
 *
 *-----------------------------------------------------------------------------*/
...
typedef uint32_t soc_sbx_g2xx_pp_lsmid_t;
typedef uint32_t soc_sbx_g2xx_pp_l2cptunnelid_t;
typedef uint32_t soc_sbx_g2xx_pp_tunnel_id_t;
typedef uint32_t soc_sbx_g2xx_pp_tcp_filter_id_t;
typedef uint32_t soc_sbx_g2xx_pp_udp_filter_id_t;
 ...
 */
extern sbStatus_t
soc_sbx_g2xx_pp_oam_up_match_set (int unit, uint32_t uValid);
