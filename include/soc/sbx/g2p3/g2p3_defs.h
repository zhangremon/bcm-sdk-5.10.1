/*
 * $Id: g2p3_defs.h 1.428.6.3 Broadcom SDK $
 *
 *
 *
...
typedef enum soc_sbx_g2p3_constant_id_s {
    ...
    SOC_SBX_G2P3_MIN_FREE_EXCEPTION_ID,
...
typedef struct soc_sbx_g2p3_dscp_qos_s {
     ...
     * update of the IFP database.  The RCE control software 
     * manages these extra table elements automatically.
     */
...
typedef struct soc_sbx_g2p3_label2e_s {
     ...
     */
    uint32 ftidx0;
    /** perform LER forwarding for this label */
    uint32 leren;
    /** perform PWE3 with ACH forwarding for this label */
    uint32 pwe3;
 ...
 * @param[out] vp returns value
 */
extern int soc_sbx_g2p3_min_free_exception_get(int unit, uint32 *vp);
 ...
 * @param[in]  sets array of set flags for policer (NULL means set all)
 * @param[in]  vs array of new values for policer
 * @param[in]  vcount array size of vs
 */
extern int soc_sbx_g2p3_lp_policer_fast_set(int unit,
                int ilpi,
                int eilpi,
                int *sets,
                uint32 *vs,
 ...
 * @param[in]  ilpi logical port table index
 * @param[in]  eilpi ending logical port table index
 * @param[in]  sets array of set flags for counter (NULL means set all)
 * @param[in]  vs array of new values for counter
 * @param[in]  vcount array size of vs
 */
extern int soc_sbx_g2p3_lp_counter_fast_set(int unit,
                int ilpi,
                int eilpi,
                int *sets,
                uint32 *vs,
 ...
 * @param[in]  ilpi logical port table index
 * @param[in]  eilpi ending logical port table index
 * @param[out]  vs array of values for counter
 * @param[in]   vcount array size of vs
 */
extern int soc_sbx_g2p3_lp_counter_fast_get(int unit,
                int ilpi,
                int eilpi,
                uint32 *vs,
                int vcount);
