...
/*
 * $Id: sbZfFe2000RcDmaFormat.hx 1.3.36.4 Broadcom SDK $
...
typedef struct 
{
  uint32_t    uInstruction[4];
  uint32_t    uPattern[32];
} sbFe2000RcDmaBlock_t;

typedef struct 
{
  uint32_t *pInstruction[4];
  uint32_t *pPattern[32];
} sbFe2000RcDmaFormatAlias_t;

typedef struct _sbZfFe2000RcDmaFormat {
  uint32_t uInstruction0;
  uint32_t uInstruction1;
  uint32_t uInstruction2;
  uint32_t uInstruction3;
  uint32_t uResv0;
  uint32_t uResv1;
  uint32_t uResv2;
  uint32_t uResv3;
  ...
  uint32_t uResv26;
  uint32_t uResv27;
  uint32_t uSb0Pattern0_31_0;
  uint32_t uSb0Pattern0_63_32;
  uint32_t uSb0Pattern0_95_64;
  uint32_t uSb0Pattern0_127_96;
  uint32_t uSb0Pattern1_31_0;
  uint32_t uSb0Pattern1_63_32;
  uint32_t uSb0Pattern1_95_64;
  uint32_t uSb0Pattern1_127_96;
  uint32_t uSb0Pattern2_31_0;
  uint32_t uSb0Pattern2_63_32;
  uint32_t uSb0Pattern2_95_64;
  uint32_t uSb0Pattern2_127_96;
  uint32_t uSb0Pattern3_31_0;
  uint32_t uSb0Pattern3_63_32;
  uint32_t uSb0Pattern3_95_64;
  uint32_t uSb0Pattern3_127_96;
  uint32_t uSb1Pattern0_31_0;
  uint32_t uSb1Pattern0_63_32;
  uint32_t uSb1Pattern0_95_64;
  uint32_t uSb1Pattern0_127_96;
  uint32_t uSb1Pattern1_31_0;
  uint32_t uSb1Pattern1_63_32;
  uint32_t uSb1Pattern1_95_64;
  uint32_t uSb1Pattern1_127_96;
  uint32_t uSb1Pattern2_31_0;
  uint32_t uSb1Pattern2_63_32;
  uint32_t uSb1Pattern2_95_64;
  uint32_t uSb1Pattern2_127_96;
  uint32_t uSb1Pattern3_31_0;
  uint32_t uSb1Pattern3_63_32;
  uint32_t uSb1Pattern3_95_64;
  uint32_t uSb1Pattern3_127_96;
...
uint32_t sbZfFe2000RcDmaFormat_Pack32(sbZfFe2000RcDmaFormat_t *pFrom,
                                      uint32_t *pToData, 
                                      uint32_t uMaxDataLength);
