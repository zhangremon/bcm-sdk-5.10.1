 ...
 *
 * $Id: sbFe2000Driver.h 1.7.52.1 Broadcom SDK $
 *
 ******************************************************************************/
...
uint32_t 
sbFe2000RcProgramWrite(sbhandle userDeviceHandle, uint32_t uRcInstance, uint32_t uBaseInstruction, uint32_t *puData);
