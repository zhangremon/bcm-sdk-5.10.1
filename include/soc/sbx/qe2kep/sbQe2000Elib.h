 ...
 * ========================================
 *
 * WORKING REVISION: $Id: sbQe2000Elib.h 1.2.224.1 Broadcom SDK $
 *
...
typedef struct sb_qe2000_elib_ip_mem_seg_cfg_s {
    uint32_t ulOffset;                  /**< Offset of segment in 8x64-bit words */
    uint32_t ulLength;                  /**< Length of segment in 8x64-bit words */
    uint32_t ulWordSize;                /**< Log2(n) size of data word in bits */
...
typedef struct sb_qe2000_elib_dma_func_params_s {
    ...
    uint32_t ulStartAddr;                    /**< Start address within specified memory */
    uint32_t ulNumLines;                     /**< Number of lines to transfer */
    uint32_t ulPreserve;                     /**< Preserve the memory contents */
...
typedef struct sb_qe2000_elib_init_params_s {
    ...
    uint32_t ulVlanA;           /**< VLAN Tag A to use for VLAN Encapsulation - Default 0x8100 (ep_ip_vencap_tag) */
    uint32_t ulVlanB;           /**< VLAN Tag B to use for VLAN Encapsulation - Default 0x9100 (ep_ip_vencap_tag) */
    uint32_t ulEthertype0;      /**< Ethertype for ucast Ethernet payload type 0 - Default 0x0000 (ep_ip_ueencap_type0) */
    uint32_t ulEthertype1;      /**< Ethertype for ucast Ethernet payload type 1 - Default 0x0000 (ep_ip_ueencap_type1) */
    uint64_t ullERHForward;     /**< Enable transmission of Egress Route Header (ERH) Per Port Bit Mask (ep_bf_erhX) - Default 0 (drop) */
    uint64_t ullSmacMsbEnable;  /**< Enable SMAC MSB, Per Port BitMask, default 0 (do not enable SMAC MC bit rewrite) */
    uint64_t ullMirrorEnable;     /**< Enable mirroring, Per Port BitMask */
...
/*
 * TODO: Need to add indication path for errors.  Idea is that elib catches EP errors, and
 *       indicates them to the application through a callback mechanism. TBD.  This is a
 *       placeholder to track this issue.
 */
...
typedef struct sb_qe2000_elib_port_cfg_s {
    ...
    uint32_t ulInst;                        /**< EP Instruction to associate with this port (PT) */
...
typedef struct sb_qe2000_elib_crt_bit_sel_s {
    ...
    uint32_t ulOffset;                  /**< Bit offset within the Source Field */
...
{
    uint32_t ulInst[SB_QE2000_ELIB_NUM_CLASS_INSTR_K];         /**< EP Instruction  */
 ...
 *
 * @param pullPacketCnt  A pointer to a uint64_t.  Upon a return indication of success,
 *                       this contains the packet count for the (port,class) pair.
 *
 * @param pullByteCnt    A pointer to a uint64_t.  Upon a return indication of success,
 ...
 * @return            Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanRecordCreate( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulScIdx, uint32_t ulVid,
 ...
 * @return            Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanRecordGet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulScIdx,
 ...
 * @return            Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanPortStateSet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulScIdx, uint32_t ulPort,
                                  SB_QE2000_ELIB_VRT_PS_T tPortState );
 ...
 * @return            Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanPortStateGet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulScIdx,
                                  uint32_t ulPort, SB_QE2000_ELIB_VRT_PS_T *ptPortState);
 ...
 * @return            Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanVidUpdate( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulScIdx, uint32_t ulVid);
 ...
 * @return              Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanScIdxAttach( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulScIdx,
                                       uint32_t ulScIdxAttach );
 ...
 * @return        Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanScIdxDetach( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulScIdx );
 ...
 * @return        Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanRecordDelete( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulScIdx );
 ...
 * @return          Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanCountGet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulScIdx,
 ...
 * @return          Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanCountAccumulateGet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulScIdx,
                                        bool_t bClrOnRd,
 ...
 * @return          Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanCountGetAll( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulScIdx,
                                 bool_t bClrOnRd,
                                 SB_QE2000_ELIB_COUNTER_ST aCounts[SB_QE2000_ELIB_MAX_COUNTERS_K]);
 ...
 * @return        Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanCountAccumulate( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulNumScIdx, uint32_t *pulCounts );
 ...
 * @return        Status.  0 indicates success.  Non-zero indicates failure.
 */
sbElibStatus_et sbQe2000ElibVlanCounterSetsAccumulate( SB_QE2000_ELIB_HANDLE Handle, uint32_t *pulNumCounters );
...
typedef struct sb_qe2000_elib_cmap_s {
    uint32_t ulFwdMap[ SB_QE2000_ELIB_NUM_CLASSES_K ];      /**< Forward Counter Map. */
    uint32_t ulDrpMap[ SB_QE2000_ELIB_NUM_CLASSES_K ];      /**< Drop Counter Map. */
...
typedef struct sb_qe2000_elib_error_s {
    ...
    uint32_t ulUnmanagedVlan;   /**< VLAN associated w/ BfPortUnmanaged Error */
    uint32_t ulUnmanagedPort;   /**< Port associated w/ BfPortUnmanaged Error */
    bool_t   bIpSegErr;         /**< Segment Addressing Error */
    bool_t   bBfVlanDisabled;   /**< Frame arrived for Disabled or uninit'ed VLAN */
    uint32_t ulDisabledVlan;    /**< VLAN associated w/ Disabled error */
 ...
 * SB_LOGV3.  Useful for low level debugging only.
 *
 * @param Handle    A valid SB_QE2000_ELIB_HANDLE.
 *
