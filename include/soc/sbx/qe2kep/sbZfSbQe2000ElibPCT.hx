...
/*
 * $Id: sbZfSbQe2000ElibPCT.hx 1.3.36.4 Broadcom SDK $
 ...
 * =================================================================
 *
 * WORKING REVISION: $Id: sbZfSbQe2000ElibPCT.hx,v 1.3.36.4 2011/05/22 05:39:03 iakramov Exp $
 *
...
typedef struct _sbZfSbQe2000ElibPCT {
  uint64_t m_PktClass15;
  uint64_t m_ByteClass15;
  uint64_t m_PktClass14;
  uint64_t m_ByteClass14;
  uint64_t m_PktClass13;
  uint64_t m_ByteClass13;
  uint64_t m_PktClass12;
  uint64_t m_ByteClass12;
  uint64_t m_PktClass11;
  uint64_t m_ByteClass11;
  uint64_t m_PktClass10;
  uint64_t m_ByteClass10;
  uint64_t m_PktClass9;
  uint64_t m_ByteClass9;
  uint64_t m_PktClass8;
  uint64_t m_ByteClass8;
  uint64_t m_PktClass7;
  uint64_t m_ByteClass7;
  uint64_t m_PktClass6;
  uint64_t m_ByteClass6;
  uint64_t m_PktClass5;
  uint64_t m_ByteClass5;
  uint64_t m_PktClass4;
  uint64_t m_ByteClass4;
  uint64_t m_PktClass3;
  uint64_t m_ByteClass3;
  uint64_t m_PktClass2;
  uint64_t m_ByteClass2;
  uint64_t m_PktClass1;
  uint64_t m_ByteClass1;
  uint64_t m_PktClass0;
  uint64_t m_ByteClass0;
