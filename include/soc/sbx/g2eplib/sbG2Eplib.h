 ...
 * ====================================================
 *
 * WORKING REVISION: $Id: sbG2Eplib.h 1.3.156.1 Broadcom SDK $
 *
...
{
    uint64_t                  ullERHForward;                /**< Bitwise per port enable, allows ERH to be forwarded with the frame */
    uint64_t                  ullSmacMsbEnable;             /**< Bitwise per port enable */
...
{
    uint64_t pullPacketCnt[SB_QE2000_ELIB_NUM_CLASSES_K]; /**< Per class packet counters */
    uint64_t pullByteCnt[SB_QE2000_ELIB_NUM_CLASSES_K];   /**< Per class byte counters */
 ...
 **/
sbElibStatus_et
sbG2EplibPortCountGet(sbG2EplibCtxt_pst pCtxt, uint32_t ulPort, sbG2EplibPCTCounters_pst pPCTCounts);
 ...
 **/
sbElibStatus_et
sbG2EplibCountAccumulate(sbG2EplibCtxt_pst pCtxt, uint32_t ulNumScIdx);
 ...
 **/
sbElibStatus_et
sbG2EplibCounterSetsAccumulate(sbG2EplibCtxt_pst pCtxt, uint32_t ulNumCounterSets);
...
sbElibStatus_et
sbG2EplibTciDmacCountReset(sbG2EplibCtxt_pst pCtxt, uint32_t nIdx);
 ...
 **/
sbElibStatus_et
sbG2EplibVlanCmapCountGet(sbG2EplibCtxt_pst pCtxt, uint32_t ulScIdx,
 ...
 **/
sbElibStatus_et
sbG2EplibVlanPortCountGet(sbG2EplibCtxt_pst pCtxt, uint32_t ulScIdx,
                         uint32_t ulPort, bool_t bClrOnRd,
                         sbG2EplibVlanCounters_s *pVlanCounter);
 ...
 **/
sbElibStatus_et
sbG2EplibVlanCountGetAll(sbG2EplibCtxt_pst pCtxt, uint32_t ulScIdx,
                        bool_t bClrOnRd,
 ...
 **/
sbElibStatus_et
sbG2EplibVlanCountAccumulateGet(sbG2EplibCtxt_pst pCtxt, uint32_t ulScIdx,
                               bool_t bClrOnRd,
                               sbG2EplibVlanCounters_s aVlanCounters[SB_QE2000_ELIB_MAX_COUNTERS_K]);
 ...
 **/
sbElibStatus_et
sbG2EplibVlanEncapSet(sbG2EplibCtxt_pst pCtxt, uint32_t ulVlanTagTypeA,
		     uint32_t ulVlanTagTypeB);
 ...
 **/
sbElibStatus_et
sbG2EplibVlanEncapGet(sbG2EplibCtxt_pst pCtxt, uint32_t *pulVlanTagTypeA,
		     uint32_t *pulVlanTagTypeB);
 ...
 **/
sbElibStatus_et
sbG2EplibMplsEncapSet(sbG2EplibCtxt_pst pCtxt, uint32_t ulMpls);
 ...
 **/
sbElibStatus_et
sbG2EplibMplsEncapGet(sbG2EplibCtxt_pst pCtxt, uint32_t *pulMpls);
