/*
 * $Id: sbZfKaEpIp16BitRewriteConsole.hx 1.1.44.4 Broadcom SDK $
...
char *
sbZfKaEpIp16BitRewrite_SPrint(sbZfKaEpIp16BitRewrite_t *pFromStruct, char *pcToString, uint32_t lStrSize);
int
