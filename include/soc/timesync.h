/*
 * $Id: timesync.h 1.4.2.1 Broadcom SDK $
...
#define SOC_PORT_CONTROL_TIMESYNC_EXT_PHASEADJUST \
        _SHR_PORT_CONTROL_PHY_TIMESYNC_EXT_PHASEADJUST
...
#define SOC_PORT_PHY_TIMESYNC_ETHERNET_CAPABLE _SHR_PORT_PHY_TIMESYNC_ETHERNET_CAPABLE /* PHY is 1588 over
                                                          Ethernet capable */
#define SOC_PORT_PHY_TIMESYNC_MPLS_CAPABLE  _SHR_PORT_PHY_TIMESYNC_MPLS_CAPABLE /* PHY is 1588 over MPLS
                                                          capable */
...
#define SOC_PORT_PHY_TIMESYNC_ENABLE        _SHR_PORT_PHY_TIMESYNC_ENABLE /* Enable Time
                                                          Synchronization
                                                          Interface */
#define SOC_PORT_PHY_TIMESYNC_CAPTURE_TS_ENABLE _SHR_PORT_PHY_TIMESYNC_CAPTURE_TS_ENABLE /* Enable Packet
                                                          Timestamping */
#define SOC_PORT_PHY_TIMESYNC_HEARTBEAT_TS_ENABLE _SHR_PORT_PHY_TIMESYNC_HEARTBEAT_TS_ENABLE /* Enable Heartbeat
                                                          Timestamping */
#define SOC_PORT_PHY_TIMESYNC_RX_CRC_ENABLE _SHR_PORT_PHY_TIMESYNC_RX_CRC_ENABLE /* Enable CRC checking */
#define SOC_PORT_PHY_TIMESYNC_8021AS_ENABLE _SHR_PORT_PHY_TIMESYNC_8021AS_ENABLE /* Enable IEEE802.1AS
                                                          mode */
...
#define SOC_PORT_PHY_TIMESYNC_CLOCK_SRC_EXT _SHR_PORT_PHY_TIMESYNC_CLOCK_SRC_EXT /* Use external clock
                                                          source (DPLL) */
#define SOC_PORT_PHY_TIMESYNC_CLOCK_SRC_EXT_MODE _SHR_PORT_PHY_TIMESYNC_CLOCK_SRC_EXT_MODE /* DPLL mode, 0 - phase
                                                          lock, 1 - frequency
                                                          lock */
...
#define SOC_PORT_CONTROL_PHY_TIMESYNC_NCOADDEND \
        _SHR_PORT_CONTROL_PHY_TIMESYNC_NCOADDEND
#define SOC_PORT_CONTROL_PHY_TIMESYNC_EXT_PHASEADJUST \
        _SHR_PORT_CONTROL_PHY_TIMESYNC_EXT_PHASEADJUST
