/*
 * $Id: mos_msg_ces.h 1.1.2.2 Broadcom SDK $
...
}__attribute__ ((packed))   bcm_ces_crm_cclk_config_msg_t;
...
}__attribute__ ((packed)) bcm_ces_crm_rclock_config_msg_t;
...
}__attribute__ ((packed)) bcm_ces_crm_status_msg_t;
/*
 * CES control message
 */
