/*
 * $Id: mos_intr_common.h 1.3 Broadcom SDK $
...
#define _SOC_SHARED_MOS_INTR_COMMOM_H
...
#define CMICM_NUM_UCS        2
#define CMICM_SW_INTR_NUM_HOSTS 4

#define CMICM_SW_INTR_UC(num) ((num == 0) ? CMICM_SW_INTR_UC0 : CMICM_SW_INTR_UC1)
