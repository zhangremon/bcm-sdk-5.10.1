/*
 * $Id: memory.h 1.33.4.2 Broadcom SDK $
...
#define SOC_MEM_FLAG_EXT_CAM    0x40000000 /* Memory is a CAM */
...
uint32 soc_mem_addr_get(int unit, soc_mem_t mem, soc_block_t block, 
