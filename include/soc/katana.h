/*
 * $Id: katana.h 1.4.2.5 Broadcom SDK $
...
extern int soc_katana_pipe_select(int unit, int egress, int pipe);
...
extern int soc_katana_init_num_cosq(int unit);
extern void _ka_lls_workaround(int unit);
...
#define KATANA_SHAPER_RATE_MAX_EXPONENT                           12
