/*
 * $Id: tnl_term.h 1.8 Broadcom SDK $
...
typedef struct _soc_tnl_term_hash_key_s {
...
#define SOC_TNL_TERM_HASH_BIT_WIDTH    ((sizeof(_soc_tnl_term_hash_key_t)) << 3)
