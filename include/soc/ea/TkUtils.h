/*
 * $Id: TkUtils.h 1.1.2.3 Broadcom SDK $
...
inline  void Tk2BufU8 (uint8 * buf, uint8 val);
inline  void Tk2BufU16 (uint8 * buf, uint16 val);
inline  void Tk2BufU32 (uint8 * buf, uint32 val);
...
/* FixMe
 * Move CTC oam routines to other file
 * Move Debug routines to other file
 */
