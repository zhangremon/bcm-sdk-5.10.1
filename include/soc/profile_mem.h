/*
 * $Id: profile_mem.h 1.18 Broadcom SDK $
...
/* Don't expect to see a large number of tables sharing the same profile index,
 * current max value is 6 */
#define _SOC_PROFILE_MEM_MAX_NUM_TABLES 6
