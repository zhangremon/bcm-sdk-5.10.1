...
#define _SHR_GPORT_TYPE_MAX _SHR_GPORT_TYPE_COSQ /* Used for sanity */
                                                            /* checks only.    */
...
#define _SHR_COSQ_GPORT_TYPE_SHIFT                      23
#define _SHR_COSQ_GPORT_TYPE_MASK                       0x7
#define _SHR_COSQ_GPORT_UCAST_EGRESS_QUEUE_PORT_MASK    0x7F
#define _SHR_COSQ_GPORT_UCAST_EGRESS_QUEUE_PORT_SHIFT   0
#define _SHR_COSQ_GPORT_MCAST_EGRESS_QUEUE_PORT_MASK    0x7F
#define _SHR_COSQ_GPORT_MCAST_EGRESS_QUEUE_PORT_SHIFT   0
#define _SHR_COSQ_GPORT_VSQ_TYPE_MASK                   0xF000
...
#define _SHR_VSQ_TYPE_INFO_CATEGORY_MASK                0xf0
#define _SHR_VSQ_TYPE_INFO_CATEGORY_SHIFT               4
...
#define _SHR_COSQ_GPORT_E2E_PORT_MASK                   0x7F
#define _SHR_COSQ_GPORT_E2E_PORT_SHIFT                  0
#define _SHR_COSQ_GPORT_ISQ_QID_SHIFT                   0
#define _SHR_COSQ_GPORT_ISQ_QID_MASK                    0xFFFF
...
#define _SHR_COSQ_VSQ_TYPE_INFO_GROUPB_SET(_type_info, _category, _tc)                 \
        ((_type_info) = (((_category << _SHR_VSQ_TYPE_INFO_CATEGORY_SHIFT) & _SHR_VSQ_TYPE_INFO_CATEGORY_MASK) | ((_tc << _SHR_VSQ_TYPE_INFO_TC_SHIFT) & _SHR_VSQ_TYPE_INFO_TC_MASK)))
#define _SHR_COSQ_VSQ_TYPE_INFO_GROUPC_SET(_type_info, _category, _connection)         \
        ((_type_info) = (((_category << _SHR_VSQ_TYPE_INFO_CATEGORY_SHIFT) & _SHR_VSQ_TYPE_INFO_CATEGORY_MASK) | ((_connection << _SHR_VSQ_TYPE_INFO_CONNECTION_SHIFT) & _SHR_VSQ_TYPE_INFO_CONNECTION_MASK)))
