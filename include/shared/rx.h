...
typedef enum _shr_rx_reason_e {
    ...
    _SHR_RX_FLOW_TRACKER,          /* Flow tracker                      */
    _SHR_RX_PROTECTION_DROP,       /* Protection drop data              */
    _SHR_RX_TRILL_NICKNAME,        /* Rbridge nickname lookup copy to CPU */
    _SHR_RX_WLAN_SHIM_HDR_ERROR,   /* WLAN shim header error to CPU     */
    _SHR_RX_MPLS_ENTROPY_LABEL_RANGE, /* Entropy label in unallowed range */
    _SHR_RX_QCN_CNM_PRP,           /* QCN CNM PRP                       */
    _SHR_RX_QCN_CNM_PRP_DLF,       /* QCN CNM PRP DLF                   */
    _SHR_RX_ICNM,                  /* I-CNM                             */
    _SHR_RX_MPLS_UNKNOWN_ACH,      /* MPLS Unknown ACH                  */
    _SHR_RX_MPLS_OUT_OF_LOOKUPS,   /* MPLS out of lookups               */
    _SHR_RX_MPLS_ILLEGAL_RESERVED_LABEL, /* MPLS illegal reserved label */
    _SHR_RX_MPLS_ALERT_LABEL,      /* MPLS alert label                  */
    _SHR_RX_NIV_PRUNE,             /* NIV access port pruning (dst = src) */
    _SHR_RX_SPLIT_HORIZON_PRUNE,   /* Split horizon pruning             */
    _SHR_RX_MULTI_DEST,            /* Unknown packet drop               */
    _SHR_RX_TRILL_PORT_MISMATCH,   /* TRILL packet vs Rbridge port conflict */
    _SHR_RX_SIGNATURE_MATCH,       /* Signature Match                   */
    _SHR_RX_WLAN_CLIENT_MOVE,      /* WLAN client moved                 */
    _SHR_RX_WLAN_SOURCE_PORT_MISS, /* WLAN SVP miss                     */
    _SHR_RX_WLAN_DATABASE_ERROR,   /* ?? same as WLAN_CLIENT_ERROR ??   */
    _SHR_RX_WLAN_SOURCE_MISS,      /* WLAN client database SA miss      */
    _SHR_RX_WLAN_DEST_MISS,        /* WLAN client database DA miss      */
