/*
 * $Id: shr_resmgr.h 1.3 Broadcom SDK $
 ...
 */
#define SHR_RES_ALLOC_SINGLE_FLAGS 0x00000003
 ...
 *      specifically aligned against the absolute value zero.
 *
 ...
 *      restrictions, such as the base alignment being a power of two.
 *
 *      Partial blocks will not be allocated.
 *
 *      The caller must track how many elements were requested and provide that
