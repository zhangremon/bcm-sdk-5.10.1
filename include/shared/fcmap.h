/*
 * $Id: fcmap.h 1.1.2.2 Broadcom SDK $
...
typedef enum {
    ...
    _SHR_BFCMAP_PORT_SPEED_2GBPS  = 2,
    _SHR_BFCMAP_PORT_SPEED_4GBPS  = 4,
    _SHR_BFCMAP_PORT_SPEED_8GBPS  = 8,
    _SHR_BFCMAP_PORT_SPEED_16GBPS = 16,
...
typedef struct _shr_bfcmap_port_config_s {
    ...
    int     rx_buffer_to_buffer_credits;      /* Receive B2B Credits */
    _shr_bfcmap_port_state_t port_state;           /* Port state, INIT, Reset, Link Up, Link down */
