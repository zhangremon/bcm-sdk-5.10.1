/*
 * $Id: port_ability.h 1.20 Broadcom SDK $
...
#define _SHR_PA_SPEED_12GB         (1 << 12)
#define _SHR_PA_SPEED_12P5GB       (1 << 13)
#define _SHR_PA_SPEED_13GB         (1 << 14)
#define _SHR_PA_SPEED_15GB         (1 << 15)
#define _SHR_PA_SPEED_16GB         (1 << 16)
#define _SHR_PA_SPEED_20GB         (1 << 17)
#define _SHR_PA_SPEED_21GB         (1 << 18)
#define _SHR_PA_SPEED_24GB         (1 << 19)
#define _SHR_PA_SPEED_25GB         (1 << 20)
#define _SHR_PA_SPEED_30GB         (1 << 21)
#define _SHR_PA_SPEED_40GB         (1 << 22)
#define _SHR_PA_SPEED_42GB         (1 << 23)
#define _SHR_PA_SPEED_100GB        (1 << 24)
#define _SHR_PA_SPEED_120GB        (1 << 25)
...
#define _SHR_PA_SPEED_ALL    (_SHR_PA_SPEED_42GB |         \
                              _SHR_PA_SPEED_40GB |         \
                              _SHR_PA_SPEED_30GB |         \
                              _SHR_PA_SPEED_25GB |         \
                              _SHR_PA_SPEED_24GB |         \
...
#define _SHR_PA_SPEED_MAX(m) (((m) & _SHR_PA_SPEED_42GB)     ? 42000 : \
...
#define _SHR_PA_SPEED(s)     ((42000 == (s)) ? _SHR_PA_SPEED_42GB : \
