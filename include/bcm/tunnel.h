/*
 * $Id: tunnel.h 1.38.2.2 Broadcom SDK $
 * 
...
#define BCM_TUNNEL_INIT_WLAN_MTU            0x00001000 /* Set MTU for outgoing
                                                          WLAN tunnel */
#define BCM_TUNNEL_INIT_WLAN_VLAN_TAGGED    0x00002000 /* Set outgoing WLAN
                                                          tunnel vlan */
#define BCM_TUNNEL_INIT_WLAN_TUNNEL_WITH_ID 0x00004000 /* Create outgoing tunnel
                                                          with ID */
#define BCM_TUNNEL_REPLACE                  0x00008000 /* Update existing
                                                          tunnel. */
