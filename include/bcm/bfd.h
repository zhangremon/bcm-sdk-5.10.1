/*
 * $Id: bfd.h 1.12.2.11 Broadcom SDK $
 * 
...
#define BCM_BFD_INTPRI_MAX                  16         /* Internal priority max
                                                          value */
#define BCM_BFD_ENDPOINT_MAX_MEP_ID_LENGTH  32         /* MPLS-TP MEP_ID maximum
                                                          length */
...
#define BCM_BFD_ENDPOINT_PWE_ACH            0x0040     /* Use MPLS Associated
                                                          ...
                                                          only for PWE Tunnel
                                                          types */
#define BCM_BFD_ENDPOINT_IPV6               0x0080     /* Use IPv6 encapsulation */
...
typedef enum bcm_bfd_tunnel_type_e {
    ...
    bcmBFDTunnelTypeIp6in6,         /* BFD over IPv6-in-IPv46 tunnel */
    bcmBFDTunnelTypeGRE,            /* BFD over GRE tunnel */
