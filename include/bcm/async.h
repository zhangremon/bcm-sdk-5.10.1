 ...
 *
 * $Id: async.h 1.470.2.32 Broadcom SDK $
 ...
 * Generated:	Fri Aug 12 01:32:31 2011
 */
...
void	bcm_cosq_pfc_config_get_async(int unit, bcm_gport_t gport, bcm_cos_queue_t cosq, uint32 flags, bcm_cosq_pfc_config_t * config, int * pfc_id, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_cosq_pfc_config_set_async(int unit, bcm_gport_t gport, bcm_cos_queue_t cosq, uint32 flags, bcm_cosq_pfc_config_t config, int * pfc_id, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_dmux_dest_add_async(int unit, bcm_port_t port, _shr_module_t dest_mod, bcm_port_t dest_port, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qset_udf_get_async(int unit, bcm_field_qset_t * qset, int udf_max, int * udf_arr, int * udf_count, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_DstModid_get_async(int unit, bcm_field_entry_t entry, bcm_module_t * data, bcm_module_t * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_DstPortTgid_get_async(int unit, bcm_field_entry_t entry, bcm_port_t * data, bcm_port_t * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_L3IntfGroup_get_async(int unit, bcm_field_entry_t entry, bcm_if_group_t * data, bcm_if_group_t * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_LookupClass0_get_async(int unit, bcm_field_entry_t entry, uint32 * data, uint32 * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_PacketFormat_get_async(int unit, bcm_field_entry_t entry, uint32 * data, uint32 * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_PortClass_get_async(int unit, bcm_field_entry_t entry, uint32 * data, uint32 * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_SrcMacGroup_get_async(int unit, bcm_field_entry_t entry, uint32 * data, uint32 * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_SrcModid_get_async(int unit, bcm_field_entry_t entry, bcm_module_t * data, bcm_module_t * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_SrcPortTgid_get_async(int unit, bcm_field_entry_t entry, bcm_port_t * data, bcm_port_t * mask, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_field_qualify_UserDefined_get_async(int unit, bcm_field_entry_t entry, bcm_field_udf_t udf_id, uint8 data[BCM_FIELD_USER_FIELD_SIZE], uint8 mask[BCM_FIELD_USER_FIELD_SIZE], bcm_async_cb_t async_callback, void *async_cookie);
...
#endif	/* INCLUDE_L3 */
#ifdef	INCLUDE_PTP
void	bcm_ptp_acceptable_master_table_add_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, int priority1_alt_value, bcm_ptp_clock_peer_address_t * master_info, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_ptp_acceptable_master_table_enabled_get_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, uint8 * enabled, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ptp_acceptable_master_table_enabled_set_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, uint8 enabled, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ptp_acceptable_master_table_list_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, int * num_masters, bcm_ptp_clock_peer_address_t * master_addr, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ptp_acceptable_master_table_remove_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, bcm_ptp_clock_peer_address_t * master_info, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_ptp_tod_output_get_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int * tod_output_count, bcm_ptp_tod_output_t * tod_output_id, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_ptp_unicast_master_table_add_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, bcm_ptp_clock_unicast_master_t * master_info, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ptp_unicast_master_table_clear_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ptp_unicast_master_table_list_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, int * num_masters, bcm_ptp_clock_peer_address_t * master_addr, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ptp_unicast_master_table_remove_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, bcm_ptp_clock_peer_address_t * master_info, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ptp_unicast_master_table_size_get_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, int * max_table_entries, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ptp_unicast_slave_add_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, bcm_ptp_clock_peer_t * slave_info, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ptp_unicast_slave_clear_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ptp_unicast_slave_list_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, int * num_slaves, bcm_ptp_clock_peer_t * slave_info, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_ptp_unicast_slave_remove_async(int unit, bcm_ptp_stack_id_t ptp_id, int clock_num, int port_num, bcm_ptp_clock_peer_t * slave_info, bcm_async_cb_t async_callback, void *async_cookie);
#endif	/* INCLUDE_PTP */
...
void	bcm_trill_multicast_add_async(int unit, uint32 flags, bcm_trill_name_t root_name, bcm_vlan_t vlan, bcm_mac_t c_dmac, bcm_multicast_t group, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_trill_multicast_delete_async(int unit, uint32 flags, bcm_trill_name_t root_name, bcm_vlan_t vlan, bcm_mac_t c_dmac, bcm_multicast_t group, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_trill_multicast_source_add_async(int unit, bcm_trill_name_t root_name, bcm_trill_name_t source_rbridge_name, bcm_gport_t port, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_trill_multicast_source_delete_async(int unit, bcm_trill_name_t root_name, bcm_trill_name_t source_rbridge_name, bcm_gport_t port, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_trill_multicast_traverse_async(int unit, bcm_trill_multicast_traverse_cb cb, void * user_data, bcm_async_cb_t async_callback, void *async_cookie);
...
void	bcm_trunk_member_get_async(int unit, bcm_trunk_t tid, int member_max, bcm_trunk_member_t * member_array, int * member_count, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_trunk_member_set_async(int unit, bcm_trunk_t tid, int member_count, bcm_trunk_member_t * member_array, bcm_async_cb_t async_callback, void *async_cookie);
void	bcm_trunk_member_traverse_async(int unit, bcm_trunk_t tid, bcm_trunk_member_traverse_cb cb, void * user_data, bcm_async_cb_t async_callback, void *async_cookie);
