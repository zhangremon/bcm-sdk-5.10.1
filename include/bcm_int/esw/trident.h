/*
 * $Id: trident.h 1.47.4.8 Broadcom SDK $
...
extern int bcm_trident_trunk_set(int, bcm_trunk_t,
...
extern int bcm_td_trill_multicast_delete(int unit, uint32 flags, bcm_trill_name_t root_name, bcm_vlan_t vid, bcm_mac_t c_dmac, 
...
extern int bcm_td_trill_multicast_group_get(int unit, bcm_multicast_t l2mc_group, bcm_multicast_t *l3mc_group);

extern int bcm_td_trill_multicast_traverse(int unit, 
                             bcm_trill_multicast_traverse_cb  cb, void *user_data);
...
extern int bcm_td_trill_egress_set(int unit, int nh_index);
...
extern int bcm_td_trill_egress_add(int unit, bcm_gport_t port, 
                             bcm_multicast_t mc_index, bcm_if_t encap_id);
extern int bcm_td_trill_egress_delete(int unit, bcm_gport_t port, 
                             bcm_multicast_t mc_index, bcm_if_t encap_id);
...
extern int _bcm_td_l3_intf_urpf_default_route_set(int unit, 
                             bcm_vlan_t vid, int enable);
extern int _bcm_td_l3_intf_urpf_default_route_get (int unit, 
                             bcm_vlan_t vid, int *enable);
extern int _bcm_td_l3_intf_urpf_mode_set(int unit, 
                             bcm_vlan_t vid, bcm_vlan_urpf_mode_t urpf_mode);
extern int _bcm_td_l3_intf_urpf_mode_get(int unit, 
                             bcm_vlan_t vid, bcm_vlan_urpf_mode_t *urpf_mode);
...
#endif /* INCLUDE_L3 */
extern int bcm_td_l2_trill_multicast_entry_add(int unit, int key, 
...
#ifdef INCLUDE_L3
extern int bcm_trident_vlan_virtual_init(int unit);
extern int bcm_trident_vlan_virtual_detach(int unit);
extern int bcm_trident_vlan_vp_create(int unit, bcm_vlan_port_t *vlan_vp);
extern int bcm_trident_vlan_vp_destroy(int unit, bcm_gport_t gport);
extern int bcm_trident_vlan_vp_find(int unit, bcm_vlan_port_t *vlan_vp);
extern int _bcm_trident_vlan_port_resolve(int unit, bcm_gport_t vlan_port_id,
                          bcm_module_t *modid, bcm_port_t *port,
                          bcm_trunk_t *trunk_id, int *id);
...
extern int bcm_trident_vlan_gport_add(int unit, bcm_vlan_t vlan, bcm_gport_t gport, 
                                   int is_untagged);
extern int bcm_trident_vlan_gport_delete(int unit, bcm_vlan_t vlan,
                                      bcm_gport_t gport); 
extern int bcm_trident_vlan_gport_delete_all(int unit, bcm_vlan_t vlan);
extern int bcm_trident_vlan_gport_get(int unit, bcm_vlan_t vlan, bcm_gport_t gport,
                                   int *is_untagged); 
extern int bcm_trident_vlan_gport_get_all(int unit, bcm_vlan_t vlan, int array_max,
        bcm_gport_t *gport_array, int *is_untagged_array, int *array_size);
extern int bcm_trident_update_vlan_pbmp(int unit, bcm_vlan_t vlan,
        bcm_pbmp_t *pbmp);

#ifdef BCM_WARM_BOOT_SUPPORT
extern int bcm_trident_vlan_virtual_reinit(int unit);
#endif /* BCM_WARM_BOOT_SUPPORT */

#ifdef BCM_WARM_BOOT_SUPPORT_SW_DUMP
extern void bcm_trident_vlan_vp_sw_dump(int unit);
