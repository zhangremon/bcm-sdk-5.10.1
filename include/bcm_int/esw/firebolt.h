/*
 * $Id: firebolt.h 1.269.2.12 Broadcom SDK $
...
typedef struct _bcm_l3_hw_calls_s {
    ...
    int (*adj_mac_add)(int unit, int idx, void *buf, int max_paths);
    /*  Delete adjacent mac entry. */
    int (*adj_mac_del)(int unit, int idx, int max_paths);
#endif /* BCM_EASYRIDER_SUPPORT */
    /* 
...
extern int bcm_xgs3_l3_info_dump(int unit);
