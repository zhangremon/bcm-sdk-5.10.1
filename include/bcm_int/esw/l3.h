/*
 * $Id: l3.h 1.65.44.1 Broadcom SDK $
...
extern int _bcm_esw_l3_lock(int unit);
extern int _bcm_esw_l3_unlock(int unit);
...
extern void l3ktebug(const char *fmt,...);
#endif
...
typedef struct _bcm_l3_bookkeeping_s {
    ...
    sal_mutex_t lock;            /* L3 module lock.               */    
