/*
 * $Id: trx.h 1.80.2.1 Broadcom SDK $
...
extern int _bcm_field_trx2_data_qualifier_packet_format_delete(int unit,int qual_id,
                                bcm_field_data_packet_format_t *packet_format);
extern int _bcm_field_trx2_udf_delete(int unit,  bcm_field_udf_spec_t *udf_spec,
                                      uint32 udf_num, uint32 user_num);
...
extern int _bcm_field_trx2_udf_write(int unit, bcm_field_udf_spec_t *udf_spec,
                                     uint32 udf_num, uint32 user_num);
extern int _bcm_field_trx2_udf_read(int unit, bcm_field_udf_spec_t *udf_spec, 
                                    uint32 udf_num, uint32 user_num);
