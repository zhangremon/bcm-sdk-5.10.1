/*
 * $Id: katana.h 1.11.2.16 Broadcom SDK $
 ...
 */
#define BCM_KT_BFD_RX_CHANNEL    1

extern int bcm_kt_bfd_init(int unit);
extern int bcm_kt_bfd_detach(int unit);
extern int bcm_kt_bfd_endpoint_create(int unit,
    bcm_bfd_endpoint_info_t *endpoint_info);
extern int bcm_kt_bfd_endpoint_get(int unit, bcm_bfd_endpoint_t endpoint,
    bcm_bfd_endpoint_info_t *endpoint_info);
extern int bcm_kt_bfd_endpoint_destroy(int unit, bcm_bfd_endpoint_t endpoint);
extern int bcm_kt_bfd_endpoint_destroy_all(int unit);
extern int bcm_kt_bfd_endpoint_poll(int unit, bcm_bfd_endpoint_t endpoint);

extern int bcm_kt_bfd_event_register(int unit,
    bcm_bfd_event_types_t event_types, bcm_bfd_event_cb cb,
    void *user_data);
extern int bcm_kt_bfd_event_unregister(int unit,
    bcm_bfd_event_types_t event_types, bcm_bfd_event_cb cb);
extern int bcm_kt_bfd_endpoint_stat_get(
    int unit,
    bcm_bfd_endpoint_t endpoint,
    bcm_bfd_endpoint_stat_t *ctr_info,
    uint8 clear);
extern int bcm_kt_bfd_auth_sha1_set(
    int unit,
    int entry,
    bcm_bfd_auth_sha1_t *sha1);
extern int bcm_kt_bfd_auth_sha1_get(
    int unit,
    int entry,
    bcm_bfd_auth_sha1_t *sha1);
extern int bcm_kt_bfd_auth_simple_password_set(
    int unit,
    int entry,
    bcm_bfd_auth_simple_password_t *sp);
extern int bcm_kt_bfd_auth_simple_password_get(
    int unit,
    int entry,
    bcm_bfd_auth_simple_password_t *sp);
...
extern int kt_s3mii_war(int unit);
