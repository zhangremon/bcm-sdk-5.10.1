 ...
 *
 * $Id: async_req.h 1.467.2.32 Broadcom SDK $
 ...
 * Generated:	Fri Aug 12 01:32:32 2011
 */
...
typedef struct bcm_async_req_s {
	...
	/* bcm_module_name has a non int return type */
		...
		} ptp_acceptable_master_table_add;
		struct {
			int unit;
			bcm_ptp_stack_id_t ptp_id;
			int clock_num;
		...
		struct {
			...
			int port_num;
			uint8 * enabled;
		} ptp_acceptable_master_table_enabled_get;
		struct {
			int unit;
			bcm_ptp_stack_id_t ptp_id;
			int clock_num;
			int port_num;
			uint8 enabled;
		} ptp_acceptable_master_table_enabled_set;
		struct {
			int unit;
			bcm_ptp_stack_id_t ptp_id;
			int clock_num;
		...
		} ptp_acceptable_master_table_list;
		struct {
			int unit;
			bcm_ptp_stack_id_t ptp_id;
			int clock_num;
			int port_num;
			bcm_ptp_clock_peer_address_t * master_info;
		} ptp_acceptable_master_table_remove;
		struct {
			int unit;
			bcm_ptp_stack_id_t ptp_id;
			int clock_num;
		...
		} ptp_unicast_master_table_add;
		struct {
			int unit;
			bcm_ptp_stack_id_t ptp_id;
			int clock_num;
			int port_num;
		} ptp_unicast_master_table_clear;
		struct {
			int unit;
			bcm_ptp_stack_id_t ptp_id;
			int clock_num;
		...
		struct {
			...
			int port_num;
			bcm_ptp_clock_peer_address_t * master_info;
		} ptp_unicast_master_table_remove;
		struct {
			int unit;
			bcm_ptp_stack_id_t ptp_id;
			int clock_num;
			int port_num;
			int * max_table_entries;
		} ptp_unicast_master_table_size_get;
		struct {
			int unit;
			bcm_ptp_stack_id_t ptp_id;
			int clock_num;
		...
		} ptp_unicast_slave_add;
		struct {
			int unit;
			bcm_ptp_stack_id_t ptp_id;
			int clock_num;
			int port_num;
		} ptp_unicast_slave_clear;
		struct {
			int unit;
			bcm_ptp_stack_id_t ptp_id;
			int clock_num;
...
typedef enum {
	...
	BCM_ASYNC_ENTRY_FIELD_QSET_UDF_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_DSTMODID_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_DSTPORTTGID_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_L3INTFGROUP_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_LOOKUPCLASS0_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_PACKETFORMAT_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_PORTCLASS_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_SRCMACGROUP_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_SRCMODID_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_SRCPORTTGID_GET,
	...
	BCM_ASYNC_ENTRY_FIELD_QUALIFY_USERDEFINED_GET,
	...
	BCM_ASYNC_ENTRY_PTP_ACCEPTABLE_MASTER_TABLE_ADD,
	BCM_ASYNC_ENTRY_PTP_ACCEPTABLE_MASTER_TABLE_CLEAR,
	BCM_ASYNC_ENTRY_PTP_ACCEPTABLE_MASTER_TABLE_ENABLED_GET,
	BCM_ASYNC_ENTRY_PTP_ACCEPTABLE_MASTER_TABLE_ENABLED_SET,
	BCM_ASYNC_ENTRY_PTP_ACCEPTABLE_MASTER_TABLE_LIST,
	BCM_ASYNC_ENTRY_PTP_ACCEPTABLE_MASTER_TABLE_REMOVE,
	...
	BCM_ASYNC_ENTRY_PTP_UNICAST_MASTER_TABLE_ADD,
	BCM_ASYNC_ENTRY_PTP_UNICAST_MASTER_TABLE_CLEAR,
	BCM_ASYNC_ENTRY_PTP_UNICAST_MASTER_TABLE_LIST,
	BCM_ASYNC_ENTRY_PTP_UNICAST_MASTER_TABLE_REMOVE,
	BCM_ASYNC_ENTRY_PTP_UNICAST_MASTER_TABLE_SIZE_GET,
	BCM_ASYNC_ENTRY_PTP_UNICAST_SLAVE_ADD,
	BCM_ASYNC_ENTRY_PTP_UNICAST_SLAVE_CLEAR,
	BCM_ASYNC_ENTRY_PTP_UNICAST_SLAVE_LIST,
	BCM_ASYNC_ENTRY_PTP_UNICAST_SLAVE_REMOVE,
	...
	BCM_ASYNC_ENTRY_TRILL_MULTICAST_ADD,
	BCM_ASYNC_ENTRY_TRILL_MULTICAST_DELETE,
	...
	BCM_ASYNC_ENTRY_TRILL_MULTICAST_TRAVERSE,
	...
	BCM_ASYNC_ENTRY_TRUNK_MEMBER_GET,
	BCM_ASYNC_ENTRY_TRUNK_MEMBER_SET,
	BCM_ASYNC_ENTRY_TRUNK_MEMBER_TRAVERSE,
