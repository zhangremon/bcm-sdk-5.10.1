 ...
 *
 * $Id: client_dispatch.h 1.361.2.30 Broadcom SDK $
 ...
 * Generated:	Fri Aug 12 12:19:52 2011
 */
...
extern int bcm_client_cosq_pfc_config_get(int,bcm_gport_t,bcm_cos_queue_t,uint32,bcm_cosq_pfc_config_t *,int *);
extern int bcm_client_cosq_pfc_config_set(int,bcm_gport_t,bcm_cos_queue_t,uint32,bcm_cosq_pfc_config_t,int *);
...
extern int bcm_client_dmux_dest_add(int,bcm_port_t,_shr_module_t,bcm_port_t);
...
extern int bcm_client_ds_classifier_traverse(int,int,bcm_ds_classifier_traverse_cb,void *);
...
extern int bcm_client_field_qset_udf_get(int,bcm_field_qset_t *,int,int *,int *);
...
extern int bcm_client_field_qualify_DstModid_get(int,bcm_field_entry_t,bcm_module_t *,bcm_module_t *);
...
extern int bcm_client_field_qualify_DstPortTgid_get(int,bcm_field_entry_t,bcm_port_t *,bcm_port_t *);
...
extern int bcm_client_field_qualify_L3IntfGroup_get(int,bcm_field_entry_t,bcm_if_group_t *,bcm_if_group_t *);
...
extern int bcm_client_field_qualify_LookupClass0_get(int,bcm_field_entry_t,uint32 *,uint32 *);
...
extern int bcm_client_field_qualify_PacketFormat_get(int,bcm_field_entry_t,uint32 *,uint32 *);
...
extern int bcm_client_field_qualify_PortClass_get(int,bcm_field_entry_t,uint32 *,uint32 *);
...
extern int bcm_client_field_qualify_SrcMacGroup_get(int,bcm_field_entry_t,uint32 *,uint32 *);
...
extern int bcm_client_field_qualify_SrcModid_get(int,bcm_field_entry_t,bcm_module_t *,bcm_module_t *);
...
extern int bcm_client_field_qualify_SrcPortTgid_get(int,bcm_field_entry_t,bcm_port_t *,bcm_port_t *);
...
extern int bcm_client_field_qualify_UserDefined_get(int,bcm_field_entry_t,bcm_field_udf_t,uint8 [BCM_FIELD_USER_FIELD_SIZE],uint8 [BCM_FIELD_USER_FIELD_SIZE]);
...
extern int bcm_client_mpls_switch_traverse(int,uint32,uint32,uint32,bcm_mpls_switch_traverse_cb,void *);
...
extern int bcm_client_ptp_cb_register(int,bcm_ptp_cb_types_t,bcm_ptp_cb,void *);
extern int bcm_client_ptp_cb_unregister(int,bcm_ptp_cb_types_t,bcm_ptp_cb);
...
extern int bcm_client_trill_multicast_add(int,uint32,bcm_trill_name_t,bcm_vlan_t,bcm_mac_t,bcm_multicast_t);
extern int bcm_client_trill_multicast_delete(int,uint32,bcm_trill_name_t,bcm_vlan_t,bcm_mac_t,bcm_multicast_t);
extern int bcm_client_trill_multicast_delete_all(int,bcm_trill_name_t);
extern int bcm_client_trill_multicast_source_add(int,bcm_trill_name_t,bcm_trill_name_t,bcm_gport_t);
extern int bcm_client_trill_multicast_source_delete(int,bcm_trill_name_t,bcm_trill_name_t,bcm_gport_t);
...
extern int bcm_client_trill_multicast_traverse(int,bcm_trill_multicast_traverse_cb,void *);
...
extern int bcm_client_trunk_member_get(int,bcm_trunk_t,int,bcm_trunk_member_t *,int *);
extern int bcm_client_trunk_member_set(int,bcm_trunk_t,int,bcm_trunk_member_t *);
/* bcm_trunk_member_t_init not dispatchable */
extern int bcm_client_trunk_member_traverse(int,bcm_trunk_t,bcm_trunk_member_traverse_cb,void *);
