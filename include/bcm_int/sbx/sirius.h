/*
 * $Id: sirius.h 1.81.2.3 Broadcom SDK $
...
/* frame parser is shared ??? */
#define PRED_TYPE_FLAGS_SHARED     0x004
...
/* frame parser gets any interface's frames */
...
extern int
bcm_sirius_trunk_get(int unit, bcm_trunk_t tid, bcm_trunk_add_info_t *t_data);
...
extern int
bcm_sirius_trunk_set(int unit, bcm_trunk_t tid, bcm_trunk_add_info_t *add_info);
...
extern int
bcm_sirius_slq_stats(uint32_t unit,
                     int queue_base,
                     bcm_cos_queue_t cosq,
                     sbBool_t enable);
