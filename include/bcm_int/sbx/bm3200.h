...
extern int
bcm_bm3200_stk_module_protocol_set(int unit, int node, bcm_module_protocol_t  protocol);

extern int
bcm_bm3200_stk_module_protocol_get(int unit, int node, bcm_module_protocol_t *protocol);
...
bcm_bm3200_fabric_distribution_control_get(int unit,
					   ...
					   int *value);
extern int
bcm_bm3200_vlan_control_vlan_set(int unit,
				 bcm_vlan_t vlan,
				 bcm_vlan_control_vlan_t control);

extern int
bcm_bm3200_vlan_port_add(int unit,
			 bcm_vlan_t vid,
			 bcm_pbmp_t pbmp,
			 bcm_pbmp_t ubmp);

extern int
bcm_bm3200_vlan_port_remove(int unit,
			    bcm_vlan_t vid,
			    bcm_pbmp_t pbmp);

#ifdef BCM_EASY_RELOAD_SUPPORT
#ifdef BCM_EASY_RELOAD_SUPPORT_SW_DUMP
int bcm_bm3200_multicast_state_get(int unit, char *pbuf);
#endif
#endif
