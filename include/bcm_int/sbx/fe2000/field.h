...
#endif 
#define FIELD_WARN(stuff)        BCM_DEBUG(BCM_DBG_WARN     | BCM_DBG_FP, stuff)
#define FIELD_ERR(stuff)         BCM_DEBUG(BCM_DBG_ERR      | BCM_DBG_FP, stuff)
#define FIELD_VERB(stuff)        BCM_DEBUG(BCM_DBG_VERBOSE  | BCM_DBG_FP, stuff)
#define FIELD_VVERB(stuff)       BCM_DEBUG(BCM_DBG_VVERBOSE | BCM_DBG_FP, stuff)
#if _SBX_FE2K_FIELD_EXCESS_VERBOSITY
#define FIELD_EVERB(stuff)       BCM_DEBUG(BCM_DBG_VVERBOSE | BCM_DBG_FP, stuff)
#else /* FIELD_EXCESS_VERBOSITY */
#define FIELD_EVERB(stuff)
#endif /* FIELD_EXCESS_VERBOSITY */
#if defined(__GNUC__) && !defined(__PEDANTIC__)
#define FIELD_MSG(string) "%s[%d]%s" string, __FILE__, __LINE__, __FUNCTION__
#define FIELD_MSG1(string) "%s[%d]%s: " string, __FILE__, __LINE__, __FUNCTION__
#else /* defined(__GNUC__) && !defined(__PEDANTIC__) */
#define FIELD_MSG(string) "%s[%d]" string, __FILE__, __LINE__
#define FIELD_MSG1(string) "%s[%d]: " string, __FILE__, __LINE__
 ...
 */
#define FIELD_PRINT(stuff) soc_cm_print stuff
...
extern int bcm_fe2000_g2p3_field_status_get(void *unitData,
