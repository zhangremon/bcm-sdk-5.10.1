...
#endif 
#define MIRROR_OUT(flags, stuff)  BCM_DEBUG(flags | BCM_DBG_API, stuff)
#define MIRROR_WARN(stuff)        MIRROR_OUT(BCM_DBG_WARN, stuff)
#define MIRROR_ERR(stuff)         MIRROR_OUT(BCM_DBG_ERR, stuff)
#define MIRROR_VERB(stuff)        MIRROR_OUT(BCM_DBG_VERBOSE, stuff)
#define MIRROR_VVERB(stuff)       MIRROR_OUT(BCM_DBG_VVERBOSE, stuff)
#define MIRROR_EVERB(stuff)       MIRROR_VVERB(stuff)
