...
typedef struct {
    ...
    uint8_t                         vc_res_alloced;       /* resources allocated on unit    */
    uint8_t                         l2ete_res_shared;     /* shared L2 ete resource         */
    union {
...
_bcm_fe2000_l3_cmp_uint32(void *a, void *b)
{
...
static __inline__ _fe2k_l3_fe_instance_t *
_bcm_fe2000_get_l3_instance_from_unit(int unit)
{
...
static  __inline__ int
_bcm_fe2000_set_l3_instance_for_unit(int unit,
                                     _fe2k_l3_fe_instance_t *fe)
{
    if (L3_UNIT_INVALID(unit)) {
        return BCM_E_UNIT;
    }
