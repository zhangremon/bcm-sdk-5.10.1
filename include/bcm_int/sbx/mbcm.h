/*
 * $Id: mbcm.h 1.66.2.3 Broadcom SDK $
...
typedef int (*mbcm_sbx_cosq_gport_discard_set_f)(int unit,
                                                 bcm_gport_t gport,  /* TODO: REMOVE */
                                                 bcm_cos_t priority, /* TODO: REMOVE */
                                                 uint32 color,
                                                 uint32 template,
                                                 uint32 queue_size,
...
typedef int (*mbcm_sbx_trunk_create_f)(int unit, bcm_trunk_t *tid);
...
typedef int (*mbcm_sbx_trunk_get_f)(int unit, bcm_trunk_t tid,
                                    bcm_trunk_add_info_t *t_data);

typedef int (*mbcm_sbx_trunk_chip_info_get_f)(int unit,
                                              bcm_trunk_chip_info_t *ta_info);

typedef int (*mbcm_sbx_trunk_set_f)(int unit, bcm_trunk_t tid,
...
#define MBCM_SBX_DRIVER_CALL(unit, function, args...) ((mbcm_sbx_driver[unit] && mbcm_sbx_driver[unit]->function)?mbcm_sbx_driver[unit]->function(args):BCM_E_UNAVAIL)
