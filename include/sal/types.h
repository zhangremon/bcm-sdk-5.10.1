/*
 * $Id: types.h 1.14.2.3 Broadcom SDK $
...
/* Device bus types */
#define SAL_PCI_DEV_TYPE          0x01   /* PCI device */
#define SAL_SPI_DEV_TYPE          0x02   /* SPI device */
#define SAL_EB_DEV_TYPE           0x04   /* EB device */
#define SAL_ICS_DEV_TYPE          0x08   /* ICS device */
#define SAL_ET_DEV_TYPE           0x10   /* MII device */

#define SAL_DEV_BUS_TYPE_MASK     0x1f

/* Device types */
#define SAL_SWITCH_DEV_TYPE       0x100   /* Switch device */
#define SAL_ETHER_DEV_TYPE        0x200   /* Ethernet device */
#define SAL_CPU_DEV_TYPE          0x400   /* CPU device */

/* Access types */
#define SAL_DEV_BUS_RD_16BIT      0x1000  /* 16 bit reads on bus */
#define SAL_DEV_BUS_WR_16BIT      0x2000  /* 16 bit writes on bus */
