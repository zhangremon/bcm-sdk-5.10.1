;
; $Id: sdk56580.asm,v 1.5.314.1 2011/05/19 11:56:04 sraj Exp $
;
...
; $SDK/src/appl/diag/esw/ledproc.c.
;
...
; See $SDK/src/appl/diag/esw/ledproc.c and $SDK/src/soc/counter.c for examples.
; In this program, 
; Bit
