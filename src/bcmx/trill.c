 ...
 *     vlan      - Customer VLAN
 *     c_dmac    - Customer D-MAC
 *     group     - Multicast Group ID
 * Returns:
 *     BCM_E_XXX
 */
int
bcmx_trill_multicast_add(uint32 flags, bcm_trill_name_t root_name,
                         bcm_vlan_t vlan, bcm_mac_t c_dmac,
                         bcm_multicast_t group)
{
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_trill_multicast_add(bcm_unit, flags, root_name,
                                         vlan, c_dmac, group);
 ...
 */
int
bcmx_trill_multicast_delete(uint32 flags, bcm_trill_name_t root_name,
                            bcm_vlan_t vlan, bcm_mac_t c_dmac,
                            bcm_multicast_t group)
{
    int  rv = BCM_E_UNAVAIL, tmp_rv;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_trill_multicast_delete(bcm_unit, flags, root_name,
                                            vlan, c_dmac, group);
        BCM_IF_ERROR_RETURN
            (BCMX_TRILL_DELETE_ERROR_CHECK(bcm_unit, tmp_rv, &rv));
    }
