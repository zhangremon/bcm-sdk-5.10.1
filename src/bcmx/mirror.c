...
/*
 * Function:
 *      bcmx_mirror_pfmt_set
 */

int
bcmx_mirror_pfmt_set(int val)
{
    int rv = BCM_E_UNAVAIL, tmp_rv;
    int i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        tmp_rv = bcm_mirror_pfmt_set(bcm_unit, val);
        BCM_IF_ERROR_RETURN(BCMX_MIRROR_SET_ERROR_CHECK(bcm_unit, tmp_rv, &rv));
    }
...
/*
 * Function:
 *      bcmx_mirror_pfmt_get
 */

int
bcmx_mirror_pfmt_get(int *val)
{
    int rv;
    int i, bcm_unit;
    ...
    BCMX_UNIT_ITER(bcm_unit, i) {
        rv = bcm_mirror_pfmt_get(bcm_unit, val);
        if (BCMX_MIRROR_GET_IS_VALID(bcm_unit, rv)) {
            return rv;
        }
    }
