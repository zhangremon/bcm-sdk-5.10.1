...
unimpl(char *desc)
{
    soc_cm_debug(DK_VERBOSE,
		 "WARNING: function %s not implemented for Hurricane\n", desc);
    return SOC_E_NONE;
}

#ifdef BCM_METER_SUPPORT

int bcm_hu_meter_init(int unit)
{
    return unimpl("bcm_hu_meter_init");
}

int bcm_hu_meter_create(int unit, int port, int *mid)
{
    return unimpl("bcm_hu_meter_create");
}

int bcm_hu_meter_delete(int unit, int port, int mid)
{
    return unimpl("bcm_hu_meter_delete");
}

int bcm_hu_meter_delete_all(int unit)
{
    return unimpl("bcm_hu_meter_delete_all");
}

int bcm_hu_meter_get(int unit, int port, int mid,
		     uint32 *kbits_sec, uint32 *kbits_burst)
{
    return unimpl("bcm_hu_meter_get");
}

int bcm_hu_meter_set(int unit, int port, int mid,
		     uint32 kbits_sec, uint32 kbits_burst)
{
    return unimpl("bcm_hu_meter_set");
}

int bcm_hu_ffppacketcounter_set(int unit, int port, int mid,
				uint64 val)
{
    return unimpl("bcm_hu_ffppacketcounter_set");
}

int bcm_hu_ffppacketcounter_get(int unit, int port, int mid,
				uint64 *val)
{
    return unimpl("bcm_hu_ffppacketcounter_get");
}

int bcm_hu_ffpcounter_init(int unit)
{
    return unimpl("bcm_hu_ffpcounter_init");
}

int bcm_hu_ffpcounter_create(int unit, int port, int *ffpcounterid)
{
    return unimpl("bcm_hu_ffpcounter_create");
}

int bcm_hu_ffpcounter_delete(int unit, int port, int ffpcounterid)
{
    return unimpl("bcm_hu_ffpcounter_delete");
}

int bcm_hu_ffpcounter_delete_all(int unit)
{
    return unimpl("bcm_hu_ffpcounter_delete_all");
}

int bcm_hu_ffpcounter_set(int unit, int port, int ffpcounterid,
			  uint64 val)
{
    return unimpl("bcm_hu_ffpcounter_set");
}

int bcm_hu_ffpcounter_get(int unit, int port, int ffpcounterid,
			  uint64 *val)
{
    return unimpl("bcm_hu_ffpcounter_get");
}
...
mbcm_functions_t mbcm_hurricane_driver = {
    ...
    bcm_hu_meter_create,
    bcm_hu_meter_delete,
    bcm_hu_meter_delete_all,
    bcm_hu_meter_get,
    bcm_hu_meter_set,
    bcm_hu_ffppacketcounter_set,
    bcm_hu_ffppacketcounter_get,
    bcm_hu_ffpcounter_init,
    bcm_hu_ffpcounter_create,
    bcm_hu_ffpcounter_delete,
    bcm_hu_ffpcounter_delete_all,
    bcm_hu_ffpcounter_set,
    bcm_hu_ffpcounter_get,
