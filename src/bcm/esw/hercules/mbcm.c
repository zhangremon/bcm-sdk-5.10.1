...
mbcm_functions_t mbcm_hercules_driver = {
    ...
    /* Meter functions */
    bcm_hercules_meter_init,
    bcm_hercules_meter_create,
    bcm_hercules_meter_delete,
    bcm_hercules_meter_delete_all,
    bcm_hercules_meter_get,
    bcm_hercules_meter_set,
    bcm_hercules_ffppacketcounter_set,
    bcm_hercules_ffppacketcounter_get,
    bcm_hercules_ffpcounter_init,
    bcm_hercules_ffpcounter_create,
    bcm_hercules_ffpcounter_delete,
    bcm_hercules_ffpcounter_delete_all,
    bcm_hercules_ffpcounter_set,
    bcm_hercules_ffpcounter_get,
    ...
    bcm_hercules_lpm_defip_sw_tbl_empty,
    bcm_hercules_lpm_defip_hw_tbl_empty,
    bcm_hercules_lpm_check_table,
    bcm_hercules_lpm_delete,
    bcm_hercules_lpm_insert,
    bcm_hercules_lpm_lookup,
