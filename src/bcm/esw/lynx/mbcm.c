...
mbcm_functions_t mbcm_lynx_driver = {
    /* L2 functions */
    /* Lynx is equivalent to Draco here */
    bcm_draco_l2_init,
    bcm_draco_l2_term,
    ...
    bcm_lynx_cosq_discard_set,
    bcm_lynx_cosq_discard_get,
    bcm_lynx_cosq_discard_port_set,
    bcm_lynx_cosq_discard_port_get,
#ifdef BCM_WARM_BOOT_SUPPORT
    bcm_lynx_cosq_sync,
#endif /* BCM_WARM_BOOT_SUPPORT */
#ifdef BCM_WARM_BOOT_SUPPORT_SW_DUMP
    bcm_lynx_cosq_sw_dump,
    ...
    bcm_lynx_ffpcounter_delete_all,
