...
unimpl(char *desc)
{
    soc_cm_debug(DK_VERBOSE,
                 "WARNING: function %s not implemented for Katana\n", desc);
    return SOC_E_NONE;
}

#ifdef BCM_METER_SUPPORT

int bcm_katana_meter_init(int unit)
{
    return unimpl("bcm_katana_meter_init");
}

int bcm_katana_meter_create(int unit, int port, int *mid)
{
    return unimpl("bcm_katana_meter_create");
}

int bcm_katana_meter_delete(int unit, int port, int mid)
{
    return unimpl("bcm_katana_meter_delete");
}

int bcm_katana_meter_delete_all(int unit)
{
    return unimpl("bcm_katana_meter_delete_all");
}

int bcm_katana_meter_get(int unit, int port, int mid,
                          uint32 *kbits_sec, uint32 *kbits_burst)
{
    return unimpl("bcm_katana_meter_get");
}

int bcm_katana_meter_set(int unit, int port, int mid,
                          uint32 kbits_sec, uint32 kbits_burst)
{
    return unimpl("bcm_katana_meter_set");
}

int bcm_katana_ffppacketcounter_set(int unit, int port, int mid,
                                     uint64 val)
{
    return unimpl("bcm_katana_ffppacketcounter_set");
}

int bcm_katana_ffppacketcounter_get(int unit, int port, int mid,
                                     uint64 *val)
{
    return unimpl("bcm_katana_ffppacketcounter_get");
}

int bcm_katana_ffpcounter_init(int unit)
{
    return unimpl("bcm_katana_ffpcounter_init");
}

int bcm_katana_ffpcounter_create(int unit, int port, int *ffpcounterid)
{
    return unimpl("bcm_katana_ffpcounter_create");
}

int bcm_katana_ffpcounter_delete(int unit, int port, int ffpcounterid)
{
    return unimpl("bcm_katana_ffpcounter_delete");
}

int bcm_katana_ffpcounter_delete_all(int unit)
{
    return unimpl("bcm_katana_ffpcounter_delete_all");
}

int bcm_katana_ffpcounter_set(int unit, int port, int ffpcounterid,
                               uint64 val)
{
    return unimpl("bcm_katana_ffpcounter_set");
}

int bcm_katana_ffpcounter_get(int unit, int port, int ffpcounterid,
                               uint64 *val)
{
    return unimpl("bcm_katana_ffpcounter_get");
}
...
#ifdef BCM_METER_SUPPORT
    /*  Meter functions */
    bcm_katana_meter_init,
    bcm_katana_meter_create,
    bcm_katana_meter_delete,
    bcm_katana_meter_delete_all,
    bcm_katana_meter_get,
    bcm_katana_meter_set,
    bcm_katana_ffppacketcounter_set,
    bcm_katana_ffppacketcounter_get,
    bcm_katana_ffpcounter_init,
    bcm_katana_ffpcounter_create,
    bcm_katana_ffpcounter_delete,
    bcm_katana_ffpcounter_delete_all,
    bcm_katana_ffpcounter_set,
    bcm_katana_ffpcounter_get,
