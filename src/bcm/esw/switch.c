/*
 * $Id: switch.c 1.433.2.32 Broadcom SDK $
...
#define VL     SOC_INFO_VALKYRIE
#define VL2     SOC_INFO_VALKYRIE2
#define EN      SOC_INFO_ENDURO
#define TD      SOC_INFO_TRIDENT
#define HU      SOC_INFO_HURRICANE
#define KA      SOC_INFO_KATANA
                        ...
                        uint16 default_ver, uint16 *recovered_ver)
{
    ...
    if ((stable_size - stable_used) >= alloc_size) {
        ...
        if (create) {
            ...
            BCM_VERB(("Allocated raw scache pointer=0x%08x, %d bytes\n",
...
#ifdef BCM_KATANA_SUPPORT
STATIC int
_bcm_ka_pkt_age_set(int unit, int arg)
{
    if (!arg) {
        /* Disable packet aging on all COSQs */
...
#ifdef BCM_KATANA_SUPPORT
STATIC int
_bcm_ka_pkt_age_get(int unit, int *arg)
{
    uint32 timerval, limitval, mask;
    int i, loopcount;
...
_bcm_xgs3_hashcontrol_set(int unit, int arg)
{
    ...
    if (SOC_IS_HB_GW(unit) || (SOC_IS_TRX(unit) && !SOC_IS_HURRICANE(unit))) {
...
_hash_bmap_t hash_select_td_trill[] =
{
    ...
    { BCM_HASH_TRILL_FIELD_MACDA_LO,              0x0040 },
    { BCM_HASH_TRILL_FIELD_MACDA_MI,              0x0080 },
    { BCM_HASH_TRILL_FIELD_MACSA_LO,              0x0100 },
    { BCM_HASH_TRILL_FIELD_MACSA_MI,              0x0200 },
...
STATIC int
_bcm_hash_offset(int unit, bcm_switch_control_t type,
                 hash_offset_info_t *info)
{
    switch (type) {
        ...
        case bcmSwitchEntropyHashSet0Offset:
            ...
            info->reg = RTAG7_HASH_ENTROPY_LABELr;
            break;
                          ...
                          bcm_switch_control_t type, int arg)
{
    ...
    BCM_IF_ERROR_RETURN(_bcm_hash_offset(unit, type, &info));

#ifdef BCM_TRIDENT_SUPPORT
    if (SOC_IS_TD_TT(unit)) {
        sub_field_width[0] = 16;
        sub_field_width[1] = 16;
        sub_field_width[2] = 4;
        sub_field_width[3] = 16;
        sub_field_width[4] = 8;
        sub_field_width[5] = 8;
        sub_field_width[6] = 16;
        sub_field_width[7] = 16;
    } else 
#endif /* BCM_TRIDENT_SUPPORT */
    {
        sub_field_width[0] = 16;
    ...
    SOC_IF_ERROR_RETURN
        (soc_reg32_set(unit, info.reg, REG_PORT_ANY, info.idx, hash_control));
                          ...
                          bcm_switch_control_t type, int *arg)
{
    ...
    SOC_IF_ERROR_RETURN
        (soc_reg32_get(unit, info.reg, REG_PORT_ANY, info.idx, &hash_control));
...
#if defined (BCM_RAVEN_SUPPORT) || defined(BCM_FIREBOLT2_SUPPORT) || defined(BCM_HURRICANE_SUPPORT)
...
bcm_switch_binding_t xgs3_bindings[] =
{
    ...
    { bcmSwitchWlanClientDstMacMissToCpu, TR2 | AP | VL2,
        ...
        NULL, 0},
    { bcmSwitchOamHeaderErrorToCpu, TR2 | AP | VL2 | EN | TD | KA,
        CPU_CONTROL_Mr, OAM_HEADER_ERROR_TOCPUf,
        NULL, 0},
    { bcmSwitchOamUnknownVersionToCpu, TR2 | AP | VL2 | EN | TD | KA,
        CPU_CONTROL_Mr, OAM_UNKNOWN_OPCODE_VERSION_TOCPUf,
        NULL, 0},
    { bcmSwitchL3SrcBindFailToCpu, TR2 | AP | VL2 | TD | KA,
        CPU_CONTROL_Mr, MAC_BIND_FAILf,
        NULL, 0},
    { bcmSwitchTunnelIp4IdShared, TR2 | AP | VL2 | TD | KA,
    ...
    { bcmSwitchIpfixRateViolationPersistent, TR2 | AP | VL2,
        ...
        NULL, 0},
    { bcmSwitchCustomerQueuing, TR2 | AP | VL2 | EN | KA,
        ING_MISC_CONFIGr, PHB2_COS_MODEf,
        NULL, soc_feature_vlan_queue_map},
    { bcmSwitchOamUnknownVersionDrop, TR2 | AP | VL2 | EN | TD | KA,
    ...
    { bcmSwitchMplsPortIndependentUpperRange2, TRVL,
        ...
        NULL, 0},       
    { bcmSwitchL3UrpfRouteEnableExternal, TRVL,
    ...
    { bcmSwitchCpuProtocolPrio, FB | FH | ER,
...
defined(BCM_TRIDENT_SUPPORT)
    { bcmSwitchAlternateStoreForward, HBGW | SCQ | TD,
    ...
    { bcmSwitchDosAttackIcmpPktOversize, TD | KA,
        DOS_CONTROL_3r, BIG_ICMP_PKT_SIZEf,
        NULL, 0 },
    { bcmSwitchDosAttackIcmpV6PingSize, TD | KA,
        DOS_CONTROL_3r, BIG_ICMPV6_PKT_SIZEf,
        NULL, soc_feature_big_icmpv6_ping_check },
    { bcmSwitchDosAttackMinTcpHdrSize, TD | KA,
    ...
    { bcmSwitchMeterAdjust, TRVL,
        ...
        NULL, soc_feature_meter_adjust },
    { bcmSwitchMeterAdjust, AP | TR2 | TD | VL2,
    ...
    { bcmSwitchUnknownIpmcToCpu, FB | BR | GW | FH | HXFX | ER,
    	CPU_CONTROL_1r, UIPMC_TOCPUf,
        NULL, soc_feature_unknown_ipmc_tocpu },
    { bcmSwitchIcmpRedirectToCpu, FB | BR | GW | FH | HXFX | ER,
        CPU_CONTROL_1r, ICMP_REDIRECT_TOCPUf,
        NULL, 0 },
    { bcmSwitchCpuUnknownPrio, FB | BR | GW | FH | HXFX | ER,
	    CPU_CONTROL_2r, CPU_LKUPFAIL_PRIORITYf,
        NULL, 0 },
    { bcmSwitchCpuSamplePrio, FB | BR | GW | FH | HXFX | ER,
    	CPU_CONTROL_2r, CPU_SFLOW_PRIORITYf,
        NULL, 0 },
    { bcmSwitchCpuDefaultPrio, FB | BR | GW | FH | HXFX | ER,
    	CPU_CONTROL_2r, CPU_DEFAULT_PRIORITYf,
        NULL, 0 },
    { bcmSwitchCpuMtuFailPrio, FB | BR | GW | FH | HXFX | ER,
	    CPU_CONTROL_2r, CPU_MTUFAIL_PRIORITYf,
        NULL, 0 },
    { bcmSwitchCpuMirrorPrio, FB | BR | GW | FH | HXFX | ER,
	    CPU_CONTROL_2r, CPU_MIRROR_PRIORITYf,
        NULL, 0 },
    { bcmSwitchCpuIcmpRedirectPrio, FB | BR | GW | FH | HXFX | ER,
	    CPU_CONTROL_2r, CPU_ICMP_REDIRECT_PRIORITYf,
        NULL, 0 },
     { bcmSwitchCpuFpCopyPrio, FB | HBGW | FH | HXFX | ER,
    	CPU_CONTROL_2r, CPU_FPCOPY_PRIORITYf,
        NULL, 0 },
    { bcmSwitchDosAttackTcpFlags, FB | BR | GW | FH | ER,
        DOS_CONTROLr, TCP_FLAGS_CHECK_ENABLEf,
        NULL, soc_feature_basic_dos_ctrl },
    { bcmSwitchDosAttackL4Port,   FB | BR | GW | FH | ER,
        DOS_CONTROLr, L4_PORT_CHECK_ENABLEf,
        NULL, soc_feature_basic_dos_ctrl },
    { bcmSwitchDosAttackTcpFrag,  FB | BR | GW | FH | ER,
        DOS_CONTROLr, TCP_FRAG_CHECK_ENABLEf,
        NULL, soc_feature_basic_dos_ctrl },
    { bcmSwitchDosAttackIcmp,     FB | BR | GW | FH | ER,
    ...
    defined(BCM_EASYRIDER_SUPPORT) || defined(BCM_BRADLEY_SUPPORT) || \
    defined(BCM_TRX_SUPPORT)
    { bcmSwitchUnknownMcastToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	CPU_CONTROL_1r, UMC_TOCPUf,
        NULL, 0 },
    { bcmSwitchUnknownUcastToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	CPU_CONTROL_1r, UUCAST_TOCPUf,
        NULL, 0 },
    { bcmSwitchL2StaticMoveToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	CPU_CONTROL_1r, STATICMOVE_TOCPUf,
        NULL, 0 },
    { bcmSwitchL3HeaderErrToCpu, FB | BR | GW | FH | HXFX | ER | TRX, /* compat */
    	CPU_CONTROL_1r, V4L3ERR_TOCPUf,
        NULL, 0 },
    { bcmSwitchUnknownL3SrcToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
	    CPU_CONTROL_1r, UNRESOLVEDL3SRC_TOCPUf,
        NULL, 0 },
    { bcmSwitchUnknownL3DestToCpu, FB | BR | GW | FH | HXFX | ER | TRX, /* compat */
    	CPU_CONTROL_1r, V4L3DSTMISS_TOCPUf,
        NULL, 0 },
    { bcmSwitchIpmcPortMissToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	CPU_CONTROL_1r, IPMCPORTMISS_TOCPUf,
        NULL, 0 },
    { bcmSwitchIpmcErrorToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	CPU_CONTROL_1r, IPMCERR_TOCPUf,
        NULL, 0 },
    { bcmSwitchL2NonStaticMoveToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
	    CPU_CONTROL_1r, NONSTATICMOVE_TOCPUf,
        NULL, 0 },
    { bcmSwitchV6L3ErrToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
     	CPU_CONTROL_1r, V6L3ERR_TOCPUf,
        NULL, 0 },
    { bcmSwitchV6L3DstMissToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
	    CPU_CONTROL_1r, V6L3DSTMISS_TOCPUf,
        NULL, 0 },
    { bcmSwitchV4L3ErrToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	CPU_CONTROL_1r, V4L3ERR_TOCPUf,
        NULL, 0 },
    { bcmSwitchV4L3DstMissToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	CPU_CONTROL_1r, V4L3DSTMISS_TOCPUf,
        NULL, 0 },
    { bcmSwitchTunnelErrToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	CPU_CONTROL_1r, TUNNEL_ERR_TOCPUf,
        NULL, 0 },
    { bcmSwitchMartianAddrToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
     	CPU_CONTROL_1r, MARTIAN_ADDR_TOCPUf,
        NULL, 0 },
    { bcmSwitchL3UcTtlErrToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	CPU_CONTROL_1r, L3UC_TTL_ERR_TOCPUf,
        NULL, 0 },
    { bcmSwitchL3SlowpathToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	CPU_CONTROL_1r, L3_SLOWPATH_TOCPUf,
        NULL, 0 },
    { bcmSwitchIpmcTtlErrToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	CPU_CONTROL_1r, IPMC_TTL_ERR_TOCPUf,
        NULL, 0 },
    { bcmSwitchSampleIngressRandomSeed, FB | BR | GW | FH | HXFX | ER | TRX,
	    SFLOW_ING_RAND_SEEDr, SEEDf,
        NULL, 0 },
    { bcmSwitchSampleEgressRandomSeed, FB | BR | GW | FH | HXFX | ER | TRX,
    	SFLOW_EGR_RAND_SEEDr, SEEDf,
        NULL, 0 },
    { bcmSwitchArpReplyToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
	    PROTOCOL_PKT_CONTROLr, ARP_REPLY_TO_CPUf,
        NULL, 0 },
    { bcmSwitchArpReplyDrop, FB | BR | GW | FH | HXFX | ER | TRX,
    	PROTOCOL_PKT_CONTROLr, ARP_REPLY_DROPf,
        NULL, 0 },
    { bcmSwitchArpRequestToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	PROTOCOL_PKT_CONTROLr, ARP_REQUEST_TO_CPUf,
        NULL, 0 },
    { bcmSwitchArpRequestDrop, FB | BR | GW | FH | HXFX | ER | TRX,
    	PROTOCOL_PKT_CONTROLr, ARP_REQUEST_DROPf,
        NULL, 0 },
    { bcmSwitchNdPktToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
    	PROTOCOL_PKT_CONTROLr, ND_PKT_TO_CPUf,
        NULL, 0 },
    { bcmSwitchNdPktDrop, FB | BR | GW | FH | HXFX | ER | TRX,
    	PROTOCOL_PKT_CONTROLr, ND_PKT_DROPf,
        NULL, 0 },
    { bcmSwitchDhcpPktToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
        PROTOCOL_PKT_CONTROLr, DHCP_PKT_TO_CPUf,
        NULL, 0 },
    { bcmSwitchDhcpPktDrop, FB | BR | GW | FH | HXFX | ER | TRX,
        PROTOCOL_PKT_CONTROLr, DHCP_PKT_DROPf,
        NULL, 0 },
    { bcmSwitchDosAttackSipEqualDip, FB | BR | GW | FH | HXFX | ER | TRX,
        DOS_CONTROLr, DROP_IF_SIP_EQUALS_DIPf,
        NULL, 0 },
    { bcmSwitchDosAttackMinTcpHdrSize, FB | BR | GW | FH | HXFX | ER | TRX,
        DOS_CONTROLr, MIN_TCPHDR_SIZEf,
        NULL, 0 },
    { bcmSwitchDosAttackV4FirstFrag, FB | BR | GW | FH | HXFX | ER | TRX,
        DOS_CONTROLr, IPV4_FIRST_FRAG_CHECK_ENABLEf,
        NULL, 0 },
    { bcmSwitchNonIpL3ErrToCpu, FB | BR | GW |  FH | HXFX | ER | TRX,
        CPU_CONTROL_1r, NIP_L3ERR_TOCPUf,
        NULL, soc_feature_nip_l3_err_tocpu },
    { bcmSwitchSourceRouteToCpu, FB | BR | GW | FH | HXFX | ER | TRX,
	    CPU_CONTROL_1r, SRCROUTE_TOCPUf,
        NULL, 0 },
    { bcmSwitchParityErrorToCpu, ER | FB | HBGW | FH | HXFX | SCQ,
        CPU_CONTROL_1r, PARITY_ERR_TOCPUf,
        NULL, soc_feature_parity_err_tocpu },
    { bcmSwitchDirectedMirroring, ER | FB | HBGW | FH | TRX,
    ...
    defined(BCM_EASYRIDER_SUPPORT) || defined(BCM_BRADLEY_SUPPORT) || \
    defined(BCM_SCORPION_SUPPORT)
    { bcmSwitchDosAttackToCpu, FB | BR | GW | FH | HXFX | ER | SCQ,
    ...
    defined(BCM_TRX_SUPPORT)
    { bcmSwitchL3MtuFailToCpu, ER | FB | BR | GW | FH | HXFX | TRX | HK,
    ...
    if (mod > SOC_MODID_MAX(unit)) {
        ...
        if (NULL == _mod_type_table[unit]) {
            _mod_type_table[unit] = (uint8 *)sal_alloc(
                (sizeof(uint8) * SOC_MODID_MAX(unit)), "MOD TYPE");
            if (NULL == _mod_type_table[unit]) {
                return BCM_E_MEMORY;
            }
            sal_memset(_mod_type_table[unit], BCM_SWITCH_MODULE_UNKNOWN, 
                       (sizeof(uint8) * SOC_MODID_MAX(unit)));
        }
                            ...
                            int arg)
{
    ...
    if (SOC_DCB_TYPE(unit) == 23) {
        ...
        PBS_MH_V7_W2_SMOD_COS_QNUM_SET(pbh, modid, 1, 0, 0, 0);
    } else {
        ...
        if ((SOC_DCB_TYPE(unit) == 11) || (SOC_DCB_TYPE(unit) == 12) ||
            ...
            PBS_MH_V5_W1_SMOD_SET(pbh, modid, 1, 0, 0);
            PBS_MH_V6_W2_DPORT_COS_QNUM_SET(pbh, port, 0, (64*port), 0);
        } else {
                            ...
                            int *arg)
{
    ...
    if (isGport) {
        ...
        gport_st.modid = pbh->src_mod;
        gport_st.modid = pbh->dst_port;
        BCM_IF_ERROR_RETURN(
    ...
    case bcmSwitchCongestionMissingCntag:
        ...
        if (soc_reg_field_get(unit, ING_MISC_CONFIGr, rval,
            ...
            *arg = soc_reg_field_get(unit, EGR_CONFIG_1r, rval,
                                     QCN_SEND_NULL_CNTAG_IF_NO_CNTAGf) ? 0 : 1;
        }
        return BCM_E_NONE;
    default:
        break;
                                ...
                                int arg)
{
    ...
    if (SOC_IS_XGS12_SWITCH(unit)) {
        ...
        if (type == bcmSwitchLinkDownInfoSkip) {
    ...
    if (SOC_IS_XGS3_SWITCH(unit)) {
...
#ifdef BCM_KATANA_SUPPORT
            if (SOC_IS_KATANA(unit)) {
                return _bcm_ka_pkt_age_set(unit, arg);
            } else
#endif
#ifdef BCM_TRX_SUPPORT
        ...
        case bcmSwitchFabricTrunkDynamicEgressBytesPercent:
            ...
            return _bcm_trident_hg_dlb_config_port_set(unit, port, type, arg);
            break;
                                ...
                                int *arg)
{
    ...
    if (SOC_IS_XGS3_SWITCH(unit)) {
...
#ifdef BCM_KATANA_SUPPORT
            if (SOC_IS_KATANA(unit)) {
                return _bcm_ka_pkt_age_get(unit, arg);
            } else
#endif
#ifdef BCM_TRX_SUPPORT
            if (SOC_IS_TRX(unit) && !SOC_IS_HURRICANE(unit)) {
        ...
        case bcmSwitchMplsIngressPortCheck:
            /*
             * A large number of invalid Coverity complaints
             * pass through this code point.
             */
        ...
        case bcmSwitchDirectedMirroring:
            if (SOC_IS_RAPTOR(unit) || SOC_IS_RAVEN(unit) || 
                SOC_IS_HAWKEYE(unit) || SOC_IS_HURRICANE(unit) ||
                SOC_IS_TD_TT(unit) || SOC_IS_KATANA(unit)) {
                *arg = 1;
                return BCM_E_NONE;
            }
        ...
        case bcmSwitchFabricTrunkDynamicEgressBytesPercent:
            ...
            return _bcm_trident_hg_dlb_config_port_get(unit, port, type, arg);
        case bcmSwitchCongestionNotificationIdLow:
            if (soc_feature(unit, soc_feature_qcn)) {
...
#ifdef BCM_BRADLEY_SUPPORT
        if ((SOC_IS_HBX(unit) || SOC_IS_TRX(unit)) && (!(SOC_IS_HURRICANE(unit)))) {
    ...
    case bcmSwitchFabricTrunkDynamicQueuedBytesMaxThreshold:
     ...
     defined(BCM_XGS3_SWITCH_SUPPORT)
...
#ifdef BCM_CMICM_SUPPORT
                if (soc_feature(unit, soc_feature_cmicm) && SOC_IS_KATANA(unit)) {
                    if (SOC_REG_FIELD_VALID(unit, CMIC_PKT_REASON_DIRECT_0_TYPEr, 
                                        REASONSf)) {
                        BCM_IF_ERROR_RETURN(
            ...
            if (soc_feature(unit, soc_feature_rcpu_1)) {
                ...
                if (soc_feature(unit, soc_feature_cmicm) && SOC_IS_KATANA(unit)) {
                    if (SOC_REG_FIELD_VALID(unit, CMIC_PKT_REASON_0_TYPEr, REASONSf)) {
                        BCM_IF_ERROR_RETURN(
                            _bcm_rcpu_switch_regall_set(unit, CMIC_PKT_REASON_0_TYPEr, 
                                                    REASONSf, arg));
                    }
            ...
            if (soc_feature(unit, soc_feature_rcpu_1)) {
                ...
                if (soc_feature(unit, soc_feature_cmicm) && SOC_IS_KATANA(unit)) {
                    if (SOC_REG_FIELD_VALID(unit,
                            CMIC_PKT_REASON_DIRECT_0_TYPEr, REASONSf)) {
                        uint32 raddr;
        ...
        case bcmSwitchHashL3DualLeastFull:
            if (soc_feature(unit, soc_feature_dual_hash)) {
                if (arg >= 0) {
                    if (SOC_REG_FIELD_VALID(unit, L3_AUX_HASH_CONTROLr, INSERT_LEAST_FULL_HALFf)) {
                        BCM_IF_ERROR_RETURN
                            (soc_reg_field32_modify(unit, L3_AUX_HASH_CONTROLr, REG_PORT_ANY,
                                                    INSERT_LEAST_FULL_HALFf, (arg ? 1 : 0)));
                        return BCM_E_NONE;
                    }
                } else {
                    return BCM_E_PARAM;
        ...
        case bcmSwitchHashL2DualLeastFull:
            if (soc_feature(unit, soc_feature_dual_hash)) {
                if (arg >= 0) {
                    if (SOC_REG_FIELD_VALID(unit, L2_AUX_HASH_CONTROLr, INSERT_LEAST_FULL_HALFf)) {
                        BCM_IF_ERROR_RETURN
                            (soc_reg_field32_modify(unit, L2_AUX_HASH_CONTROLr, REG_PORT_ANY,
                                                    INSERT_LEAST_FULL_HALFf, (arg ? 1 : 0)));
                        return BCM_E_NONE;
                    }
                } else {
        ...
        case bcmSwitchHashMPLSDualLeastFull:
            if (soc_feature(unit, soc_feature_dual_hash)) {
                if (arg >= 0) {
                    if (SOC_REG_FIELD_VALID(unit, MPLS_ENTRY_HASH_CONTROLr, INSERT_LEAST_FULL_HALFf)) {
                        BCM_IF_ERROR_RETURN
    ...
    defined(BCM_HURRICANE_SUPPORT)
        case bcmSwitchSynchronousPortClockSource:
            if (soc_feature(unit, soc_feature_gmii_clkout)) {
                if (!SOC_PORT_VALID(unit, (int)arg)) {
                    return SOC_E_PARAM;
                }
#if defined(BCM_ENDURO_SUPPORT) || defined(BCM_HURRICANE_SUPPORT)
                if (SOC_IS_ENDURO(unit) || SOC_IS_HURRICANE(unit)) {
        ...
        case bcmSwitchLoadBalanceHashSelect:
            {
                ...
                regaddr = soc_reg_addr(unit, reg, REG_PORT_ANY, 0);
        ...
        case bcmSwitchL3SrcHitEnable:
            {
                ...
                regaddr = soc_reg_addr(unit, reg, REG_PORT_ANY, 0);
                BCM_IF_ERROR_RETURN(soc_reg_read(unit, reg, regaddr, &rval));
                                           ...
                                           int encap_pri)
{
    ...
    soc_field_t efields[2] = {IEEE_802_1_PRI_MAP_ENABLEf, MH_TC_MAP_ENABLEf};
    soc_field_t fields[2] = {IEEE_802_1_Pf, MH_TCf};
    uint32      values[2] = {0,0}, evalues[2] = {0,0};
    int         ieee_idx = 0, hg2_idx = 1;  /* index to values array */
    ...
    if (!flags) {   /* Empty flags mean disable mapping */
        ...
        int max_flen = (1 << soc_reg_field_length(unit,CMIC_PKT_PRI_MAP_TABLEr,
                                                  IEEE_802_1_Pf)) - 1;
                                           ...
                                           int *encap_pri)
{
    ...
    if (flags & BCM_SWITCH_REMOTE_CPU_ENCAP_IEEE) {
        BCM_IF_ERROR_RETURN(
            READ_CMIC_PKT_CTRLr(unit, &regval));
        if (!soc_reg_field_get(unit, CMIC_PKT_CTRLr, regval,
                               IEEE_802_1_PRI_MAP_ENABLEf)) {
            *encap_pri = -1;
        } else {
            BCM_IF_ERROR_RETURN(
                READ_CMIC_PKT_PRI_MAP_TABLEr(unit, internal_cpu_pri, &regval));
            *encap_pri = soc_reg_field_get(unit, CMIC_PKT_PRI_MAP_TABLEr, 
                                           regval, IEEE_802_1_Pf); 
        }
    } else if (flags & BCM_SWITCH_REMOTE_CPU_ENCAP_HIGIG2) {
        BCM_IF_ERROR_RETURN(
            READ_CMIC_PKT_CTRLr(unit, &regval));
