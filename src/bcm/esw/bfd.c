...
#if defined(BCM_KATANA_SUPPORT)
    if (SOC_IS_KATANA(unit)) {
        result = bcm_kt_bfd_endpoint_create(unit, endpoint_info);
    } 
#endif
...
#if defined(BCM_KATANA_SUPPORT)
    if (SOC_IS_KATANA(unit)) {
        result = bcm_kt_bfd_endpoint_get(unit, endpoint, endpoint_info);
    } 
#endif
...
#if defined(BCM_KATANA_SUPPORT)
    if (SOC_IS_KATANA(unit)) {
        result = bcm_kt_bfd_endpoint_destroy(unit, endpoint);
    } 
#endif
...
#if defined(BCM_KATANA_SUPPORT)
    if (SOC_IS_KATANA(unit)) {
        result = bcm_kt_bfd_endpoint_destroy_all(unit);
    } 
#endif
...
#if defined(BCM_KATANA_SUPPORT)
    if (SOC_IS_KATANA(unit)) {
        result = bcm_kt_bfd_endpoint_poll(unit, endpoint);
    } 
#endif
...
#if defined(BCM_KATANA_SUPPORT)
    if (SOC_IS_KATANA(unit)) {
        result = bcm_kt_bfd_event_register(unit, event_types, cb, user_data);
    } 
#endif
...
#if defined(BCM_KATANA_SUPPORT)
    if (SOC_IS_KATANA(unit)) {
        result = bcm_kt_bfd_event_unregister(unit, event_types, cb);
    } 
#endif
...
#if defined(BCM_KATANA_SUPPORT)
    if (SOC_IS_KATANA(unit)) {
        result = bcm_kt_bfd_endpoint_stat_get(unit, endpoint, ctr_info, clear);
    } 
#endif
...
#if defined(BCM_KATANA_SUPPORT)
    if (SOC_IS_KATANA(unit)) {
        result = bcm_kt_bfd_auth_sha1_set(unit, index, sha1);
    } 
#endif
...
#if defined(BCM_KATANA_SUPPORT)
    if (SOC_IS_KATANA(unit)) {
        result = bcm_kt_bfd_auth_sha1_get(unit, index, sha1);
    } 
#endif
...
#if defined(BCM_KATANA_SUPPORT)
    if (SOC_IS_KATANA(unit)) {
        result = bcm_kt_bfd_auth_simple_password_set(unit, index, sp);
    } 
#endif
...
#if defined(BCM_KATANA_SUPPORT)
    if (SOC_IS_KATANA(unit)) {
        result = bcm_kt_bfd_auth_simple_password_get(unit, index, sp);
    } 
#endif
...
#else /* INCLUDE_L3 && INCLUDE_BFD */
int _bcm_esw_bfd_not_empty;
#endif  /* INCLUDE_L3 && INCLUDE_BFD */
