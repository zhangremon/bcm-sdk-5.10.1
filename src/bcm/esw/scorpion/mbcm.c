...
unimpl(char *desc)
{
    soc_cm_debug(DK_VERBOSE,
		 "WARNING: function %s not implemented for BCM56820\n", desc);
    return SOC_E_NONE;
}

#ifdef BCM_METER_SUPPORT

int bcm_sc_meter_init(int unit)
{
    return unimpl("bcm_sc_meter_init");
}

int bcm_sc_meter_create(int unit, int port, int *mid)
{
    return unimpl("bcm_sc_meter_create");
}

int bcm_sc_meter_delete(int unit, int port, int mid)
{
    return unimpl("bcm_sc_meter_delete");
}

int bcm_sc_meter_delete_all(int unit)
{
    return unimpl("bcm_sc_meter_delete_all");
}

int bcm_sc_meter_get(int unit, int port, int mid,
		     uint32 *kbits_sec, uint32 *kbits_burst)
{
    return unimpl("bcm_sc_meter_get");
}

int bcm_sc_meter_set(int unit, int port, int mid,
		     uint32 kbits_sec, uint32 kbits_burst)
{
    return unimpl("bcm_sc_meter_set");
}

int bcm_sc_ffppacketcounter_set(int unit, int port, int mid,
				uint64 val)
{
    return unimpl("bcm_sc_ffppacketcounter_set");
}

int bcm_sc_ffppacketcounter_get(int unit, int port, int mid,
				uint64 *val)
{
    return unimpl("bcm_sc_ffppacketcounter_get");
}

int bcm_sc_ffpcounter_init(int unit)
{
    return unimpl("bcm_sc_ffpcounter_init");
}

int bcm_sc_ffpcounter_create(int unit, int port, int *ffpcounterid)
{
    return unimpl("bcm_sc_ffpcounter_create");
}

int bcm_sc_ffpcounter_delete(int unit, int port, int ffpcounterid)
{
    return unimpl("bcm_sc_ffpcounter_delete");
}

int bcm_sc_ffpcounter_delete_all(int unit)
{
    return unimpl("bcm_sc_ffpcounter_delete_all");
}

int bcm_sc_ffpcounter_set(int unit, int port, int ffpcounterid,
			  uint64 val)
{
    return unimpl("bcm_sc_ffpcounter_set");
}

int bcm_sc_ffpcounter_get(int unit, int port, int ffpcounterid,
			  uint64 *val)
{
    return unimpl("bcm_sc_ffpcounter_get");
}
...
mbcm_functions_t mbcm_scorpion_driver = {
    ...
    bcm_sc_meter_create,
    bcm_sc_meter_delete,
    bcm_sc_meter_delete_all,
    bcm_sc_meter_get,
    bcm_sc_meter_set,
    bcm_sc_ffppacketcounter_set,
    bcm_sc_ffppacketcounter_get,
    bcm_sc_ffpcounter_init,
    bcm_sc_ffpcounter_create,
    bcm_sc_ffpcounter_delete,
    bcm_sc_ffpcounter_delete_all,
    bcm_sc_ffpcounter_set,
    bcm_sc_ffpcounter_get,
