...
unimpl(char *desc)
{
    soc_cm_debug(DK_VERBOSE,
		 "WARNING: BCM5660x function %s not implemented\n", desc);
    return SOC_E_NONE;
}

#ifdef BCM_METER_SUPPORT

int bcm_er_meter_init(int unit)
{
    return unimpl("bcm_er_meter_init");
}

int bcm_er_meter_create(int unit, int port, int *mid)
{
    return unimpl("bcm_er_meter_create");
}

int bcm_er_meter_delete(int unit, int port, int mid)
{
    return unimpl("bcm_er_meter_delete");
}

int bcm_er_meter_delete_all(int unit)
{
    return unimpl("bcm_er_meter_delete_all");
}

int bcm_er_meter_get(int unit, int port, int mid,
		     uint32 *kbits_sec, uint32 *kbits_burst)
{
    return unimpl("bcm_er_meter_get");
}

int bcm_er_meter_set(int unit, int port, int mid,
		     uint32 kbits_sec, uint32 kbits_burst)
{
    return unimpl("bcm_er_meter_set");
}

int bcm_er_ffppacketcounter_set(int unit, int port, int mid,
				uint64 val)
{
    return unimpl("bcm_er_ffppacketcounter_set");
}

int bcm_er_ffppacketcounter_get(int unit, int port, int mid,
				uint64 *val)
{
    return unimpl("bcm_er_ffppacketcounter_get");
}

int bcm_er_ffpcounter_init(int unit)
{
    return unimpl("bcm_er_ffpcounter_init");
}

int bcm_er_ffpcounter_create(int unit, int port, int *ffpcounterid)
{
    return unimpl("bcm_er_ffpcounter_create");
}

int bcm_er_ffpcounter_delete(int unit, int port, int ffpcounterid)
{
    return unimpl("bcm_er_ffpcounter_delete");
}

int bcm_er_ffpcounter_delete_all(int unit)
{
    return unimpl("bcm_er_ffpcounter_delete_all");
}

int bcm_er_ffpcounter_set(int unit, int port, int ffpcounterid,
			  uint64 val)
{
    return unimpl("bcm_er_ffpcounter_set");
}

int bcm_er_ffpcounter_get(int unit, int port, int ffpcounterid,
			  uint64 *val)
{
    return unimpl("bcm_er_ffpcounter_get");
}

#endif /* BCM_METER_SUPPORT */

mbcm_functions_t mbcm_easyrider_driver =
{
    ...
    bcm_er_meter_create,
    bcm_er_meter_delete,
    bcm_er_meter_delete_all,
    bcm_er_meter_get,
    bcm_er_meter_set,
    bcm_er_ffppacketcounter_set,
    bcm_er_ffppacketcounter_get,
    bcm_er_ffpcounter_init,
    bcm_er_ffpcounter_create,
    bcm_er_ffpcounter_delete,
    bcm_er_ffpcounter_delete_all,
    bcm_er_ffpcounter_set,
    bcm_er_ffpcounter_get,
...
int bcm_esw_easyrider_mbcm_not_empty;
