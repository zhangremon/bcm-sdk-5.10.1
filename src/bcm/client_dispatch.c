/*
 * $Id: client_dispatch.c 1.403.2.17 Broadcom SDK $
 * 
...
/*
 * $Id: client_dispatch.c,v 1.403.2.17 2011/08/12 20:10:57 reldeeb Exp $
 * 
 * $Copyright: Copyright 2011 Broadcom Corporation.
 * This program is the proprietary software of Broadcom Corporation
 * and/or its licensors, and may only be used, duplicated, modified
...
int 
bcm_client_ces_attach_ethernet(
    int unit, 
    int port)
{
...
int 
bcm_client_ces_egress_status_get(
    int unit, 
...
int 
bcm_client_ces_ethernet_config_get(
    int unit, 
    int port, 
...
int 
bcm_client_ces_ethernet_config_set(
    int unit, 
    int port, 
    bcm_ces_mac_cmd_config_t *config)
{
...
int 
bcm_client_ces_service_cas_packet_enable(
    int unit, 
    bcm_ces_service_t ces_service, 
...
int 
bcm_client_ces_service_config_get(
    int unit, 
    bcm_ces_service_t ces_service, 
...
int 
bcm_client_ces_service_destroy(
    int unit, 
    bcm_ces_service_t ces_service)
{
    return BCM_E_UNAVAIL;
...
int 
bcm_client_ces_service_destroy_all(
    int unit)
{
    return BCM_E_UNAVAIL;
}
...
int 
bcm_client_ces_service_enable_get(
    int unit, 
    bcm_ces_service_t ces_service, 
    int *enable)
{
...
int 
bcm_client_ces_service_enable_set(
    int unit, 
    bcm_ces_service_t ces_service, 
    int enable)
{
...
int 
bcm_client_ces_service_ingress_cas_enable_get(
    int unit, 
    bcm_ces_service_t ces_service, 
    int *enable)
{
...
int 
bcm_client_ces_service_ingress_cas_enable_set(
    int unit, 
    bcm_ces_service_t ces_service, 
    int enable)
{
...
int 
bcm_client_ces_service_pm_clear(
    int unit, 
    bcm_ces_service_t ces_service)
{
    return BCM_E_UNAVAIL;
...
int 
bcm_client_ces_service_rclock_config_get(
    int unit, 
    bcm_ces_service_t ces_service, 
...
int 
bcm_client_ces_service_rclock_config_set(
    int unit, 
    bcm_ces_service_t ces_service, 
    bcm_ces_rclock_config_t *config)
{
...
int 
bcm_client_ces_services_cclk_config_get(
    int unit, 
...
int 
bcm_client_ces_services_cclk_config_set(
    int unit, 
    bcm_ces_cclk_config_t *config)
{
    return BCM_E_UNAVAIL;
...
int 
bcm_client_port_tdm_cas_abcd_get(
    int unit, 
    bcm_port_t tdm_port, 
...
int 
bcm_client_port_tdm_cas_status_get(
    int unit, 
    bcm_port_t tdm_port, 
    uint32 *cas_changed)
{
...
int 
bcm_client_port_tdm_ces_ports_get(
    int unit, 
    bcm_port_t tdm_port, 
    uint32 *n_ports, 
...
int 
bcm_client_port_tdm_config_get(
    int unit, 
    bcm_port_t tdm_port, 
...
int 
bcm_client_port_tdm_config_set(
    int unit, 
    bcm_port_t tdm_port, 
    bcm_tdm_port_config_t *config)
{
...
int 
bcm_client_ptp_acceptable_master_table_add(
    int unit, 
...
int 
bcm_client_ptp_acceptable_master_table_enabled_get(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num, 
...
int 
bcm_client_ptp_acceptable_master_table_enabled_set(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num, 
...
int 
bcm_client_ptp_acceptable_master_table_list(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num, 
...
int 
bcm_client_ptp_acceptable_master_table_remove(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num, 
...
int 
bcm_client_ptp_unicast_master_table_add(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num, 
...
int 
bcm_client_ptp_unicast_master_table_clear(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num)
...
int 
bcm_client_ptp_unicast_master_table_list(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num, 
...
int 
bcm_client_ptp_unicast_master_table_remove(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num, 
...
int 
bcm_client_ptp_unicast_master_table_size_get(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num, 
...
int 
bcm_client_ptp_unicast_slave_add(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num, 
...
int 
bcm_client_ptp_unicast_slave_clear(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num)
...
int 
bcm_client_ptp_unicast_slave_list(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num, 
...
int 
bcm_client_ptp_unicast_slave_remove(
    int unit, 
    bcm_ptp_stack_id_t ptp_id, 
    int clock_num, 
    int port_num, 
