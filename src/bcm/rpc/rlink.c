/*
 * $Id: rlink.c 1.43.2.8 Broadcom SDK $
...
/*
 * Register an ptp callback function on the rpc client
 * Referenced from the client dispatch table
 */
int
bcm_client_ptp_cb_register(int unit,
                              uint32 cb_types,
                              bcm_ptp_cb f,
                              void *cookie)
{
    /* to be done for PTP, including this function to compile */
    return BCM_E_NONE;
}

/*
 * Remove an ptp callback function on the rpc client
 * Referenced from the client dispatch table
 */
int
bcm_client_ptp_cb_unregister(int unit,
                                uint32 cb_types, 
                                bcm_ptp_cb f)
{
    /* to be done for PTP, including this function to compile */
