 ...
 */
int
bcm_sbx_ipfix_register(int unit,
 ...
 */
int
bcm_sbx_ipfix_unregister(int unit,
                         bcm_ipfix_callback_t callback,
                         void *userdata)
{
    return BCM_E_UNAVAIL;
...
/*
 * Function:
 *     bcm_sbx_ipfix_config_set function
 * Description:
 ...
 *     BCM_E_PORT
 * Notes:
 *     - IP_PROT will be automatically enabled if any of the ICMP_TYPE,
 *       ICMP_CODE, or L4_SRC_PORT is enabled.
 */
int
bcm_sbx_ipfix_config_set(int unit,
                         bcm_port_t port,
...
/*
 * Function:
 *     bcm_sbx_ipfix_config_get function
 * Description:
 ...
 */
int
bcm_sbx_ipfix_config_get(int unit,
                         bcm_port_t port,
                         bcm_ipfix_stage_t stage,
                         bcm_ipfix_config_t *config)
{
...
int
bcm_sbx_ipfix_rate_create(int unit,
...
int
bcm_sbx_ipfix_rate_destroy(int unit,
...
int
bcm_sbx_ipfix_rate_get(int unit,
                       bcm_ipfix_rate_t *rate_info)
{
    return BCM_E_UNAVAIL;
}
...
int
bcm_sbx_ipfix_rate_traverse(int unit,
...
int
bcm_sbx_ipfix_rate_destroy_all(int unit)
{
    return BCM_E_UNAVAIL;
}
...
int
bcm_sbx_ipfix_rate_mirror_add(int unit,
                              bcm_ipfix_rate_id_t rate_id,
...
int
bcm_sbx_ipfix_rate_mirror_delete(int unit,
                                 bcm_ipfix_rate_id_t rate_id,
                                 bcm_gport_t mirror_dest_id)
{
    return BCM_E_UNAVAIL;
 ...
 */
int
bcm_sbx_ipfix_rate_mirror_delete_all(int unit,
                                     bcm_ipfix_rate_id_t rate_id)
{
    return BCM_E_UNAVAIL;
}
...
int
bcm_sbx_ipfix_rate_mirror_get(int unit,
                              bcm_ipfix_rate_id_t rate_id,
...
int
bcm_sbx_ipfix_mirror_config_set(int unit,
                                bcm_ipfix_stage_t stage,
                                bcm_gport_t port,
...
int
bcm_sbx_ipfix_mirror_config_get(int unit,
                                bcm_ipfix_stage_t stage,
                                bcm_gport_t port,
                                bcm_ipfix_mirror_config_t *config)
{
...
int
bcm_sbx_ipfix_mirror_port_dest_add(int unit,
                                   bcm_ipfix_stage_t stage,
                                   bcm_gport_t port,
                                   bcm_gport_t mirror_dest_id)
{
...
int
bcm_sbx_ipfix_mirror_port_dest_delete(int unit,
                                      bcm_ipfix_stage_t stage,
                                      bcm_gport_t port,
                                      bcm_gport_t mirror_dest_id)
{
...
int
bcm_sbx_ipfix_mirror_port_dest_delete_all(int unit,
                                          bcm_ipfix_stage_t stage,
                                          bcm_gport_t port)
{
    return BCM_E_UNAVAIL;
...
int
bcm_sbx_ipfix_mirror_port_dest_get(int unit,
                                   bcm_ipfix_stage_t stage,
                                   bcm_gport_t port,
                                   int mirror_dest_size,
                                   bcm_gport_t *mirror_dest_id,
