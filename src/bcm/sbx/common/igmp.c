...
int
bcm_sbx_igmp_snooping_init(int unit)
{
    return BCM_E_UNAVAIL;
}

int
bcm_sbx_igmp_snooping_enable_get(int unit, int *enable)
{
    return BCM_E_UNAVAIL;
}

int
bcm_sbx_igmp_snooping_enable_set(int unit, int enable)
{
    return BCM_E_UNAVAIL;
}
