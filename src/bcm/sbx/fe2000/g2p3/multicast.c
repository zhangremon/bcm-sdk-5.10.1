/*
 * $Id: multicast.c 1.6 Broadcom SDK $
...
int
_bcm_fe2000_g2p3_multicast_l2_encap_get(int              unit,
                                        ...
                                        bcm_if_t        *encap_id)
{
    ...
    soc_sbx_g2p3_oi2e_t oie;
    int                 rv = BCM_E_NONE;
    uint32              ftIndex;

    rv = _bcm_fe2000_vlan_fte_gport_get(unit, gport, &ftIndex);
    if (BCM_E_NONE == rv) {
