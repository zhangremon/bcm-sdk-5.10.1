/*
 * $Id: sbZfSbQe2000ElibVRT.c 1.3.36.4 Broadcom SDK $
...
sbZfSbQe2000ElibVRT_Unpack(sbZfSbQe2000ElibVRT_t *pToStruct,
  ...
  (pToStruct)->m_nVid0 =  (uint32_t)  ((pFromData)[2] >> 4) & 0x0f;
  (pToStruct)->m_nVid0 |=  (uint32_t)  (pFromData)[3] << 4;

  /* Unpack Member: m_nVid1 */
  (pToStruct)->m_nVid1 =  (uint32_t)  ((pFromData)[10] >> 4) & 0x0f;
  (pToStruct)->m_nVid1 |=  (uint32_t)  (pFromData)[11] << 4;

  /* Unpack Member: m_nOffset */
  (pToStruct)->m_nOffset =  (uint32_t)  ((pFromData)[9] >> 7) & 0x01;
  (pToStruct)->m_nOffset |=  (uint32_t)  ((pFromData)[10] & 0x0f) << 1;

  /* Unpack Member: m_nPortState_0 */
  (pToStruct)->m_nPortState_0 =  (uint32_t)  ((pFromData)[4] ) & 0x03;

  /* Unpack Member: m_nPortState_1 */
  (pToStruct)->m_nPortState_1 =  (uint32_t)  ((pFromData)[4] >> 2) & 0x03;

  /* Unpack Member: m_nPortState_2 */
  (pToStruct)->m_nPortState_2 =  (uint32_t)  ((pFromData)[4] >> 4) & 0x03;

  /* Unpack Member: m_nPortState_3 */
  (pToStruct)->m_nPortState_3 =  (uint32_t)  ((pFromData)[4] >> 6) & 0x03;

  /* Unpack Member: m_nPortState_4 */
  (pToStruct)->m_nPortState_4 =  (uint32_t)  ((pFromData)[5] ) & 0x03;

  /* Unpack Member: m_nPortState_5 */
  (pToStruct)->m_nPortState_5 =  (uint32_t)  ((pFromData)[5] >> 2) & 0x03;

  /* Unpack Member: m_nPortState_6 */
  (pToStruct)->m_nPortState_6 =  (uint32_t)  ((pFromData)[5] >> 4) & 0x03;

  /* Unpack Member: m_nPortState_7 */
  (pToStruct)->m_nPortState_7 =  (uint32_t)  ((pFromData)[5] >> 6) & 0x03;

  /* Unpack Member: m_nPortState_8 */
  (pToStruct)->m_nPortState_8 =  (uint32_t)  ((pFromData)[6] ) & 0x03;

  /* Unpack Member: m_nPortState_9 */
  (pToStruct)->m_nPortState_9 =  (uint32_t)  ((pFromData)[6] >> 2) & 0x03;

  /* Unpack Member: m_nPortState_10 */
  (pToStruct)->m_nPortState_10 =  (uint32_t)  ((pFromData)[6] >> 4) & 0x03;

  /* Unpack Member: m_nPortState_11 */
  (pToStruct)->m_nPortState_11 =  (uint32_t)  ((pFromData)[6] >> 6) & 0x03;

  /* Unpack Member: m_nPortState_12 */
  (pToStruct)->m_nPortState_12 =  (uint32_t)  ((pFromData)[7] ) & 0x03;

  /* Unpack Member: m_nPortState_13 */
  (pToStruct)->m_nPortState_13 =  (uint32_t)  ((pFromData)[7] >> 2) & 0x03;

  /* Unpack Member: m_nPortState_14 */
  (pToStruct)->m_nPortState_14 =  (uint32_t)  ((pFromData)[7] >> 4) & 0x03;

  /* Unpack Member: m_nPortState_15 */
  (pToStruct)->m_nPortState_15 =  (uint32_t)  ((pFromData)[7] >> 6) & 0x03;

  /* Unpack Member: m_nPortState_16 */
  (pToStruct)->m_nPortState_16 =  (uint32_t)  ((pFromData)[0] ) & 0x03;

  /* Unpack Member: m_nPortState_17 */
  (pToStruct)->m_nPortState_17 =  (uint32_t)  ((pFromData)[0] >> 2) & 0x03;

  /* Unpack Member: m_nPortState_18 */
  (pToStruct)->m_nPortState_18 =  (uint32_t)  ((pFromData)[0] >> 4) & 0x03;

  /* Unpack Member: m_nPortState_19 */
  (pToStruct)->m_nPortState_19 =  (uint32_t)  ((pFromData)[0] >> 6) & 0x03;

  /* Unpack Member: m_nPortState_20 */
  (pToStruct)->m_nPortState_20 =  (uint32_t)  ((pFromData)[1] ) & 0x03;

  /* Unpack Member: m_nPortState_21 */
  (pToStruct)->m_nPortState_21 =  (uint32_t)  ((pFromData)[1] >> 2) & 0x03;

  /* Unpack Member: m_nPortState_22 */
  (pToStruct)->m_nPortState_22 =  (uint32_t)  ((pFromData)[1] >> 4) & 0x03;

  /* Unpack Member: m_nPortState_23 */
  (pToStruct)->m_nPortState_23 =  (uint32_t)  ((pFromData)[1] >> 6) & 0x03;

  /* Unpack Member: m_nPortState_24 */
  (pToStruct)->m_nPortState_24 =  (uint32_t)  ((pFromData)[12] ) & 0x03;

  /* Unpack Member: m_nPortState_25 */
  (pToStruct)->m_nPortState_25 =  (uint32_t)  ((pFromData)[12] >> 2) & 0x03;

  /* Unpack Member: m_nPortState_26 */
  (pToStruct)->m_nPortState_26 =  (uint32_t)  ((pFromData)[12] >> 4) & 0x03;

  /* Unpack Member: m_nPortState_27 */
  (pToStruct)->m_nPortState_27 =  (uint32_t)  ((pFromData)[12] >> 6) & 0x03;

  /* Unpack Member: m_nPortState_28 */
  (pToStruct)->m_nPortState_28 =  (uint32_t)  ((pFromData)[13] ) & 0x03;

  /* Unpack Member: m_nPortState_29 */
  (pToStruct)->m_nPortState_29 =  (uint32_t)  ((pFromData)[13] >> 2) & 0x03;

  /* Unpack Member: m_nPortState_30 */
  (pToStruct)->m_nPortState_30 =  (uint32_t)  ((pFromData)[13] >> 4) & 0x03;

  /* Unpack Member: m_nPortState_31 */
  (pToStruct)->m_nPortState_31 =  (uint32_t)  ((pFromData)[13] >> 6) & 0x03;

  /* Unpack Member: m_nPortState_32 */
  (pToStruct)->m_nPortState_32 =  (uint32_t)  ((pFromData)[14] ) & 0x03;

  /* Unpack Member: m_nPortState_33 */
  (pToStruct)->m_nPortState_33 =  (uint32_t)  ((pFromData)[14] >> 2) & 0x03;

  /* Unpack Member: m_nPortState_34 */
  (pToStruct)->m_nPortState_34 =  (uint32_t)  ((pFromData)[14] >> 4) & 0x03;

  /* Unpack Member: m_nPortState_35 */
  (pToStruct)->m_nPortState_35 =  (uint32_t)  ((pFromData)[14] >> 6) & 0x03;

  /* Unpack Member: m_nPortState_36 */
  (pToStruct)->m_nPortState_36 =  (uint32_t)  ((pFromData)[15] ) & 0x03;

  /* Unpack Member: m_nPortState_37 */
  (pToStruct)->m_nPortState_37 =  (uint32_t)  ((pFromData)[15] >> 2) & 0x03;

  /* Unpack Member: m_nPortState_38 */
  (pToStruct)->m_nPortState_38 =  (uint32_t)  ((pFromData)[15] >> 4) & 0x03;

  /* Unpack Member: m_nPortState_39 */
  (pToStruct)->m_nPortState_39 =  (uint32_t)  ((pFromData)[15] >> 6) & 0x03;

  /* Unpack Member: m_nPortState_40 */
  (pToStruct)->m_nPortState_40 =  (uint32_t)  ((pFromData)[8] ) & 0x03;

  /* Unpack Member: m_nPortState_41 */
  (pToStruct)->m_nPortState_41 =  (uint32_t)  ((pFromData)[8] >> 2) & 0x03;

  /* Unpack Member: m_nPortState_42 */
  (pToStruct)->m_nPortState_42 =  (uint32_t)  ((pFromData)[8] >> 4) & 0x03;

  /* Unpack Member: m_nPortState_43 */
  (pToStruct)->m_nPortState_43 =  (uint32_t)  ((pFromData)[8] >> 6) & 0x03;

  /* Unpack Member: m_nPortState_44 */
  (pToStruct)->m_nPortState_44 =  (uint32_t)  ((pFromData)[9] ) & 0x03;

  /* Unpack Member: m_nPortState_45 */
  (pToStruct)->m_nPortState_45 =  (uint32_t)  ((pFromData)[9] >> 2) & 0x03;

  /* Unpack Member: m_nPortState_46 */
  (pToStruct)->m_nPortState_46 =  (uint32_t)  ((pFromData)[9] >> 4) & 0x03;

  /* Unpack Member: m_nPortState_47 */
  (pToStruct)->m_nPortState_47 =  (uint32_t)  ((pFromData)[9] >> 6) & 0x03;

  /* Unpack Member: m_nPortState_48 */
  (pToStruct)->m_nPortState_48 =  (uint32_t)  ((pFromData)[2] ) & 0x03;

  /* Unpack Member: m_nPortState_49 */
  (pToStruct)->m_nPortState_49 =  (uint32_t)  ((pFromData)[2] >> 2) & 0x03;
