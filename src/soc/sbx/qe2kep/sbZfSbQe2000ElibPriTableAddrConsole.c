/*
 * $Id: sbZfSbQe2000ElibPriTableAddrConsole.c 1.3.36.3 Broadcom SDK $
...
sbZfSbQe2000ElibPriTableAddr_Print(sbZfSbQe2000ElibPriTableAddr_t *pFromStruct) {
  SB_LOG("SbQe2000ElibPriTableAddr:: port=0x%02x", (unsigned int)  pFromStruct->m_nPort);
  SB_LOG(" cos=0x%01x", (unsigned int)  pFromStruct->m_nCos);
  SB_LOG(" dp=0x%01x", (unsigned int)  pFromStruct->m_nDp);
  SB_LOG(" ecn=0x%01x", (unsigned int)  pFromStruct->m_nEcn);
  SB_LOG("\n");
...
char *
sbZfSbQe2000ElibPriTableAddr_SPrint(sbZfSbQe2000ElibPriTableAddr_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
