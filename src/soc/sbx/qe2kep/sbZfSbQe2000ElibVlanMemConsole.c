/*
 * $Id: sbZfSbQe2000ElibVlanMemConsole.c 1.3.36.3 Broadcom SDK $
...
sbZfSbQe2000ElibVlanMem_Print(sbZfSbQe2000ElibVlanMem_t *pFromStruct) {
  SB_LOG("SbQe2000ElibVlanMem:: patches=0x%01x", (unsigned int)  pFromStruct->m_Patches);
  SB_LOG(" edges=0x%01x", (unsigned int)  pFromStruct->m_Edges);
  SB_LOG(" numfree=0x%01x", (unsigned int)  pFromStruct->m_NumFree);
  SB_LOG(" numused=0x%01x", (unsigned int)  pFromStruct->m_NumUsed);
  SB_LOG("\n");
...
char *
sbZfSbQe2000ElibVlanMem_SPrint(sbZfSbQe2000ElibVlanMem_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
