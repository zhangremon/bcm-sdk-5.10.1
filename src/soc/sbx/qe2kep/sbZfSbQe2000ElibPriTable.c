/*
 * $Id: sbZfSbQe2000ElibPriTable.c 1.3.36.4 Broadcom SDK $
...
sbZfSbQe2000ElibPriTable_Unpack(sbZfSbQe2000ElibPriTable_t *pToStruct,
  ...
  /* Unpack Member: Rsvd7 */
  (pToStruct)->Rsvd7 =  (uint32_t)  (pFromData)[31] ;

  /* Unpack Member: Pri63 */
  (pToStruct)->Pri63 =  (uint32_t)  ((pFromData)[30] >> 5) & 0x07;

  /* Unpack Member: Pri62 */
  (pToStruct)->Pri62 =  (uint32_t)  ((pFromData)[30] >> 2) & 0x07;

  /* Unpack Member: Pri61 */
  (pToStruct)->Pri61 =  (uint32_t)  ((pFromData)[29] >> 7) & 0x01;
  (pToStruct)->Pri61 |=  (uint32_t)  ((pFromData)[30] & 0x03) << 1;

  /* Unpack Member: Pri60 */
  (pToStruct)->Pri60 =  (uint32_t)  ((pFromData)[29] >> 4) & 0x07;

  /* Unpack Member: Pri59 */
  (pToStruct)->Pri59 =  (uint32_t)  ((pFromData)[29] >> 1) & 0x07;

  /* Unpack Member: Pri58 */
  (pToStruct)->Pri58 =  (uint32_t)  ((pFromData)[28] >> 6) & 0x03;
  (pToStruct)->Pri58 |=  (uint32_t)  ((pFromData)[29] & 0x01) << 2;

  /* Unpack Member: Pri57 */
  (pToStruct)->Pri57 =  (uint32_t)  ((pFromData)[28] >> 3) & 0x07;

  /* Unpack Member: Pri56 */
  (pToStruct)->Pri56 =  (uint32_t)  ((pFromData)[28] ) & 0x07;

  /* Unpack Member: Rsvd6 */
  (pToStruct)->Rsvd6 =  (uint32_t)  (pFromData)[27] ;

  /* Unpack Member: Pri55 */
  (pToStruct)->Pri55 =  (uint32_t)  ((pFromData)[26] >> 5) & 0x07;

  /* Unpack Member: Pri54 */
  (pToStruct)->Pri54 =  (uint32_t)  ((pFromData)[26] >> 2) & 0x07;

  /* Unpack Member: Pri53 */
  (pToStruct)->Pri53 =  (uint32_t)  ((pFromData)[25] >> 7) & 0x01;
  (pToStruct)->Pri53 |=  (uint32_t)  ((pFromData)[26] & 0x03) << 1;

  /* Unpack Member: Pri52 */
  (pToStruct)->Pri52 =  (uint32_t)  ((pFromData)[25] >> 4) & 0x07;

  /* Unpack Member: Pri51 */
  (pToStruct)->Pri51 =  (uint32_t)  ((pFromData)[25] >> 1) & 0x07;

  /* Unpack Member: Pri50 */
  (pToStruct)->Pri50 =  (uint32_t)  ((pFromData)[24] >> 6) & 0x03;
  (pToStruct)->Pri50 |=  (uint32_t)  ((pFromData)[25] & 0x01) << 2;

  /* Unpack Member: Pri49 */
  (pToStruct)->Pri49 =  (uint32_t)  ((pFromData)[24] >> 3) & 0x07;

  /* Unpack Member: Pri48 */
  (pToStruct)->Pri48 =  (uint32_t)  ((pFromData)[24] ) & 0x07;

  /* Unpack Member: Rsvd5 */
  (pToStruct)->Rsvd5 =  (uint32_t)  (pFromData)[23] ;

  /* Unpack Member: Pri47 */
  (pToStruct)->Pri47 =  (uint32_t)  ((pFromData)[22] >> 5) & 0x07;

  /* Unpack Member: Pri46 */
  (pToStruct)->Pri46 =  (uint32_t)  ((pFromData)[22] >> 2) & 0x07;

  /* Unpack Member: Pri45 */
  (pToStruct)->Pri45 =  (uint32_t)  ((pFromData)[21] >> 7) & 0x01;
  (pToStruct)->Pri45 |=  (uint32_t)  ((pFromData)[22] & 0x03) << 1;

  /* Unpack Member: Pri44 */
  (pToStruct)->Pri44 =  (uint32_t)  ((pFromData)[21] >> 4) & 0x07;

  /* Unpack Member: Pri43 */
  (pToStruct)->Pri43 =  (uint32_t)  ((pFromData)[21] >> 1) & 0x07;

  /* Unpack Member: Pri42 */
  (pToStruct)->Pri42 =  (uint32_t)  ((pFromData)[20] >> 6) & 0x03;
  (pToStruct)->Pri42 |=  (uint32_t)  ((pFromData)[21] & 0x01) << 2;

  /* Unpack Member: Pri41 */
  (pToStruct)->Pri41 =  (uint32_t)  ((pFromData)[20] >> 3) & 0x07;

  /* Unpack Member: Pri40 */
  (pToStruct)->Pri40 =  (uint32_t)  ((pFromData)[20] ) & 0x07;

  /* Unpack Member: Rsvd4 */
  (pToStruct)->Rsvd4 =  (uint32_t)  (pFromData)[19] ;

  /* Unpack Member: Pri39 */
  (pToStruct)->Pri39 =  (uint32_t)  ((pFromData)[18] >> 5) & 0x07;

  /* Unpack Member: Pri38 */
  (pToStruct)->Pri38 =  (uint32_t)  ((pFromData)[18] >> 2) & 0x07;

  /* Unpack Member: Pri37 */
  (pToStruct)->Pri37 =  (uint32_t)  ((pFromData)[17] >> 7) & 0x01;
  (pToStruct)->Pri37 |=  (uint32_t)  ((pFromData)[18] & 0x03) << 1;

  /* Unpack Member: Pri36 */
  (pToStruct)->Pri36 =  (uint32_t)  ((pFromData)[17] >> 4) & 0x07;

  /* Unpack Member: Pri35 */
  (pToStruct)->Pri35 =  (uint32_t)  ((pFromData)[17] >> 1) & 0x07;

  /* Unpack Member: Pri34 */
  (pToStruct)->Pri34 =  (uint32_t)  ((pFromData)[16] >> 6) & 0x03;
  (pToStruct)->Pri34 |=  (uint32_t)  ((pFromData)[17] & 0x01) << 2;

  /* Unpack Member: Pri33 */
  (pToStruct)->Pri33 =  (uint32_t)  ((pFromData)[16] >> 3) & 0x07;

  /* Unpack Member: Pri32 */
  (pToStruct)->Pri32 =  (uint32_t)  ((pFromData)[16] ) & 0x07;

  /* Unpack Member: Rsvd3 */
  (pToStruct)->Rsvd3 =  (uint32_t)  (pFromData)[15] ;

  /* Unpack Member: Pri31 */
  (pToStruct)->Pri31 =  (uint32_t)  ((pFromData)[14] >> 5) & 0x07;

  /* Unpack Member: Pri30 */
  (pToStruct)->Pri30 =  (uint32_t)  ((pFromData)[14] >> 2) & 0x07;

  /* Unpack Member: Pri29 */
  (pToStruct)->Pri29 =  (uint32_t)  ((pFromData)[13] >> 7) & 0x01;
  (pToStruct)->Pri29 |=  (uint32_t)  ((pFromData)[14] & 0x03) << 1;

  /* Unpack Member: Pri28 */
  (pToStruct)->Pri28 =  (uint32_t)  ((pFromData)[13] >> 4) & 0x07;

  /* Unpack Member: Pri27 */
  (pToStruct)->Pri27 =  (uint32_t)  ((pFromData)[13] >> 1) & 0x07;

  /* Unpack Member: Pri26 */
  (pToStruct)->Pri26 =  (uint32_t)  ((pFromData)[12] >> 6) & 0x03;
  (pToStruct)->Pri26 |=  (uint32_t)  ((pFromData)[13] & 0x01) << 2;

  /* Unpack Member: Pri25 */
  (pToStruct)->Pri25 =  (uint32_t)  ((pFromData)[12] >> 3) & 0x07;

  /* Unpack Member: Pri24 */
  (pToStruct)->Pri24 =  (uint32_t)  ((pFromData)[12] ) & 0x07;

  /* Unpack Member: Rsvd2 */
  (pToStruct)->Rsvd2 =  (uint32_t)  (pFromData)[11] ;

  /* Unpack Member: Pri23 */
  (pToStruct)->Pri23 =  (uint32_t)  ((pFromData)[10] >> 5) & 0x07;

  /* Unpack Member: Pri22 */
  (pToStruct)->Pri22 =  (uint32_t)  ((pFromData)[10] >> 2) & 0x07;

  /* Unpack Member: Pri21 */
  (pToStruct)->Pri21 =  (uint32_t)  ((pFromData)[9] >> 7) & 0x01;
  (pToStruct)->Pri21 |=  (uint32_t)  ((pFromData)[10] & 0x03) << 1;

  /* Unpack Member: Pri20 */
  (pToStruct)->Pri20 =  (uint32_t)  ((pFromData)[9] >> 4) & 0x07;

  /* Unpack Member: Pri19 */
  (pToStruct)->Pri19 =  (uint32_t)  ((pFromData)[9] >> 1) & 0x07;

  /* Unpack Member: Pri18 */
  (pToStruct)->Pri18 =  (uint32_t)  ((pFromData)[8] >> 6) & 0x03;
  (pToStruct)->Pri18 |=  (uint32_t)  ((pFromData)[9] & 0x01) << 2;

  /* Unpack Member: Pri17 */
  (pToStruct)->Pri17 =  (uint32_t)  ((pFromData)[8] >> 3) & 0x07;

  /* Unpack Member: Pri16 */
  (pToStruct)->Pri16 =  (uint32_t)  ((pFromData)[8] ) & 0x07;

  /* Unpack Member: Rsvd1 */
  (pToStruct)->Rsvd1 =  (uint32_t)  (pFromData)[7] ;

  /* Unpack Member: Pri15 */
  (pToStruct)->Pri15 =  (uint32_t)  ((pFromData)[6] >> 5) & 0x07;

  /* Unpack Member: Pri14 */
  (pToStruct)->Pri14 =  (uint32_t)  ((pFromData)[6] >> 2) & 0x07;

  /* Unpack Member: Pri13 */
  (pToStruct)->Pri13 =  (uint32_t)  ((pFromData)[5] >> 7) & 0x01;
  (pToStruct)->Pri13 |=  (uint32_t)  ((pFromData)[6] & 0x03) << 1;

  /* Unpack Member: Pri12 */
  (pToStruct)->Pri12 =  (uint32_t)  ((pFromData)[5] >> 4) & 0x07;

  /* Unpack Member: Pri11 */
  (pToStruct)->Pri11 =  (uint32_t)  ((pFromData)[5] >> 1) & 0x07;

  /* Unpack Member: Pri10 */
  (pToStruct)->Pri10 =  (uint32_t)  ((pFromData)[4] >> 6) & 0x03;
  (pToStruct)->Pri10 |=  (uint32_t)  ((pFromData)[5] & 0x01) << 2;

  /* Unpack Member: Pri9 */
  (pToStruct)->Pri9 =  (uint32_t)  ((pFromData)[4] >> 3) & 0x07;

  /* Unpack Member: Pri8 */
  (pToStruct)->Pri8 =  (uint32_t)  ((pFromData)[4] ) & 0x07;

  /* Unpack Member: Rsvd0 */
  (pToStruct)->Rsvd0 =  (uint32_t)  (pFromData)[3] ;

  /* Unpack Member: Pri7 */
  (pToStruct)->Pri7 =  (uint32_t)  ((pFromData)[2] >> 5) & 0x07;

  /* Unpack Member: Pri6 */
  (pToStruct)->Pri6 =  (uint32_t)  ((pFromData)[2] >> 2) & 0x07;

  /* Unpack Member: Pri5 */
  (pToStruct)->Pri5 =  (uint32_t)  ((pFromData)[1] >> 7) & 0x01;
  (pToStruct)->Pri5 |=  (uint32_t)  ((pFromData)[2] & 0x03) << 1;

  /* Unpack Member: Pri4 */
  (pToStruct)->Pri4 =  (uint32_t)  ((pFromData)[1] >> 4) & 0x07;

  /* Unpack Member: Pri3 */
  (pToStruct)->Pri3 =  (uint32_t)  ((pFromData)[1] >> 1) & 0x07;

  /* Unpack Member: Pri2 */
  (pToStruct)->Pri2 =  (uint32_t)  ((pFromData)[0] >> 6) & 0x03;
  (pToStruct)->Pri2 |=  (uint32_t)  ((pFromData)[1] & 0x01) << 2;

  /* Unpack Member: Pri1 */
  (pToStruct)->Pri1 =  (uint32_t)  ((pFromData)[0] >> 3) & 0x07;

  /* Unpack Member: Pri0 */
  (pToStruct)->Pri0 =  (uint32_t)  ((pFromData)[0] ) & 0x07;
