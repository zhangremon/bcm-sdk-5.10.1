/*
 * $Id: sbZfSbQe2000ElibCITConsole.c 1.3.36.3 Broadcom SDK $
...
sbZfSbQe2000ElibCIT_Print(sbZfSbQe2000ElibCIT_t *pFromStruct) {
  SB_LOG("SbQe2000ElibCIT:: inst7=0x%08x", (unsigned int)  pFromStruct->m_Instruction7);
  SB_LOG(" inst6=0x%08x", (unsigned int)  pFromStruct->m_Instruction6);
  SB_LOG(" inst5=0x%08x", (unsigned int)  pFromStruct->m_Instruction5);
  SB_LOG("\n");

  SB_LOG("SbQe2000ElibCIT:: inst4=0x%08x", (unsigned int)  pFromStruct->m_Instruction4);
  SB_LOG(" inst3=0x%08x", (unsigned int)  pFromStruct->m_Instruction3);
  SB_LOG(" inst2=0x%08x", (unsigned int)  pFromStruct->m_Instruction2);
  SB_LOG("\n");

  SB_LOG("SbQe2000ElibCIT:: inst1=0x%08x", (unsigned int)  pFromStruct->m_Instruction1);
  SB_LOG(" inst0=0x%08x", (unsigned int)  pFromStruct->m_Instruction0);
  SB_LOG("\n");
...
char *
sbZfSbQe2000ElibCIT_SPrint(sbZfSbQe2000ElibCIT_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
