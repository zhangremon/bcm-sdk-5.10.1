/*
 * $Id: sbZfSbQe2000ElibFMVT.c 1.3.36.4 Broadcom SDK $
...
sbZfSbQe2000ElibFMVT_Unpack(sbZfSbQe2000ElibFMVT_t *pToStruct,
  ...
  {
    VOL COMPILER_UINT64 *tmp0 = &(pToStruct)->m_nnPortMap2;
  ...
  {
    VOL COMPILER_UINT64 *tmp0 = &(pToStruct)->m_nnPortMap1;
  ...
  {
    VOL COMPILER_UINT64 *tmp0 = &(pToStruct)->m_nnPortMap0;
