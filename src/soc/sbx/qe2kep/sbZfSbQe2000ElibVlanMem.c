/*
 * $Id: sbZfSbQe2000ElibVlanMem.c 1.3.36.4 Broadcom SDK $
...
sbZfSbQe2000ElibVlanMem_Unpack(sbZfSbQe2000ElibVlanMem_t *pToStruct,
  ...
  (pToStruct)->m_Patches =  (int32_t)  ((pFromData)[0] ) & 0x01;

  /* Unpack Member: m_Edges */
  (pToStruct)->m_Edges =  (int32_t)  ((pFromData)[0] ) & 0x01;

  /* Unpack Member: m_NumFree */
  (pToStruct)->m_NumFree =  (int32_t)  ((pFromData)[0] ) & 0x01;

  /* Unpack Member: m_NumUsed */
  (pToStruct)->m_NumUsed =  (int32_t)  ((pFromData)[0] ) & 0x01;
