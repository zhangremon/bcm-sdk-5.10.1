/*
 * $Id: sbZfSbQe2000ElibVIT.c 1.3.36.4 Broadcom SDK $
...
sbZfSbQe2000ElibVIT_Unpack(sbZfSbQe2000ElibVIT_t *pToStruct,
  ...
  (pToStruct)->m_record3 =  (int32_t)  (pFromData)[6] ;
  (pToStruct)->m_record3 |=  (int32_t)  (pFromData)[7] << 8;

  /* Unpack Member: m_record2 */
  (pToStruct)->m_record2 =  (int32_t)  (pFromData)[4] ;
  (pToStruct)->m_record2 |=  (int32_t)  (pFromData)[5] << 8;

  /* Unpack Member: m_record1 */
  (pToStruct)->m_record1 =  (int32_t)  (pFromData)[2] ;
  (pToStruct)->m_record1 |=  (int32_t)  (pFromData)[3] << 8;

  /* Unpack Member: m_record0 */
  (pToStruct)->m_record0 =  (int32_t)  (pFromData)[0] ;
  (pToStruct)->m_record0 |=  (int32_t)  (pFromData)[1] << 8;
