 ...
 * =========================================
 *
 * WORKING REVISION: $Id: sbQe2000Elib.c 1.10.40.1 Broadcom SDK $
 *
...
static sbElibStatus_et sbQe2000ElibPCTDmaPoll( SB_QE2000_ELIB_CONTEXT_PST pEp, uint8_t *pucPCT );
static sbElibStatus_et sbQe2000ElibPCTPioPoll( SB_QE2000_ELIB_CONTEXT_PST pEp, uint8_t *pucPCT );
#if defined(SB_QE2000_EP_BIST_RUN)
static sbElibStatus_et sbQe2000ElibBistRun( SB_QE2000_ELIB_CONTEXT_PST pEp, uint32_t *pulStatus );
#endif
...
sbElibStatus_et sbQe2000ElibDefParamsGet( SB_QE2000_ELIB_INIT_PARAMS_PST pParams )
{
    ...
    pParams->ullSmacMsbEnable = 0;
    pParams->ullMirrorEnable = 0;
...
sbElibStatus_et sbQe2000ElibInit( SB_QE2000_ELIB_HANDLE *pHandle, void *pHalCtx, SB_QE2000_ELIB_INIT_PARAMS_ST Params )
{
    ...
    uint32_t ulMirror0;
    uint32_t ulMirror1;
    uint32_t ulVencapTag;
    sbElibStatus_et nStatus;
#if defined(SB_QE2000_EP_BIST_RUN)
    uint32_t ulBistStatus;
#endif
    void *pTmpVoid;
    ...
    pTmpVoid = NULL;
    nStatus = gen_thin_malloc((void *)pHalCtx,
                              SB_ALLOC_INTERNAL,
    ...
    if (TRUE == Params.bEpEna)
    {
        ...
        else
        {
            ...
            ulERH0 = (uint32_t)(0xFFFFFFFF & Params.ullERHForward);
            ulERH1 = (uint32_t)((Params.ullERHForward >> 32) & 0x3FFFF);
            ulSmacMsb0 = (uint32_t)(0xFFFFFFFF & Params.ullSmacMsbEnable);
            ulSmacMsb1 = (uint32_t)((Params.ullSmacMsbEnable >> 32) & 0x3FFFF);
            ulMirror0 = (uint32_t)(0xFFFFFFFF & Params.ullMirrorEnable);
            ulMirror1 = (uint32_t)((Params.ullMirrorEnable >> 32) & 0x3FFFF);
        }
...
sbElibStatus_et sbQe2000ElibVlanEncapSet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulVlanTagA, uint32_t ulVlanTagB )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    uint32_t ulVencapTag;
...
sbElibStatus_et sbQe2000ElibVlanEncapGet( SB_QE2000_ELIB_HANDLE Handle, uint32_t *pulVlanTagA, uint32_t *pulVlanTagB )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    uint32_t ulVencapTag;
...
sbElibStatus_et sbQe2000ElibMplsEncapSet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulMpls )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    uint32_t ulMplsEncap;
...
sbElibStatus_et sbQe2000ElibMplsEncapGet( SB_QE2000_ELIB_HANDLE Handle, uint32_t *pulMpls )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    uint32_t ulMplsEncap;
...
sbElibStatus_et sbQe2000ElibPortCfgSet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulPort, SB_QE2000_ELIB_PORT_CFG_ST Cfg )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    sbElibStatus_et nStatus;
    SB_QE2000_ELIB_PORT_CFG_ST oldCfg;
    uint32_t ulRewrite, ulBf;
    uint32_t ulUntag, ulTagSel;
    uint32_t ulModPort;
    sbZfSbQe2000ElibPT_t sZfPt;
    uint32_t aulData[SB_ZF_SB_QE2000_ELIB_PT_ENTRY_SIZE_IN_BYTES / sizeof(uint32_t)];
    uint32_t ulClTransitBytes, ulClTransitPkts;
    int i;
    ...
    for( i = 0; i < SB_QE2000_ELIB_NUM_CLASSES_K; i++ )
    {
        ...
        if( Cfg.bClassEna[i] != oldCfg.bClassEna[i] )
        {
            ...
            /* TODO: read counters for this class */
            ...
            {
                case 1:
                    pEp->asPCT[ulPort].m_PktClass1 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass1 += ulClTransitPkts;
                    break;
                case 2:
                    pEp->asPCT[ulPort].m_PktClass2 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass2 += ulClTransitPkts;
                    break;
                case 3:
                    pEp->asPCT[ulPort].m_PktClass3 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass3 += ulClTransitPkts;
                    break;
                case 4:
                    pEp->asPCT[ulPort].m_PktClass4 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass4 += ulClTransitPkts;
                    break;
                case 5:
                    pEp->asPCT[ulPort].m_PktClass5 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass5 += ulClTransitPkts;
                    break;
                case 6:
                    pEp->asPCT[ulPort].m_PktClass6 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass6 += ulClTransitPkts;
                    break;
                case 7:
                    pEp->asPCT[ulPort].m_PktClass7 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass7 += ulClTransitPkts;
                    break;
                case 8:
                    pEp->asPCT[ulPort].m_PktClass8 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass8 += ulClTransitPkts;
                    break;
                case 9:
                    pEp->asPCT[ulPort].m_PktClass9 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass9 += ulClTransitPkts;
                    break;
                case 10:
                    pEp->asPCT[ulPort].m_PktClass10 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass10 += ulClTransitPkts;
                    break;
                case 11:
                    pEp->asPCT[ulPort].m_PktClass11 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass11 += ulClTransitPkts;
                    break;
                case 12:
                    pEp->asPCT[ulPort].m_PktClass12 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass12 += ulClTransitPkts;
                    break;
                case 13:
                    pEp->asPCT[ulPort].m_PktClass13 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass13 += ulClTransitPkts;
                    break;
                case 14:
                    pEp->asPCT[ulPort].m_PktClass14 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass14 += ulClTransitPkts;
                    break;
                case 15:
                    pEp->asPCT[ulPort].m_PktClass15 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass15 += ulClTransitPkts;
                    break;
                case 0:
                default:
                    pEp->asPCT[ulPort].m_PktClass0 += ulClTransitPkts;
                    pEp->asPCT[ulPort].m_ByteClass0 += ulClTransitPkts;
                    break;
            }
...
sbElibStatus_et sbQe2000ElibPortCfgGet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulPort, SB_QE2000_ELIB_PORT_CFG_PST pCfg )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
...
sbElibStatus_et sbQe2000ElibCRTSet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulIndex, uint32_t ulClass )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    uint32_t ulWordIdx, ulEntry;
...
sbElibStatus_et sbQe2000ElibCRTPush( SB_QE2000_ELIB_HANDLE Handle, bool_t bAll )
{
    ...
    sbElibStatus_et nStatus;
    int nWordIdx;
    uint32_t aulCRT[SB_ZF_SB_QE2000_ELIB_CRT_ENTRY_SIZE_IN_BYTES / sizeof(uint32_t)];
...
sbElibStatus_et sbQe2000ElibCRTGet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulIndex, uint32_t* pulClass )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
...
sbElibStatus_et sbQe2000ElibCITSet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulClass, SB_QE2000_ELIB_CIT_ENTRY_ST Inst )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    uint32_t aulInst[SB_ZF_SB_QE2000_ELIB_CIT_ENTRY_SIZE_IN_BYTES / sizeof (uint32_t)];
    sbElibStatus_et status;
    int nInstr;
    uint32_t ulClassOffset;
    uint32_t ulAppend;
    uint8_t ucAppend;
...
sbElibStatus_et sbQe2000ElibCITGet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulClass, SB_QE2000_ELIB_CIT_ENTRY_PST pInst )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    uint32_t aulInst[SB_ZF_SB_QE2000_ELIB_CIT_ENTRY_SIZE_IN_BYTES / sizeof (uint32_t)];
    sbElibStatus_et status;
...
sbElibStatus_et sbQe2000ElibPCTGet( SB_QE2000_ELIB_HANDLE Handle,
                        uint32_t ulPort,
                        uint32_t ulClass,
                        uint64_t *pullPacketCnt,
                        uint64_t *pullByteCnt )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    sbElibStatus_et nStatus;
...
sbElibStatus_et sbQe2000ElibCmapSet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulSelect, SB_QE2000_ELIB_CMAP_ST Map )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    uint32_t ulCmapFwd0, ulCmapFwd1;
    uint32_t ulCmapDrp0, ulCmapDrp1;
    uint32_t ulBfConfigReg;
...
sbElibStatus_et sbQe2000ElibCmapGet( SB_QE2000_ELIB_HANDLE Handle, uint32_t ulSelect, SB_QE2000_ELIB_CMAP_PST pMap )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    uint32_t ulCmapFwd0, ulCmapFwd1;
    uint32_t ulCmapDrp0, ulCmapDrp1;
...
sbElibStatus_et sbQe2000ElibPortPriRewriteSet( SB_QE2000_ELIB_HANDLE Handle,
                                               uint32_t ulPort,
                                               uint32_t pPortPriTable[64])
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    uint32_t aulPriIdx[SB_ZF_SB_QE2000_ELIB_PRI_TABLE_ADDR_SIZE_IN_BYTES / sizeof(uint32_t)];
    uint32_t aulPriTable[SB_ZF_SB_QE2000_ELIB_PRI_TABLE_SIZE / sizeof(uint32_t)];
    uint32_t ulAddr;
    int nIdx;
                                           ...
                                           uint32_t ulPri )
{
    SB_QE2000_ELIB_CONTEXT_PST pEp = (SB_QE2000_ELIB_CONTEXT_PST) Handle;
    uint32_t aulPriIdx[SB_ZF_SB_QE2000_ELIB_PRI_TABLE_ADDR_SIZE_IN_BYTES / sizeof(uint32_t)];
    uint32_t ulAddr, ulShift, ulMask, ulData, ulReg;
    sbElibStatus_et status;
    sbZfSbQe2000ElibPriTableAddr_t tPri;
                         ...
                         void *pUserData)
{
    ...
    int nPort;
    sbElibStatus_et nStatus;
    uint32_t aulMvtTuple[SB_ZF_SB_QE2000_ELIB_FMVT_ENTRY_SIZE_IN_BYTES / sizeof(uint32_t)];
    int nGrpSize;
    int nColumn;
...
sbElibStatus_et sbQe2000ElibCountsReset( SB_QE2000_ELIB_HANDLE Handle )
{
    ...
    {
        pEp->aullClassPktCnt[nIdx] = 0;
    }

    for( nIdx = 0; nIdx < SB_QE2000_ELIB_NUM_PORTS_K; nIdx++ )
    {
        pEp->asPCT[nIdx].m_PktClass15 = 0;
        pEp->asPCT[nIdx].m_PktClass14 = 0;
        pEp->asPCT[nIdx].m_PktClass13 = 0;
        pEp->asPCT[nIdx].m_PktClass12 = 0;
        pEp->asPCT[nIdx].m_PktClass11 = 0;
        pEp->asPCT[nIdx].m_PktClass10 = 0;
        pEp->asPCT[nIdx].m_PktClass9  = 0;
        pEp->asPCT[nIdx].m_PktClass8  = 0;
        pEp->asPCT[nIdx].m_PktClass7  = 0;
        pEp->asPCT[nIdx].m_PktClass6  = 0;
        pEp->asPCT[nIdx].m_PktClass5  = 0;
        pEp->asPCT[nIdx].m_PktClass4  = 0;
        pEp->asPCT[nIdx].m_PktClass3  = 0;
        pEp->asPCT[nIdx].m_PktClass2  = 0;
        pEp->asPCT[nIdx].m_PktClass1  = 0;
        pEp->asPCT[nIdx].m_PktClass0  = 0;

        pEp->asPCT[nIdx].m_ByteClass15 = 0;
        pEp->asPCT[nIdx].m_ByteClass14 = 0;
        pEp->asPCT[nIdx].m_ByteClass13 = 0;
        pEp->asPCT[nIdx].m_ByteClass12 = 0;
        pEp->asPCT[nIdx].m_ByteClass11 = 0;
        pEp->asPCT[nIdx].m_ByteClass10 = 0;
        pEp->asPCT[nIdx].m_ByteClass9  = 0;
        pEp->asPCT[nIdx].m_ByteClass8  = 0;
        pEp->asPCT[nIdx].m_ByteClass7  = 0;
        pEp->asPCT[nIdx].m_ByteClass6  = 0;
        pEp->asPCT[nIdx].m_ByteClass5  = 0;
        pEp->asPCT[nIdx].m_ByteClass4  = 0;
        pEp->asPCT[nIdx].m_ByteClass3  = 0;
        pEp->asPCT[nIdx].m_ByteClass2  = 0;
        pEp->asPCT[nIdx].m_ByteClass1  = 0;
        pEp->asPCT[nIdx].m_ByteClass0  = 0;
    } /* end for each port */
...
static sbElibStatus_et sbQe2000ElibClassPktCountPoll( SB_QE2000_ELIB_CONTEXT_PST pEp )
{
    ...
    for( nClass = 0; nClass < SB_QE2000_ELIB_NUM_CLASSES_K; nClass++ )
    {
        pEp->aullClassPktCnt[nClass] += SAND_HAL_READ_INDEX(pEp->pHalCtx, KA, EP_CL_PKT0, nClass);
    }
...
static uint8_t aucPCT[SB_QE2000_ELIB_NUM_CLASSES_K * SB_QE2000_ELIB_NUM_PORTS_K * sizeof(uint64_t)];
...
static sbElibStatus_et sbQe2000ElibPCTPoll( SB_QE2000_ELIB_CONTEXT_PST pEp )
{
    ...
    for( nPort = 0; nPort < SB_QE2000_ELIB_NUM_PORTS_K; nPort++ )
    {
        ...
        pEp->asPCT[nPort].m_PktClass15 += sZfPCT.m_PktClass15;
        pEp->asPCT[nPort].m_PktClass14 += sZfPCT.m_PktClass14;
        pEp->asPCT[nPort].m_PktClass13 += sZfPCT.m_PktClass13;
        pEp->asPCT[nPort].m_PktClass12 += sZfPCT.m_PktClass12;
        pEp->asPCT[nPort].m_PktClass11 += sZfPCT.m_PktClass11;
        pEp->asPCT[nPort].m_PktClass10 += sZfPCT.m_PktClass10;
        pEp->asPCT[nPort].m_PktClass9 += sZfPCT.m_PktClass9;
        pEp->asPCT[nPort].m_PktClass8 += sZfPCT.m_PktClass8;
        pEp->asPCT[nPort].m_PktClass7 += sZfPCT.m_PktClass7;
        pEp->asPCT[nPort].m_PktClass6 += sZfPCT.m_PktClass6;
        pEp->asPCT[nPort].m_PktClass5 += sZfPCT.m_PktClass5;
        pEp->asPCT[nPort].m_PktClass4 += sZfPCT.m_PktClass4;
        pEp->asPCT[nPort].m_PktClass3 += sZfPCT.m_PktClass3;
        pEp->asPCT[nPort].m_PktClass2 += sZfPCT.m_PktClass2;
        pEp->asPCT[nPort].m_PktClass1 += sZfPCT.m_PktClass1;
        pEp->asPCT[nPort].m_PktClass0 += sZfPCT.m_PktClass0;

        pEp->asPCT[nPort].m_ByteClass15 += sZfPCT.m_ByteClass15;
        pEp->asPCT[nPort].m_ByteClass14 += sZfPCT.m_ByteClass14;
        pEp->asPCT[nPort].m_ByteClass13 += sZfPCT.m_ByteClass13;
        pEp->asPCT[nPort].m_ByteClass12 += sZfPCT.m_ByteClass12;
        pEp->asPCT[nPort].m_ByteClass11 += sZfPCT.m_ByteClass11;
        pEp->asPCT[nPort].m_ByteClass10 += sZfPCT.m_ByteClass10;
        pEp->asPCT[nPort].m_ByteClass9 += sZfPCT.m_ByteClass9;
        pEp->asPCT[nPort].m_ByteClass8 += sZfPCT.m_ByteClass8;
        pEp->asPCT[nPort].m_ByteClass7 += sZfPCT.m_ByteClass7;
        pEp->asPCT[nPort].m_ByteClass6 += sZfPCT.m_ByteClass6;
        pEp->asPCT[nPort].m_ByteClass5 += sZfPCT.m_ByteClass5;
        pEp->asPCT[nPort].m_ByteClass4 += sZfPCT.m_ByteClass4;
        pEp->asPCT[nPort].m_ByteClass3 += sZfPCT.m_ByteClass3;
        pEp->asPCT[nPort].m_ByteClass2 += sZfPCT.m_ByteClass2;
        pEp->asPCT[nPort].m_ByteClass1 += sZfPCT.m_ByteClass1;
        pEp->asPCT[nPort].m_ByteClass0 += sZfPCT.m_ByteClass0;
