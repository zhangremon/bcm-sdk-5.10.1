/*
 * $Id: sbZfG2EplibIpSegment.c 1.5.12.4 Broadcom SDK $
...
sbZfG2EplibIpSegment_Unpack(sbZfG2EplibIpSegment_t *pToStruct,
  ...
  /* Unpack Member: start */
  (pToStruct)->start =  (uint32_t)  ((pFromData)[0] ) & 0x01;

  /* Unpack Member: end */
  (pToStruct)->end =  (uint32_t)  ((pFromData)[0] ) & 0x01;

  /* Unpack Member: width */
  (pToStruct)->width =  (uint32_t)  ((pFromData)[0] ) & 0x01;

  /* Unpack Member: entrysize */
  (pToStruct)->entrysize =  (uint32_t)  ((pFromData)[0] ) & 0x01;
