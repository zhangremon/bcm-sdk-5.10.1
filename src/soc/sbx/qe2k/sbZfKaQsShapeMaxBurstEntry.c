/*
 * $Id: sbZfKaQsShapeMaxBurstEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaQsShapeMaxBurstEntry_Unpack(sbZfKaQsShapeMaxBurstEntry_t *pToStruct,
  ...
  (pToStruct)->m_nEnable =  (uint32_t)  ((pFromData)[1] >> 7) & 0x01;

  /* Unpack Member: m_nShapeMaxBurst */
  (pToStruct)->m_nShapeMaxBurst =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_nShapeMaxBurst |=  (uint32_t)  (pFromData)[2] << 8;
  (pToStruct)->m_nShapeMaxBurst |=  (uint32_t)  ((pFromData)[1] & 0x7f) << 16;
#else
  ...
  /* Unpack Member: m_nEnable */
  (pToStruct)->m_nEnable =  (uint32_t)  ((pFromData)[2] >> 7) & 0x01;

  /* Unpack Member: m_nShapeMaxBurst */
  (pToStruct)->m_nShapeMaxBurst =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_nShapeMaxBurst |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->m_nShapeMaxBurst |=  (uint32_t)  ((pFromData)[2] & 0x7f) << 16;
#endif
