/*
 * $Id: sbZfKaQsLnaPriEntryConsole.c 1.2.12.3 Broadcom SDK $
...
sbZfKaQsLnaPriEntry_Print(sbZfKaQsLnaPriEntry_t *pFromStruct) {
  SB_LOG("KaQsLnaPriEntry:: pri4=0x%08x", (unsigned int)  pFromStruct->m_nPri4);
  SB_LOG(" pri3=0x%08x", (unsigned int)  pFromStruct->m_nPri3);
  SB_LOG(" pri2=0x%08x", (unsigned int)  pFromStruct->m_nPri2);
  SB_LOG("\n");

  SB_LOG("KaQsLnaPriEntry:: pri1=0x%08x", (unsigned int)  pFromStruct->m_nPri1);
  SB_LOG(" pri0=0x%08x", (unsigned int)  pFromStruct->m_nPri0);
  SB_LOG("\n");
...
char *
sbZfKaQsLnaPriEntry_SPrint(sbZfKaQsLnaPriEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
