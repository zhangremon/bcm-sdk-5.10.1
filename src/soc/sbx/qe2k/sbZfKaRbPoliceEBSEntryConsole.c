/*
 * $Id: sbZfKaRbPoliceEBSEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaRbPoliceEBSEntry_Print(sbZfKaRbPoliceEBSEntry_t *pFromStruct) {
  SB_LOG("KaRbPoliceEBSEntry:: ebs=0x%06x", (unsigned int)  pFromStruct->m_nEBS);
  SB_LOG("\n");
...
char *
sbZfKaRbPoliceEBSEntry_SPrint(sbZfKaRbPoliceEBSEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
