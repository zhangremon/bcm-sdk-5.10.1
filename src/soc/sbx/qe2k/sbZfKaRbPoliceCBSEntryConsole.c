/*
 * $Id: sbZfKaRbPoliceCBSEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaRbPoliceCBSEntry_Print(sbZfKaRbPoliceCBSEntry_t *pFromStruct) {
  SB_LOG("KaRbPoliceCBSEntry:: cbs=0x%06x", (unsigned int)  pFromStruct->m_nCBS);
  SB_LOG("\n");
...
char *
sbZfKaRbPoliceCBSEntry_SPrint(sbZfKaRbPoliceCBSEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
