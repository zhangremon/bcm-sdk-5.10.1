/*
 * $Id: sbZfKaQsPriLutEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQsPriLutEntry_Print(sbZfKaQsPriLutEntry_t *pFromStruct) {
  SB_LOG("KaQsPriLutEntry:: res=0x%06x", (unsigned int)  pFromStruct->m_nReserved);
...
char *
sbZfKaQsPriLutEntry_SPrint(sbZfKaQsPriLutEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
