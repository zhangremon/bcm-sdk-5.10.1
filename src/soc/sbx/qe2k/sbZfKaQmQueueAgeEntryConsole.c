/*
 * $Id: sbZfKaQmQueueAgeEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQmQueueAgeEntry_Print(sbZfKaQmQueueAgeEntry_t *pFromStruct) {
  SB_LOG("KaQmQueueAgeEntry:: age=0x%01x", (unsigned int)  pFromStruct->m_nAge);
  SB_LOG("\n");
...
char *
sbZfKaQmQueueAgeEntry_SPrint(sbZfKaQmQueueAgeEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
