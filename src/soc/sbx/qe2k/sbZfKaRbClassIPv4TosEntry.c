/*
 * $Id: sbZfKaRbClassIPv4TosEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaRbClassIPv4TosEntry_Unpack(sbZfKaRbClassIPv4TosEntry_t *pToStruct,
  ...
  (pToStruct)->m_nTos1Dp =  (uint32_t)  ((pFromData)[2] >> 4) & 0x03;

  /* Unpack Member: m_nTos1Lsb */
  (pToStruct)->m_nTos1Lsb =  (uint32_t)  ((pFromData)[2] ) & 0x0f;

  /* Unpack Member: m_nReserve0 */
  (pToStruct)->m_nReserve0 =  (uint32_t)  ((pFromData)[3] >> 6) & 0x03;

  /* Unpack Member: m_nTos0Dp */
  (pToStruct)->m_nTos0Dp =  (uint32_t)  ((pFromData)[3] >> 4) & 0x03;

  /* Unpack Member: m_nTos0Lsb */
  (pToStruct)->m_nTos0Lsb =  (uint32_t)  ((pFromData)[3] ) & 0x0f;
#else
  ...
  /* Unpack Member: m_nTos1Dp */
  (pToStruct)->m_nTos1Dp =  (uint32_t)  ((pFromData)[1] >> 4) & 0x03;

  /* Unpack Member: m_nTos1Lsb */
  (pToStruct)->m_nTos1Lsb =  (uint32_t)  ((pFromData)[1] ) & 0x0f;

  /* Unpack Member: m_nReserve0 */
  (pToStruct)->m_nReserve0 =  (uint32_t)  ((pFromData)[0] >> 6) & 0x03;

  /* Unpack Member: m_nTos0Dp */
  (pToStruct)->m_nTos0Dp =  (uint32_t)  ((pFromData)[0] >> 4) & 0x03;

  /* Unpack Member: m_nTos0Lsb */
  (pToStruct)->m_nTos0Lsb =  (uint32_t)  ((pFromData)[0] ) & 0x0f;
#endif
