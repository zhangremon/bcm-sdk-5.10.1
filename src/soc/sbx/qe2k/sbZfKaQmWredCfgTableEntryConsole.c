/*
 * $Id: sbZfKaQmWredCfgTableEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQmWredCfgTableEntry_Print(sbZfKaQmWredCfgTableEntry_t *pFromStruct) {
  SB_LOG("KaQmWredCfgTableEntry:: template=0x%01x", (unsigned int)  pFromStruct->m_nTemplate);
...
char *
sbZfKaQmWredCfgTableEntry_SPrint(sbZfKaQmWredCfgTableEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
