/*
 * $Id: sbZfKaQsRateTableEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQsRateTableEntry_Print(sbZfKaQsRateTableEntry_t *pFromStruct) {
  SB_LOG("KaQsRateTableEntry:: integer=0x%06x", (unsigned int)  pFromStruct->m_nInteger);
  SB_LOG(" fraction=0x%02x", (unsigned int)  pFromStruct->m_nFraction);
  SB_LOG("\n");
...
char *
sbZfKaQsRateTableEntry_SPrint(sbZfKaQsRateTableEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
