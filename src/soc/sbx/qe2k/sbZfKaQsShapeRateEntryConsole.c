/*
 * $Id: sbZfKaQsShapeRateEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQsShapeRateEntry_Print(sbZfKaQsShapeRateEntry_t *pFromStruct) {
  SB_LOG("KaQsShapeRateEntry:: res=0x%02x", (unsigned int)  pFromStruct->m_nReserved);
  SB_LOG(" mode=0x%01x", (unsigned int)  pFromStruct->m_nMode);
...
char *
sbZfKaQsShapeRateEntry_SPrint(sbZfKaQsShapeRateEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
