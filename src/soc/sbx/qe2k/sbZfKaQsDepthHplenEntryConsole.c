/*
 * $Id: sbZfKaQsDepthHplenEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQsDepthHplenEntry_Print(sbZfKaQsDepthHplenEntry_t *pFromStruct) {
  SB_LOG("KaQsDepthHplenEntry:: res=0x%07x", (unsigned int)  pFromStruct->m_nReserved);
...
char *
sbZfKaQsDepthHplenEntry_SPrint(sbZfKaQsDepthHplenEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
