/*
 * $Id: sbZfKaEiMemDataEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaEiMemDataEntry_Unpack(sbZfKaEiMemDataEntry_t *pToStruct,
  ...
  (pToStruct)->m_nSizeMask =  (uint32_t)  ((pFromData)[2] >> 7) & 0x01;
  (pToStruct)->m_nSizeMask |=  (uint32_t)  (pFromData)[1] << 1;

  /* Unpack Member: m_nRbOnly */
  (pToStruct)->m_nRbOnly =  (uint32_t)  ((pFromData)[2] >> 6) & 0x01;
  ...
  /* Unpack Member: m_nSizeMask */
  (pToStruct)->m_nSizeMask =  (uint32_t)  ((pFromData)[1] >> 7) & 0x01;
  (pToStruct)->m_nSizeMask |=  (uint32_t)  (pFromData)[2] << 1;

  /* Unpack Member: m_nRbOnly */
  (pToStruct)->m_nRbOnly =  (uint32_t)  ((pFromData)[1] >> 6) & 0x01;
