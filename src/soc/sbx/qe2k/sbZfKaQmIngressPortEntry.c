/*
 * $Id: sbZfKaQmIngressPortEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaQmIngressPortEntry_Unpack(sbZfKaQmIngressPortEntry_t *pToStruct,
  ...
  (pToStruct)->m_nIngressSpi4 =  (uint8_t)  ((pFromData)[3] >> 6) & 0x01;

  /* Unpack Member: m_nIngressPort */
  (pToStruct)->m_nIngressPort =  (uint32_t)  ((pFromData)[3] ) & 0x3f;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nIngressSpi4 */
  (pToStruct)->m_nIngressSpi4 =  (uint8_t)  ((pFromData)[0] >> 6) & 0x01;

  /* Unpack Member: m_nIngressPort */
  (pToStruct)->m_nIngressPort =  (uint32_t)  ((pFromData)[0] ) & 0x3f;
#endif
