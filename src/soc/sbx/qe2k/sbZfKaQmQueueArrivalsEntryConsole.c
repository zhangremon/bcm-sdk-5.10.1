/*
 * $Id: sbZfKaQmQueueArrivalsEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQmQueueArrivalsEntry_Print(sbZfKaQmQueueArrivalsEntry_t *pFromStruct) {
  SB_LOG("KaQmQueueArrivalsEntry:: arrivals=0x%07x", (unsigned int)  pFromStruct->m_nArrivals);
  SB_LOG("\n");
...
char *
sbZfKaQmQueueArrivalsEntry_SPrint(sbZfKaQmQueueArrivalsEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
