/*
 * $Id: sbZfKaEpBfPriTableAddrConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaEpBfPriTableAddr_Print(sbZfKaEpBfPriTableAddr_t *pFromStruct) {
  SB_LOG("KaEpBfPriTableAddr:: port=0x%02x", (unsigned int)  pFromStruct->m_nPort);
...
char *
sbZfKaEpBfPriTableAddr_SPrint(sbZfKaEpBfPriTableAddr_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
