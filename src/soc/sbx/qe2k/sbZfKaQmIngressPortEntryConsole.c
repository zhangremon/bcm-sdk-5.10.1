/*
 * $Id: sbZfKaQmIngressPortEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQmIngressPortEntry_Print(sbZfKaQmIngressPortEntry_t *pFromStruct) {
  SB_LOG("KaQmIngressPortEntry:: ingressspi4=0x%01x", (unsigned int)  pFromStruct->m_nIngressSpi4);
  SB_LOG(" ingressport=0x%02x", (unsigned int)  pFromStruct->m_nIngressPort);
  SB_LOG("\n");
...
char *
sbZfKaQmIngressPortEntry_SPrint(sbZfKaQmIngressPortEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
