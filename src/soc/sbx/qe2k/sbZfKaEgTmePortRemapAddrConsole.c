/*
 * $Id: sbZfKaEgTmePortRemapAddrConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaEgTmePortRemapAddr_Print(sbZfKaEgTmePortRemapAddr_t *pFromStruct) {
  SB_LOG("KaEgTmePortRemapAddr:: node=0x%02x", (unsigned int)  pFromStruct->m_nNode);
...
char *
sbZfKaEgTmePortRemapAddr_SPrint(sbZfKaEgTmePortRemapAddr_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
