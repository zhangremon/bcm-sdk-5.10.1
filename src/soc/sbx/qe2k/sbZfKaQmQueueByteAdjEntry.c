/*
 * $Id: sbZfKaQmQueueByteAdjEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaQmQueueByteAdjEntry_Unpack(sbZfKaQmQueueByteAdjEntry_t *pToStruct,
  ...
  (pToStruct)->m_nSign =  (uint32_t)  ((pFromData)[3] >> 6) & 0x01;

  /* Unpack Member: m_nBytes */
  (pToStruct)->m_nBytes =  (uint32_t)  ((pFromData)[3] ) & 0x3f;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nSign */
  (pToStruct)->m_nSign =  (uint32_t)  ((pFromData)[0] >> 6) & 0x01;

  /* Unpack Member: m_nBytes */
  (pToStruct)->m_nBytes =  (uint32_t)  ((pFromData)[0] ) & 0x3f;
#endif
