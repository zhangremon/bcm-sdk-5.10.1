/*
 * $Id: sbZfKaQsLnaNextPriEntry.c 1.2.12.4 Broadcom SDK $
...
sbZfKaQsLnaNextPriEntry_Unpack(sbZfKaQsLnaNextPriEntry_t *pToStruct,
  ...
  (pToStruct)->m_nSelPort =  (uint32_t)  ((pFromData)[15] >> 4) & 0x0f;
  (pToStruct)->m_nSelPort |=  (uint32_t)  ((pFromData)[14] & 0x03) << 4;

  /* Unpack Member: m_nNextPri24 */
  (pToStruct)->m_nNextPri24 =  (uint32_t)  ((pFromData)[15] ) & 0x0f;

  /* Unpack Member: m_nNextPri23 */
  (pToStruct)->m_nNextPri23 =  (uint32_t)  ((pFromData)[8] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri22 */
  (pToStruct)->m_nNextPri22 =  (uint32_t)  ((pFromData)[8] ) & 0x0f;

  /* Unpack Member: m_nNextPri21 */
  (pToStruct)->m_nNextPri21 =  (uint32_t)  ((pFromData)[9] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri20 */
  (pToStruct)->m_nNextPri20 =  (uint32_t)  ((pFromData)[9] ) & 0x0f;

  /* Unpack Member: m_nNextPri19 */
  (pToStruct)->m_nNextPri19 =  (uint32_t)  ((pFromData)[10] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri18 */
  (pToStruct)->m_nNextPri18 =  (uint32_t)  ((pFromData)[10] ) & 0x0f;

  /* Unpack Member: m_nNextPri17 */
  (pToStruct)->m_nNextPri17 =  (uint32_t)  ((pFromData)[11] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri16 */
  (pToStruct)->m_nNextPri16 =  (uint32_t)  ((pFromData)[11] ) & 0x0f;

  /* Unpack Member: m_nNextPri15 */
  (pToStruct)->m_nNextPri15 =  (uint32_t)  ((pFromData)[4] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri14 */
  (pToStruct)->m_nNextPri14 =  (uint32_t)  ((pFromData)[4] ) & 0x0f;

  /* Unpack Member: m_nNextPri13 */
  (pToStruct)->m_nNextPri13 =  (uint32_t)  ((pFromData)[5] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri12 */
  (pToStruct)->m_nNextPri12 =  (uint32_t)  ((pFromData)[5] ) & 0x0f;

  /* Unpack Member: m_nNextPri11 */
  (pToStruct)->m_nNextPri11 =  (uint32_t)  ((pFromData)[6] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri10 */
  (pToStruct)->m_nNextPri10 =  (uint32_t)  ((pFromData)[6] ) & 0x0f;

  /* Unpack Member: m_nNextPri9 */
  (pToStruct)->m_nNextPri9 =  (uint32_t)  ((pFromData)[7] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri8 */
  (pToStruct)->m_nNextPri8 =  (uint32_t)  ((pFromData)[7] ) & 0x0f;

  /* Unpack Member: m_nNextPri7 */
  (pToStruct)->m_nNextPri7 =  (uint32_t)  ((pFromData)[0] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri6 */
  (pToStruct)->m_nNextPri6 =  (uint32_t)  ((pFromData)[0] ) & 0x0f;

  /* Unpack Member: m_nNextPri5 */
  (pToStruct)->m_nNextPri5 =  (uint32_t)  ((pFromData)[1] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri4 */
  (pToStruct)->m_nNextPri4 =  (uint32_t)  ((pFromData)[1] ) & 0x0f;

  /* Unpack Member: m_nNextPri3 */
  (pToStruct)->m_nNextPri3 =  (uint32_t)  ((pFromData)[2] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri2 */
  (pToStruct)->m_nNextPri2 =  (uint32_t)  ((pFromData)[2] ) & 0x0f;

  /* Unpack Member: m_nNextPri1 */
  (pToStruct)->m_nNextPri1 =  (uint32_t)  ((pFromData)[3] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri0 */
  (pToStruct)->m_nNextPri0 =  (uint32_t)  ((pFromData)[3] ) & 0x0f;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nSelPort */
  (pToStruct)->m_nSelPort =  (uint32_t)  ((pFromData)[12] >> 4) & 0x0f;
  (pToStruct)->m_nSelPort |=  (uint32_t)  ((pFromData)[13] & 0x03) << 4;

  /* Unpack Member: m_nNextPri24 */
  (pToStruct)->m_nNextPri24 =  (uint32_t)  ((pFromData)[12] ) & 0x0f;

  /* Unpack Member: m_nNextPri23 */
  (pToStruct)->m_nNextPri23 =  (uint32_t)  ((pFromData)[11] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri22 */
  (pToStruct)->m_nNextPri22 =  (uint32_t)  ((pFromData)[11] ) & 0x0f;

  /* Unpack Member: m_nNextPri21 */
  (pToStruct)->m_nNextPri21 =  (uint32_t)  ((pFromData)[10] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri20 */
  (pToStruct)->m_nNextPri20 =  (uint32_t)  ((pFromData)[10] ) & 0x0f;

  /* Unpack Member: m_nNextPri19 */
  (pToStruct)->m_nNextPri19 =  (uint32_t)  ((pFromData)[9] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri18 */
  (pToStruct)->m_nNextPri18 =  (uint32_t)  ((pFromData)[9] ) & 0x0f;

  /* Unpack Member: m_nNextPri17 */
  (pToStruct)->m_nNextPri17 =  (uint32_t)  ((pFromData)[8] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri16 */
  (pToStruct)->m_nNextPri16 =  (uint32_t)  ((pFromData)[8] ) & 0x0f;

  /* Unpack Member: m_nNextPri15 */
  (pToStruct)->m_nNextPri15 =  (uint32_t)  ((pFromData)[7] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri14 */
  (pToStruct)->m_nNextPri14 =  (uint32_t)  ((pFromData)[7] ) & 0x0f;

  /* Unpack Member: m_nNextPri13 */
  (pToStruct)->m_nNextPri13 =  (uint32_t)  ((pFromData)[6] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri12 */
  (pToStruct)->m_nNextPri12 =  (uint32_t)  ((pFromData)[6] ) & 0x0f;

  /* Unpack Member: m_nNextPri11 */
  (pToStruct)->m_nNextPri11 =  (uint32_t)  ((pFromData)[5] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri10 */
  (pToStruct)->m_nNextPri10 =  (uint32_t)  ((pFromData)[5] ) & 0x0f;

  /* Unpack Member: m_nNextPri9 */
  (pToStruct)->m_nNextPri9 =  (uint32_t)  ((pFromData)[4] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri8 */
  (pToStruct)->m_nNextPri8 =  (uint32_t)  ((pFromData)[4] ) & 0x0f;

  /* Unpack Member: m_nNextPri7 */
  (pToStruct)->m_nNextPri7 =  (uint32_t)  ((pFromData)[3] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri6 */
  (pToStruct)->m_nNextPri6 =  (uint32_t)  ((pFromData)[3] ) & 0x0f;

  /* Unpack Member: m_nNextPri5 */
  (pToStruct)->m_nNextPri5 =  (uint32_t)  ((pFromData)[2] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri4 */
  (pToStruct)->m_nNextPri4 =  (uint32_t)  ((pFromData)[2] ) & 0x0f;

  /* Unpack Member: m_nNextPri3 */
  (pToStruct)->m_nNextPri3 =  (uint32_t)  ((pFromData)[1] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri2 */
  (pToStruct)->m_nNextPri2 =  (uint32_t)  ((pFromData)[1] ) & 0x0f;

  /* Unpack Member: m_nNextPri1 */
  (pToStruct)->m_nNextPri1 =  (uint32_t)  ((pFromData)[0] >> 4) & 0x0f;

  /* Unpack Member: m_nNextPri0 */
  (pToStruct)->m_nNextPri0 =  (uint32_t)  ((pFromData)[0] ) & 0x0f;
#endif
