/*
 * $Id: sbZfKaQsShapeTableEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQsShapeTableEntry_Print(sbZfKaQsShapeTableEntry_t *pFromStruct) {
  SB_LOG("KaQsShapeTableEntry:: shaperatels2b=0x%04x", (unsigned int)  pFromStruct->m_nShapeRateLS2B);
  SB_LOG(" enable=0x%01x", (unsigned int)  pFromStruct->m_nEnable);
  SB_LOG("\n");

  SB_LOG("KaQsShapeTableEntry:: shapemaxburst=0x%06x", (unsigned int)  pFromStruct->m_nShapeMaxBurst);
  SB_LOG(" shape=0x%06x", (unsigned int)  pFromStruct->m_nShape);
  SB_LOG("\n");
...
char *
sbZfKaQsShapeTableEntry_SPrint(sbZfKaQsShapeTableEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
