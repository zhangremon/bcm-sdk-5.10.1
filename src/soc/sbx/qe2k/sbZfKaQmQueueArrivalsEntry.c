/*
 * $Id: sbZfKaQmQueueArrivalsEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaQmQueueArrivalsEntry_Unpack(sbZfKaQmQueueArrivalsEntry_t *pToStruct,
  ...
  (pToStruct)->m_nArrivals =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_nArrivals |=  (uint32_t)  (pFromData)[2] << 8;
  (pToStruct)->m_nArrivals |=  (uint32_t)  (pFromData)[1] << 16;
  (pToStruct)->m_nArrivals |=  (uint32_t)  ((pFromData)[0] & 0x0f) << 24;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nArrivals */
  (pToStruct)->m_nArrivals =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_nArrivals |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->m_nArrivals |=  (uint32_t)  (pFromData)[2] << 16;
  (pToStruct)->m_nArrivals |=  (uint32_t)  ((pFromData)[3] & 0x0f) << 24;
#endif
