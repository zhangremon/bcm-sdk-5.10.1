/*
 * $Id: sbZfKaQmQueueByteAdjEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQmQueueByteAdjEntry_Print(sbZfKaQmQueueByteAdjEntry_t *pFromStruct) {
  SB_LOG("KaQmQueueByteAdjEntry:: sign=0x%01x", (unsigned int)  pFromStruct->m_nSign);
  SB_LOG(" bytes=0x%02x", (unsigned int)  pFromStruct->m_nBytes);
  SB_LOG("\n");
...
char *
sbZfKaQmQueueByteAdjEntry_SPrint(sbZfKaQmQueueByteAdjEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
