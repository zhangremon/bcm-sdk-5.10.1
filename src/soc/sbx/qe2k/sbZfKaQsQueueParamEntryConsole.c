/*
 * $Id: sbZfKaQsQueueParamEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQsQueueParamEntry_Print(sbZfKaQsQueueParamEntry_t *pFromStruct) {
  SB_LOG("KaQsQueueParamEntry:: res=0x%06x", (unsigned int)  pFromStruct->m_nReserved);
...
char *
sbZfKaQsQueueParamEntry_SPrint(sbZfKaQsQueueParamEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
