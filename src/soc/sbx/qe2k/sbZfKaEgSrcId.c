/*
 * $Id: sbZfKaEgSrcId.c 1.1.44.4 Broadcom SDK $
...
sbZfKaEgSrcId_Unpack(sbZfKaEgSrcId_t *pToStruct,
  ...
  (pToStruct)->m_nSrcId =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_nSrcId |=  (uint32_t)  ((pFromData)[2] & 0x0f) << 8;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nSrcId */
  (pToStruct)->m_nSrcId =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_nSrcId |=  (uint32_t)  ((pFromData)[1] & 0x0f) << 8;
#endif
