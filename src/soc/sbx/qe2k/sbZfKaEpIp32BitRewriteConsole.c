/*
 * $Id: sbZfKaEpIp32BitRewriteConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaEpIp32BitRewrite_Print(sbZfKaEpIp32BitRewrite_t *pFromStruct) {
  SB_LOG("KaEpIp32BitRewrite:: data=0x%08x", (unsigned int)  pFromStruct->m_nData);
  SB_LOG("\n");
...
char *
sbZfKaEpIp32BitRewrite_SPrint(sbZfKaEpIp32BitRewrite_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
