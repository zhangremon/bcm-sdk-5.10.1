/*
 * $Id: sbZfKaRbClassIPv4TosEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaRbClassIPv4TosEntry_Print(sbZfKaRbClassIPv4TosEntry_t *pFromStruct) {
  SB_LOG("KaRbClassIPv4TosEntry:: res1=0x%01x", (unsigned int)  pFromStruct->m_nReserve1);
  SB_LOG(" tos1dp=0x%01x", (unsigned int)  pFromStruct->m_nTos1Dp);
  SB_LOG(" tos1lsb=0x%01x", (unsigned int)  pFromStruct->m_nTos1Lsb);
  SB_LOG(" res0=0x%01x", (unsigned int)  pFromStruct->m_nReserve0);
  SB_LOG(" tos0dp=0x%01x", (unsigned int)  pFromStruct->m_nTos0Dp);
  SB_LOG("\n");

  SB_LOG("KaRbClassIPv4TosEntry:: tos0lsb=0x%01x", (unsigned int)  pFromStruct->m_nTos0Lsb);
  SB_LOG("\n");
...
char *
sbZfKaRbClassIPv4TosEntry_SPrint(sbZfKaRbClassIPv4TosEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
