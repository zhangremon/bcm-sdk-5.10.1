/*
 * $Id: sbZfKaEpVlanIndTableEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaEpVlanIndTableEntry_Unpack(sbZfKaEpVlanIndTableEntry_t *pToStruct,
  ...
  (pToStruct)->m_nRecord3 =  (uint32_t)  (pFromData)[5] ;
  (pToStruct)->m_nRecord3 |=  (uint32_t)  (pFromData)[4] << 8;

  /* Unpack Member: m_nRecord2 */
  (pToStruct)->m_nRecord2 =  (uint32_t)  (pFromData)[7] ;
  (pToStruct)->m_nRecord2 |=  (uint32_t)  (pFromData)[6] << 8;

  /* Unpack Member: m_nRecord1 */
  (pToStruct)->m_nRecord1 =  (uint32_t)  (pFromData)[1] ;
  (pToStruct)->m_nRecord1 |=  (uint32_t)  (pFromData)[0] << 8;

  /* Unpack Member: m_nRecord0 */
  (pToStruct)->m_nRecord0 =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_nRecord0 |=  (uint32_t)  (pFromData)[2] << 8;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nRecord3 */
  (pToStruct)->m_nRecord3 =  (uint32_t)  (pFromData)[6] ;
  (pToStruct)->m_nRecord3 |=  (uint32_t)  (pFromData)[7] << 8;

  /* Unpack Member: m_nRecord2 */
  (pToStruct)->m_nRecord2 =  (uint32_t)  (pFromData)[4] ;
  (pToStruct)->m_nRecord2 |=  (uint32_t)  (pFromData)[5] << 8;

  /* Unpack Member: m_nRecord1 */
  (pToStruct)->m_nRecord1 =  (uint32_t)  (pFromData)[2] ;
  (pToStruct)->m_nRecord1 |=  (uint32_t)  (pFromData)[3] << 8;

  /* Unpack Member: m_nRecord0 */
  (pToStruct)->m_nRecord0 =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_nRecord0 |=  (uint32_t)  (pFromData)[1] << 8;
#endif
