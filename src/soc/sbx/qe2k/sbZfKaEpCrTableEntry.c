/*
 * $Id: sbZfKaEpCrTableEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaEpCrTableEntry_Unpack(sbZfKaEpCrTableEntry_t *pToStruct,
  ...
  (pToStruct)->m_nClass15 =  (uint32_t)  ((pFromData)[4] >> 4) & 0x0f;

  /* Unpack Member: m_nClass14 */
  (pToStruct)->m_nClass14 =  (uint32_t)  ((pFromData)[4] ) & 0x0f;

  /* Unpack Member: m_nClass13 */
  (pToStruct)->m_nClass13 =  (uint32_t)  ((pFromData)[5] >> 4) & 0x0f;

  /* Unpack Member: m_nClass12 */
  (pToStruct)->m_nClass12 =  (uint32_t)  ((pFromData)[5] ) & 0x0f;

  /* Unpack Member: m_nClass11 */
  (pToStruct)->m_nClass11 =  (uint32_t)  ((pFromData)[6] >> 4) & 0x0f;

  /* Unpack Member: m_nClass10 */
  (pToStruct)->m_nClass10 =  (uint32_t)  ((pFromData)[6] ) & 0x0f;

  /* Unpack Member: m_nClass9 */
  (pToStruct)->m_nClass9 =  (uint32_t)  ((pFromData)[7] >> 4) & 0x0f;

  /* Unpack Member: m_nClass8 */
  (pToStruct)->m_nClass8 =  (uint32_t)  ((pFromData)[7] ) & 0x0f;

  /* Unpack Member: m_nClass7 */
  (pToStruct)->m_nClass7 =  (uint32_t)  ((pFromData)[0] >> 4) & 0x0f;

  /* Unpack Member: m_nClass6 */
  (pToStruct)->m_nClass6 =  (uint32_t)  ((pFromData)[0] ) & 0x0f;

  /* Unpack Member: m_nClass5 */
  (pToStruct)->m_nClass5 =  (uint32_t)  ((pFromData)[1] >> 4) & 0x0f;

  /* Unpack Member: m_nClass4 */
  (pToStruct)->m_nClass4 =  (uint32_t)  ((pFromData)[1] ) & 0x0f;

  /* Unpack Member: m_nClass3 */
  (pToStruct)->m_nClass3 =  (uint32_t)  ((pFromData)[2] >> 4) & 0x0f;

  /* Unpack Member: m_nClass2 */
  (pToStruct)->m_nClass2 =  (uint32_t)  ((pFromData)[2] ) & 0x0f;

  /* Unpack Member: m_nClass1 */
  (pToStruct)->m_nClass1 =  (uint32_t)  ((pFromData)[3] >> 4) & 0x0f;

  /* Unpack Member: m_nClass0 */
  (pToStruct)->m_nClass0 =  (uint32_t)  ((pFromData)[3] ) & 0x0f;
#else
