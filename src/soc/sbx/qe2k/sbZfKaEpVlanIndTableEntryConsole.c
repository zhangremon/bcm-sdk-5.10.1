/*
 * $Id: sbZfKaEpVlanIndTableEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaEpVlanIndTableEntry_Print(sbZfKaEpVlanIndTableEntry_t *pFromStruct) {
  SB_LOG("KaEpVlanIndTableEntry:: record3=0x%04x", (unsigned int)  pFromStruct->m_nRecord3);
  SB_LOG(" record2=0x%04x", (unsigned int)  pFromStruct->m_nRecord2);
  SB_LOG(" record1=0x%04x", (unsigned int)  pFromStruct->m_nRecord1);
  SB_LOG("\n");

  SB_LOG("KaEpVlanIndTableEntry:: record0=0x%04x", (unsigned int)  pFromStruct->m_nRecord0);
  SB_LOG("\n");
...
char *
sbZfKaEpVlanIndTableEntry_SPrint(sbZfKaEpVlanIndTableEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
