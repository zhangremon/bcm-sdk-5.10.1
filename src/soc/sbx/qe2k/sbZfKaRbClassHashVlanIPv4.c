/*
 * $Id: sbZfKaRbClassHashVlanIPv4.c 1.1.44.4 Broadcom SDK $
...
sbZfKaRbClassHashVlanIPv4_Pack(sbZfKaRbClassHashVlanIPv4_t *pFrom,
  ...
  (pToData)[42] |= ((pFrom)->m_nPadWord3 & 0x01) <<7;
  (pToData)[41] |= ((pFrom)->m_nPadWord3 >> 1) &0xFF;
  (pToData)[40] |= ((pFrom)->m_nPadWord3 >> 9) &0xFF;
  (pToData)[47] |= ((pFrom)->m_nPadWord3 >> 17) &0xFF;
  (pToData)[46] |= ((pFrom)->m_nPadWord3 >> 25) &0xFF;
  (pToData)[45] |= ((pFrom)->m_nPadWord3 >> 33) &0xFF;

  /* Pack Member: m_nPadWord1 */
  (pToData)[33] |= ((pFrom)->m_nPadWord1) & 0xFF;
  (pToData)[32] |= ((pFrom)->m_nPadWord1 >> 8) &0xFF;
  (pToData)[39] |= ((pFrom)->m_nPadWord1 >> 16) &0xFF;
  (pToData)[38] |= ((pFrom)->m_nPadWord1 >> 24) &0xFF;
  (pToData)[37] |= ((pFrom)->m_nPadWord1 >> 32) &0xFF;
  (pToData)[36] |= ((pFrom)->m_nPadWord1 >> 40) &0xFF;
  (pToData)[43] |= ((pFrom)->m_nPadWord1 >> 48) &0xFF;
  (pToData)[42] |= ((pFrom)->m_nPadWord1 >> 56) & 0x7f;
  ...
  (pToData)[23] |= ((pFrom)->m_nPadWord2 >> 32) &0xFF;
  (pToData)[22] |= ((pFrom)->m_nPadWord2 >> 40) &0xFF;
...
sbZfKaRbClassHashVlanIPv4_Unpack(sbZfKaRbClassHashVlanIPv4_t *pToStruct,
  ...
  (pToStruct)->m_nIpSa =  (uint32_t)  (pFromData)[29] ;
  (pToStruct)->m_nIpSa |=  (uint32_t)  (pFromData)[28] << 8;
  (pToStruct)->m_nIpSa |=  (uint32_t)  (pFromData)[35] << 16;
  (pToStruct)->m_nIpSa |=  (uint32_t)  (pFromData)[34] << 24;

  /* Unpack Member: m_nIpDa */
  (pToStruct)->m_nIpDa =  (uint32_t)  (pFromData)[25] ;
  (pToStruct)->m_nIpDa |=  (uint32_t)  (pFromData)[24] << 8;
  (pToStruct)->m_nIpDa |=  (uint32_t)  (pFromData)[31] << 16;
  (pToStruct)->m_nIpDa |=  (uint32_t)  (pFromData)[30] << 24;

  /* Unpack Member: m_nSocket */
  (pToStruct)->m_nSocket =  (uint32_t)  (pFromData)[21] ;
  (pToStruct)->m_nSocket |=  (uint32_t)  (pFromData)[20] << 8;
  (pToStruct)->m_nSocket |=  (uint32_t)  (pFromData)[27] << 16;
  (pToStruct)->m_nSocket |=  (uint32_t)  (pFromData)[26] << 24;
  ...
  /* Unpack Member: m_nIpSa */
  (pToStruct)->m_nIpSa =  (uint32_t)  (pFromData)[30] ;
  (pToStruct)->m_nIpSa |=  (uint32_t)  (pFromData)[31] << 8;
  (pToStruct)->m_nIpSa |=  (uint32_t)  (pFromData)[32] << 16;
  (pToStruct)->m_nIpSa |=  (uint32_t)  (pFromData)[33] << 24;

  /* Unpack Member: m_nIpDa */
  (pToStruct)->m_nIpDa =  (uint32_t)  (pFromData)[26] ;
  (pToStruct)->m_nIpDa |=  (uint32_t)  (pFromData)[27] << 8;
  (pToStruct)->m_nIpDa |=  (uint32_t)  (pFromData)[28] << 16;
  (pToStruct)->m_nIpDa |=  (uint32_t)  (pFromData)[29] << 24;

  /* Unpack Member: m_nSocket */
  (pToStruct)->m_nSocket =  (uint32_t)  (pFromData)[22] ;
  (pToStruct)->m_nSocket |=  (uint32_t)  (pFromData)[23] << 8;
  (pToStruct)->m_nSocket |=  (uint32_t)  (pFromData)[24] << 16;
  (pToStruct)->m_nSocket |=  (uint32_t)  (pFromData)[25] << 24;
