/*
 * $Id: sbZfKaQmRateDeltaMaxTableEntryConsole.c 1.1.20.3 Broadcom SDK $
...
sbZfKaQmRateDeltaMaxTableEntry_Print(sbZfKaQmRateDeltaMaxTableEntry_t *pFromStruct) {
  SB_LOG("KaQmRateDeltaMaxTableEntry:: rate_delta_max=0x%07x", (unsigned int)  pFromStruct->m_nRateDeltaMax);
  SB_LOG("\n");
...
char *
sbZfKaQmRateDeltaMaxTableEntry_SPrint(sbZfKaQmRateDeltaMaxTableEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
