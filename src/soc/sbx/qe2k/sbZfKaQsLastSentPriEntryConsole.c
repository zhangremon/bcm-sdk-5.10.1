/*
 * $Id: sbZfKaQsLastSentPriEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQsLastSentPriEntry_Print(sbZfKaQsLastSentPriEntry_t *pFromStruct) {
  SB_LOG("KaQsLastSentPriEntry:: res=0x%06x", (unsigned int)  pFromStruct->m_nReserved);
...
char *
sbZfKaQsLastSentPriEntry_SPrint(sbZfKaQsLastSentPriEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
