/*
 * $Id: sbZfKaQsQ2EcEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQsQ2EcEntry_Print(sbZfKaQsQ2EcEntry_t *pFromStruct) {
  SB_LOG("KaQsQ2EcEntry:: res=0x%04x", (unsigned int)  pFromStruct->m_nReserved);
...
char *
sbZfKaQsQ2EcEntry_SPrint(sbZfKaQsQ2EcEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
