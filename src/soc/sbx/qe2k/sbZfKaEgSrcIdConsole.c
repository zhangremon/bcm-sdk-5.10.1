/*
 * $Id: sbZfKaEgSrcIdConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaEgSrcId_Print(sbZfKaEgSrcId_t *pFromStruct) {
  SB_LOG("KaEgSrcId:: src_id=0x%03x", (unsigned int)  pFromStruct->m_nSrcId);
  SB_LOG("\n");
...
char *
sbZfKaEgSrcId_SPrint(sbZfKaEgSrcId_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
