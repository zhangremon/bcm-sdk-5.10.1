/*
 * $Id: sbZfKaQmWredCfgTableEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaQmWredCfgTableEntry_Unpack(sbZfKaQmWredCfgTableEntry_t *pToStruct,
  ...
  (pToStruct)->m_nTemplate =  (uint32_t)  ((pFromData)[3] >> 4) & 0x0f;
  ...
  /* Unpack Member: m_nTemplate */
  (pToStruct)->m_nTemplate =  (uint32_t)  ((pFromData)[0] >> 4) & 0x0f;
