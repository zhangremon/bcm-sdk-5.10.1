/*
 * $Id: sbZfKaQsLastSentPriAddrConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQsLastSentPriAddr_Print(sbZfKaQsLastSentPriAddr_t *pFromStruct) {
  SB_LOG("KaQsLastSentPriAddr:: res=0x%05x", (unsigned int)  pFromStruct->m_nReserved);
...
char *
sbZfKaQsLastSentPriAddr_SPrint(sbZfKaQsLastSentPriAddr_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
