/*
 * $Id: sbZfKaQmPortBwCfgTableEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQmPortBwCfgTableEntry_Print(sbZfKaQmPortBwCfgTableEntry_t *pFromStruct) {
  SB_LOG("KaQmPortBwCfgTableEntry:: spqueues=0x%02x", (unsigned int)  pFromStruct->m_nSpQueues);
  SB_LOG(" queues=0x%02x", (unsigned int)  pFromStruct->m_nQueues);
  SB_LOG(" basequeue=0x%04x", (unsigned int)  pFromStruct->m_nBaseQueue);
  SB_LOG("\n");

  SB_LOG("KaQmPortBwCfgTableEntry:: linerate=0x%06x", (unsigned int)  pFromStruct->m_nLineRate);
  SB_LOG("\n");
...
char *
sbZfKaQmPortBwCfgTableEntry_SPrint(sbZfKaQmPortBwCfgTableEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
