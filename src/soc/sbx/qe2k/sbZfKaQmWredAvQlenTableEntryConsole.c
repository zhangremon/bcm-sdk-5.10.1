/*
 * $Id: sbZfKaQmWredAvQlenTableEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQmWredAvQlenTableEntry_Print(sbZfKaQmWredAvQlenTableEntry_t *pFromStruct) {
  SB_LOG("KaQmWredAvQlenTableEntry:: queueavg=0x%07x", (unsigned int)  pFromStruct->m_nQueueAvg);
  SB_LOG("\n");
...
char *
sbZfKaQmWredAvQlenTableEntry_SPrint(sbZfKaQmWredAvQlenTableEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
