/*
 * $Id: sbZfKaQmRateDeltaMaxTableEntry.c 1.1.20.4 Broadcom SDK $
...
sbZfKaQmRateDeltaMaxTableEntry_Unpack(sbZfKaQmRateDeltaMaxTableEntry_t *pToStruct,
  ...
  (pToStruct)->m_nRateDeltaMax |=  (uint32_t)  (pFromData)[2] << 8;
  (pToStruct)->m_nRateDeltaMax |=  (uint32_t)  (pFromData)[1] << 16;
  (pToStruct)->m_nRateDeltaMax |=  (uint32_t)  ((pFromData)[0] & 0x07) << 24;
#else
  ...
  (pToStruct)->m_nRateDeltaMax |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->m_nRateDeltaMax |=  (uint32_t)  (pFromData)[2] << 16;
  (pToStruct)->m_nRateDeltaMax |=  (uint32_t)  ((pFromData)[3] & 0x07) << 24;
#endif
