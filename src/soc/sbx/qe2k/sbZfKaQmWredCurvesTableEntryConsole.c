/*
 * $Id: sbZfKaQmWredCurvesTableEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQmWredCurvesTableEntry_Print(sbZfKaQmWredCurvesTableEntry_t *pFromStruct) {
  SB_LOG("KaQmWredCurvesTableEntry:: tmin=0x%04x", (unsigned int)  pFromStruct->m_nTmin);
  ...
  SB_LOG("KaQmWredCurvesTableEntry:: slope=0x%03x", (unsigned int)  pFromStruct->m_nSlope);
  SB_LOG("\n");
...
char *
sbZfKaQmWredCurvesTableEntry_SPrint(sbZfKaQmWredCurvesTableEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
