/*
 * $Id: sbZfKaEbMvtAddressConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaEbMvtAddress_Print(sbZfKaEbMvtAddress_t *pFromStruct) {
  SB_LOG("KaEbMvtAddress:: reserved=0x%03x", (unsigned int)  pFromStruct->m_nReserved);
  SB_LOG(" egress=0x%02x", (unsigned int)  pFromStruct->m_nEgress);
...
char *
sbZfKaEbMvtAddress_SPrint(sbZfKaEbMvtAddress_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
