/*
 * $Id: sbZfKaRbClassDefaultQEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaRbClassDefaultQEntry_Unpack(sbZfKaRbClassDefaultQEntry_t *pToStruct,
  ...
  (pToStruct)->m_nDefaultDp =  (uint32_t)  ((pFromData)[1] ) & 0x03;

  /* Unpack Member: m_nSpare0 */
  (pToStruct)->m_nSpare0 =  (uint32_t)  ((pFromData)[2] >> 6) & 0x03;

  /* Unpack Member: m_nDefaultQ */
  (pToStruct)->m_nDefaultQ =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_nDefaultQ |=  (uint32_t)  ((pFromData)[2] & 0x3f) << 8;
#else
  ...
  /* Unpack Member: m_nDefaultDp */
  (pToStruct)->m_nDefaultDp =  (uint32_t)  ((pFromData)[2] ) & 0x03;

  /* Unpack Member: m_nSpare0 */
  (pToStruct)->m_nSpare0 =  (uint32_t)  ((pFromData)[1] >> 6) & 0x03;

  /* Unpack Member: m_nDefaultQ */
  (pToStruct)->m_nDefaultQ =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_nDefaultQ |=  (uint32_t)  ((pFromData)[1] & 0x3f) << 8;
#endif
