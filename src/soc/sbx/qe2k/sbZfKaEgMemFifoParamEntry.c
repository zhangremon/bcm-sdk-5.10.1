/*
 * $Id: sbZfKaEgMemFifoParamEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaEgMemFifoParamEntry_Unpack(sbZfKaEgMemFifoParamEntry_t *pToStruct,
  ...
  (pToStruct)->m_nThreshHi =  (uint32_t)  ((pFromData)[0] >> 2) & 0x3f;
  (pToStruct)->m_nThreshHi |=  (uint32_t)  ((pFromData)[7] & 0x0f) << 6;

  /* Unpack Member: m_nThreshLo */
  (pToStruct)->m_nThreshLo =  (uint32_t)  (pFromData)[1] ;
  (pToStruct)->m_nThreshLo |=  (uint32_t)  ((pFromData)[0] & 0x03) << 8;

  /* Unpack Member: m_nShaper1 */
  (pToStruct)->m_nShaper1 =  (uint32_t)  (pFromData)[2] ;

  /* Unpack Member: m_nShaper0 */
  (pToStruct)->m_nShaper0 =  (uint32_t)  (pFromData)[3] ;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nThreshHi */
  (pToStruct)->m_nThreshHi =  (uint32_t)  ((pFromData)[3] >> 2) & 0x3f;
  (pToStruct)->m_nThreshHi |=  (uint32_t)  ((pFromData)[4] & 0x0f) << 6;

  /* Unpack Member: m_nThreshLo */
  (pToStruct)->m_nThreshLo =  (uint32_t)  (pFromData)[2] ;
  (pToStruct)->m_nThreshLo |=  (uint32_t)  ((pFromData)[3] & 0x03) << 8;

  /* Unpack Member: m_nShaper1 */
  (pToStruct)->m_nShaper1 =  (uint32_t)  (pFromData)[1] ;

  /* Unpack Member: m_nShaper0 */
  (pToStruct)->m_nShaper0 =  (uint32_t)  (pFromData)[0] ;
#endif
