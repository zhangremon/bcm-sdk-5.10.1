/*
 * $Id: sbZfKaRbPolicePortQMapEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaRbPolicePortQMapEntry_Print(sbZfKaRbPolicePortQMapEntry_t *pFromStruct) {
  SB_LOG("KaRbPolicePortQMapEntry:: res2=0x%02x", (unsigned int)  pFromStruct->m_nReserved2);
  SB_LOG(" oddmeter=0x%03x", (unsigned int)  pFromStruct->m_nOddMeter);
  SB_LOG(" res1=0x%02x", (unsigned int)  pFromStruct->m_nReserved1);
  SB_LOG("\n");

  SB_LOG("KaRbPolicePortQMapEntry:: evenmeter=0x%03x", (unsigned int)  pFromStruct->m_nEvenMeter);
  SB_LOG("\n");
...
char *
sbZfKaRbPolicePortQMapEntry_SPrint(sbZfKaRbPolicePortQMapEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
