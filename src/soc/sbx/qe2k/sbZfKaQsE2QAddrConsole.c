/*
 * $Id: sbZfKaQsE2QAddrConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQsE2QAddr_Print(sbZfKaQsE2QAddr_t *pFromStruct) {
  SB_LOG("KaQsE2QAddr:: res=0x%05x", (unsigned int)  pFromStruct->m_nReserved);
...
char *
sbZfKaQsE2QAddr_SPrint(sbZfKaQsE2QAddr_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
