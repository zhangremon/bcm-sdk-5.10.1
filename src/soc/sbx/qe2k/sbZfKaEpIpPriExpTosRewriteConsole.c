/*
 * $Id: sbZfKaEpIpPriExpTosRewriteConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaEpIpPriExpTosRewrite_Print(sbZfKaEpIpPriExpTosRewrite_t *pFromStruct) {
  SB_LOG("KaEpIpPriExpTosRewrite:: tos=0x%02x", (unsigned int)  pFromStruct->m_nTos);
  SB_LOG("\n");
...
char *
sbZfKaEpIpPriExpTosRewrite_SPrint(sbZfKaEpIpPriExpTosRewrite_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
