/*
 * $Id: sbZfKaQmSlqCntrsEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQmSlqCntrsEntry_Print(sbZfKaQmSlqCntrsEntry_t *pFromStruct) {
  SB_LOG("KaQmSlqCntrsEntry:: data1=0x%08x", (unsigned int)  pFromStruct->m_nData1);
  SB_LOG(" data0=0x%08x", (unsigned int)  pFromStruct->m_nData0);
  SB_LOG("\n");
...
char *
sbZfKaQmSlqCntrsEntry_SPrint(sbZfKaQmSlqCntrsEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
