/*
 * $Id: sbZfKaEpInstruction.c 1.1.44.4 Broadcom SDK $
...
sbZfKaEpInstruction_Unpack(sbZfKaEpInstruction_t *pToStruct,
  ...
  (pToStruct)->m_nValid =  (int32_t)  ((pFromData)[0] >> 7) & 0x01;

  /* Unpack Member: m_nOpcode */
  (pToStruct)->m_nOpcode =  (int32_t)  ((pFromData)[0] >> 1) & 0x3f;

  /* Unpack Member: m_nOpAVariable */
  (pToStruct)->m_nOpAVariable =  (int32_t)  ((pFromData)[0] ) & 0x01;

  /* Unpack Member: m_nOperandA */
  (pToStruct)->m_nOperandA =  (int32_t)  ((pFromData)[1] >> 2) & 0x3f;

  /* Unpack Member: m_nOpBVariable */
  (pToStruct)->m_nOpBVariable =  (int32_t)  ((pFromData)[1] >> 1) & 0x01;

  /* Unpack Member: m_nOperandB */
  (pToStruct)->m_nOperandB =  (int32_t)  ((pFromData)[2] >> 3) & 0x1f;
  (pToStruct)->m_nOperandB |=  (int32_t)  ((pFromData)[1] & 0x01) << 5;

  /* Unpack Member: m_nOpCVariable */
  (pToStruct)->m_nOpCVariable =  (int32_t)  ((pFromData)[2] >> 2) & 0x01;

  /* Unpack Member: m_nOperandC */
  (pToStruct)->m_nOperandC =  (int32_t)  (pFromData)[3] ;
  (pToStruct)->m_nOperandC |=  (int32_t)  ((pFromData)[2] & 0x03) << 8;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nValid */
  (pToStruct)->m_nValid =  (int32_t)  ((pFromData)[3] >> 7) & 0x01;

  /* Unpack Member: m_nOpcode */
  (pToStruct)->m_nOpcode =  (int32_t)  ((pFromData)[3] >> 1) & 0x3f;

  /* Unpack Member: m_nOpAVariable */
  (pToStruct)->m_nOpAVariable =  (int32_t)  ((pFromData)[3] ) & 0x01;

  /* Unpack Member: m_nOperandA */
  (pToStruct)->m_nOperandA =  (int32_t)  ((pFromData)[2] >> 2) & 0x3f;

  /* Unpack Member: m_nOpBVariable */
  (pToStruct)->m_nOpBVariable =  (int32_t)  ((pFromData)[2] >> 1) & 0x01;

  /* Unpack Member: m_nOperandB */
  (pToStruct)->m_nOperandB =  (int32_t)  ((pFromData)[1] >> 3) & 0x1f;
  (pToStruct)->m_nOperandB |=  (int32_t)  ((pFromData)[2] & 0x01) << 5;

  /* Unpack Member: m_nOpCVariable */
  (pToStruct)->m_nOpCVariable =  (int32_t)  ((pFromData)[1] >> 2) & 0x01;

  /* Unpack Member: m_nOperandC */
  (pToStruct)->m_nOperandC =  (int32_t)  (pFromData)[0] ;
  (pToStruct)->m_nOperandC |=  (int32_t)  ((pFromData)[1] & 0x03) << 8;
#endif
