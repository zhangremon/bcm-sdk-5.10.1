/*
 * $Id: sbZfKaEpIpTtlRangeConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaEpIpTtlRange_Print(sbZfKaEpIpTtlRange_t *pFromStruct) {
  SB_LOG("KaEpIpTtlRange:: hi=0x%08x", (unsigned int)  pFromStruct->m_nHighTtl);
  SB_LOG(" lo=0x%08x", (unsigned int)  pFromStruct->m_nLowTtl);
  SB_LOG("\n");
...
char *
sbZfKaEpIpTtlRange_SPrint(sbZfKaEpIpTtlRange_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
