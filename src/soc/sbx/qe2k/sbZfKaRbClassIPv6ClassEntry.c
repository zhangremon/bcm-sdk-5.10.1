/*
 * $Id: sbZfKaRbClassIPv6ClassEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaRbClassIPv6ClassEntry_Unpack(sbZfKaRbClassIPv6ClassEntry_t *pToStruct,
  ...
  (pToStruct)->m_nReserve1 =  (uint32_t)  ((pFromData)[2] >> 6) & 0x03;

  /* Unpack Member: m_nClass1Dp */
  (pToStruct)->m_nClass1Dp =  (uint32_t)  ((pFromData)[2] >> 4) & 0x03;

  /* Unpack Member: m_nClass1Lsb */
  (pToStruct)->m_nClass1Lsb =  (uint32_t)  ((pFromData)[2] ) & 0x0f;

  /* Unpack Member: m_nReserve0 */
  (pToStruct)->m_nReserve0 =  (uint32_t)  ((pFromData)[3] >> 6) & 0x03;

  /* Unpack Member: m_nClass0Dp */
  (pToStruct)->m_nClass0Dp =  (uint32_t)  ((pFromData)[3] >> 4) & 0x03;

  /* Unpack Member: m_nClass0Lsb */
  (pToStruct)->m_nClass0Lsb =  (uint32_t)  ((pFromData)[3] ) & 0x0f;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nReserve1 */
  (pToStruct)->m_nReserve1 =  (uint32_t)  ((pFromData)[1] >> 6) & 0x03;

  /* Unpack Member: m_nClass1Dp */
  (pToStruct)->m_nClass1Dp =  (uint32_t)  ((pFromData)[1] >> 4) & 0x03;

  /* Unpack Member: m_nClass1Lsb */
  (pToStruct)->m_nClass1Lsb =  (uint32_t)  ((pFromData)[1] ) & 0x0f;

  /* Unpack Member: m_nReserve0 */
  (pToStruct)->m_nReserve0 =  (uint32_t)  ((pFromData)[0] >> 6) & 0x03;

  /* Unpack Member: m_nClass0Dp */
  (pToStruct)->m_nClass0Dp =  (uint32_t)  ((pFromData)[0] >> 4) & 0x03;

  /* Unpack Member: m_nClass0Lsb */
  (pToStruct)->m_nClass0Lsb =  (uint32_t)  ((pFromData)[0] ) & 0x0f;
#endif
