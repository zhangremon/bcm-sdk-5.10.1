/*
 * $Id: sbZfKaEpIpPortVridSmacTableEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaEpIpPortVridSmacTableEntry_Print(sbZfKaEpIpPortVridSmacTableEntry_t *pFromStruct) {
  SB_LOG("KaEpIpPortVridSmacTableEntry:: res=0x%04x", (unsigned int)  pFromStruct->m_nReserved);
...
char *
sbZfKaEpIpPortVridSmacTableEntry_SPrint(sbZfKaEpIpPortVridSmacTableEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
