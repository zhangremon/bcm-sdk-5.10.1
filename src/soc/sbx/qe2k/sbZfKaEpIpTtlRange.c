/*
 * $Id: sbZfKaEpIpTtlRange.c 1.1.44.4 Broadcom SDK $
...
sbZfKaEpIpTtlRange_Unpack(sbZfKaEpIpTtlRange_t *pToStruct,
  ...
  (pToStruct)->m_nHighTtl =  (uint32_t)  (pFromData)[7] ;
  (pToStruct)->m_nHighTtl |=  (uint32_t)  (pFromData)[6] << 8;
  (pToStruct)->m_nHighTtl |=  (uint32_t)  (pFromData)[5] << 16;
  (pToStruct)->m_nHighTtl |=  (uint32_t)  (pFromData)[4] << 24;

  /* Unpack Member: m_nLowTtl */
  (pToStruct)->m_nLowTtl =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_nLowTtl |=  (uint32_t)  (pFromData)[2] << 8;
  (pToStruct)->m_nLowTtl |=  (uint32_t)  (pFromData)[1] << 16;
  (pToStruct)->m_nLowTtl |=  (uint32_t)  (pFromData)[0] << 24;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nHighTtl */
  (pToStruct)->m_nHighTtl =  (uint32_t)  (pFromData)[4] ;
  (pToStruct)->m_nHighTtl |=  (uint32_t)  (pFromData)[5] << 8;
  (pToStruct)->m_nHighTtl |=  (uint32_t)  (pFromData)[6] << 16;
  (pToStruct)->m_nHighTtl |=  (uint32_t)  (pFromData)[7] << 24;

  /* Unpack Member: m_nLowTtl */
  (pToStruct)->m_nLowTtl =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_nLowTtl |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->m_nLowTtl |=  (uint32_t)  (pFromData)[2] << 16;
  (pToStruct)->m_nLowTtl |=  (uint32_t)  (pFromData)[3] << 24;
#endif
