/*
 * $Id: sbZfKaEgNotTmePortRemapAddr.c 1.1.44.4 Broadcom SDK $
...
sbZfKaEgNotTmePortRemapAddr_Unpack(sbZfKaEgNotTmePortRemapAddr_t *pToStruct,
  ...
  (pToStruct)->m_nTxdma =  (uint8_t)  ((pFromData)[2] ) & 0x01;

  /* Unpack Member: m_nEf */
  (pToStruct)->m_nEf =  (uint8_t)  ((pFromData)[3] >> 7) & 0x01;

  /* Unpack Member: m_nQe1k */
  (pToStruct)->m_nQe1k =  (uint8_t)  ((pFromData)[3] >> 6) & 0x01;
  ...
  /* Unpack Member: m_nTxdma */
  (pToStruct)->m_nTxdma =  (uint8_t)  ((pFromData)[1] ) & 0x01;

  /* Unpack Member: m_nEf */
  (pToStruct)->m_nEf =  (uint8_t)  ((pFromData)[0] >> 7) & 0x01;

  /* Unpack Member: m_nQe1k */
  (pToStruct)->m_nQe1k =  (uint8_t)  ((pFromData)[0] >> 6) & 0x01;
