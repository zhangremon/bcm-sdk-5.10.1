/*
 * $Id: sbZfKaRbPoliceEBSEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaRbPoliceEBSEntry_Unpack(sbZfKaRbPoliceEBSEntry_t *pToStruct,
  ...
  (pToStruct)->m_nEBS =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_nEBS |=  (uint32_t)  (pFromData)[2] << 8;
  (pToStruct)->m_nEBS |=  (uint32_t)  (pFromData)[1] << 16;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nEBS */
  (pToStruct)->m_nEBS =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_nEBS |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->m_nEBS |=  (uint32_t)  (pFromData)[2] << 16;
#endif
