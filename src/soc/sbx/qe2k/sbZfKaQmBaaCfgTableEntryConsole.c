/*
 * $Id: sbZfKaQmBaaCfgTableEntryConsole.c 1.1.44.3 Broadcom SDK $
...
sbZfKaQmBaaCfgTableEntry_Print(sbZfKaQmBaaCfgTableEntry_t *pFromStruct) {
  SB_LOG("KaQmBaaCfgTableEntry:: gamma=0x%02x", (unsigned int)  pFromStruct->m_nGamma);
  SB_LOG("\n");
...
char *
sbZfKaQmBaaCfgTableEntry_SPrint(sbZfKaQmBaaCfgTableEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
