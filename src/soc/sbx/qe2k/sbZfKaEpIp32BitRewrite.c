/*
 * $Id: sbZfKaEpIp32BitRewrite.c 1.1.44.4 Broadcom SDK $
...
sbZfKaEpIp32BitRewrite_Unpack(sbZfKaEpIp32BitRewrite_t *pToStruct,
  ...
  (pToStruct)->m_nData =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_nData |=  (uint32_t)  (pFromData)[2] << 8;
  (pToStruct)->m_nData |=  (uint32_t)  (pFromData)[1] << 16;
  (pToStruct)->m_nData |=  (uint32_t)  (pFromData)[0] << 24;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nData */
  (pToStruct)->m_nData =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_nData |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->m_nData |=  (uint32_t)  (pFromData)[2] << 16;
  (pToStruct)->m_nData |=  (uint32_t)  (pFromData)[3] << 24;
#endif
