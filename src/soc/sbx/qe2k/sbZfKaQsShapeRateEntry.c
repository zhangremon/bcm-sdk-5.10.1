/*
 * $Id: sbZfKaQsShapeRateEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfKaQsShapeRateEntry_Unpack(sbZfKaQsShapeRateEntry_t *pToStruct,
  ...
  (pToStruct)->m_nReserved =  (uint32_t)  (pFromData)[0] ;

  /* Unpack Member: m_nMode */
  (pToStruct)->m_nMode =  (uint32_t)  ((pFromData)[1] >> 7) & 0x01;

  /* Unpack Member: m_nShapeRate */
  (pToStruct)->m_nShapeRate =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_nShapeRate |=  (uint32_t)  (pFromData)[2] << 8;
  (pToStruct)->m_nShapeRate |=  (uint32_t)  ((pFromData)[1] & 0x7f) << 16;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nReserved */
  (pToStruct)->m_nReserved =  (uint32_t)  (pFromData)[3] ;

  /* Unpack Member: m_nMode */
  (pToStruct)->m_nMode =  (uint32_t)  ((pFromData)[2] >> 7) & 0x01;

  /* Unpack Member: m_nShapeRate */
  (pToStruct)->m_nShapeRate =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_nShapeRate |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->m_nShapeRate |=  (uint32_t)  ((pFromData)[2] & 0x7f) << 16;
#endif
