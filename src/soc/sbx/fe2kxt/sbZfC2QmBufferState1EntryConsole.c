/*
 * $Id: sbZfC2QmBufferState1EntryConsole.c 1.1.34.3 Broadcom SDK $
...
#include "sbZfC2QmBufferState1EntryConsole.hx"
...
sbZfC2QmBufferState1Entry_Print(sbZfC2QmBufferState1Entry_t *pFromStruct) {
  SB_LOG("C2QmBufferState1Entry:: drop=0x%01x", (unsigned int)  pFromStruct->m_uDrop);
  ...
  SB_LOG("C2QmBufferState1Entry:: continuebyte=0x%02x", (unsigned int)  pFromStruct->m_uContinueByte);
...
char *
sbZfC2QmBufferState1Entry_SPrint(sbZfC2QmBufferState1Entry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2QmBufferState1Entry:: drop=0x%01x", (unsigned int)  pFromStruct->m_uDrop);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2QmBufferState1Entry:: continuebyte=0x%02x", (unsigned int)  pFromStruct->m_uContinueByte);
