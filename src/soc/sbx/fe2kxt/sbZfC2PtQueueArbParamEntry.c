/*
 * $Id: sbZfC2PtQueueArbParamEntry.c 1.1.34.4 Broadcom SDK $
...
sbZfC2PtQueueArbParamEntry_Pack(sbZfC2PtQueueArbParamEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2PTQUEUEARBPARAMENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2PTQUEUEARBPARAMENTRY_SIZE_IN_BYTES;
}
