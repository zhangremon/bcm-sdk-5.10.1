/*
 * $Id: sbZfC2PpCamQueryFormatConsole.c 1.1.34.3 Broadcom SDK $
...
sbZfC2PpCamQueryFormat_Print(sbZfC2PpCamQueryFormat_t *pFromStruct) {
  SB_LOG("C2PpCamQueryFormat:: state=0x%06x", (unsigned int)  pFromStruct->m_uState);
  SB_LOG(" data5=0x%08x", (unsigned int)  pFromStruct->m_uQueryData5);
  SB_LOG(" data4=0x%08x", (unsigned int)  pFromStruct->m_uQueryData4);
  SB_LOG("\n");

  SB_LOG("C2PpCamQueryFormat:: data3=0x%08x", (unsigned int)  pFromStruct->m_uQueryData3);
  SB_LOG(" data2=0x%08x", (unsigned int)  pFromStruct->m_uQueryData2);
  SB_LOG(" data1=0x%08x", (unsigned int)  pFromStruct->m_uQueryData1);
  SB_LOG("\n");

  SB_LOG("C2PpCamQueryFormat:: data0=0x%08x", (unsigned int)  pFromStruct->m_uQueryData0);
...
char *
sbZfC2PpCamQueryFormat_SPrint(sbZfC2PpCamQueryFormat_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
