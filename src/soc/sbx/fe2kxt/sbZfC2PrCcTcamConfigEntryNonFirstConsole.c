/*
 * $Id: sbZfC2PrCcTcamConfigEntryNonFirstConsole.c 1.1.22.3 Broadcom SDK $
...
sbZfC2PrCcTcamConfigEntryNonFirst_Print(sbZfC2PrCcTcamConfigEntryNonFirst_t *pFromStruct) {
  SB_LOG("C2PrCcTcamConfigEntryNonFirst:: mask0_31=0x%08x", (unsigned int)  pFromStruct->m_uMask0_31);
  SB_LOG(" mask32_63=0x%08x", (unsigned int)  pFromStruct->m_uMask32_63);
  SB_LOG("\n");

  SB_LOG("C2PrCcTcamConfigEntryNonFirst:: mask64_95=0x%08x", (unsigned int)  pFromStruct->m_uMask64_95);
  SB_LOG(" mask96_127=0x%08x", (unsigned int)  pFromStruct->m_uMask96_127);
  SB_LOG("\n");

  SB_LOG("C2PrCcTcamConfigEntryNonFirst:: mask128_159=0x%08x", (unsigned int)  pFromStruct->m_uMask128_159);
  SB_LOG("\n");

  SB_LOG("C2PrCcTcamConfigEntryNonFirst:: mask160_191=0x%08x", (unsigned int)  pFromStruct->m_uMask160_191);
  SB_LOG(" mask192_199=0x%02x", (unsigned int)  pFromStruct->m_uMask192_199);
  SB_LOG("\n");

  SB_LOG("C2PrCcTcamConfigEntryNonFirst:: maskstate=0x%04x", (unsigned int)  pFromStruct->m_uMaskState);
  SB_LOG(" packet0_31=0x%08x", (unsigned int)  pFromStruct->m_uPacket0_31);
  SB_LOG("\n");

  SB_LOG("C2PrCcTcamConfigEntryNonFirst:: packet32_63=0x%08x", (unsigned int)  pFromStruct->m_uPacket32_63);
  SB_LOG("\n");

  SB_LOG("C2PrCcTcamConfigEntryNonFirst:: packet64_95=0x%08x", (unsigned int)  pFromStruct->m_uPacket64_95);
  SB_LOG("\n");

  SB_LOG("C2PrCcTcamConfigEntryNonFirst:: packet96_127=0x%08x", (unsigned int)  pFromStruct->m_uPacket96_127);
  SB_LOG("\n");

  SB_LOG("C2PrCcTcamConfigEntryNonFirst:: packet128_159=0x%08x", (unsigned int)  pFromStruct->m_uPacket128_159);
  SB_LOG("\n");

  SB_LOG("C2PrCcTcamConfigEntryNonFirst:: packet160_191=0x%08x", (unsigned int)  pFromStruct->m_uPacket160_191);
  SB_LOG(" packet192_199=0x%02x", (unsigned int)  pFromStruct->m_uPacket192_199);
  SB_LOG("\n");

  SB_LOG("C2PrCcTcamConfigEntryNonFirst:: state=0x%04x", (unsigned int)  pFromStruct->m_uState);
...
char *
sbZfC2PrCcTcamConfigEntryNonFirst_SPrint(sbZfC2PrCcTcamConfigEntryNonFirst_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
