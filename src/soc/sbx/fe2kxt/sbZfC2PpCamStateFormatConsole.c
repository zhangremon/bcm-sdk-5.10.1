/*
 * $Id: sbZfC2PpCamStateFormatConsole.c 1.1.34.3 Broadcom SDK $
...
sbZfC2PpCamStateFormat_Print(sbZfC2PpCamStateFormat_t *pFromStruct) {
  SB_LOG("C2PpCamStateFormat:: resv1=0x%02x", (unsigned int)  pFromStruct->m_uResv1);
  ...
  SB_LOG("C2PpCamStateFormat:: resv0=0x%01x", (unsigned int)  pFromStruct->m_uResv0);
  ...
  SB_LOG("C2PpCamStateFormat:: pbits1=0x%01x", (unsigned int)  pFromStruct->m_uPropBits1);
...
char *
sbZfC2PpCamStateFormat_SPrint(sbZfC2PpCamStateFormat_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
