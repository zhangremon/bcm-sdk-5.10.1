/*
 * $Id: sbZfC2PpCamRamConfigurationInstance0EntryConsole.c 1.1.34.3 Broadcom SDK $
...
sbZfC2PpCamRamConfigurationInstance0Entry_Print(sbZfC2PpCamRamConfigurationInstance0Entry_t *pFromStruct) {
  SB_LOG("C2PpCamRamConfigurationInstance0Entry:: lengthunits=0x%01x", (unsigned int)  pFromStruct->m_uLengthUnits);
  SB_LOG(" lengthmask=0x%01x", (unsigned int)  pFromStruct->m_uLengthMask);
  SB_LOG("\n");

  SB_LOG("C2PpCamRamConfigurationInstance0Entry:: lengthptr=0x%02x", (unsigned int)  pFromStruct->m_uLengthPtr);
  SB_LOG(" statemask=0x%06x", (unsigned int)  pFromStruct->m_uStateMask);
  SB_LOG("\n");

  SB_LOG("C2PpCamRamConfigurationInstance0Entry:: state=0x%06x", (unsigned int)  pFromStruct->m_uState);
  SB_LOG(" hashstart=0x%01x", (unsigned int)  pFromStruct->m_uHashStart);
  SB_LOG("\n");

  SB_LOG("C2PpCamRamConfigurationInstance0Entry:: hashtemplate=0x%02x", (unsigned int)  pFromStruct->m_uHashTemplate);
  SB_LOG("\n");

  SB_LOG("C2PpCamRamConfigurationInstance0Entry:: checkeroffset=0x%02x", (unsigned int)  pFromStruct->m_uCheckerOffset);
  SB_LOG(" checkertype=0x%01x", (unsigned int)  pFromStruct->m_uCheckerType);
  SB_LOG("\n");

  SB_LOG("C2PpCamRamConfigurationInstance0Entry:: headeravalid=0x%01x", (unsigned int)  pFromStruct->m_uHeaderAValid);
  SB_LOG(" headeratype=0x%01x", (unsigned int)  pFromStruct->m_uHeaderAType);
  SB_LOG("\n");

  SB_LOG("C2PpCamRamConfigurationInstance0Entry:: headerabaselength=0x%02x", (unsigned int)  pFromStruct->m_uHeaderABaseLength);
  SB_LOG("\n");

  SB_LOG("C2PpCamRamConfigurationInstance0Entry:: headerbvalid=0x%01x", (unsigned int)  pFromStruct->m_uHeaderBValid);
  SB_LOG(" headerbtype=0x%01x", (unsigned int)  pFromStruct->m_uHeaderBType);
  SB_LOG("\n");

  SB_LOG("C2PpCamRamConfigurationInstance0Entry:: headerbbaselength=0x%02x", (unsigned int)  pFromStruct->m_uHeaderBBaseLength);
  SB_LOG(" shift=0x%02x", (unsigned int)  pFromStruct->m_uShift);
  SB_LOG("\n");

  SB_LOG("C2PpCamRamConfigurationInstance0Entry:: variablemask=0x%08x", (unsigned int)  pFromStruct->m_uVariableMask);
  SB_LOG("\n");

  SB_LOG("C2PpCamRamConfigurationInstance0Entry:: variabledata=0x%08x", (unsigned int)  pFromStruct->m_uVariableData);
  SB_LOG("\n");
...
char *
sbZfC2PpCamRamConfigurationInstance0Entry_SPrint(sbZfC2PpCamRamConfigurationInstance0Entry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
