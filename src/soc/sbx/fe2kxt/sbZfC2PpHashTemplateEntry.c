/*
 * $Id: sbZfC2PpHashTemplateEntry.c 1.1.34.4 Broadcom SDK $
...
sbZfC2PpHashTemplateEntry_Pack(sbZfC2PpHashTemplateEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2PPHASHTEMPLATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2PPHASHTEMPLATEENTRY_SIZE_IN_BYTES;
}
