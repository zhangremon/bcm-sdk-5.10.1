/*
 * $Id: sbZfC2MmInternal0MemoryEntry.c 1.1.34.4 Broadcom SDK $
...
sbZfC2MmInternal0MemoryEntry_Pack(sbZfC2MmInternal0MemoryEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2MMINTERNAL0MEMORYENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2MMINTERNAL0MEMORYENTRY_SIZE_IN_BYTES;
}
