/*
 * $Id: sbZfC2MmWidePortMemoryEntry.c 1.1.34.4 Broadcom SDK $
...
sbZfC2MmWidePortMemoryEntry_Pack(sbZfC2MmWidePortMemoryEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2MMWIDEPORTMEMORYENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2MMWIDEPORTMEMORYENTRY_SIZE_IN_BYTES;
}
