/*
 * $Id: sbZfC2PdHeaderConfigConsole.c 1.1.34.3 Broadcom SDK $
...
#include "sbZfC2PdHeaderConfigConsole.hx"



/* Print members in struct */
void
sbZfC2PdHeaderConfig_Print(sbZfC2PdHeaderConfig_t *pFromStruct) {
  SB_LOG("C2PdHeaderConfig:: spare0=0x%02x", (unsigned int)  pFromStruct->m_uSpare0);
  ...
  SB_LOG("C2PdHeaderConfig:: spare2=0x%01x", (unsigned int)  pFromStruct->m_uSpare2);
...
char *
sbZfC2PdHeaderConfig_SPrint(sbZfC2PdHeaderConfig_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2PdHeaderConfig:: spare0=0x%02x", (unsigned int)  pFromStruct->m_uSpare0);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2PdHeaderConfig:: spare2=0x%01x", (unsigned int)  pFromStruct->m_uSpare2);
...
int
sbZfC2PdHeaderConfig_Validate(sbZfC2PdHeaderConfig_t *pZf) {
...
int
sbZfC2PdHeaderConfig_SetField(sbZfC2PdHeaderConfig_t *s, char* name, int value) {
