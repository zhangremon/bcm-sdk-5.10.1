/*
 * $Id: sbZfC2DiagUcodeSharedConsole.c 1.1.34.3 Broadcom SDK $
...
sbZfC2DiagUcodeShared_Print(sbZfC2DiagUcodeShared_t *pFromStruct) {
  SB_LOG("C2DiagUcodeShared:: memsize0=0x%01x", (unsigned int)  pFromStruct->m_ulMemSizeMm0N0);
  ...
  SB_LOG("C2DiagUcodeShared:: memsize4=0x%01x", (unsigned int)  pFromStruct->m_ulMemSizeMm1N1);
...
char *
sbZfC2DiagUcodeShared_SPrint(sbZfC2DiagUcodeShared_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
