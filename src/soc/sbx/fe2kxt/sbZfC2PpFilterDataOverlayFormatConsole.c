/*
 * $Id: sbZfC2PpFilterDataOverlayFormatConsole.c 1.1.34.3 Broadcom SDK $
...
sbZfC2PpFilterDataOverlayFormat_Print(sbZfC2PpFilterDataOverlayFormat_t *pFromStruct) {
  SB_LOG("C2PpFilterDataOverlayFormat:: frag=0x%01x", (unsigned int)  pFromStruct->m_uFragment);
  ...
  SB_LOG("C2PpFilterDataOverlayFormat:: fid1=0x%01x", (unsigned int)  pFromStruct->m_uFilterId1);
  SB_LOG("\n");
...
char *
sbZfC2PpFilterDataOverlayFormat_SPrint(sbZfC2PpFilterDataOverlayFormat_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
