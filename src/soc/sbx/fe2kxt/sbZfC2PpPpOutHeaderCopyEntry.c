/*
 * $Id: sbZfC2PpPpOutHeaderCopyEntry.c 1.1.34.4 Broadcom SDK $
...
sbZfC2PpPpOutHeaderCopyEntry_Pack(sbZfC2PpPpOutHeaderCopyEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2PPPPOUTHEADERCOPYENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2PPPPOUTHEADERCOPYENTRY_SIZE_IN_BYTES;
}
