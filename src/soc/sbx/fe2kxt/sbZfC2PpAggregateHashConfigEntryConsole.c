/*
 * $Id: sbZfC2PpAggregateHashConfigEntryConsole.c,v 1.1.34.3 2011/05/22 05:39:54 iakramov Exp $
...
sbZfC2PpAggregateHashConfigEntry_Print(sbZfC2PpAggregateHashConfigEntry_t *pFromStruct) {
  SB_LOG("C2PpAggregateHashConfigEntry:: data9=0x%08x", (unsigned int)  pFromStruct->m_uData9);
  SB_LOG(" data8=0x%08x", (unsigned int)  pFromStruct->m_uData8);
  SB_LOG("\n");

  SB_LOG("C2PpAggregateHashConfigEntry:: data7=0x%08x", (unsigned int)  pFromStruct->m_uData7);
  SB_LOG(" data6=0x%08x", (unsigned int)  pFromStruct->m_uData6);
  SB_LOG("\n");

  SB_LOG("C2PpAggregateHashConfigEntry:: data5=0x%08x", (unsigned int)  pFromStruct->m_uData5);
  SB_LOG(" data4=0x%08x", (unsigned int)  pFromStruct->m_uData4);
  SB_LOG("\n");

  SB_LOG("C2PpAggregateHashConfigEntry:: data3=0x%08x", (unsigned int)  pFromStruct->m_uData3);
  SB_LOG(" data2=0x%08x", (unsigned int)  pFromStruct->m_uData2);
  SB_LOG("\n");

  SB_LOG("C2PpAggregateHashConfigEntry:: data1=0x%08x", (unsigned int)  pFromStruct->m_uData1);
