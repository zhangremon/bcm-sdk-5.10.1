/*
 * $Id: sbZfC2PpCamQueryFormat.c 1.1.34.4 Broadcom SDK $
...
sbZfC2PpCamQueryFormat_Unpack(sbZfC2PpCamQueryFormat_t *pToStruct,
  ...
  (pToStruct)->m_uState =  (uint32_t)  (pFromData)[24] ;
  (pToStruct)->m_uState |=  (uint32_t)  (pFromData)[25] << 8;
  (pToStruct)->m_uState |=  (uint32_t)  (pFromData)[26] << 16;

  /* Unpack Member: m_uQueryData5 */
  (pToStruct)->m_uQueryData5 =  (uint32_t)  (pFromData)[20] ;
  (pToStruct)->m_uQueryData5 |=  (uint32_t)  (pFromData)[21] << 8;
  (pToStruct)->m_uQueryData5 |=  (uint32_t)  (pFromData)[22] << 16;
  (pToStruct)->m_uQueryData5 |=  (uint32_t)  (pFromData)[23] << 24;
  ...
  (pToStruct)->m_uQueryData0 =  (uint32_t)  ((pFromData)[0] >> 2) & 0x3f;
  (pToStruct)->m_uQueryData0 |=  (uint32_t)  (pFromData)[1] << 6;
  (pToStruct)->m_uQueryData0 |=  (uint32_t)  (pFromData)[2] << 14;
  (pToStruct)->m_uQueryData0 |=  (uint32_t)  (pFromData)[3] << 22;

  /* Unpack Member: m_uResv */
  (pToStruct)->m_uResv =  (uint32_t)  ((pFromData)[0] ) & 0x03;
