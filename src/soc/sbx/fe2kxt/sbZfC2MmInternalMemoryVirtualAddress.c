/*
 * $Id: sbZfC2MmInternalMemoryVirtualAddress.c 1.1.34.4 Broadcom SDK $
...
#include "sbTypes.h"
#include "sbZfC2MmInternalMemoryVirtualAddress.hx"
...
sbZfC2MmInternalMemoryVirtualAddress_Pack(sbZfC2MmInternalMemoryVirtualAddress_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2MMINTERNALMEMORYVIRTUALADDRESS_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2MMINTERNALMEMORYVIRTUALADDRESS_SIZE_IN_BYTES;
}
