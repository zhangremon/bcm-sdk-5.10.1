/*
 * $Id: sbZfC2LrLrpInstructionMemoryBank0EntryConsole.c 1.1.34.3 Broadcom SDK $
...
#include "sbZfC2LrLrpInstructionMemoryBank0EntryConsole.hx"
...
sbZfC2LrLrpInstructionMemoryBank0Entry_Print(sbZfC2LrLrpInstructionMemoryBank0Entry_t *pFromStruct) {
  SB_LOG("C2LrLrpInstructionMemoryBank0Entry:: thread=0x%01x", (unsigned int)  pFromStruct->m_uThread);
  ...
  SB_LOG("C2LrLrpInstructionMemoryBank0Entry:: target=0x%05x", (unsigned int)  pFromStruct->m_uTarget);
  SB_LOG(" sourcea=0x%08x", (unsigned int)  pFromStruct->m_uSourceA);
  SB_LOG("\n");

  SB_LOG("C2LrLrpInstructionMemoryBank0Entry:: sourceb=0x%04x", (unsigned int)  pFromStruct->m_uSourceB);
...
char *
sbZfC2LrLrpInstructionMemoryBank0Entry_SPrint(sbZfC2LrLrpInstructionMemoryBank0Entry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2LrLrpInstructionMemoryBank0Entry:: thread=0x%01x", (unsigned int)  pFromStruct->m_uThread);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2LrLrpInstructionMemoryBank0Entry:: target=0x%05x", (unsigned int)  pFromStruct->m_uTarget);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," sourcea=0x%08x", (unsigned int)  pFromStruct->m_uSourceA);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"\n");

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2LrLrpInstructionMemoryBank0Entry:: sourceb=0x%04x", (unsigned int)  pFromStruct->m_uSourceB);
