/*
 * $Id: sbZfC2QmQueueCountersEntry.c 1.1.34.4 Broadcom SDK $
...
#include "sbTypes.h"
#include "sbZfC2QmQueueCountersEntry.hx"
...
sbZfC2QmQueueCountersEntry_Pack(sbZfC2QmQueueCountersEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2QMQUEUECOUNTERSENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2QMQUEUECOUNTERSENTRY_SIZE_IN_BYTES;
}
