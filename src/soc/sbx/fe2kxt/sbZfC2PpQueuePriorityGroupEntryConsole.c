/*
 * $Id: sbZfC2PpQueuePriorityGroupEntryConsole.c 1.1.34.3 Broadcom SDK $
...
sbZfC2PpQueuePriorityGroupEntry_Print(sbZfC2PpQueuePriorityGroupEntry_t *pFromStruct) {
  SB_LOG("C2PpQueuePriorityGroupEntry:: priority=0x%01x", (unsigned int)  pFromStruct->m_uPriority);
