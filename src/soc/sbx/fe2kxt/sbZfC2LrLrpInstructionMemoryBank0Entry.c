/*
 * $Id: sbZfC2LrLrpInstructionMemoryBank0Entry.c 1.1.34.4 Broadcom SDK $
...
sbZfC2LrLrpInstructionMemoryBank0Entry_Pack(sbZfC2LrLrpInstructionMemoryBank0Entry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2LRLRPINSTRUCTIONMEMORYBANK0ENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2LRLRPINSTRUCTIONMEMORYBANK0ENTRY_SIZE_IN_BYTES;
}
