/*
 * $Id: sbZfC2DiagUcodeCtlConsole.c 1.1.34.3 Broadcom SDK $
...
sbZfC2DiagUcodeCtl_Print(sbZfC2DiagUcodeCtl_t *pFromStruct) {
  SB_LOG("C2DiagUcodeCtl:: status=0x%01x", (unsigned int)  pFromStruct->m_ulStatus);
  ...
  SB_LOG("C2DiagUcodeCtl:: ucloaded=0x%01x", (unsigned int)  pFromStruct->m_ulUcLoaded);
  ...
  SB_LOG("C2DiagUcodeCtl:: memexst2=0x%01x", (unsigned int)  pFromStruct->m_ulMemExstMm0W);
  ...
  SB_LOG("C2DiagUcodeCtl:: testoffset=0x%05x", (unsigned int)  pFromStruct->m_ulTestOffset);
  SB_LOG("\n");
...
char *
sbZfC2DiagUcodeCtl_SPrint(sbZfC2DiagUcodeCtl_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
