/*
 * $Id: sbZfC2PpeDescriptor.c 1.1.34.4 Broadcom SDK $
...
#include "sbTypes.h"
#include "sbZfC2PpeDescriptor.hx"
...
sbZfC2PpeDescriptor_Pack(sbZfC2PpeDescriptor_t *pFrom,
  ...
  int i;
  int size = SB_ZF_ZFC2PPEDESCRIPTOR_SIZE_IN_BYTES;
  ...
  return SB_ZF_ZFC2PPEDESCRIPTOR_SIZE_IN_BYTES;
}
...
sbZfC2PpeDescriptor_Unpack(sbZfC2PpeDescriptor_t *pToStruct,
  ...
  (pToStruct)->m_uRxPortData0 =  (uint32_t)  (pFromData)[171] ;

  /* Unpack Member: m_uReplicantCnt */
  (pToStruct)->m_uReplicantCnt =  (uint32_t)  ((pFromData)[169] >> 4) & 0x0f;
  (pToStruct)->m_uReplicantCnt |=  (uint32_t)  (pFromData)[170] << 4;

  /* Unpack Member: m_bReplicantBit */
  (pToStruct)->m_bReplicantBit =  (uint32_t)  ((pFromData)[169] >> 3) & 0x01;

  /* Unpack Member: m_uResv0 */
  (pToStruct)->m_uResv0 =  (uint32_t)  ((pFromData)[169] >> 2) & 0x01;

  /* Unpack Member: m_uDrop */
  (pToStruct)->m_uDrop =  (uint32_t)  ((pFromData)[169] >> 1) & 0x01;

  /* Unpack Member: m_uEnqueue */
  (pToStruct)->m_uEnqueue =  (uint32_t)  ((pFromData)[169] ) & 0x01;

  /* Unpack Member: m_uDqueue */
  (pToStruct)->m_uDqueue =  (uint32_t)  (pFromData)[168] ;

  /* Unpack Member: m_uRxPortData1 */
  (pToStruct)->m_uRxPortData1 =  (uint32_t)  ((pFromData)[165] >> 6) & 0x03;
  (pToStruct)->m_uRxPortData1 |=  (uint32_t)  (pFromData)[166] << 2;
  (pToStruct)->m_uRxPortData1 |=  (uint32_t)  (pFromData)[167] << 10;
  ...
  (pToStruct)->m_uAggrHash =  (uint32_t)  (pFromData)[160] ;
  (pToStruct)->m_uAggrHash |=  (uint32_t)  (pFromData)[161] << 8;
  (pToStruct)->m_uAggrHash |=  (uint32_t)  (pFromData)[162] << 16;
  (pToStruct)->m_uAggrHash |=  (uint32_t)  (pFromData)[163] << 24;

  /* Unpack Member: m_uVariable */
  (pToStruct)->m_uVariable =  (uint32_t)  (pFromData)[156] ;
  (pToStruct)->m_uVariable |=  (uint32_t)  (pFromData)[157] << 8;
  (pToStruct)->m_uVariable |=  (uint32_t)  (pFromData)[158] << 16;
  (pToStruct)->m_uVariable |=  (uint32_t)  (pFromData)[159] << 24;
