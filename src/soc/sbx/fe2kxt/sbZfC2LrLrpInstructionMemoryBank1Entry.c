/*
 * $Id: sbZfC2LrLrpInstructionMemoryBank1Entry.c 1.1.34.4 Broadcom SDK $
...
sbZfC2LrLrpInstructionMemoryBank1Entry_Pack(sbZfC2LrLrpInstructionMemoryBank1Entry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2LRLRPINSTRUCTIONMEMORYBANK1ENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2LRLRPINSTRUCTIONMEMORYBANK1ENTRY_SIZE_IN_BYTES;
}
