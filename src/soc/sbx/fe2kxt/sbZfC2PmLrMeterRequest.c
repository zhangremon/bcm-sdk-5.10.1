/*
 * $Id: sbZfC2PmLrMeterRequest.c 1.1.34.4 Broadcom SDK $
...
sbZfC2PmLrMeterRequest_Pack(sbZfC2PmLrMeterRequest_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2PMLRMETERREQUEST_SIZE_IN_BYTES;
  ...
  (pToData)[6] |= ((pFrom)->m_uResv0 & 0x01) <<7;
  (pToData)[7] |= ((pFrom)->m_uResv0 >> 1) &0xFF;

  /* Pack Member: m_uPolicerId */
  (pToData)[4] |= ((pFrom)->m_uPolicerId) & 0xFF;
  (pToData)[5] |= ((pFrom)->m_uPolicerId >> 8) &0xFF;
  (pToData)[6] |= ((pFrom)->m_uPolicerId >> 16) & 0x7f;
  ...
  return SB_ZF_C2PMLRMETERREQUEST_SIZE_IN_BYTES;
}
...
sbZfC2PmLrMeterRequest_Unpack(sbZfC2PmLrMeterRequest_t *pToStruct,
  ...
  (pToStruct)->m_uResv0 =  (uint32_t)  ((pFromData)[6] >> 7) & 0x01;
  (pToStruct)->m_uResv0 |=  (uint32_t)  (pFromData)[7] << 1;

  /* Unpack Member: m_uPolicerId */
  (pToStruct)->m_uPolicerId =  (uint32_t)  (pFromData)[4] ;
  (pToStruct)->m_uPolicerId |=  (uint32_t)  (pFromData)[5] << 8;
  (pToStruct)->m_uPolicerId |=  (uint32_t)  ((pFromData)[6] & 0x7f) << 16;
