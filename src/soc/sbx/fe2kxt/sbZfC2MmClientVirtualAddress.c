/*
 * $Id: sbZfC2MmClientVirtualAddress.c 1.1.34.4 Broadcom SDK $
...
sbZfC2MmClientVirtualAddress_Pack(sbZfC2MmClientVirtualAddress_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2MMCLIENTVIRTUALADDRESS_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2MMCLIENTVIRTUALADDRESS_SIZE_IN_BYTES;
}
...
sbZfC2MmClientVirtualAddress_Unpack(sbZfC2MmClientVirtualAddress_t *pToStruct,
  ...
  (pToStruct)->m_uSegment |=  (uint32_t)  ((pFromData)[3] & 0x0f) << 1;
