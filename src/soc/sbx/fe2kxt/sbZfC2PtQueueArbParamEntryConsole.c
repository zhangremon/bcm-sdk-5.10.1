/*
 * $Id: sbZfC2PtQueueArbParamEntryConsole.c 1.1.34.3 Broadcom SDK $
...
sbZfC2PtQueueArbParamEntry_Print(sbZfC2PtQueueArbParamEntry_t *pFromStruct) {
  SB_LOG("C2PtQueueArbParamEntry:: ppeenqueue=0x%01x", (unsigned int)  pFromStruct->m_uPpeEnqueue);
  ...
  SB_LOG("C2PtQueueArbParamEntry:: queue=0x%02x", (unsigned int)  pFromStruct->m_uQueue);
  SB_LOG(" pbselect=0x%01x", (unsigned int)  pFromStruct->m_uPbSelect);
  SB_LOG(" spare1=0x%03x", (unsigned int)  pFromStruct->m_uSpare1);
  SB_LOG("\n");

  SB_LOG("C2PtQueueArbParamEntry:: dstinterface=0x%01x", (unsigned int)  pFromStruct->m_uDstInterface);
  SB_LOG(" space2=0x%01x", (unsigned int)  pFromStruct->m_uSpace2);
  SB_LOG(" dstport=0x%02x", (unsigned int)  pFromStruct->m_uDstPort);
  SB_LOG("\n");

  SB_LOG("C2PtQueueArbParamEntry:: dstqueue=0x%02x", (unsigned int)  pFromStruct->m_uDstQueue);
  SB_LOG("\n");
...
char *
sbZfC2PtQueueArbParamEntry_SPrint(sbZfC2PtQueueArbParamEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
