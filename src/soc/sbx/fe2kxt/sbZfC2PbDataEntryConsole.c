/*
 * $Id: sbZfC2PbDataEntryConsole.c 1.1.34.3 Broadcom SDK $
...
char *
sbZfC2PbDataEntry_SPrint(sbZfC2PbDataEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
