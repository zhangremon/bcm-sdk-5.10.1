/*
 * $Id: sbZfC2MmNarrowPortMemoryVirtualAddress.c 1.1.34.4 Broadcom SDK $
...
sbZfC2MmNarrowPortMemoryVirtualAddress_Pack(sbZfC2MmNarrowPortMemoryVirtualAddress_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2MMNARROWPORTMEMORYVIRTUALADDRESS_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2MMNARROWPORTMEMORYVIRTUALADDRESS_SIZE_IN_BYTES;
}
