/*
 * $Id: sbZfC2MmWidePortMemorySegmentConfigData.c 1.1.34.4 Broadcom SDK $
...
sbZfC2MmWidePortMemorySegmentConfigData_Pack(sbZfC2MmWidePortMemorySegmentConfigData_t *pFrom,
  ...
  int i;
  int size = SB_ZF_C2MMWIDEPORTMEMORYSEGMENTCONFIGDATA_SIZE_IN_BYTES;
  ...
  return SB_ZF_C2MMWIDEPORTMEMORYSEGMENTCONFIGDATA_SIZE_IN_BYTES;
}
