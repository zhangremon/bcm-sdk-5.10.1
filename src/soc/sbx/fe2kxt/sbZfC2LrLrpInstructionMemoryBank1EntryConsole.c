/*
 * $Id: sbZfC2LrLrpInstructionMemoryBank1EntryConsole.c 1.1.34.3 Broadcom SDK $
...
#include "sbZfC2LrLrpInstructionMemoryBank1EntryConsole.hx"
...
sbZfC2LrLrpInstructionMemoryBank1Entry_Print(sbZfC2LrLrpInstructionMemoryBank1Entry_t *pFromStruct) {
  SB_LOG("C2LrLrpInstructionMemoryBank1Entry:: thread=0x%01x", (unsigned int)  pFromStruct->m_uThread);
  ...
  SB_LOG("C2LrLrpInstructionMemoryBank1Entry:: target=0x%05x", (unsigned int)  pFromStruct->m_uTarget);
  SB_LOG(" sourcea=0x%08x", (unsigned int)  pFromStruct->m_uSourceA);
  SB_LOG("\n");

  SB_LOG("C2LrLrpInstructionMemoryBank1Entry:: sourceb=0x%04x", (unsigned int)  pFromStruct->m_uSourceB);
...
char *
sbZfC2LrLrpInstructionMemoryBank1Entry_SPrint(sbZfC2LrLrpInstructionMemoryBank1Entry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2LrLrpInstructionMemoryBank1Entry:: thread=0x%01x", (unsigned int)  pFromStruct->m_uThread);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2LrLrpInstructionMemoryBank1Entry:: target=0x%05x", (unsigned int)  pFromStruct->m_uTarget);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," sourcea=0x%08x", (unsigned int)  pFromStruct->m_uSourceA);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"\n");

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2LrLrpInstructionMemoryBank1Entry:: sourceb=0x%04x", (unsigned int)  pFromStruct->m_uSourceB);
