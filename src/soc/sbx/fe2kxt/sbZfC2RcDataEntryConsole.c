/*
 * $Id: sbZfC2RcDataEntryConsole.c 1.1.34.3 Broadcom SDK $
...
#include "sbZfC2RcDataEntryConsole.hx"
...
sbZfC2RcDataEntry_Print(sbZfC2RcDataEntry_t *pFromStruct) {
  ...
  SB_LOG("C2RcDataEntry:: data5=0x%06x", (unsigned int)  pFromStruct->m_uData5);
  ...
  SB_LOG("C2RcDataEntry:: data3=0x%06x", (unsigned int)  pFromStruct->m_uData3);
  ...
  SB_LOG("C2RcDataEntry:: data1=0x%06x", (unsigned int)  pFromStruct->m_uData1);
...
char *
sbZfC2RcDataEntry_SPrint(sbZfC2RcDataEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data39=0x%08x", (unsigned int)  pFromStruct->m_uData39);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data36=0x%08x", (unsigned int)  pFromStruct->m_uData36);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data33=0x%08x", (unsigned int)  pFromStruct->m_uData33);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data30=0x%08x", (unsigned int)  pFromStruct->m_uData30);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data27=0x%08x", (unsigned int)  pFromStruct->m_uData27);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data24=0x%08x", (unsigned int)  pFromStruct->m_uData24);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data21=0x%08x", (unsigned int)  pFromStruct->m_uData21);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data18=0x%08x", (unsigned int)  pFromStruct->m_uData18);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data15=0x%08x", (unsigned int)  pFromStruct->m_uData15);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data12=0x%08x", (unsigned int)  pFromStruct->m_uData12);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data9=0x%08x", (unsigned int)  pFromStruct->m_uData9);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data7=0x%06x", (unsigned int)  pFromStruct->m_uData7);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data5=0x%06x", (unsigned int)  pFromStruct->m_uData5);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data3=0x%06x", (unsigned int)  pFromStruct->m_uData3);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"C2RcDataEntry:: data1=0x%06x", (unsigned int)  pFromStruct->m_uData1);
