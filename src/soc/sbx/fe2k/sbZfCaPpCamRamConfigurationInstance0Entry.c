/*
 * $Id: sbZfCaPpCamRamConfigurationInstance0Entry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPpCamRamConfigurationInstance0Entry_Unpack(sbZfCaPpCamRamConfigurationInstance0Entry_t *pToStruct,
  ...
  (pToStruct)->m_uStateMask4 =  (uint32_t)  ((pFromData)[17] >> 1) & 0x01;

  /* Unpack Member: m_uStateMask3 */
  (pToStruct)->m_uStateMask3 =  (uint32_t)  ((pFromData)[17] ) & 0x01;

  /* Unpack Member: m_uStateMask2 */
  (pToStruct)->m_uStateMask2 =  (uint32_t)  ((pFromData)[16] >> 7) & 0x01;

  /* Unpack Member: m_uStateMask1 */
  (pToStruct)->m_uStateMask1 =  (uint32_t)  ((pFromData)[16] >> 6) & 0x01;

  /* Unpack Member: m_uStateMask0 */
  (pToStruct)->m_uStateMask0 =  (uint32_t)  ((pFromData)[16] >> 5) & 0x01;

  /* Unpack Member: m_uStateStreamMask */
  (pToStruct)->m_uStateStreamMask =  (uint32_t)  ((pFromData)[16] >> 4) & 0x01;
