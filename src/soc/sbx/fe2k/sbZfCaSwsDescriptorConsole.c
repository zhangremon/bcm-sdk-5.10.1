/*
 * $Id: sbZfCaSwsDescriptorConsole.c 1.1.48.3 Broadcom SDK $
...
#include "sbZfCaSwsDescriptorConsole.hx"



/* Print members in struct */
void
sbZfCaSwsDescriptor_Print(sbZfCaSwsDescriptor_t *pFromStruct) {
  SB_LOG("CaSwsDescriptor:: resv0=0x%01x", (unsigned int)  pFromStruct->m_uResv0);
  SB_LOG(" srcbuffer=0x%04x", (unsigned int)  pFromStruct->m_uSourceBuffer);
  SB_LOG(" resv1=0x%04x", (unsigned int)  pFromStruct->m_uResv1);
  SB_LOG(" str=0x%01x", (unsigned int)  pFromStruct->m_uStreamSelector);
  SB_LOG("\n");

  SB_LOG("CaSwsDescriptor:: buffer=0x%04x", (unsigned int)  pFromStruct->m_uBufferNumber);
  SB_LOG(" expidx=0x%02x", (unsigned int)  pFromStruct->m_uExceptionIndex);
  SB_LOG(" squeue=0x%02x", (unsigned int)  pFromStruct->m_uSourceQueue);
  SB_LOG(" resv2=0x%02x", (unsigned int)  pFromStruct->m_uResv2);
  SB_LOG("\n");

  SB_LOG("CaSwsDescriptor:: repcnt=0x%03x", (unsigned int)  pFromStruct->m_uReplicantCnt);
  SB_LOG(" repbit=0x%01x", (unsigned int)  pFromStruct->m_uReplicantBit);
  ...
  SB_LOG("CaSwsDescriptor:: dque=0x%02x", (unsigned int)  pFromStruct->m_uDqueue);
  SB_LOG(" resv4=0x%05x", (unsigned int)  pFromStruct->m_uResv4);
  ...
  SB_LOG("CaSwsDescriptor:: pdata1=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte1);
  ...
  SB_LOG("CaSwsDescriptor:: pdata5=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte5);
  ...
  SB_LOG("CaSwsDescriptor:: pdata9=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte9);
  ...
  SB_LOG("CaSwsDescriptor:: pdata13=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte13);
  ...
  SB_LOG("CaSwsDescriptor:: pdata17=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte17);
  ...
  SB_LOG("CaSwsDescriptor:: pdata21=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte21);
  ...
  SB_LOG("CaSwsDescriptor:: pdata25=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte25);
  ...
  SB_LOG("CaSwsDescriptor:: pdata29=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte29);
  ...
  SB_LOG("CaSwsDescriptor:: pdata33=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte33);
  ...
  SB_LOG("CaSwsDescriptor:: pdata37=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte37);
  ...
  SB_LOG("CaSwsDescriptor:: pdata41=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte41);
  ...
  SB_LOG("CaSwsDescriptor:: pdata45=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte45);
  ...
  SB_LOG("CaSwsDescriptor:: pdata49=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte49);
  ...
  SB_LOG("CaSwsDescriptor:: pdata53=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte53);
  ...
  SB_LOG("CaSwsDescriptor:: pdata57=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte57);
  ...
  SB_LOG("CaSwsDescriptor:: pdata61=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte61);
  ...
  SB_LOG("CaSwsDescriptor:: pdata65=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte65);
  ...
  SB_LOG("CaSwsDescriptor:: pdata69=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte69);
  ...
  SB_LOG("CaSwsDescriptor:: pdata73=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte73);
  ...
  SB_LOG("CaSwsDescriptor:: pdata77=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte77);
  ...
  SB_LOG("CaSwsDescriptor:: pdata81=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte81);
  ...
  SB_LOG("CaSwsDescriptor:: pdata85=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte85);
  ...
  SB_LOG("CaSwsDescriptor:: pdata89=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte89);
  ...
  SB_LOG("CaSwsDescriptor:: pdata93=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte93);
  ...
  SB_LOG("CaSwsDescriptor:: pdata97=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte97);
  ...
  SB_LOG("CaSwsDescriptor:: pdata101=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte101);
  ...
  SB_LOG("CaSwsDescriptor:: pdata105=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte105);
  ...
  SB_LOG("CaSwsDescriptor:: pdata109=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte109);
  ...
  SB_LOG("CaSwsDescriptor:: pdata113=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte113);
  ...
  SB_LOG("CaSwsDescriptor:: pdata117=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte117);
  ...
  SB_LOG("CaSwsDescriptor:: pdata121=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte121);
  ...
  SB_LOG("CaSwsDescriptor:: pdata125=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte125);
  ...
  SB_LOG("CaSwsDescriptor:: pdata129=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte129);
  ...
  SB_LOG("CaSwsDescriptor:: pdata133=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte133);
  ...
  SB_LOG("CaSwsDescriptor:: pdata137=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte137);
  ...
  SB_LOG("CaSwsDescriptor:: pdata141=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte141);
  ...
  SB_LOG("CaSwsDescriptor:: pdata145=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte145);
  ...
  SB_LOG("CaSwsDescriptor:: pdata149=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte149);
  ...
  SB_LOG("CaSwsDescriptor:: pdata153=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte153);
...
char *
sbZfCaSwsDescriptor_SPrint(sbZfCaSwsDescriptor_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: resv0=0x%01x", (unsigned int)  pFromStruct->m_uResv0);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," srcbuffer=0x%04x", (unsigned int)  pFromStruct->m_uSourceBuffer);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: buffer=0x%04x", (unsigned int)  pFromStruct->m_uBufferNumber);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," expidx=0x%02x", (unsigned int)  pFromStruct->m_uExceptionIndex);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," squeue=0x%02x", (unsigned int)  pFromStruct->m_uSourceQueue);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," resv2=0x%02x", (unsigned int)  pFromStruct->m_uResv2);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"\n");

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: repcnt=0x%03x", (unsigned int)  pFromStruct->m_uReplicantCnt);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," repbit=0x%01x", (unsigned int)  pFromStruct->m_uReplicantBit);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: dque=0x%02x", (unsigned int)  pFromStruct->m_uDqueue);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," resv4=0x%05x", (unsigned int)  pFromStruct->m_uResv4);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata1=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte1);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata5=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte5);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata9=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte9);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata13=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte13);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata17=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte17);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata21=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte21);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata25=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte25);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata29=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte29);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata33=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte33);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata37=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte37);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata41=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte41);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata45=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte45);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata49=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte49);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata53=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte53);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata57=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte57);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata61=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte61);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata65=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte65);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata69=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte69);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata73=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte73);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata77=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte77);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata81=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte81);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata85=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte85);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata89=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte89);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata93=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte93);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata97=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte97);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata101=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte101);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata105=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte105);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata109=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte109);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata113=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte113);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata117=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte117);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata121=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte121);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata125=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte125);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata129=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte129);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata133=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte133);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata137=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte137);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata141=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte141);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata145=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte145);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata149=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte149);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaSwsDescriptor:: pdata153=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte153);
...
int
sbZfCaSwsDescriptor_Validate(sbZfCaSwsDescriptor_t *pZf) {

  if (pZf->m_uResv0 > 0xf) return 0;
  if (pZf->m_uSourceBuffer > 0x3fff) return 0;
  if (pZf->m_uResv1 > 0x7fff) return 0;
  if (pZf->m_uStreamSelector > 0x7) return 0;
  if (pZf->m_uBufferNumber > 0x1fff) return 0;
  if (pZf->m_uExceptionIndex > 0xff) return 0;
  if (pZf->m_uSourceQueue > 0xff) return 0;
  if (pZf->m_uResv2 > 0xff) return 0;
  if (pZf->m_uReplicantCnt > 0xfff) return 0;
  if (pZf->m_uReplicantBit > 0x1) return 0;
  if (pZf->m_uResv3 > 0x1) return 0;
  if (pZf->m_uDrop > 0x1) return 0;
  if (pZf->m_uEnqueue > 0x1) return 0;
  if (pZf->m_uDqueue > 0xff) return 0;
  if (pZf->m_uResv4 > 0x3ffff) return 0;
...
int
sbZfCaSwsDescriptor_SetField(sbZfCaSwsDescriptor_t *s, char* name, int value) {

  if (SB_STRCMP(name, "") == 0 ) {
    return -1;
  } else if (SB_STRCMP(name, "m_uresv0") == 0) {
    s->m_uResv0 = value;
  } else if (SB_STRCMP(name, "m_usourcebuffer") == 0) {
    s->m_uSourceBuffer = value;
  } else if (SB_STRCMP(name, "m_uresv1") == 0) {
    s->m_uResv1 = value;
  } else if (SB_STRCMP(name, "m_ustreamselector") == 0) {
    s->m_uStreamSelector = value;
  } else if (SB_STRCMP(name, "m_ubuffernumber") == 0) {
    s->m_uBufferNumber = value;
  ...
  } else if (SB_STRCMP(name, "m_ureplicantbit") == 0) {
    s->m_uReplicantBit = value;
