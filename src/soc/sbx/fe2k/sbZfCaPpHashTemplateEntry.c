/*
 * $Id: sbZfCaPpHashTemplateEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPpHashTemplateEntry_Pack(sbZfCaPpHashTemplateEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPPHASHTEMPLATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPPHASHTEMPLATEENTRY_SIZE_IN_BYTES;
}
