/*
 * $Id: sbZfCaMmInternal1MemoryEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaMmInternal1MemoryEntry_Pack(sbZfCaMmInternal1MemoryEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAMMINTERNAL1MEMORYENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAMMINTERNAL1MEMORYENTRY_SIZE_IN_BYTES;
}
