/*
 * $Id: sbZfFe2000RcSbPatternConsole.c 1.3.36.3 Broadcom SDK $
...
sbZfFe2000RcSbPattern_Print(sbZfFe2000RcSbPattern_t *pFromStruct) {
  SB_LOG("Fe2000RcSbPattern:: pat3=0x%08x", (unsigned int)  pFromStruct->uPattern3);
  SB_LOG(" pat2=0x%08x", (unsigned int)  pFromStruct->uPattern2);
  SB_LOG(" pat1=0x%08x", (unsigned int)  pFromStruct->uPattern1);
  SB_LOG("\n");

  SB_LOG("Fe2000RcSbPattern:: pat0=0x%08x", (unsigned int)  pFromStruct->uPattern0);
  SB_LOG("\n");
...
char *
sbZfFe2000RcSbPattern_SPrint(sbZfFe2000RcSbPattern_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
