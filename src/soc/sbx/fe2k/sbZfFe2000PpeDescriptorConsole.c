/*
 * $Id: sbZfFe2000PpeDescriptorConsole.c 1.3.36.3 Broadcom SDK $
...
sbZfFe2000PpeDescriptor_Print(sbZfFe2000PpeDescriptor_t *pFromStruct) {
  SB_LOG("Fe2000PpeDescriptor:: contbyte=0x%02x", (unsigned int)  pFromStruct->m_uContinueByte);
  ...
  SB_LOG("Fe2000PpeDescriptor:: hdr4=0x%01x", (unsigned int)  pFromStruct->m_uHeaderType4);
  ...
  SB_LOG("Fe2000PpeDescriptor:: locn0=0x%02x", (unsigned int)  pFromStruct->m_uLocation0);
  ...
  SB_LOG("Fe2000PpeDescriptor:: locn4=0x%02x", (unsigned int)  pFromStruct->m_uLocation4);
  ...
  SB_LOG("Fe2000PpeDescriptor:: locn8=0x%02x", (unsigned int)  pFromStruct->m_uLocation8);
  SB_LOG(" locn9=0x%02x", (unsigned int)  pFromStruct->m_uLocation9);
  SB_LOG(" str=0x%01x", (unsigned int)  pFromStruct->m_uStreamSelector);
  SB_LOG(" buffer=0x%01x", (unsigned int)  pFromStruct->m_uBuffer);
  SB_LOG(" expidx=0x%02x", (unsigned int)  pFromStruct->m_uExceptIndex);
  SB_LOG("\n");

  SB_LOG("Fe2000PpeDescriptor:: sque=0x%02x", (unsigned int)  pFromStruct->m_uSourceQueue);
  SB_LOG(" rxport0=0x%02x", (unsigned int)  pFromStruct->m_uRxPortData0);
  SB_LOG(" repcnt=0x%03x", (unsigned int)  pFromStruct->m_uReplicantCnt);
  SB_LOG(" repbit=0x%01x", (unsigned int)  pFromStruct->m_bReplicantBit);
  SB_LOG("\n");

  SB_LOG("Fe2000PpeDescriptor:: resv0=0x%01x", (unsigned int)  pFromStruct->m_uResv0);
  SB_LOG(" drop=0x%01x", (unsigned int)  pFromStruct->m_uDrop);
  SB_LOG(" enq=0x%01x", (unsigned int)  pFromStruct->m_uEnqueue);
  SB_LOG(" dqueue=0x%02x", (unsigned int)  pFromStruct->m_uDqueue);
  SB_LOG("\n");

  SB_LOG("Fe2000PpeDescriptor:: rxport1=0x%05x", (unsigned int)  pFromStruct->m_uRxPortData1);
  SB_LOG(" frmlen=0x%04x", (unsigned int)  pFromStruct->m_uFrameLength);
  SB_LOG(" aggrhash=0x%08x", (unsigned int)  pFromStruct->m_uAggrHash);
  SB_LOG("\n");

  SB_LOG("Fe2000PpeDescriptor:: variable=0x%08x", (unsigned int)  pFromStruct->m_uVariable);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata2=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte2);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata6=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte6);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata10=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte10);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata14=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte14);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata18=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte18);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata22=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte22);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata26=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte26);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata30=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte30);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata34=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte34);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata38=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte38);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata42=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte42);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata46=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte46);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata50=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte50);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata54=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte54);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata58=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte58);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata62=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte62);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata66=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte66);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata70=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte70);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata74=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte74);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata78=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte78);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata82=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte82);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata86=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte86);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata90=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte90);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata94=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte94);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata98=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte98);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata102=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte102);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata105=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte105);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata108=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte108);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata111=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte111);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata114=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte114);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata117=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte117);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata120=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte120);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata123=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte123);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata126=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte126);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata129=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte129);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata132=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte132);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata135=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte135);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata138=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte138);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata141=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte141);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata144=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte144);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata147=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte147);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata150=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte150);
  ...
  SB_LOG("Fe2000PpeDescriptor:: pdata153=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte153);
...
char *
sbZfFe2000PpeDescriptor_SPrint(sbZfFe2000PpeDescriptor_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
