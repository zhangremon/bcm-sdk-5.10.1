/*
 * $Id: sbZfCaPbCounterEntryConsole.c 1.1.48.3 Broadcom SDK $
...
char *
sbZfCaPbCounterEntry_SPrint(sbZfCaPbCounterEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
