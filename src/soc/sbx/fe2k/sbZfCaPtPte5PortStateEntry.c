/*
 * $Id: sbZfCaPtPte5PortStateEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPtPte5PortStateEntry_Pack(sbZfCaPtPte5PortStateEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPTPTE5PORTSTATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPTPTE5PORTSTATEENTRY_SIZE_IN_BYTES;
}
