/*
 * $Id: sbZfCaPpCamConfigurationInstance0EntryConsole.c 1.1.48.3 Broadcom SDK $
...
sbZfCaPpCamConfigurationInstance0Entry_Print(sbZfCaPpCamConfigurationInstance0Entry_t *pFromStruct) {
  SB_LOG("CaPpCamConfigurationInstance0Entry:: mask5=0x%06x", (unsigned int)  pFromStruct->m_uMask5);
  SB_LOG(" mask4=0x%08x", (unsigned int)  pFromStruct->m_uMask4);
  SB_LOG("\n");

  SB_LOG("CaPpCamConfigurationInstance0Entry:: mask3=0x%08x", (unsigned int)  pFromStruct->m_uMask3);
  SB_LOG(" mask2=0x%08x", (unsigned int)  pFromStruct->m_uMask2);
  SB_LOG("\n");

  SB_LOG("CaPpCamConfigurationInstance0Entry:: mask1=0x%08x", (unsigned int)  pFromStruct->m_uMask1);
  SB_LOG(" mask0=0x%08x", (unsigned int)  pFromStruct->m_uMask0);
  SB_LOG("\n");

  SB_LOG("CaPpCamConfigurationInstance0Entry:: data5=0x%06x", (unsigned int)  pFromStruct->m_uData5);
  SB_LOG(" data4=0x%08x", (unsigned int)  pFromStruct->m_uData4);
  SB_LOG("\n");

  SB_LOG("CaPpCamConfigurationInstance0Entry:: data3=0x%08x", (unsigned int)  pFromStruct->m_uData3);
  SB_LOG(" data2=0x%08x", (unsigned int)  pFromStruct->m_uData2);
  SB_LOG("\n");

  SB_LOG("CaPpCamConfigurationInstance0Entry:: data1=0x%08x", (unsigned int)  pFromStruct->m_uData1);
  SB_LOG(" data0=0x%08x", (unsigned int)  pFromStruct->m_uData0);
  SB_LOG("\n");

  SB_LOG("CaPpCamConfigurationInstance0Entry:: valid=0x%01x", (unsigned int)  pFromStruct->m_uValid);
  SB_LOG("\n");
...
char *
sbZfCaPpCamConfigurationInstance0Entry_SPrint(sbZfCaPpCamConfigurationInstance0Entry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
