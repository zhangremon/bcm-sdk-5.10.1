/*
 * $Id: sbZfFe2000PtQueueToPortEntryConsole.c 1.3.36.3 Broadcom SDK $
...
sbZfFe2000PtQueueToPortEntry_Print(sbZfFe2000PtQueueToPortEntry_t *pFromStruct) {
  SB_LOG("Fe2000PtQueueToPortEntry:: pbsel=0x%01x", (unsigned int)  pFromStruct->m_uPbSel);
  ...
  SB_LOG("Fe2000PtQueueToPortEntry:: destinterface=0x%01x", (unsigned int)  pFromStruct->m_uDestInterface);
...
char *
sbZfFe2000PtQueueToPortEntry_SPrint(sbZfFe2000PtQueueToPortEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
