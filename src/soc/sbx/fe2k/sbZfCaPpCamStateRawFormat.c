/*
 * $Id: sbZfCaPpCamStateRawFormat.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPpCamStateRawFormat_Unpack(sbZfCaPpCamStateRawFormat_t *pToStruct,
  ...
  (pToStruct)->m_uUnmodifiedState =  (uint32_t)  (pFromData)[1] ;
  (pToStruct)->m_uUnmodifiedState |=  (uint32_t)  (pFromData)[2] << 8;
