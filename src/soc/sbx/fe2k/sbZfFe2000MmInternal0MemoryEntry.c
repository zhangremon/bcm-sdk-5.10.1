/*
 * $Id: sbZfFe2000MmInternal0MemoryEntry.c 1.3.36.4 Broadcom SDK $
...
sbZfFe2000MmInternal0MemoryEntry_Pack(sbZfFe2000MmInternal0MemoryEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_FE2000INTERNAL0MEMORYENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FE2000INTERNAL0MEMORYENTRY_SIZE_IN_BYTES;
}
