/*
 * $Id: sbZfCaPtPte4MirrorPortStateEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPtPte4MirrorPortStateEntry_Pack(sbZfCaPtPte4MirrorPortStateEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPTPTE4MIRRORPORTSTATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPTPTE4MIRRORPORTSTATEENTRY_SIZE_IN_BYTES;
}
