/*
 * $Id: sbZfCaQmQueueState1EntryConsole.c 1.1.48.3 Broadcom SDK $
...
sbZfCaQmQueueState1Entry_Print(sbZfCaQmQueueState1Entry_t *pFromStruct) {
  SB_LOG("CaQmQueueState1Entry:: drop=0x%01x", (unsigned int)  pFromStruct->m_uDrop);
...
char *
sbZfCaQmQueueState1Entry_SPrint(sbZfCaQmQueueState1Entry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
