/*
 * $Id: sbZfFe2000LrpDescriptorConsole.c 1.3.36.3 Broadcom SDK $
...
#include "sbZfFe2000LrpDescriptorConsole.hx"



/* Print members in struct */
void
sbZfFe2000LrpDescriptor_Print(sbZfFe2000LrpDescriptor_t *pFromStruct) {
  SB_LOG("Fe2000LrpDescriptor:: contbyte=0x%02x", (unsigned int)  pFromStruct->m_uContinueByte);
  ...
  SB_LOG("Fe2000LrpDescriptor:: hdr4=0x%01x", (unsigned int)  pFromStruct->m_uHeaderType4);
  ...
  SB_LOG("Fe2000LrpDescriptor:: locn0=0x%02x", (unsigned int)  pFromStruct->m_uLocation0);
  ...
  SB_LOG("Fe2000LrpDescriptor:: locn4=0x%02x", (unsigned int)  pFromStruct->m_uLocation4);
  SB_LOG(" locn5=0x%02x", (unsigned int)  pFromStruct->m_uLocation5);
  SB_LOG(" locn6=0x%02x", (unsigned int)  pFromStruct->m_uLocation6);
  SB_LOG(" locn7=0x%02x", (unsigned int)  pFromStruct->m_uLocation7);
  SB_LOG("\n");

  SB_LOG("Fe2000LrpDescriptor:: locn8=0x%02x", (unsigned int)  pFromStruct->m_uLocation8);
  SB_LOG(" locn9=0x%02x", (unsigned int)  pFromStruct->m_uLocation9);
  SB_LOG(" str=0x%01x", (unsigned int)  pFromStruct->m_uStreamSelector);
  SB_LOG(" buffer=0x%04x", (unsigned int)  pFromStruct->m_uBuffer);
  SB_LOG("\n");

  SB_LOG("Fe2000LrpDescriptor:: expidx=0x%02x", (unsigned int)  pFromStruct->m_uExceptIndex);
  SB_LOG(" sque=0x%02x", (unsigned int)  pFromStruct->m_uSourceQueue);
  SB_LOG(" tc=0x%01x", (unsigned int)  pFromStruct->m_uTruncationCommand);
  SB_LOG(" hccpy=0x%01x", (unsigned int)  pFromStruct->m_uHeaderCopy);
  SB_LOG(" mirridx=0x%01x", (unsigned int)  pFromStruct->m_uMirrorIndex);
  SB_LOG("\n");

  SB_LOG("Fe2000LrpDescriptor:: cpycnt=0x%03x", (unsigned int)  pFromStruct->m_uCopyCount);
  SB_LOG(" crcmode=0x%01x", (unsigned int)  pFromStruct->m_uCrcMode);
  SB_LOG(" dropbit=0x%01x", (unsigned int)  pFromStruct->m_uDropBit);
  SB_LOG(" enq=0x%01x", (unsigned int)  pFromStruct->m_uEnqueue);
  SB_LOG("\n");

  SB_LOG("Fe2000LrpDescriptor:: dqueue=0x%02x", (unsigned int)  pFromStruct->m_uDestinationQueue);
  ...
  SB_LOG("Fe2000LrpDescriptor:: frmlen=0x%04x", (unsigned int)  pFromStruct->m_uFrameLength);
  SB_LOG(" resv2=0x%08x", (unsigned int)  pFromStruct->m_uResv2);
  SB_LOG(" resv3=0x%08x", (unsigned int)  pFromStruct->m_uResv3);
  SB_LOG("\n");

  SB_LOG("Fe2000LrpDescriptor:: pdata0=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte0);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata4=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte4);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata8=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte8);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata12=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte12);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata16=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte16);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata20=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte20);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata24=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte24);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata28=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte28);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata32=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte32);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata36=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte36);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata40=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte40);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata44=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte44);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata48=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte48);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata52=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte52);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata56=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte56);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata60=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte60);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata64=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte64);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata68=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte68);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata72=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte72);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata76=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte76);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata80=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte80);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata84=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte84);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata88=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte88);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata92=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte92);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata96=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte96);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata100=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte100);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata103=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte103);
  SB_LOG(" pdata104=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte104);
  SB_LOG(" pdata105=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte105);
  SB_LOG("\n");

  SB_LOG("Fe2000LrpDescriptor:: pdata106=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte106);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata109=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte109);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata112=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte112);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata115=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte115);
  SB_LOG(" pdata116=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte116);
  SB_LOG(" pdata117=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte117);
  SB_LOG("\n");

  SB_LOG("Fe2000LrpDescriptor:: pdata118=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte118);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata121=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte121);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata124=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte124);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata127=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte127);
  SB_LOG(" pdata128=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte128);
  SB_LOG(" pdata129=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte129);
  SB_LOG("\n");

  SB_LOG("Fe2000LrpDescriptor:: pdata130=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte130);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata133=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte133);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata136=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte136);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata139=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte139);
  SB_LOG(" pdata140=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte140);
  SB_LOG(" pdata141=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte141);
  SB_LOG("\n");

  SB_LOG("Fe2000LrpDescriptor:: pdata142=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte142);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata145=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte145);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata148=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte148);
  ...
  SB_LOG("Fe2000LrpDescriptor:: pdata151=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte151);
  SB_LOG(" pdata152=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte152);
  SB_LOG(" pdata153=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte153);
  SB_LOG("\n");

  SB_LOG("Fe2000LrpDescriptor:: pdata154=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte154);
...
char *
sbZfFe2000LrpDescriptor_SPrint(sbZfFe2000LrpDescriptor_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: contbyte=0x%02x", (unsigned int)  pFromStruct->m_uContinueByte);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: hdr4=0x%01x", (unsigned int)  pFromStruct->m_uHeaderType4);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: locn0=0x%02x", (unsigned int)  pFromStruct->m_uLocation0);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: locn4=0x%02x", (unsigned int)  pFromStruct->m_uLocation4);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: locn8=0x%02x", (unsigned int)  pFromStruct->m_uLocation8);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: expidx=0x%02x", (unsigned int)  pFromStruct->m_uExceptIndex);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," sque=0x%02x", (unsigned int)  pFromStruct->m_uSourceQueue);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," tc=0x%01x", (unsigned int)  pFromStruct->m_uTruncationCommand);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," hccpy=0x%01x", (unsigned int)  pFromStruct->m_uHeaderCopy);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," mirridx=0x%01x", (unsigned int)  pFromStruct->m_uMirrorIndex);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"\n");

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: cpycnt=0x%03x", (unsigned int)  pFromStruct->m_uCopyCount);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," crcmode=0x%01x", (unsigned int)  pFromStruct->m_uCrcMode);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," dropbit=0x%01x", (unsigned int)  pFromStruct->m_uDropBit);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt]," enq=0x%01x", (unsigned int)  pFromStruct->m_uEnqueue);
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"\n");

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: dqueue=0x%02x", (unsigned int)  pFromStruct->m_uDestinationQueue);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: frmlen=0x%04x", (unsigned int)  pFromStruct->m_uFrameLength);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata0=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte0);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata4=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte4);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata8=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte8);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata12=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte12);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata16=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte16);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata20=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte20);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata24=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte24);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata28=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte28);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata32=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte32);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata36=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte36);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata40=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte40);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata44=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte44);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata48=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte48);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata52=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte52);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata56=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte56);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata60=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte60);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata64=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte64);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata68=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte68);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata72=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte72);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata76=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte76);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata80=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte80);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata84=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte84);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata88=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte88);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata92=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte92);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata96=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte96);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata100=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte100);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata103=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte103);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata106=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte106);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata109=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte109);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata112=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte112);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata115=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte115);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata118=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte118);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata121=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte121);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata124=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte124);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata127=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte127);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata130=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte130);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata133=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte133);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata136=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte136);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata139=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte139);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata142=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte142);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata145=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte145);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata148=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte148);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata151=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte151);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"Fe2000LrpDescriptor:: pdata154=0x%02x", (unsigned int)  pFromStruct->m_uPacketDataByte154);
...
int
sbZfFe2000LrpDescriptor_Validate(sbZfFe2000LrpDescriptor_t *pZf) {
  ...
  if (pZf->m_uTruncationCommand > 0x7) return 0;
  if (pZf->m_uHeaderCopy > 0x1) return 0;
...
int
sbZfFe2000LrpDescriptor_SetField(sbZfFe2000LrpDescriptor_t *s, char* name, int value) {
  ...
  } else if (SB_STRCMP(name, "m_utruncationcommand") == 0) {
    s->m_uTruncationCommand = value;
  } else if (SB_STRCMP(name, "m_uheadercopy") == 0) {
    s->m_uHeaderCopy = value;
