/*
 * $Id: sbZfFe2000LrpDescriptor.c 1.3.36.4 Broadcom SDK $
...
#include "sbZfFe2000LrpDescriptor.hx"
...
sbZfFe2000LrpDescriptor_Pack(sbZfFe2000LrpDescriptor_t *pFrom,
  ...
  int i;
  int size = SB_ZF_FE2000LRPDESCRIPTOR_SIZE_IN_BYTES;
  ...
  return SB_ZF_FE2000LRPDESCRIPTOR_SIZE_IN_BYTES;
}
...
sbZfFe2000LrpDescriptor_Unpack(sbZfFe2000LrpDescriptor_t *pToStruct,
  ...
  (pToStruct)->m_uContinueByte =  (uint32_t)  (pFromData)[191] ;

  /* Unpack Member: m_uHeaderType0 */
  (pToStruct)->m_uHeaderType0 =  (uint32_t)  ((pFromData)[190] >> 4) & 0x0f;

  /* Unpack Member: m_uHeaderType1 */
  (pToStruct)->m_uHeaderType1 =  (uint32_t)  ((pFromData)[190] ) & 0x0f;

  /* Unpack Member: m_uHeaderType2 */
  (pToStruct)->m_uHeaderType2 =  (uint32_t)  ((pFromData)[189] >> 4) & 0x0f;

  /* Unpack Member: m_uHeaderType3 */
  (pToStruct)->m_uHeaderType3 =  (uint32_t)  ((pFromData)[189] ) & 0x0f;

  /* Unpack Member: m_uHeaderType4 */
  (pToStruct)->m_uHeaderType4 =  (uint32_t)  ((pFromData)[188] >> 4) & 0x0f;

  /* Unpack Member: m_uHeaderType5 */
  (pToStruct)->m_uHeaderType5 =  (uint32_t)  ((pFromData)[188] ) & 0x0f;

  /* Unpack Member: m_uHeaderType6 */
  (pToStruct)->m_uHeaderType6 =  (uint32_t)  ((pFromData)[187] >> 4) & 0x0f;

  /* Unpack Member: m_uHeaderType7 */
  (pToStruct)->m_uHeaderType7 =  (uint32_t)  ((pFromData)[187] ) & 0x0f;

  /* Unpack Member: m_uHeaderType8 */
  (pToStruct)->m_uHeaderType8 =  (uint32_t)  ((pFromData)[186] >> 4) & 0x0f;

  /* Unpack Member: m_uHeaderType9 */
  (pToStruct)->m_uHeaderType9 =  (uint32_t)  ((pFromData)[186] ) & 0x0f;

  /* Unpack Member: m_uLocation0 */
  (pToStruct)->m_uLocation0 =  (uint32_t)  (pFromData)[185] ;

  /* Unpack Member: m_uLocation1 */
  (pToStruct)->m_uLocation1 =  (uint32_t)  (pFromData)[184] ;

  /* Unpack Member: m_uLocation2 */
  (pToStruct)->m_uLocation2 =  (uint32_t)  (pFromData)[183] ;

  /* Unpack Member: m_uLocation3 */
  (pToStruct)->m_uLocation3 =  (uint32_t)  (pFromData)[182] ;

  /* Unpack Member: m_uLocation4 */
  (pToStruct)->m_uLocation4 =  (uint32_t)  (pFromData)[181] ;

  /* Unpack Member: m_uLocation5 */
  (pToStruct)->m_uLocation5 =  (uint32_t)  (pFromData)[180] ;

  /* Unpack Member: m_uLocation6 */
  (pToStruct)->m_uLocation6 =  (uint32_t)  (pFromData)[179] ;

  /* Unpack Member: m_uLocation7 */
  (pToStruct)->m_uLocation7 =  (uint32_t)  (pFromData)[178] ;

  /* Unpack Member: m_uLocation8 */
  (pToStruct)->m_uLocation8 =  (uint32_t)  (pFromData)[177] ;

  /* Unpack Member: m_uLocation9 */
  (pToStruct)->m_uLocation9 =  (uint32_t)  (pFromData)[176] ;

  /* Unpack Member: m_uStreamSelector */
  (pToStruct)->m_uStreamSelector =  (uint32_t)  ((pFromData)[175] >> 5) & 0x07;

  /* Unpack Member: m_uBuffer */
  (pToStruct)->m_uBuffer =  (uint32_t)  (pFromData)[174] ;
  (pToStruct)->m_uBuffer |=  (uint32_t)  ((pFromData)[175] & 0x1f) << 8;

  /* Unpack Member: m_uExceptIndex */
  (pToStruct)->m_uExceptIndex =  (uint32_t)  (pFromData)[173] ;

  /* Unpack Member: m_uSourceQueue */
  (pToStruct)->m_uSourceQueue =  (uint32_t)  (pFromData)[172] ;

  /* Unpack Member: m_uTruncationCommand */
  (pToStruct)->m_uTruncationCommand =  (uint32_t)  ((pFromData)[171] >> 5) & 0x07;

  /* Unpack Member: m_uHeaderCopy */
  (pToStruct)->m_uHeaderCopy =  (uint32_t)  ((pFromData)[171] >> 4) & 0x01;

  /* Unpack Member: m_uMirrorIndex */
  (pToStruct)->m_uMirrorIndex =  (uint32_t)  ((pFromData)[171] ) & 0x0f;

  /* Unpack Member: m_uCopyCount */
  (pToStruct)->m_uCopyCount =  (uint32_t)  ((pFromData)[169] >> 4) & 0x0f;
  (pToStruct)->m_uCopyCount |=  (uint32_t)  (pFromData)[170] << 4;

  /* Unpack Member: m_uCrcMode */
  (pToStruct)->m_uCrcMode =  (uint32_t)  ((pFromData)[169] >> 2) & 0x03;

  /* Unpack Member: m_uDropBit */
  (pToStruct)->m_uDropBit =  (uint32_t)  ((pFromData)[169] >> 1) & 0x01;

  /* Unpack Member: m_uEnqueue */
  (pToStruct)->m_uEnqueue =  (uint32_t)  ((pFromData)[169] ) & 0x01;

  /* Unpack Member: m_uDestinationQueue */
  (pToStruct)->m_uDestinationQueue =  (uint32_t)  (pFromData)[168] ;

  /* Unpack Member: m_uXferLength */
  (pToStruct)->m_uXferLength =  (uint32_t)  ((pFromData)[166] >> 2) & 0x3f;
  (pToStruct)->m_uXferLength |=  (uint32_t)  (pFromData)[167] << 6;

  /* Unpack Member: m_uPacketMarking */
  (pToStruct)->m_uPacketMarking =  (uint32_t)  ((pFromData)[166] ) & 0x03;

  /* Unpack Member: m_uResv1 */
  (pToStruct)->m_uResv1 =  (uint32_t)  ((pFromData)[165] >> 6) & 0x03;

  /* Unpack Member: m_uFrameLength */
  (pToStruct)->m_uFrameLength =  (uint32_t)  (pFromData)[164] ;
  (pToStruct)->m_uFrameLength |=  (uint32_t)  ((pFromData)[165] & 0x3f) << 8;

  /* Unpack Member: m_uResv2 */
  (pToStruct)->m_uResv2 =  (uint32_t)  (pFromData)[160] ;
  (pToStruct)->m_uResv2 |=  (uint32_t)  (pFromData)[161] << 8;
  (pToStruct)->m_uResv2 |=  (uint32_t)  (pFromData)[162] << 16;
  (pToStruct)->m_uResv2 |=  (uint32_t)  (pFromData)[163] << 24;

  /* Unpack Member: m_uResv3 */
  (pToStruct)->m_uResv3 =  (uint32_t)  (pFromData)[156] ;
  (pToStruct)->m_uResv3 |=  (uint32_t)  (pFromData)[157] << 8;
  (pToStruct)->m_uResv3 |=  (uint32_t)  (pFromData)[158] << 16;
  (pToStruct)->m_uResv3 |=  (uint32_t)  (pFromData)[159] << 24;
