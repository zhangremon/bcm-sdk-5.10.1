/*
 * $Id: sbZfCaMmInternal0SegmentConfigEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaMmInternal0SegmentConfigEntry_Pack(sbZfCaMmInternal0SegmentConfigEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAMMINTERNAL0SEGMENTCONFIGENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAMMINTERNAL0SEGMENTCONFIGENTRY_SIZE_IN_BYTES;
}
