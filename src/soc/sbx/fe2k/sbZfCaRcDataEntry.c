/*
 * $Id: sbZfCaRcDataEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaRcDataEntry_Unpack(sbZfCaRcDataEntry_t *pToStruct,
  ...
  (pToStruct)->m_uSpare3 =  (uint32_t)  ((pFromData)[14] >> 4) & 0x0f;
  (pToStruct)->m_uSpare3 |=  (uint32_t)  (pFromData)[15] << 4;

  /* Unpack Member: m_uData3 */
  (pToStruct)->m_uData3 =  (uint32_t)  (pFromData)[12] ;
  (pToStruct)->m_uData3 |=  (uint32_t)  (pFromData)[13] << 8;
  (pToStruct)->m_uData3 |=  (uint32_t)  ((pFromData)[14] & 0x0f) << 16;

  /* Unpack Member: m_uSpare2 */
  (pToStruct)->m_uSpare2 =  (uint32_t)  ((pFromData)[10] >> 4) & 0x0f;
  (pToStruct)->m_uSpare2 |=  (uint32_t)  (pFromData)[11] << 4;

  /* Unpack Member: m_uData2 */
  (pToStruct)->m_uData2 =  (uint32_t)  (pFromData)[8] ;
  (pToStruct)->m_uData2 |=  (uint32_t)  (pFromData)[9] << 8;
  (pToStruct)->m_uData2 |=  (uint32_t)  ((pFromData)[10] & 0x0f) << 16;

  /* Unpack Member: m_uSpare1 */
  (pToStruct)->m_uSpare1 =  (uint32_t)  ((pFromData)[6] >> 4) & 0x0f;
  (pToStruct)->m_uSpare1 |=  (uint32_t)  (pFromData)[7] << 4;

  /* Unpack Member: m_uData1 */
  (pToStruct)->m_uData1 =  (uint32_t)  (pFromData)[4] ;
  (pToStruct)->m_uData1 |=  (uint32_t)  (pFromData)[5] << 8;
  (pToStruct)->m_uData1 |=  (uint32_t)  ((pFromData)[6] & 0x0f) << 16;

  /* Unpack Member: m_uSpare0 */
  (pToStruct)->m_uSpare0 =  (uint32_t)  ((pFromData)[2] >> 4) & 0x0f;
  (pToStruct)->m_uSpare0 |=  (uint32_t)  (pFromData)[3] << 4;

  /* Unpack Member: m_uData0 */
  (pToStruct)->m_uData0 =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_uData0 |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->m_uData0 |=  (uint32_t)  ((pFromData)[2] & 0x0f) << 16;
