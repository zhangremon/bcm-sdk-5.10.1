/*
 * $Id: sbZfCaPtPte6PortStateEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPtPte6PortStateEntry_Pack(sbZfCaPtPte6PortStateEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPTPTE6PORTSTATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPTPTE6PORTSTATEENTRY_SIZE_IN_BYTES;
}
