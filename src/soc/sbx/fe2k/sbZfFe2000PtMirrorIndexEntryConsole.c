/*
 * $Id: sbZfFe2000PtMirrorIndexEntryConsole.c 1.3.36.3 Broadcom SDK $
...
sbZfFe2000PtMirrorIndexEntry_Print(sbZfFe2000PtMirrorIndexEntry_t *pFromStruct) {
  SB_LOG("Fe2000PtMirrorIndexEntry:: spare=0x%05x", (unsigned int)  pFromStruct->m_uSpare);
  SB_LOG(" overwritehdr=0x%01x", (unsigned int)  pFromStruct->m_uOverWriteHdr);
  SB_LOG(" highgighdr=0x%01x", (unsigned int)  pFromStruct->m_uHighGigHdr);
  SB_LOG("\n");

  SB_LOG("Fe2000PtMirrorIndexEntry:: dropsrcpkt=0x%01x", (unsigned int)  pFromStruct->m_uDropSrcPkt);
  SB_LOG(" hdrpresent=0x%01x", (unsigned int)  pFromStruct->m_uHdrPresent);
...
char *
sbZfFe2000PtMirrorIndexEntry_SPrint(sbZfFe2000PtMirrorIndexEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
