/*
 * $Id: sbZfCaPtPte4MirrorPortStateEntryConsole.c 1.1.48.3 Broadcom SDK $
...
sbZfCaPtPte4MirrorPortStateEntry_Print(sbZfCaPtPte4MirrorPortStateEntry_t *pFromStruct) {
  SB_LOG("CaPtPte4MirrorPortStateEntry:: hdrpresent=0x%01x", (unsigned int)  pFromStruct->m_uHdrPresent);
  SB_LOG(" pktlength=0x%04x", (unsigned int)  pFromStruct->m_uPktLength);
  SB_LOG("\n");

  SB_LOG("CaPtPte4MirrorPortStateEntry:: numpageshi=0x%01x", (unsigned int)  pFromStruct->m_uNumPagesHi);
  SB_LOG(" numpageslo=0x%01x", (unsigned int)  pFromStruct->m_uNumPagesLo);
  SB_LOG(" buffer=0x%03x", (unsigned int)  pFromStruct->m_uBuffer);
  SB_LOG("\n");

  SB_LOG("CaPtPte4MirrorPortStateEntry:: sourcequeue=0x%02x", (unsigned int)  pFromStruct->m_uSourceQueue);
...
char *
sbZfCaPtPte4MirrorPortStateEntry_SPrint(sbZfCaPtPte4MirrorPortStateEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
