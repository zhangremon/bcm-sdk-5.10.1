/*
 * $Id: sbZfCaPedDescriptor.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPedDescriptor_Pack(sbZfCaPedDescriptor_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPEDDESCRIPTOR_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPEDDESCRIPTOR_SIZE_IN_BYTES;
}
...
sbZfCaPedDescriptor_Unpack(sbZfCaPedDescriptor_t *pToStruct,
  ...
  (pToStruct)->m_uBuffer =  (uint32_t)  (pFromData)[166] ;
  (pToStruct)->m_uBuffer |=  (uint32_t)  ((pFromData)[167] & 0x1f) << 8;
