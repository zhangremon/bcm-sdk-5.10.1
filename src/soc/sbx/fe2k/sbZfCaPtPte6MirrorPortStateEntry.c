/*
 * $Id: sbZfCaPtPte6MirrorPortStateEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPtPte6MirrorPortStateEntry_Pack(sbZfCaPtPte6MirrorPortStateEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPTPTE6MIRRORPORTSTATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPTPTE6MIRRORPORTSTATEENTRY_SIZE_IN_BYTES;
}
