/*
 * $Id: sbZfCaPtPte3PortStateEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPtPte3PortStateEntry_Pack(sbZfCaPtPte3PortStateEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPTPTE3PORTSTATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPTPTE3PORTSTATEENTRY_SIZE_IN_BYTES;
}
