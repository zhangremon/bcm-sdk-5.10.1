/*
 * $Id: sbZfCaUcodeAccessDescriptorConsole.c 1.1.48.3 Broadcom SDK $
...
#include "sbZfCaUcodeAccessDescriptorConsole.hx"



/* Print members in struct */
void
sbZfCaUcodeAccessDescriptor_Print(sbZfCaUcodeAccessDescriptor_t *pFromStruct) {
  SB_LOG("CaUcodeAccessDescriptor:: rwn=0x%01x", (unsigned int)  pFromStruct->m_nRWN);
...
char *
sbZfCaUcodeAccessDescriptor_SPrint(sbZfCaUcodeAccessDescriptor_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaUcodeAccessDescriptor:: rwn=0x%01x", (unsigned int)  pFromStruct->m_nRWN);
...
int
sbZfCaUcodeAccessDescriptor_Validate(sbZfCaUcodeAccessDescriptor_t *pZf) {
...
int
sbZfCaUcodeAccessDescriptor_SetField(sbZfCaUcodeAccessDescriptor_t *s, char* name, int value) {
