/*
 * $Id: sbZfCaPpCamConfigurationEntryConsole.c 1.1.48.3 Broadcom SDK $
...
sbZfCaPpCamConfigurationEntry_Print(sbZfCaPpCamConfigurationEntry_t *pFromStruct) {
  SB_LOG("CaPpCamConfigurationEntry:: spare0=0x%02x", (unsigned int)  pFromStruct->m_uSpare0);
  SB_LOG(" mask5=0x%06x", (unsigned int)  pFromStruct->m_uMask5);
  SB_LOG(" mask4=0x%08x", (unsigned int)  pFromStruct->m_uMask4);
  SB_LOG("\n");

  SB_LOG("CaPpCamConfigurationEntry:: mask3=0x%08x", (unsigned int)  pFromStruct->m_uMask3);
  SB_LOG(" mask2=0x%08x", (unsigned int)  pFromStruct->m_uMask2);
  SB_LOG("\n");

  SB_LOG("CaPpCamConfigurationEntry:: mask1=0x%08x", (unsigned int)  pFromStruct->m_uMask1);
  SB_LOG(" mask0=0x%08x", (unsigned int)  pFromStruct->m_uMask0);
  SB_LOG(" spare1=0x%02x", (unsigned int)  pFromStruct->m_uSpare1);
  SB_LOG("\n");

  SB_LOG("CaPpCamConfigurationEntry:: valid=0x%01x", (unsigned int)  pFromStruct->m_uValid);
  SB_LOG(" data5=0x%06x", (unsigned int)  pFromStruct->m_uData5);
  SB_LOG(" data4=0x%08x", (unsigned int)  pFromStruct->m_uData4);
  SB_LOG("\n");

  SB_LOG("CaPpCamConfigurationEntry:: data3=0x%08x", (unsigned int)  pFromStruct->m_uData3);
  SB_LOG(" data2=0x%08x", (unsigned int)  pFromStruct->m_uData2);
  SB_LOG("\n");

  SB_LOG("CaPpCamConfigurationEntry:: data1=0x%08x", (unsigned int)  pFromStruct->m_uData1);
...
char *
sbZfCaPpCamConfigurationEntry_SPrint(sbZfCaPpCamConfigurationEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
