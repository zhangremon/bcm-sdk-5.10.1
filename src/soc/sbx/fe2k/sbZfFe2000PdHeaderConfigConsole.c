/*
 * $Id: sbZfFe2000PdHeaderConfigConsole.c 1.3.36.3 Broadcom SDK $
...
sbZfFe2000PdHeaderConfig_Print(sbZfFe2000PdHeaderConfig_t *pFromStruct) {
  SB_LOG("Fe2000PdHeaderConfig:: spare0=0x%02x", (unsigned int)  pFromStruct->m_uSpare0);
  ...
  SB_LOG("Fe2000PdHeaderConfig:: spare2=0x%01x", (unsigned int)  pFromStruct->m_uSpare2);
...
char *
sbZfFe2000PdHeaderConfig_SPrint(sbZfFe2000PdHeaderConfig_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
