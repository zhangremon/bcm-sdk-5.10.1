/*
 * $Id: sbZfCaMmInternal0MemoryEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaMmInternal0MemoryEntry_Pack(sbZfCaMmInternal0MemoryEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAMMINTERNAL0MEMORYENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAMMINTERNAL0MEMORYENTRY_SIZE_IN_BYTES;
}
