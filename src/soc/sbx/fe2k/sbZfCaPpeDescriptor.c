/*
 * $Id: sbZfCaPpeDescriptor.c 1.1.48.4 Broadcom SDK $
...
#include "sbTypes.h"
#include "sbZfCaPpeDescriptor.hx"
...
sbZfCaPpeDescriptor_Pack(sbZfCaPpeDescriptor_t *pFrom,
  ...
  int i;
  int size = SB_ZF_ZFCAPPEDESCRIPTOR_SIZE_IN_BYTES;
  ...
  return SB_ZF_ZFCAPPEDESCRIPTOR_SIZE_IN_BYTES;
}
...
sbZfCaPpeDescriptor_Unpack(sbZfCaPpeDescriptor_t *pToStruct,
  ...
  (pToStruct)->m_uBuffer =  (uint32_t)  ((pFromData)[175] >> 3) & 0x03;
