/*
 * $Id: sbZfCaLrLrpInstructionMemoryEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaLrLrpInstructionMemoryEntry_Pack(sbZfCaLrLrpInstructionMemoryEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CALRLRPINSTRUCTIONMEMORYENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CALRLRPINSTRUCTIONMEMORYENTRY_SIZE_IN_BYTES;
}
