/*
 * $Id: sbZfCaPdPdOutputHeaderCopyBufferEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPdPdOutputHeaderCopyBufferEntry_Pack(sbZfCaPdPdOutputHeaderCopyBufferEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPDPDOUTPUTHEADERCOPYBUFFERENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPDPDOUTPUTHEADERCOPYBUFFERENTRY_SIZE_IN_BYTES;
}
