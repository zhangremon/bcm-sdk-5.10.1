/*
 * $Id: sbZfCaPtPte3MirrorPortStateEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPtPte3MirrorPortStateEntry_Pack(sbZfCaPtPte3MirrorPortStateEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPTPTE3MIRRORPORTSTATEENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPTPTE3MIRRORPORTSTATEENTRY_SIZE_IN_BYTES;
}
