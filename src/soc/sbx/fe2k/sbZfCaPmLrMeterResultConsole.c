/*
 * $Id: sbZfCaPmLrMeterResultConsole.c 1.1.48.3 Broadcom SDK $
...
#include "sbZfCaPmLrMeterResultConsole.hx"
...
sbZfCaPmLrMeterResult_Print(sbZfCaPmLrMeterResult_t *pFromStruct) {
  SB_LOG("CaPmLrMeterResult:: drp=0x%01x", (unsigned int)  pFromStruct->m_uDrop);
  ...
  SB_LOG("CaPmLrMeterResult:: pmdp=0x%01x", (unsigned int)  pFromStruct->m_uPmuDp);
...
char *
sbZfCaPmLrMeterResult_SPrint(sbZfCaPmLrMeterResult_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPmLrMeterResult:: drp=0x%01x", (unsigned int)  pFromStruct->m_uDrop);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPmLrMeterResult:: pmdp=0x%01x", (unsigned int)  pFromStruct->m_uPmuDp);
