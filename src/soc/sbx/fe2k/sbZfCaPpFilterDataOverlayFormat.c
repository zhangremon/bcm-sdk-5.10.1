/*
 * $Id: sbZfCaPpFilterDataOverlayFormat.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPpFilterDataOverlayFormat_Pack(sbZfCaPpFilterDataOverlayFormat_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPPFILTERDATAOVERLAYFORMAT_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPPFILTERDATAOVERLAYFORMAT_SIZE_IN_BYTES;
}
