/*
 * $Id: sbZfCaPbDataEntryConsole.c 1.1.48.3 Broadcom SDK $
...
#include "sbZfCaPbDataEntryConsole.hx"
...
char *
sbZfCaPbDataEntry_SPrint(sbZfCaPbDataEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbDataEntry:: data23=0x%08x", (unsigned int)  pFromStruct->m_uData23);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbDataEntry:: data20=0x%08x", (unsigned int)  pFromStruct->m_uData20);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbDataEntry:: data17=0x%08x", (unsigned int)  pFromStruct->m_uData17);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbDataEntry:: data14=0x%08x", (unsigned int)  pFromStruct->m_uData14);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbDataEntry:: data11=0x%08x", (unsigned int)  pFromStruct->m_uData11);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbDataEntry:: data8=0x%08x", (unsigned int)  pFromStruct->m_uData8);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbDataEntry:: data5=0x%08x", (unsigned int)  pFromStruct->m_uData5);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPbDataEntry:: data2=0x%08x", (unsigned int)  pFromStruct->m_uData2);
