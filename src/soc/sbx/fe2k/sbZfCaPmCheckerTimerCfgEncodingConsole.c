/*
 * $Id: sbZfCaPmCheckerTimerCfgEncodingConsole.c 1.1.48.3 Broadcom SDK $
...
#include "sbZfCaPmCheckerTimerCfgEncodingConsole.hx"



/* Print members in struct */
void
sbZfCaPmCheckerTimerCfgEncoding_Print(sbZfCaPmCheckerTimerCfgEncoding_t *pFromStruct) {
  SB_LOG("CaPmCheckerTimerCfgEncoding:: type=0x%01x", (unsigned int)  pFromStruct->m_uType);
  ...
  SB_LOG("CaPmCheckerTimerCfgEncoding:: mode32=0x%01x", (unsigned int)  pFromStruct->m_uMode32);
...
char *
sbZfCaPmCheckerTimerCfgEncoding_SPrint(sbZfCaPmCheckerTimerCfgEncoding_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;

  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPmCheckerTimerCfgEncoding:: type=0x%01x", (unsigned int)  pFromStruct->m_uType);
  ...
  WrCnt += SB_SPRINTF(&pcToString[WrCnt],"CaPmCheckerTimerCfgEncoding:: mode32=0x%01x", (unsigned int)  pFromStruct->m_uMode32);
...
int
sbZfCaPmCheckerTimerCfgEncoding_Validate(sbZfCaPmCheckerTimerCfgEncoding_t *pZf) {
...
int
sbZfCaPmCheckerTimerCfgEncoding_SetField(sbZfCaPmCheckerTimerCfgEncoding_t *s, char* name, int value) {
