/*
 * $Id: sbZfCaQmBufferState1NonHeaderEntry.c 1.1.48.4 Broadcom SDK $
...
sbZfCaQmBufferState1NonHeaderEntry_Pack(sbZfCaQmBufferState1NonHeaderEntry_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAQMBUFFERSTATE1NONHEADERENTRY_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAQMBUFFERSTATE1NONHEADERENTRY_SIZE_IN_BYTES;
}
