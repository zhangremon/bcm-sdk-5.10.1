/*
 * $Id: sbZfCaPpRxPortDataPpDescriptorFormat.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPpRxPortDataPpDescriptorFormat_Pack(sbZfCaPpRxPortDataPpDescriptorFormat_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPPRXPORTDATAPPDESCRIPTORFORMAT_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPPRXPORTDATAPPDESCRIPTORFORMAT_SIZE_IN_BYTES;
}
