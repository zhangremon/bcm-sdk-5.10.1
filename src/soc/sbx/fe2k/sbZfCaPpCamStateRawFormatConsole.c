/*
 * $Id: sbZfCaPpCamStateRawFormatConsole.c 1.1.48.3 Broadcom SDK $
...
sbZfCaPpCamStateRawFormat_Print(sbZfCaPpCamStateRawFormat_t *pFromStruct) {
  SB_LOG("CaPpCamStateRawFormat:: resv0=0x%02x", (unsigned int)  pFromStruct->m_uResv0);
  SB_LOG(" state=0x%04x", (unsigned int)  pFromStruct->m_uUnmodifiedState);
  SB_LOG(" pbits4=0x%01x", (unsigned int)  pFromStruct->m_uPropBits4);
  SB_LOG(" pbits3=0x%01x", (unsigned int)  pFromStruct->m_uPropBits3);
  SB_LOG("\n");

  SB_LOG("CaPpCamStateRawFormat:: pbits2=0x%01x", (unsigned int)  pFromStruct->m_uPropBits2);
  SB_LOG(" pbits1=0x%01x", (unsigned int)  pFromStruct->m_uPropBits1);
...
char *
sbZfCaPpCamStateRawFormat_SPrint(sbZfCaPpCamStateRawFormat_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
