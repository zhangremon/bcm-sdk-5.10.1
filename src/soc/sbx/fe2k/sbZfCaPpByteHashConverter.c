/*
 * $Id: sbZfCaPpByteHashConverter.c 1.1.48.4 Broadcom SDK $
...
sbZfCaPpByteHashConverter_Pack(sbZfCaPpByteHashConverter_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAPPBYTEHASHCONVERTER_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAPPBYTEHASHCONVERTER_SIZE_IN_BYTES;
}
