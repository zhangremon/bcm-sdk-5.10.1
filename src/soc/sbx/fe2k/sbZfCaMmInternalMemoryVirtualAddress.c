/*
 * $Id: sbZfCaMmInternalMemoryVirtualAddress.c 1.1.48.4 Broadcom SDK $
...
sbZfCaMmInternalMemoryVirtualAddress_Pack(sbZfCaMmInternalMemoryVirtualAddress_t *pFrom,
  ...
  int i;
  int size = SB_ZF_CAMMINTERNALMEMORYVIRTUALADDRESS_SIZE_IN_BYTES;
  ...
  return SB_ZF_CAMMINTERNALMEMORYVIRTUALADDRESS_SIZE_IN_BYTES;
}
