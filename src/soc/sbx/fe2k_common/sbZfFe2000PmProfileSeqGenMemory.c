/*
 * $Id: sbZfFe2000PmProfileSeqGenMemory.c 1.1.34.4 Broadcom SDK $
...
sbZfFe2000PmProfileSeqGenMemory_Pack(sbZfFe2000PmProfileSeqGenMemory_t *pFrom,
  ...
  int i;
  int size = SB_ZF_FE_2000_PM_PROFSEQGENMEMORY_SIZE_IN_BYTES;
  ...
  return SB_ZF_FE_2000_PM_PROFSEQGENMEMORY_SIZE_IN_BYTES;
}
...
uint32_t sbZfFe2000PmProfileSeqGenMemory_Pack32( sbZfFe2000PmProfileSeqGenMemory_t *pFrom, 
                                               ...
                                               uint32_t nMaxToDataIndex)
{
  uint8_t uBuffer[SB_ZF_FE_2000_PM_PROFSEQGENMEMORY_SIZE_IN_WORDS*4];
  uint32_t uIndex =0;
  uint32_t *pBuffer = NULL;
  uint32_t uNumberOfWords = SB_ZF_FE_2000_PM_PROFSEQGENMEMORY_SIZE_IN_WORDS;
  sbZfFe2000PmProfileSeqGenMemory_Pack(pFrom , &uBuffer[0], SB_ZF_FE_2000_PM_PROFSEQGENMEMORY_SIZE_IN_BYTES);
