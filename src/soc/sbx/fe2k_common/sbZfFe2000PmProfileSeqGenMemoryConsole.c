/*
 * $Id: sbZfFe2000PmProfileSeqGenMemoryConsole.c 1.1.34.3 Broadcom SDK $
...
sbZfFe2000PmProfileSeqGenMemory_Print(sbZfFe2000PmProfileSeqGenMemory_t *pFromStruct) {
  SB_LOG("Fe2000PmProfileSeqGenMemory:: resv0=0x%01x", (unsigned int)  pFromStruct->uResv0);
  SB_LOG(" type=0x%01x", (unsigned int)  pFromStruct->uType);
  SB_LOG(" profmode=0x%01x", (unsigned int)  pFromStruct->uProfMode);
  SB_LOG("\n");

  SB_LOG("Fe2000PmProfileSeqGenMemory:: resv1=0x%07x", (unsigned int)  pFromStruct->uResv1);
...
char *
sbZfFe2000PmProfileSeqGenMemory_SPrint(sbZfFe2000PmProfileSeqGenMemory_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
