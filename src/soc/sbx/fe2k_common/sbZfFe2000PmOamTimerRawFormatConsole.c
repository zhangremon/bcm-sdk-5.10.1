/*
 * $Id: sbZfFe2000PmOamTimerRawFormatConsole.c 1.1.34.3 Broadcom SDK $
...
sbZfFe2000PmOamTimerRawFormat_Print(sbZfFe2000PmOamTimerRawFormat_t *pFromStruct) {
  SB_LOG("Fe2000PmOamTimerRawFormat:: profid=0x%03x", (unsigned int)  pFromStruct->uProfileId);
  SB_LOG(" started=0x%01x", (unsigned int)  pFromStruct->uStarted);
  SB_LOG(" time=0x%05x", (unsigned int)  pFromStruct->uTime);
  SB_LOG("\n");

  SB_LOG("Fe2000PmOamTimerRawFormat:: rsvd=0x%08x", (unsigned int)  pFromStruct->uRsvd);
  SB_LOG("\n");
...
char *
sbZfFe2000PmOamTimerRawFormat_SPrint(sbZfFe2000PmOamTimerRawFormat_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
