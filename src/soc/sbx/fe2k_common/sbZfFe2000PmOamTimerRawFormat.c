/*
 * $Id: sbZfFe2000PmOamTimerRawFormat.c 1.1.34.4 Broadcom SDK $
...
sbZfFe2000PmOamTimerRawFormat_Unpack(sbZfFe2000PmOamTimerRawFormat_t *pToStruct,
  ...
  (pToStruct)->uStarted =  (uint32_t)  ((pFromData)[6] >> 4) & 0x01;

  /* Unpack Member: uTime */
  (pToStruct)->uTime =  (uint32_t)  (pFromData)[4] ;
  (pToStruct)->uTime |=  (uint32_t)  (pFromData)[5] << 8;
  (pToStruct)->uTime |=  (uint32_t)  ((pFromData)[6] & 0x0f) << 16;

  /* Unpack Member: uRsvd */
  (pToStruct)->uRsvd =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->uRsvd |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->uRsvd |=  (uint32_t)  (pFromData)[2] << 16;
  (pToStruct)->uRsvd |=  (uint32_t)  (pFromData)[3] << 24;
