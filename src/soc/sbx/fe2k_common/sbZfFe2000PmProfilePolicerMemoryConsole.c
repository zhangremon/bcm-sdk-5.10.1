/*
 * $Id: sbZfFe2000PmProfilePolicerMemoryConsole.c 1.1.34.3 Broadcom SDK $
...
sbZfFe2000PmProfilePolicerMemory_Print(sbZfFe2000PmProfilePolicerMemory_t *pFromStruct) {
  SB_LOG("Fe2000PmProfilePolicerMemory:: resv0=0x%01x", (unsigned int)  pFromStruct->uResv0);
  ...
  SB_LOG("Fe2000PmProfilePolicerMemory:: bcnodcr=0x%01x", (unsigned int)  pFromStruct->bBktCNoDecrement);
  SB_LOG(" lenshift=0x%01x", (unsigned int)  pFromStruct->uLengthShift);
  SB_LOG(" eir=0x%03x", (unsigned int)  pFromStruct->uEIR);
  SB_LOG(" cir=0x%03x", (unsigned int)  pFromStruct->uCIR);
  SB_LOG("\n");

  SB_LOG("Fe2000PmProfilePolicerMemory:: cflag=0x%01x", (unsigned int)  pFromStruct->bCouplingFlag);
  SB_LOG(" r2698=0x%01x", (unsigned int)  pFromStruct->bRFC2698Mode);
  SB_LOG(" blind=0x%01x", (unsigned int)  pFromStruct->bBlind);
  SB_LOG(" bcsize=0x%02x", (unsigned int)  pFromStruct->uBktCSize);
  SB_LOG("\n");

  SB_LOG("Fe2000PmProfilePolicerMemory:: ebs=0x%03x", (unsigned int)  pFromStruct->uEBS);
  SB_LOG(" cbs=0x%03x", (unsigned int)  pFromStruct->uCBS);
  SB_LOG("\n");
...
char *
sbZfFe2000PmProfilePolicerMemory_SPrint(sbZfFe2000PmProfilePolicerMemory_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
