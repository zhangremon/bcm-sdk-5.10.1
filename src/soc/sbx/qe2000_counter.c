/* 
 * $Id: qe2000_counter.c 1.5 Broadcom SDK $
                            ...
                            uint64 *val, int *width)
{
    ...
    SOC_DEBUG_PRINT((DK_VERBOSE + DK_COUNTER, "_soc_qe2000_counter_qm_read set %d cntr %d enb %d\n",
    ...
    if (SOC_FAILURE(rv)) {
        SOC_DEBUG_PRINT((DK_ERR, "qe2000 counter read failure\n"));
        return rv;
    }
