...
/*
 * $Id: bm9600.c 1.26.4.3 Broadcom SDK $
 *
...
#define BM9600_LOG_ERROR(format, args...) printf(format, ##args)
...
soc_bm9600_NmMemoryCacheAllocate(int unit)
{
    ...
    /* TODO: Later revisions of polaris will not require this fix */
