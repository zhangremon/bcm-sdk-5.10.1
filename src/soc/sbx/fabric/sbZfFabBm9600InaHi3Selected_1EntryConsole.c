/*
 * $Id: sbZfFabBm9600InaHi3Selected_1EntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600InaHi3Selected_1Entry_Print(sbZfFabBm9600InaHi3Selected_1Entry_t *pFromStruct) {
  SB_LOG("FabBm9600InaHi3Selected_1Entry:: pri=0x%01x", (unsigned int)  pFromStruct->m_uPri);
  SB_LOG(" portsetaddr=0x%02x", (unsigned int)  pFromStruct->m_uPortsetAddr);
  SB_LOG(" offset=0x%01x", (unsigned int)  pFromStruct->m_uOffset);
  SB_LOG("\n");

  SB_LOG("FabBm9600InaHi3Selected_1Entry:: sysport=0x%03x", (unsigned int)  pFromStruct->m_uSysport);
  SB_LOG("\n");
