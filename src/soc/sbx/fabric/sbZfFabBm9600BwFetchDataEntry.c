/*
 * $Id: sbZfFabBm9600BwFetchDataEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfFabBm9600BwFetchDataEntry_Unpack(sbZfFabBm9600BwFetchDataEntry_t *pToStruct,
  ...
  (pToStruct)->m_uData =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_uData |=  (uint32_t)  (pFromData)[2] << 8;
  (pToStruct)->m_uData |=  (uint32_t)  (pFromData)[1] << 16;
  (pToStruct)->m_uData |=  (uint32_t)  (pFromData)[0] << 24;
#else
