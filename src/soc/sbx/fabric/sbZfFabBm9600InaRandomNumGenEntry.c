/*
 * $Id: sbZfFabBm9600InaRandomNumGenEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfFabBm9600InaRandomNumGenEntry_Unpack(sbZfFabBm9600InaRandomNumGenEntry_t *pToStruct,
  ...
  (pToStruct)->m_uSeed =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_uSeed |=  (uint32_t)  (pFromData)[2] << 8;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_uSeed */
  (pToStruct)->m_uSeed =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_uSeed |=  (uint32_t)  (pFromData)[1] << 8;
#endif
