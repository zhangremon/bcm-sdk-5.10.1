/*
 * $Id: sbZfFabBm3200BwLthrEntry.c 1.2.28.4 Broadcom SDK $
...
sbZfFabBm3200BwLthrEntry_Unpack(sbZfFabBm3200BwLthrEntry_t *pToStruct,
  ...
  (pToStruct)->m_nLengthThresh =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_nLengthThresh |=  (uint32_t)  (pFromData)[2] << 8;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_nLengthThresh */
  (pToStruct)->m_nLengthThresh =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_nLengthThresh |=  (uint32_t)  (pFromData)[1] << 8;
#endif
...
/*
 * $Id: sbZfFabBm3200BwLthrEntry.c,v 1.2.28.4 2011/05/22 05:39:14 iakramov Exp $
 * $Copyright: Copyright 2011 Broadcom Corporation.
 * This program is the proprietary software of Broadcom Corporation
 * and/or its licensors, and may only be used, duplicated, modified
 * or distributed pursuant to the terms and conditions of a separate,
...
sbZfFabBm3200BwLthrEntry_Print(sbZfFabBm3200BwLthrEntry_t *pFromStruct) {
  SB_LOG("FabBm3200BwLthrEntry:: lengththresh=0x%04x", (unsigned int)  pFromStruct->m_nLengthThresh);
  SB_LOG("\n");
...
int
sbZfFabBm3200BwLthrEntry_SPrint(sbZfFabBm3200BwLthrEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
