/*
 * $Id: sbZfFabBm9600BwR1Wct0AEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfFabBm9600BwR1Wct0AEntry_Unpack(sbZfFabBm9600BwR1Wct0AEntry_t *pToStruct,
  ...
  (pToStruct)->m_uTMinDp0 =  (uint32_t)  (pFromData)[1] ;
  (pToStruct)->m_uTMinDp0 |=  (uint32_t)  (pFromData)[0] << 8;

  /* Unpack Member: m_uTMaxDp0 */
  (pToStruct)->m_uTMaxDp0 =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_uTMaxDp0 |=  (uint32_t)  (pFromData)[2] << 8;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_uTMinDp0 */
  (pToStruct)->m_uTMinDp0 =  (uint32_t)  (pFromData)[2] ;
  (pToStruct)->m_uTMinDp0 |=  (uint32_t)  (pFromData)[3] << 8;

  /* Unpack Member: m_uTMaxDp0 */
  (pToStruct)->m_uTMaxDp0 =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_uTMaxDp0 |=  (uint32_t)  (pFromData)[1] << 8;
#endif
