/*
 * $Id: sbZfFabBm9600BwR0WdtEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwR0WdtEntry_Print(sbZfFabBm9600BwR0WdtEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwR0WdtEntry:: template1=0x%02x", (unsigned int)  pFromStruct->m_uTemplate1);
  SB_LOG(" spare1=0x%01x", (unsigned int)  pFromStruct->m_uSpare1);
  SB_LOG(" gain1=0x%01x", (unsigned int)  pFromStruct->m_uGain1);
  SB_LOG(" template0=0x%02x", (unsigned int)  pFromStruct->m_uTemplate0);
  SB_LOG("\n");

  SB_LOG("FabBm9600BwR0WdtEntry:: spare0=0x%01x", (unsigned int)  pFromStruct->m_uSpare0);
  SB_LOG(" gain0=0x%01x", (unsigned int)  pFromStruct->m_uGain0);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwR0WdtEntry_SPrint(sbZfFabBm9600BwR0WdtEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
