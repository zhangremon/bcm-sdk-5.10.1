/*
 * $Id: sbZfFabBm9600NmEgressRankerEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600NmEgressRankerEntry_Print(sbZfFabBm9600NmEgressRankerEntry_t *pFromStruct) {
  SB_LOG("FabBm9600NmEgressRankerEntry:: seed=0x%02x", (unsigned int)  pFromStruct->m_uSeed);
  SB_LOG("\n");
...
char *
sbZfFabBm9600NmEgressRankerEntry_SPrint(sbZfFabBm9600NmEgressRankerEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
