/*
 * $Id: sbZfFabBm9600NmRandomNumGenEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600NmRandomNumGenEntry_Print(sbZfFabBm9600NmRandomNumGenEntry_t *pFromStruct) {
  SB_LOG("FabBm9600NmRandomNumGenEntry:: seed=0x%02x", (unsigned int)  pFromStruct->m_uSeed);
  SB_LOG("\n");
...
char *
sbZfFabBm9600NmRandomNumGenEntry_SPrint(sbZfFabBm9600NmRandomNumGenEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
