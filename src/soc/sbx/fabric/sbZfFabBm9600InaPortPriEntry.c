/*
 * $Id: sbZfFabBm9600InaPortPriEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfFabBm9600InaPortPriEntry_Unpack(sbZfFabBm9600InaPortPriEntry_t *pToStruct,
  ...
  (pToStruct)->m_uPri_15 =  (uint32_t)  ((pFromData)[12] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_15 */
  (pToStruct)->m_uNextpri_15 =  (uint32_t)  ((pFromData)[12] ) & 0x0f;

  /* Unpack Member: m_uPri_14 */
  (pToStruct)->m_uPri_14 =  (uint32_t)  ((pFromData)[13] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_14 */
  (pToStruct)->m_uNextpri_14 =  (uint32_t)  ((pFromData)[13] ) & 0x0f;

  /* Unpack Member: m_uPri_13 */
  (pToStruct)->m_uPri_13 =  (uint32_t)  ((pFromData)[14] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_13 */
  (pToStruct)->m_uNextpri_13 =  (uint32_t)  ((pFromData)[14] ) & 0x0f;

  /* Unpack Member: m_uPri_12 */
  (pToStruct)->m_uPri_12 =  (uint32_t)  ((pFromData)[15] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_12 */
  (pToStruct)->m_uNextpri_12 =  (uint32_t)  ((pFromData)[15] ) & 0x0f;

  /* Unpack Member: m_uPri_11 */
  (pToStruct)->m_uPri_11 =  (uint32_t)  ((pFromData)[8] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_11 */
  (pToStruct)->m_uNextpri_11 =  (uint32_t)  ((pFromData)[8] ) & 0x0f;

  /* Unpack Member: m_uPri_10 */
  (pToStruct)->m_uPri_10 =  (uint32_t)  ((pFromData)[9] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_10 */
  (pToStruct)->m_uNextpri_10 =  (uint32_t)  ((pFromData)[9] ) & 0x0f;

  /* Unpack Member: m_uPri_9 */
  (pToStruct)->m_uPri_9 =  (uint32_t)  ((pFromData)[10] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_9 */
  (pToStruct)->m_uNextpri_9 =  (uint32_t)  ((pFromData)[10] ) & 0x0f;

  /* Unpack Member: m_uPri_8 */
  (pToStruct)->m_uPri_8 =  (uint32_t)  ((pFromData)[11] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_8 */
  (pToStruct)->m_uNextpri_8 =  (uint32_t)  ((pFromData)[11] ) & 0x0f;

  /* Unpack Member: m_uPri_7 */
  (pToStruct)->m_uPri_7 =  (uint32_t)  ((pFromData)[4] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_7 */
  (pToStruct)->m_uNextpri_7 =  (uint32_t)  ((pFromData)[4] ) & 0x0f;

  /* Unpack Member: m_uPri_6 */
  (pToStruct)->m_uPri_6 =  (uint32_t)  ((pFromData)[5] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_6 */
  (pToStruct)->m_uNextpri_6 =  (uint32_t)  ((pFromData)[5] ) & 0x0f;

  /* Unpack Member: m_uPri_5 */
  (pToStruct)->m_uPri_5 =  (uint32_t)  ((pFromData)[6] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_5 */
  (pToStruct)->m_uNextpri_5 =  (uint32_t)  ((pFromData)[6] ) & 0x0f;

  /* Unpack Member: m_uPri_4 */
  (pToStruct)->m_uPri_4 =  (uint32_t)  ((pFromData)[7] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_4 */
  (pToStruct)->m_uNextpri_4 =  (uint32_t)  ((pFromData)[7] ) & 0x0f;

  /* Unpack Member: m_uPri_3 */
  (pToStruct)->m_uPri_3 =  (uint32_t)  ((pFromData)[0] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_3 */
  (pToStruct)->m_uNextpri_3 =  (uint32_t)  ((pFromData)[0] ) & 0x0f;

  /* Unpack Member: m_uPri_2 */
  (pToStruct)->m_uPri_2 =  (uint32_t)  ((pFromData)[1] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_2 */
  (pToStruct)->m_uNextpri_2 =  (uint32_t)  ((pFromData)[1] ) & 0x0f;

  /* Unpack Member: m_uPri_1 */
  (pToStruct)->m_uPri_1 =  (uint32_t)  ((pFromData)[2] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_1 */
  (pToStruct)->m_uNextpri_1 =  (uint32_t)  ((pFromData)[2] ) & 0x0f;

  /* Unpack Member: m_uPri_0 */
  (pToStruct)->m_uPri_0 =  (uint32_t)  ((pFromData)[3] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_0 */
  (pToStruct)->m_uNextpri_0 =  (uint32_t)  ((pFromData)[3] ) & 0x0f;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_uPri_15 */
  (pToStruct)->m_uPri_15 =  (uint32_t)  ((pFromData)[15] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_15 */
  (pToStruct)->m_uNextpri_15 =  (uint32_t)  ((pFromData)[15] ) & 0x0f;

  /* Unpack Member: m_uPri_14 */
  (pToStruct)->m_uPri_14 =  (uint32_t)  ((pFromData)[14] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_14 */
  (pToStruct)->m_uNextpri_14 =  (uint32_t)  ((pFromData)[14] ) & 0x0f;

  /* Unpack Member: m_uPri_13 */
  (pToStruct)->m_uPri_13 =  (uint32_t)  ((pFromData)[13] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_13 */
  (pToStruct)->m_uNextpri_13 =  (uint32_t)  ((pFromData)[13] ) & 0x0f;

  /* Unpack Member: m_uPri_12 */
  (pToStruct)->m_uPri_12 =  (uint32_t)  ((pFromData)[12] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_12 */
  (pToStruct)->m_uNextpri_12 =  (uint32_t)  ((pFromData)[12] ) & 0x0f;

  /* Unpack Member: m_uPri_11 */
  (pToStruct)->m_uPri_11 =  (uint32_t)  ((pFromData)[11] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_11 */
  (pToStruct)->m_uNextpri_11 =  (uint32_t)  ((pFromData)[11] ) & 0x0f;

  /* Unpack Member: m_uPri_10 */
  (pToStruct)->m_uPri_10 =  (uint32_t)  ((pFromData)[10] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_10 */
  (pToStruct)->m_uNextpri_10 =  (uint32_t)  ((pFromData)[10] ) & 0x0f;

  /* Unpack Member: m_uPri_9 */
  (pToStruct)->m_uPri_9 =  (uint32_t)  ((pFromData)[9] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_9 */
  (pToStruct)->m_uNextpri_9 =  (uint32_t)  ((pFromData)[9] ) & 0x0f;

  /* Unpack Member: m_uPri_8 */
  (pToStruct)->m_uPri_8 =  (uint32_t)  ((pFromData)[8] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_8 */
  (pToStruct)->m_uNextpri_8 =  (uint32_t)  ((pFromData)[8] ) & 0x0f;

  /* Unpack Member: m_uPri_7 */
  (pToStruct)->m_uPri_7 =  (uint32_t)  ((pFromData)[7] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_7 */
  (pToStruct)->m_uNextpri_7 =  (uint32_t)  ((pFromData)[7] ) & 0x0f;

  /* Unpack Member: m_uPri_6 */
  (pToStruct)->m_uPri_6 =  (uint32_t)  ((pFromData)[6] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_6 */
  (pToStruct)->m_uNextpri_6 =  (uint32_t)  ((pFromData)[6] ) & 0x0f;

  /* Unpack Member: m_uPri_5 */
  (pToStruct)->m_uPri_5 =  (uint32_t)  ((pFromData)[5] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_5 */
  (pToStruct)->m_uNextpri_5 =  (uint32_t)  ((pFromData)[5] ) & 0x0f;

  /* Unpack Member: m_uPri_4 */
  (pToStruct)->m_uPri_4 =  (uint32_t)  ((pFromData)[4] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_4 */
  (pToStruct)->m_uNextpri_4 =  (uint32_t)  ((pFromData)[4] ) & 0x0f;

  /* Unpack Member: m_uPri_3 */
  (pToStruct)->m_uPri_3 =  (uint32_t)  ((pFromData)[3] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_3 */
  (pToStruct)->m_uNextpri_3 =  (uint32_t)  ((pFromData)[3] ) & 0x0f;

  /* Unpack Member: m_uPri_2 */
  (pToStruct)->m_uPri_2 =  (uint32_t)  ((pFromData)[2] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_2 */
  (pToStruct)->m_uNextpri_2 =  (uint32_t)  ((pFromData)[2] ) & 0x0f;

  /* Unpack Member: m_uPri_1 */
  (pToStruct)->m_uPri_1 =  (uint32_t)  ((pFromData)[1] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_1 */
  (pToStruct)->m_uNextpri_1 =  (uint32_t)  ((pFromData)[1] ) & 0x0f;

  /* Unpack Member: m_uPri_0 */
  (pToStruct)->m_uPri_0 =  (uint32_t)  ((pFromData)[0] >> 4) & 0x0f;

  /* Unpack Member: m_uNextpri_0 */
  (pToStruct)->m_uNextpri_0 =  (uint32_t)  ((pFromData)[0] ) & 0x0f;
#endif
