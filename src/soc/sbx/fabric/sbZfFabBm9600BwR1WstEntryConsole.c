/*
 * $Id: sbZfFabBm9600BwR1WstEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwR1WstEntry_Print(sbZfFabBm9600BwR1WstEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwR1WstEntry:: average=0x%08x", (unsigned int)  pFromStruct->m_uAverage);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwR1WstEntry_SPrint(sbZfFabBm9600BwR1WstEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
