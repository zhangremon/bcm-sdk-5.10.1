/*
 * $Id: sbZfFabBm9600InaRandomNumGenEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600InaRandomNumGenEntry_Print(sbZfFabBm9600InaRandomNumGenEntry_t *pFromStruct) {
  SB_LOG("FabBm9600InaRandomNumGenEntry:: seed=0x%04x", (unsigned int)  pFromStruct->m_uSeed);
  SB_LOG("\n");
...
char *
sbZfFabBm9600InaRandomNumGenEntry_SPrint(sbZfFabBm9600InaRandomNumGenEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
