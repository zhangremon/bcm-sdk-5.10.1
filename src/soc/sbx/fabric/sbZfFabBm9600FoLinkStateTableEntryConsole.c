/*
 * $Id: sbZfFabBm9600FoLinkStateTableEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600FoLinkStateTableEntry_Print(sbZfFabBm9600FoLinkStateTableEntry_t *pFromStruct) {
  SB_LOG("FabBm9600FoLinkStateTableEntry:: sb=0x%01x", (unsigned int)  pFromStruct->m_uSb);
  SB_LOG(" error=0x%01x", (unsigned int)  pFromStruct->m_uError);
  SB_LOG(" linkstate=0x%08x", (unsigned int)  pFromStruct->m_uLinkState);
  SB_LOG("\n");
...
char *
sbZfFabBm9600FoLinkStateTableEntry_SPrint(sbZfFabBm9600FoLinkStateTableEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
