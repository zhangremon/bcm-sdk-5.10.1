/*
 * $Id: sbZfFabBm9600BwR1Wct2BEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfFabBm9600BwR1Wct2BEntry_Unpack(sbZfFabBm9600BwR1Wct2BEntry_t *pToStruct,
  ...
  (pToStruct)->m_uTEcnDp2 =  (uint32_t)  (pFromData)[1] ;
  (pToStruct)->m_uTEcnDp2 |=  (uint32_t)  (pFromData)[0] << 8;

  /* Unpack Member: m_uScaleDp2 */
  (pToStruct)->m_uScaleDp2 =  (uint32_t)  ((pFromData)[2] >> 4) & 0x0f;

  /* Unpack Member: m_uSlopeDp2 */
  (pToStruct)->m_uSlopeDp2 =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_uSlopeDp2 |=  (uint32_t)  ((pFromData)[2] & 0x0f) << 8;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_uTEcnDp2 */
  (pToStruct)->m_uTEcnDp2 =  (uint32_t)  (pFromData)[2] ;
  (pToStruct)->m_uTEcnDp2 |=  (uint32_t)  (pFromData)[3] << 8;

  /* Unpack Member: m_uScaleDp2 */
  (pToStruct)->m_uScaleDp2 =  (uint32_t)  ((pFromData)[1] >> 4) & 0x0f;

  /* Unpack Member: m_uSlopeDp2 */
  (pToStruct)->m_uSlopeDp2 =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_uSlopeDp2 |=  (uint32_t)  ((pFromData)[1] & 0x0f) << 8;
#endif
