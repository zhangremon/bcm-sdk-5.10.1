/*
 * $Id: sbZfFabBm9600BwR1Wct1AEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwR1Wct1AEntry_Print(sbZfFabBm9600BwR1Wct1AEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwR1Wct1AEntry:: tmindp1=0x%04x", (unsigned int)  pFromStruct->m_uTMinDp1);
  SB_LOG(" tmaxdp1=0x%04x", (unsigned int)  pFromStruct->m_uTMaxDp1);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwR1Wct1AEntry_SPrint(sbZfFabBm9600BwR1Wct1AEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
