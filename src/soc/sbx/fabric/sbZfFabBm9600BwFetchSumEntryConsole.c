/*
 * $Id: sbZfFabBm9600BwFetchSumEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwFetchSumEntry_Print(sbZfFabBm9600BwFetchSumEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwFetchSumEntry:: sum=0x%08x", (unsigned int)  pFromStruct->m_uSum);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwFetchSumEntry_SPrint(sbZfFabBm9600BwFetchSumEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
