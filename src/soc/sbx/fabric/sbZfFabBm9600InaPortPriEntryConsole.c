/*
 * $Id: sbZfFabBm9600InaPortPriEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600InaPortPriEntry_Print(sbZfFabBm9600InaPortPriEntry_t *pFromStruct) {
  ...
  SB_LOG("FabBm9600InaPortPriEntry:: pri_7=0x%01x", (unsigned int)  pFromStruct->m_uPri_7);
  ...
  SB_LOG("FabBm9600InaPortPriEntry:: pri_5=0x%01x", (unsigned int)  pFromStruct->m_uPri_5);
  ...
  SB_LOG("FabBm9600InaPortPriEntry:: pri_3=0x%01x", (unsigned int)  pFromStruct->m_uPri_3);
  ...
  SB_LOG("FabBm9600InaPortPriEntry:: pri_1=0x%01x", (unsigned int)  pFromStruct->m_uPri_1);
...
char *
sbZfFabBm9600InaPortPriEntry_SPrint(sbZfFabBm9600InaPortPriEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
