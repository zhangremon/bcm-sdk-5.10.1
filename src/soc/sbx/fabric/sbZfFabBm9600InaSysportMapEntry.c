/*
 * $Id: sbZfFabBm9600InaSysportMapEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfFabBm9600InaSysportMapEntry_Unpack(sbZfFabBm9600InaSysportMapEntry_t *pToStruct,
  ...
  (pToStruct)->m_uPortsetAddr =  (uint32_t)  ((pFromData)[3] >> 4) & 0x0f;
  (pToStruct)->m_uPortsetAddr |=  (uint32_t)  ((pFromData)[2] & 0x0f) << 4;

  /* Unpack Member: m_uOffset */
  (pToStruct)->m_uOffset =  (uint32_t)  ((pFromData)[3] ) & 0x0f;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_uPortsetAddr */
  (pToStruct)->m_uPortsetAddr =  (uint32_t)  ((pFromData)[0] >> 4) & 0x0f;
  (pToStruct)->m_uPortsetAddr |=  (uint32_t)  ((pFromData)[1] & 0x0f) << 4;

  /* Unpack Member: m_uOffset */
  (pToStruct)->m_uOffset =  (uint32_t)  ((pFromData)[0] ) & 0x0f;
#endif
