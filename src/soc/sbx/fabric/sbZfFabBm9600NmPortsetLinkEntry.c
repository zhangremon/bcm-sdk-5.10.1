/*
 * $Id: sbZfFabBm9600NmPortsetLinkEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfFabBm9600NmPortsetLinkEntry_Unpack(sbZfFabBm9600NmPortsetLinkEntry_t *pToStruct,
  ...
  (pToStruct)->m_uIndex =  (uint32_t)  (pFromData)[2] ;

  /* Unpack Member: m_uNxtPtr */
  (pToStruct)->m_uNxtPtr =  (uint32_t)  (pFromData)[3] ;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_uIndex */
  (pToStruct)->m_uIndex =  (uint32_t)  (pFromData)[1] ;

  /* Unpack Member: m_uNxtPtr */
  (pToStruct)->m_uNxtPtr =  (uint32_t)  (pFromData)[0] ;
#endif
