/*
 * $Id: sbZfFabBm9600BwR0BwpEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfFabBm9600BwR0BwpEntry_Unpack(sbZfFabBm9600BwR0BwpEntry_t *pToStruct,
  ...
  (pToStruct)->m_uGamma =  (uint32_t)  (pFromData)[0] ;

  /* Unpack Member: m_uSigma */
  (pToStruct)->m_uSigma =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_uSigma |=  (uint32_t)  (pFromData)[2] << 8;
  (pToStruct)->m_uSigma |=  (uint32_t)  (pFromData)[1] << 16;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_uGamma */
  (pToStruct)->m_uGamma =  (uint32_t)  (pFromData)[3] ;

  /* Unpack Member: m_uSigma */
  (pToStruct)->m_uSigma =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_uSigma |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->m_uSigma |=  (uint32_t)  (pFromData)[2] << 16;
#endif
