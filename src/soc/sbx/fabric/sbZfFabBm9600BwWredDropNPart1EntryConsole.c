/*
 * $Id: sbZfFabBm9600BwWredDropNPart1EntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwWredDropNPart1Entry_Print(sbZfFabBm9600BwWredDropNPart1Entry_t *pFromStruct) {
  SB_LOG("FabBm9600BwWredDropNPart1Entry:: dp1=0x%01x", (unsigned int)  pFromStruct->m_uDp1);
  SB_LOG(" ecn1=0x%01x", (unsigned int)  pFromStruct->m_uEcn1);
  SB_LOG(" reserved1=0x%01x", (unsigned int)  pFromStruct->m_uReserved1);
  SB_LOG(" pbde1=0x%03x", (unsigned int)  pFromStruct->m_uPbDe1);
  SB_LOG("\n");

  SB_LOG("FabBm9600BwWredDropNPart1Entry:: dp0=0x%01x", (unsigned int)  pFromStruct->m_uDp0);
  SB_LOG(" ecn0=0x%01x", (unsigned int)  pFromStruct->m_uEcn0);
  SB_LOG(" reserved0=0x%01x", (unsigned int)  pFromStruct->m_uReserved0);
  SB_LOG(" pbde0=0x%03x", (unsigned int)  pFromStruct->m_uPbDe0);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwWredDropNPart1Entry_SPrint(sbZfFabBm9600BwWredDropNPart1Entry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
