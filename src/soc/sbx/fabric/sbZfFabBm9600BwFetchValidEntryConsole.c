/*
 * $Id: sbZfFabBm9600BwFetchValidEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwFetchValidEntry_Print(sbZfFabBm9600BwFetchValidEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwFetchValidEntry:: valid=0x%08x", (unsigned int)  pFromStruct->m_uValid);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwFetchValidEntry_SPrint(sbZfFabBm9600BwFetchValidEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
