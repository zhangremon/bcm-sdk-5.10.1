/*
 * $Id: sbZfFabBm9600BwAllocRateEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfFabBm9600BwAllocRateEntry_Unpack(sbZfFabBm9600BwAllocRateEntry_t *pToStruct,
  ...
  (pToStruct)->m_uRate =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_uRate |=  (uint32_t)  (pFromData)[2] << 8;
  (pToStruct)->m_uRate |=  (uint32_t)  (pFromData)[1] << 16;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_uRate */
  (pToStruct)->m_uRate =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_uRate |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->m_uRate |=  (uint32_t)  (pFromData)[2] << 16;
#endif
