/*
 * $Id: sbZfFabBm9600InaSysportMapEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600InaSysportMapEntry_Print(sbZfFabBm9600InaSysportMapEntry_t *pFromStruct) {
  SB_LOG("FabBm9600InaSysportMapEntry:: portsetaddr=0x%02x", (unsigned int)  pFromStruct->m_uPortsetAddr);
...
char *
sbZfFabBm9600InaSysportMapEntry_SPrint(sbZfFabBm9600InaSysportMapEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
