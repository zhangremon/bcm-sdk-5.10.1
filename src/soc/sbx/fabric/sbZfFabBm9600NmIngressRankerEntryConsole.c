/*
 * $Id: sbZfFabBm9600NmIngressRankerEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600NmIngressRankerEntry_Print(sbZfFabBm9600NmIngressRankerEntry_t *pFromStruct) {
  SB_LOG("FabBm9600NmIngressRankerEntry:: seed=0x%02x", (unsigned int)  pFromStruct->m_uSeed);
  SB_LOG("\n");
...
char *
sbZfFabBm9600NmIngressRankerEntry_SPrint(sbZfFabBm9600NmIngressRankerEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
