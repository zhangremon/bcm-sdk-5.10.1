/*
 * $Id: sbZfFabBm3200BwBandwidthParameterEntry.c 1.1.48.4 Broadcom SDK $
...
/*
 * $Id: sbZfFabBm3200BwBandwidthParameterEntry.c,v 1.1.48.4 2011/05/22 05:39:13 iakramov Exp $
 * $Copyright: Copyright 2011 Broadcom Corporation.
 * This program is the proprietary software of Broadcom Corporation
 * and/or its licensors, and may only be used, duplicated, modified
 * or distributed pursuant to the terms and conditions of a separate,
...
sbZfFabBm3200BwBandwidthParameterEntry_Print(sbZfFabBm3200BwBandwidthParameterEntry_t *pFromStruct) {
  SB_LOG("FabBm3200BwBandwidthParameterEntry:: gamma=0x%02x", (unsigned int)  pFromStruct->m_nGamma);
...
int
sbZfFabBm3200BwBandwidthParameterEntry_SPrint(sbZfFabBm3200BwBandwidthParameterEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
