/*
 * $Id: sbZfFabBm9600BwR0BagEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwR0BagEntry_Print(sbZfFabBm9600BwR0BagEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwR0BagEntry:: bagrate=0x%06x", (unsigned int)  pFromStruct->m_uBagRate);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwR0BagEntry_SPrint(sbZfFabBm9600BwR0BagEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
