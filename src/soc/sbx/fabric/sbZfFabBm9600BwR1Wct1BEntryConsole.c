/*
 * $Id: sbZfFabBm9600BwR1Wct1BEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwR1Wct1BEntry_Print(sbZfFabBm9600BwR1Wct1BEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwR1Wct1BEntry:: tecndp1=0x%04x", (unsigned int)  pFromStruct->m_uTEcnDp1);
  SB_LOG(" scaledp1=0x%01x", (unsigned int)  pFromStruct->m_uScaleDp1);
  SB_LOG(" slopedp1=0x%03x", (unsigned int)  pFromStruct->m_uSlopeDp1);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwR1Wct1BEntry_SPrint(sbZfFabBm9600BwR1Wct1BEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
