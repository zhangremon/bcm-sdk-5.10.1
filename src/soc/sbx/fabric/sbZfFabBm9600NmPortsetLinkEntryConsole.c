/*
 * $Id: sbZfFabBm9600NmPortsetLinkEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600NmPortsetLinkEntry_Print(sbZfFabBm9600NmPortsetLinkEntry_t *pFromStruct) {
  SB_LOG("FabBm9600NmPortsetLinkEntry:: index=0x%02x", (unsigned int)  pFromStruct->m_uIndex);
  SB_LOG(" nxtptr=0x%02x", (unsigned int)  pFromStruct->m_uNxtPtr);
  SB_LOG("\n");
...
char *
sbZfFabBm9600NmPortsetLinkEntry_SPrint(sbZfFabBm9600NmPortsetLinkEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
