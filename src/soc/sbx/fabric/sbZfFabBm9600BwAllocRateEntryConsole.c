/*
 * $Id: sbZfFabBm9600BwAllocRateEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwAllocRateEntry_Print(sbZfFabBm9600BwAllocRateEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwAllocRateEntry:: rate=0x%06x", (unsigned int)  pFromStruct->m_uRate);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwAllocRateEntry_SPrint(sbZfFabBm9600BwAllocRateEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
