/*
 * $Id: sbZfFabBm9600BwR1Wct0BEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwR1Wct0BEntry_Print(sbZfFabBm9600BwR1Wct0BEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwR1Wct0BEntry:: tecndp0=0x%04x", (unsigned int)  pFromStruct->m_uTEcnDp0);
  SB_LOG(" scaledp0=0x%01x", (unsigned int)  pFromStruct->m_uScaleDp0);
  SB_LOG(" slopedp0=0x%03x", (unsigned int)  pFromStruct->m_uSlopeDp0);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwR1Wct0BEntry_SPrint(sbZfFabBm9600BwR1Wct0BEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
