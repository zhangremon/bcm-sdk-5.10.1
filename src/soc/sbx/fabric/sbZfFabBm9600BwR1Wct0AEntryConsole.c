/*
 * $Id: sbZfFabBm9600BwR1Wct0AEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwR1Wct0AEntry_Print(sbZfFabBm9600BwR1Wct0AEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwR1Wct0AEntry:: tmindp0=0x%04x", (unsigned int)  pFromStruct->m_uTMinDp0);
  SB_LOG(" tmaxdp0=0x%04x", (unsigned int)  pFromStruct->m_uTMaxDp0);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwR1Wct0AEntry_SPrint(sbZfFabBm9600BwR1Wct0AEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
