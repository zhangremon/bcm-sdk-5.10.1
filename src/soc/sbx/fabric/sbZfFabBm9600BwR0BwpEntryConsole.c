/*
 * $Id: sbZfFabBm9600BwR0BwpEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwR0BwpEntry_Print(sbZfFabBm9600BwR0BwpEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwR0BwpEntry:: gamma=0x%02x", (unsigned int)  pFromStruct->m_uGamma);
  SB_LOG(" sigma=0x%06x", (unsigned int)  pFromStruct->m_uSigma);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwR0BwpEntry_SPrint(sbZfFabBm9600BwR0BwpEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
