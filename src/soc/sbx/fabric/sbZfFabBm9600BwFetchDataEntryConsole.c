/*
 * $Id: sbZfFabBm9600BwFetchDataEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwFetchDataEntry_Print(sbZfFabBm9600BwFetchDataEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwFetchDataEntry:: data=0x%08x", (unsigned int)  pFromStruct->m_uData);
  SB_LOG("\n");
...
char *
sbZfFabBm9600BwFetchDataEntry_SPrint(sbZfFabBm9600BwFetchDataEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
