/*
 * $Id: sbZfFabBm9600NmPortsetInfoEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600NmPortsetInfoEntry_Print(sbZfFabBm9600NmPortsetInfoEntry_t *pFromStruct) {
  SB_LOG("FabBm9600NmPortsetInfoEntry:: virtualport=0x%01x", (unsigned int)  pFromStruct->m_uVirtualPort);
  SB_LOG(" vporteopp=0x%01x", (unsigned int)  pFromStruct->m_uVportEopp);
  SB_LOG(" startport=0x%02x", (unsigned int)  pFromStruct->m_uStartPort);
  SB_LOG("\n");

  SB_LOG("FabBm9600NmPortsetInfoEntry:: egnode=0x%02x", (unsigned int)  pFromStruct->m_uEgNode);
  SB_LOG("\n");
...
char *
sbZfFabBm9600NmPortsetInfoEntry_SPrint(sbZfFabBm9600NmPortsetInfoEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
