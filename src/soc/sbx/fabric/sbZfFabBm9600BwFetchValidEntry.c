/*
 * $Id: sbZfFabBm9600BwFetchValidEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfFabBm9600BwFetchValidEntry_Unpack(sbZfFabBm9600BwFetchValidEntry_t *pToStruct,
  ...
  (pToStruct)->m_uValid =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_uValid |=  (uint32_t)  (pFromData)[2] << 8;
  (pToStruct)->m_uValid |=  (uint32_t)  (pFromData)[1] << 16;
  (pToStruct)->m_uValid |=  (uint32_t)  (pFromData)[0] << 24;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_uValid */
  (pToStruct)->m_uValid =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_uValid |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->m_uValid |=  (uint32_t)  (pFromData)[2] << 16;
  (pToStruct)->m_uValid |=  (uint32_t)  (pFromData)[3] << 24;
#endif
