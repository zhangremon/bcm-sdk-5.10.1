/*
 * $Id: sbZfFabBm9600BwAllocCfgBaseEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwAllocCfgBaseEntry_Print(sbZfFabBm9600BwAllocCfgBaseEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwAllocCfgBaseEntry:: enc=0x%01x", (unsigned int)  pFromStruct->m_uEnc);
...
char *
sbZfFabBm9600BwAllocCfgBaseEntry_SPrint(sbZfFabBm9600BwAllocCfgBaseEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
