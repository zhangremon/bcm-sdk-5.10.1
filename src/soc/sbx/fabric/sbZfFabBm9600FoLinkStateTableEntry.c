/*
 * $Id: sbZfFabBm9600FoLinkStateTableEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfFabBm9600FoLinkStateTableEntry_Unpack(sbZfFabBm9600FoLinkStateTableEntry_t *pToStruct,
  ...
  /* Unpack Member: m_uSb */
  (pToStruct)->m_uSb =  (uint32_t)  ((pFromData)[7] >> 1) & 0x01;

  /* Unpack Member: m_uError */
  (pToStruct)->m_uError =  (uint32_t)  ((pFromData)[7] ) & 0x01;

  /* Unpack Member: m_uLinkState */
  (pToStruct)->m_uLinkState =  (uint32_t)  (pFromData)[3] ;
  (pToStruct)->m_uLinkState |=  (uint32_t)  (pFromData)[2] << 8;
  (pToStruct)->m_uLinkState |=  (uint32_t)  (pFromData)[1] << 16;
  (pToStruct)->m_uLinkState |=  (uint32_t)  (pFromData)[0] << 24;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_uSb */
  (pToStruct)->m_uSb =  (uint32_t)  ((pFromData)[4] >> 1) & 0x01;

  /* Unpack Member: m_uError */
  (pToStruct)->m_uError =  (uint32_t)  ((pFromData)[4] ) & 0x01;

  /* Unpack Member: m_uLinkState */
  (pToStruct)->m_uLinkState =  (uint32_t)  (pFromData)[0] ;
  (pToStruct)->m_uLinkState |=  (uint32_t)  (pFromData)[1] << 8;
  (pToStruct)->m_uLinkState |=  (uint32_t)  (pFromData)[2] << 16;
  (pToStruct)->m_uLinkState |=  (uint32_t)  (pFromData)[3] << 24;
#endif
