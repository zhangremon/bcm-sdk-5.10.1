/*
 * $Id: sbZfFabBm9600XbXcfgRemapEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600XbXcfgRemapEntry_Print(sbZfFabBm9600XbXcfgRemapEntry_t *pFromStruct) {
  SB_LOG("FabBm9600XbXcfgRemapEntry:: xcfgb=0x%02x", (unsigned int)  pFromStruct->m_uXcfgB);
  SB_LOG(" xcfga=0x%02x", (unsigned int)  pFromStruct->m_uXcfgA);
  SB_LOG("\n");
...
char *
sbZfFabBm9600XbXcfgRemapEntry_SPrint(sbZfFabBm9600XbXcfgRemapEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
