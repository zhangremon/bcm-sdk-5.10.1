/*
 * $Id: sbZfFabBm9600BwR1BagEntryConsole.c 1.1.38.3 Broadcom SDK $
...
sbZfFabBm9600BwR1BagEntry_Print(sbZfFabBm9600BwR1BagEntry_t *pFromStruct) {
  SB_LOG("FabBm9600BwR1BagEntry:: numvoqs=0x%02x", (unsigned int)  pFromStruct->m_uNumVoqs);
...
char *
sbZfFabBm9600BwR1BagEntry_SPrint(sbZfFabBm9600BwR1BagEntry_t *pFromStruct, char *pcToString, uint32_t lStrSize) {
  uint32_t WrCnt = 0x0;
