/*
 * $Id: sbZfFabBm9600XbXcfgRemapEntry.c 1.1.44.4 Broadcom SDK $
...
sbZfFabBm9600XbXcfgRemapEntry_Unpack(sbZfFabBm9600XbXcfgRemapEntry_t *pToStruct,
  ...
  (pToStruct)->m_uXcfgB =  (uint32_t)  (pFromData)[2] ;

  /* Unpack Member: m_uXcfgA */
  (pToStruct)->m_uXcfgA =  (uint32_t)  (pFromData)[3] ;
#else

  /* Unpack operation based on little endian */

  /* Unpack Member: m_uXcfgB */
  (pToStruct)->m_uXcfgB =  (uint32_t)  (pFromData)[1] ;

  /* Unpack Member: m_uXcfgA */
  (pToStruct)->m_uXcfgA =  (uint32_t)  (pFromData)[0] ;
#endif
