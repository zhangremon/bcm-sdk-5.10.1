/*
 * $Id: phy5464.c 1.145.44.3 Broadcom SDK $
...
_phy_5464_reset_setup(int unit, soc_port_t port)
{
    ...
    DPRINTF("_phy_5464_reset_setup: u=%d p=%d medium=%s\n",
            unit, port,
    ...
    SOC_IF_ERROR_RETURN
        (MODIFY_PHY5464_SPARE_3r(unit, pc, 0, 1));
#endif
...
phy_5464_init(int unit, soc_port_t port)
{
    ...
    DPRINTF("phy_5464_init: u=%d p=%d phy_addr=%d\n",
...
phy_5464_duplex_set(int unit, soc_port_t port, int duplex)
{
    ...
    DPRINTF("phy_5464_duplex_set: u=%d p=%d d=%d\n",
            unit, port, duplex);
...
phy_5464_speed_set(int unit, soc_port_t port, int speed)
{
    ...
    DPRINTF("phy_5464_speed_set: u=%d p=%d s=%d fiber=%d\n",
...
phy_5464_master_set(int unit, soc_port_t port, int master)
{
    ...
    DPRINTF("phy_5464_master_set: u=%d p=%d master=%d fiber=%d\n",
