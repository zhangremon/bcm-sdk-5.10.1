/*
 * $Id: phy545xx.c 1.40.38.1 Broadcom SDK $
...
_phy_54580_no_reset_setup(int unit, soc_port_t port, int fiber)
{
    ...
    SOC_DEBUG_PRINT((DK_PHY, "_phy_54580_reset_setup: u=%d p=%d medium=%s\n",
                     unit, port,
...
phy_54580_init(int unit, soc_port_t port)
{
    ...
    if (mmi_mdio_addr == -1) {
        soc_cm_debug(DK_WARN, "phy_54580_init: "
    ...
    if(rv != BMACSEC_E_NONE) {
        SOC_DEBUG_PRINT((DK_WARN, "phy_54580_init: bmacsec_phy_mac_addr_set "
    ...
    SOC_DEBUG_PRINT((DK_PHY, "phy_54580_init: "
...
phy_54580_enable_set(int unit, soc_port_t port, int enable)
{
    ...
    if (pc->automedium || PHY_FIBER_MODE(unit, port)) {
        ...
        SOC_DEBUG_PRINT((DK_PHY, "phy_54580_enable_set: "
