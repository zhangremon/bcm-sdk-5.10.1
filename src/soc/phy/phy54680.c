/*
 * $Id: phy54680.c 1.93.2.31 Broadcom SDK $
...
phy_54680_lb_set(int unit, soc_port_t port, int enable)
{
    ...
    if (PHY_IS_BCM53125(pc) || PHY_IS_BCM53128(pc) || PHY_IS_BCM53324(pc) || PHY_IS_BCM52681E(pc)) {
        /* No SGMII interface */
...
_phy_54680_eee_enable(int unit, soc_port_t port, int enable)
{
    ...
    if (enable == 1) {
        ...
        if(!PHY_IS_BCM53125(pc) && !PHY_IS_BCM53128(pc)) { /* no support  of AutogrEEEn */
            SOC_IF_ERROR_RETURN
...
phy_54680_timesync_config_set(int unit, soc_port_t port, soc_port_phy_timesync_config_t *conf)
{
    ...
    if (conf->validity_mask & SOC_PORT_PHY_TIMESYNC_VALID_PHY_1588_DPLL_LOOP_FILTER) {
        ...
        SOC_IF_ERROR_RETURN
            (_phy_54680e_blk_top_lvl_reg_write(unit, pc_port1, 0, 0x42, (uint16)((COMPILER_64_LO(conf->phy_1588_dpll_loop_filter) >> 16) & 0xffff)));
    }
