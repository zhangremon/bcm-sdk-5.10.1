/*
 * $Id: phydefs.h 1.20.108.3 Broadcom SDK $
...
#if defined(INCLUDE_PHY_SERDES) && defined(BCM_ESW_SUPPORT)
#define INCLUDE_SERDES_ASSUMED
#endif /* INCLUDE_PHY_SERDES || BCM_ESW_SUPPORT */
