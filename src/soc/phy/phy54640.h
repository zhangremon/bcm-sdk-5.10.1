/*
 * $Id: phy54640.h 1.9.2.1 Broadcom SDK $
...
#define READ_PHY54640_1ST_SERDES_CTRLr(_unit, _phy_ctrl, _val) \
            PHY54640_REG_READ((_unit), (_phy_ctrl), 0x00, 0x0016, 0x1c, (_val))
#define WRITE_PHY54640_1ST_SERDES_CTRLr(_unit, _phy_ctrl, _val) \
            PHY54640_REG_WRITE((_unit), (_phy_ctrl), 0x00, 0x0016, 0x1c, (_val))
#define MODIFY_PHY54640_1ST_SERDES_CTRLr(_unit, _phy_ctrl, _val, _mask) \
...
#define READ_PHY54640_AUX_1000X_CTRLr(_unit, _phy_ctrl, _val) \
            PHY54640_REG_READ((_unit), (_phy_ctrl), 0x00, 0x001b, 0x1c, (_val))
#define WRITE_PHY54640_AUX_1000X_CTRLr(_unit, _phy_ctrl, _val) \
            PHY54640_REG_WRITE((_unit), (_phy_ctrl), 0x00, 0x001b, 0x1c, (_val))
#define MODIFY_PHY54640_AUX_1000X_CTRLr(_unit, _phy_ctrl, _val, _mask) \
