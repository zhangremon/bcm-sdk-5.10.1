/*
 * $Id: phy8481.h 1.38.64.5 Broadcom SDK $
...
#define READ_PHY8481_PHYC_CTL_AI_LPI_CTLr(_unit, _phy_ctrl, _val) \
            READ_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa88a : 0xa878,(_val))
#define WRITE_PHY8481_PHYC_CTL_AI_LPI_CTLr(_unit, _phy_ctrl, _val) \
            WRITE_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa88a : 0xa878,(_val))
#define MODIFY_PHY8481_PHYC_CTL_AI_LPI_CTLr(_unit, _phy_ctrl, _val, _mask) \
            MODIFY_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa88a : 0xa878, (_val), (_mask))

#define READ_PHY8481_EEE_STATISTICS_CTLr(_unit, _phy_ctrl, _val) \
            READ_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa8f5 : 0xa907,(_val))
#define WRITE_PHY8481_EEE_STATISTICS_CTLr(_unit, _phy_ctrl, _val) \
            WRITE_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa8f5 : 0xa907,(_val))
#define MODIFY_PHY8481_EEE_STATISTICS_CTLr(_unit, _phy_ctrl, _val, _mask) \
            MODIFY_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa8f5 : 0xa907, (_val), (_mask))

#define READ_PHY8481_EXP_EEE_TX_EVENTS_HIGHr(_unit, _phy_ctrl, _val) \
            READ_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa8f6 : 0xa908,(_val))
#define READ_PHY8481_EXP_EEE_TX_EVENTS_LOWr(_unit, _phy_ctrl, _val) \
            READ_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa8f7 : 0xa909,(_val))

#define READ_PHY8481_EXP_EEE_RX_EVENTS_HIGHr(_unit, _phy_ctrl, _val) \
            READ_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa8fa : 0xa90c,(_val))
#define READ_PHY8481_EXP_EEE_RX_EVENTS_LOWr(_unit, _phy_ctrl, _val) \
            READ_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa8fb : 0xa90d,(_val))

#define READ_PHY8481_EXP_EEE_TX_DURATION_HIGHr(_unit, _phy_ctrl, _val) \
            READ_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa8f8 : 0xa90a,(_val))
#define READ_PHY8481_EXP_EEE_TX_DURATION_LOWr(_unit, _phy_ctrl, _val) \
            READ_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa8f9 : 0xa90b,(_val))

#define READ_PHY8481_EXP_EEE_RX_DURATION_HIGHr(_unit, _phy_ctrl, _val) \
            READ_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa8fc : 0xa90e,(_val))
#define READ_PHY8481_EXP_EEE_RX_DURATION_LOWr(_unit, _phy_ctrl, _val) \
            READ_PHY8481_PMAD_REG((_unit), (_phy_ctrl), PHY_IS_BCM8483X((_phy_ctrl)) ? 0xa8fd : 0xa90f,(_val))
...
#define READ_PHY8481_1ST_SERDES_CTRLr(_unit, _phy_ctrl, _val) \
            PHY8481_D7_FFXX_REG_READ((_unit), (_phy_ctrl), 0x00, 0x0016, 0xfffc, (_val))
#define WRITE_PHY8481_1ST_SERDES_CTRLr(_unit, _phy_ctrl, _val) \
            PHY8481_D7_FFXX_REG_WRITE((_unit), (_phy_ctrl), 0x00, 0x0016, 0xfffc, (_val))
#define MODIFY_PHY8481_1ST_SERDES_CTRLr(_unit, _phy_ctrl, _val, _mask) \
