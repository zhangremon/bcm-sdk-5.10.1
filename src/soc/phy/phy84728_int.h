...
/*
 * $Id: phy84728_int.h 1.1.2.2 Broadcom SDK $
...
#define BSDK_PHY84728_IS_10G_CHANNEL(dev_port)              \
                    ((dev_port == 0) || (dev_port ==1))

#define BSDK_PHY84728_IS_GIG_ONLY_CHANNEL(dev_port)         \
 ...
 */
#define BSDK_PHY84728_DEV1_1000X_ANA_C37_FD          (1 << 5)
#define BSDK_PHY84728_DEV1_1000X_ANA_C37_HD          (1 << 6)
#define BSDK_PHY84728_DEV1_1000X_ANA_C37_PAUSE       (1 << 7)
#define BSDK_PHY84728_DEV1_1000X_ANA_C37_ASYM_PAUSE  (1 << 8)



/* MII Control register definations */
#define BSDK_PHY84728_SGMII_MII_CTRL_SS_MSB  (1 << 6) /* Speed select, MSb */
#define BSDK_PHY84728_SGMII_MII_CTRL_FD      (1 << 8) /* Full Duplex */
#define BSDK_PHY84728_SGMII_MII_CTRL_RAN     (1 << 9) /* Restart Autoneg*/
#define BSDK_PHY84728_SGMII_MII_CTRL_PD      (1 << 11) /* Power Down */
#define BSDK_PHY84728_SGMII_MII_CTRL_AE      (1 << 12) /* Autoneg enable */
#define BSDK_PHY84728_SGMII_MII_CTRL_SS_LSB  (1 << 13) /* Speed select, LSb */
#define BSDK_PHY84728_SGMII_MII_CTRL_LE      (1 << 14) /* Loopback enable */
#define BSDK_PHY84728_SGMII_MII_CTRL_RESET   (1 << 15) /* PHY reset */

#define BSDK_PHY84728_SGMII_MII_CTRL_SS(_x)    ((_x) &  \
                                     (BSDK_PHY84728_SGMII_MII_CTRL_SS_LSB | \
                                      BSDK_PHY84728_SGMII_MII_CTRL_SS_MSB))
#define BSDK_PHY84728_SGMII_MII_CTRL_SS_10          0
#define BSDK_PHY84728_SGMII_MII_CTRL_SS_100         \
                                    (BSDK_PHY84728_SGMII_MII_CTRL_SS_LSB)
#define BSDK_PHY84728_SGMII_MII_CTRL_SS_1000        \
                                    (BSDK_PHY84728_SGMII_MII_CTRL_SS_MSB)
#define BSDK_PHY84728_SGMII_MII_CTRL_SS_INVALID     \
                                    (BSDK_PHY84728_SGMII_MII_CTRL_SS_LSB | \
                                     BSDK_PHY84728_SGMII_MII_CTRL_SS_MSB)
#define BSDK_PHY84728_SGMII_MII_CTRL_SS_MASK        \
                                    (BSDK_PHY84728_SGMII_MII_CTRL_SS_LSB | \
                                     BSDK_PHY84728_SGMII_MII_CTRL_SS_MSB)

/* MII Status register definations */
#define BSDK_PHY84728_SGMII_MII_STAT_LINK_STATUS     (1 << 2)
#define BSDK_PHY84728_SGMII_MII_STAT_AN_DONE         (1 << 5)


/* 1000x Control1 Register definations */
#define BSDK_PHY84728_SGMII_BASE1000X_CTRL1r_FIBER_MODE     (1 << 0)
#define BSDK_PHY84728_SGMII_BASE1000X_CTRL1r_TBI_INT        (1 << 1)
#define BSDK_PHY84728_SGMII_BASE1000X_CTRL1r_SD_ENABLE      (1 << 2)
#define BSDK_PHY84728_SGMII_BASE1000X_CTRL1r_INVERT_SD      (1 << 3)
#define BSDK_PHY84728_SGMII_BASE1000X_CTRL1r_AUTODETECT_EN  (1 << 4)
#define BSDK_PHY84728_SGMII_BASE1000X_CTRL1r_SGMII_MASTER   (1 << 5)
#define BSDK_PHY84728_SGMII_BASE1000X_CTRL1r_DIS_PLL_PWRDN  (1 << 6)


/* 1000x Status1 Register definations */
#define BSDK_PHY84728_SGMII_BASE1000X_STAT1r_FIBER_MODE     (1 << 0)
#define BSDK_PHY84728_SGMII_BASE1000X_STAT1r_LINK_STATUS    (1 << 1)
#define BSDK_PHY84728_SGMII_BASE1000X_STAT1r_DUPLEX_STATUS  (1 << 2)
#define BSDK_PHY84728_SGMII_BASE1000X_STAT1r_SPEED_STATUS   ((1 << 3) | \
                                                               (1 << 4))
#define BSDK_PHY84728_SGMII_BASE1000X_STAT1r_PAUSE_TX       (1 << 5)
#define BSDK_PHY84728_SGMII_BASE1000X_STAT1r_PAUSE_RX       (1 << 6)


/* Speed Link status register defination */
#define BSDK_PHY84728_SGMII_SPEED_LD_STATr_LN_PDM_SPEED_10M    (1 << 0)
#define BSDK_PHY84728_SGMII_SPEED_LD_STATr_LN_PDM_SPEED_100M   (1 << 1)
#define BSDK_PHY84728_SGMII_SPEED_LD_STATr_LN_PDM_SPEED_1G     (1 << 2)
#define BSDK_PHY84728_SGMII_SPEED_LD_STATr_LN_AN_COMPLETE      (1 << 6)
#define BSDK_PHY84728_SGMII_SPEED_LD_STATr_LN_RX_SD            (1 << 7)
#define BSDK_PHY84728_SGMII_SPEED_LD_STATr_SYS_PDM_SPEED_10M   (1 << 8)
#define BSDK_PHY84728_SGMII_SPEED_LD_STATr_SYS_PDM_SPEED_100M  (1 << 9)
#define BSDK_PHY84728_SGMII_SPEED_LD_STATr_SYS_PDM_SPEED_1G    (1 << 10)
#define BSDK_PHY84728_SGMII_SPEED_LD_STATr_SYS_AN_COMPLETE     (1 << 14)
#define BSDK_PHY84728_SGMII_SPEED_LD_STATr_SYS_RX_SD           (1 << 15)

/* SGMII MACSEC Control register defination */
#define BSDK_PHY84728_SGMII_MACSEC_CTRL_BYPASS_MODE            (1 << 0)
#define BSDK_PHY84728_SGMII_MACSEC_CTRL_ENABLE_PWRDN_MACSEC    (1 << 8)
#define BSDK_PHY84728_SGMII_MACSEC_CTRL_UDSW_PWRDW_MACSEC      (1 << 11)
#define BSDK_PHY84728_SGMII_MACSEC_CTRL_UDSW_RESET_MACSEC      (1 << 15)
...
/* Speed Link status register defination */
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_PDM_SPEED_10M    (1 << 0)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_PDM_SPEED_100M   (1 << 1)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_PDM_SPEED_1G     (1 << 2)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_PDM_SPEED_2P5G   (1 << 3)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_PDM_SPEED_10G    (1 << 4)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_AN_COMPLETE      (1 << 6)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_RX_SD            (1 << 7)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_PDM_SPEED_10M   (1 << 8)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_PDM_SPEED_100M  (1 << 9)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_PDM_SPEED_1G    (1 << 10)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_PDM_SPEED_2P5G  (1 << 11)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_PDM_SPEED_10G   (1 << 12)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_AN_COMPLETE     (1 << 14)
#define BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_RX_SD           (1 << 15)

#define BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_PDM_SPEED_MASK                \
                    (BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_PDM_SPEED_10M |  \
                     BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_PDM_SPEED_100M | \
                     BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_PDM_SPEED_1G |   \
                     BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_PDM_SPEED_2P5G | \
                     BSDK_PHY84728_PMD_SPEED_LD_STATr_LN_PDM_SPEED_10G)

#define BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_PDM_SPEED_MASK                \
                    (BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_PDM_SPEED_10M |  \
                     BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_PDM_SPEED_100M | \
                     BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_PDM_SPEED_1G |   \
                     BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_PDM_SPEED_2P5G | \
                     BSDK_PHY84728_PMD_SPEED_LD_STATr_SYS_PDM_SPEED_10G)
...
#define BSDK_PHY84728_AN_BASE1000X_CTRL1r_FIBER_MODE         (1 << 0)
#define BSDK_PHY84728_AN_BASE1000X_CTRL1r_TBI_INT            (1 << 1)
#define BSDK_PHY84728_AN_BASE1000X_CTRL1r_SD_ENABLE          (1 << 2)
#define BSDK_PHY84728_AN_BASE1000X_CTRL1r_INVERT_SD          (1 << 3)
#define BSDK_PHY84728_AN_BASE1000X_CTRL1r_AUTODETECT_EN      (1 << 4)
#define BSDK_PHY84728_AN_BASE1000X_CTRL1r_SGMII_MASTER       (1 << 5)
#define BSDK_PHY84728_AN_BASE1000X_CTRL1r_DIS_PLL_PWRDN      (1 << 6)


/* 1000x Status1 Register definations */
#define BSDK_PHY84728_AN_BASE1000X_STAT1r_SGMII_MODE      (1 << 0)
#define BSDK_PHY84728_AN_BASE1000X_STAT1r_LINK_STATUS     (1 << 1)
#define BSDK_PHY84728_AN_BASE1000X_STAT1r_DUPLEX_STATUS   (1 << 2)
#define BSDK_PHY84728_AN_BASE1000X_STAT1r_SPEED_STATUS    ((1 << 3) | \
                                                             (1 << 4))
#define BSDK_PHY84728_AN_BASE1000X_STAT1r_PAUSE_TX        (1 << 5)
#define BSDK_PHY84728_AN_BASE1000X_STAT1r_PAUSE_RX        (1 << 6)
...
#if 0
#define BSDK_READ_PHY54XX_MII_PHY_ID0r(_pctrl, _val) \
            BSDK_PHY54XX_REG_READ((_pctrl), 0x00, 0x0001, 0x02, (_val))
#define BSDK_WRITE_PHY54XX_MII_PHY_ID0r(_pctrl, _val) \
            BSDK_PHY54XX_REG_WRITE((_pctrl), 0x00, 0x0001, 0x02, (_val))
#define BSDK_MODIFY_PHY54XX_MII_PHY_ID0r(_pctrl, _val, _mask) \
            BSDK_PHY54XX_REG_MODIFY((_pctrl), 0x00, 0x0001, 0x02, \
                             (_val), (_mask))
#endif
...
#define BSDK_RD_PHY84728_SGMII_DEV1_PMD_CTRLr(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0x0000, (_val)) 
#define BSDK_WR_PHY84728_SGMII_DEV1_PMD_CTRLr(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0x0000, (_val)) 
#define BSDK_MOD_PHY84728_SGMII_DEV1_PMD_CTRLr(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0x0000,          \
                                     (_val), (_mask))

/* PMD Status Register */
#define BSDK_RD_PHY84728_SGMII_DEV1_PMD_STATr(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0x0001, (_val)) 
#define BSDK_WR_PHY84728_SGMII_DEV1_PMD_STATr(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0x0001, (_val)) 
#define BSDK_MOD_PHY84728_SGMII_DEV1_PMD_STATr(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0x0001,          \
                                     (_val), (_mask))

/* PMD ID0 Register */
#define BSDK_RD_PHY84728_SGMII_DEV1_PMD_ID0r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0x0002, (_val)) 
#define BSDK_WR_PHY84728_SGMII_DEV1_PMD_ID0r(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0x0002, (_val)) 
#define BSDK_MOD_PHY84728_SGMII_DEV1_PMD_ID0r(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0x0002,          \
                                     (_val), (_mask))

/* PMD ID1 Register */
#define BSDK_RD_PHY84728_SGMII_DEV1_PMD_ID1r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0x0003, (_val)) 
#define BSDK_WR_PHY84728_SGMII_DEV1_PMD_ID1r(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0x0003, (_val)) 
#define BSDK_MOD_PHY84728_SGMII_DEV1_PMD_ID1r(_pctrl, _val, _mask) \
...
#define BSDK_RD_PHY84728_SGMII_DEV1_BASE1000X_CTRL1r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0x8300, (_val)) 
#define BSDK_WR_PHY84728_SGMII_DEV1_BASE1000X_CTRL1r(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0x8300, (_val)) 
#define BSDK_MOD_PHY84728_SGMII_DEV1_BASE1000X_CTRL1r(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0x8300,          \
                                     (_val), (_mask))

/* 1000X Control2 Register */
#define BSDK_RD_PHY84728_SGMII_DEV1_BASE1000X_CTRL2r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0x8301, (_val)) 
#define BSDK_WR_PHY84728_SGMII_DEV1_BASE1000X_CTRL2r(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0x8301, (_val)) 
#define BSDK_MOD_PHY84728_SGMII_DEV1_BASE1000X_CTRL2r(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0x8301,          \
                                     (_val), (_mask))

/* 1000X Control3 Register */
#define BSDK_RD_PHY84728_SGMII_DEV1_BASE1000X_CTRL3r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0x8302, (_val)) 
#define BSDK_WR_PHY84728_SGMII_DEV1_BASE1000X_CTRL3r(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0x8302, (_val)) 
#define BSDK_MOD_PHY84728_SGMII_DEV1_BASE1000X_CTRL3r(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0x8302,          \
                                     (_val), (_mask))

/* 1000X Control4 Register */
#define BSDK_RD_PHY84728_SGMII_DEV1_BASE1000X_CTRL4r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0x8303, (_val)) 
#define BSDK_WR_PHY84728_SGMII_DEV1_BASE1000X_CTRL4r(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0x8303, (_val)) 
#define BSDK_MOD_PHY84728_SGMII_DEV1_BASE1000X_CTRL4r(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0x8303,          \
                                     (_val), (_mask))

/* 1000X Status1 Register */
#define BSDK_RD_PHY84728_SGMII_DEV1_BASE1000X_STAT1r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0x8304, (_val)) 

/* 1000X Status2 Register */
#define BSDK_RD_PHY84728_SGMII_DEV1_BASE1000X_STAT2r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0x8305, (_val)) 

/* 1000X Status3 Register */
#define BSDK_RD_PHY84728_SGMII_DEV1_BASE1000X_STAT3r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0x8306, (_val)) 
...
#define BSDK_RD_PHY84728_SGMII_DEV1_SPEED_LINK_DETECT_STATr(_pctrl, _val)  \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0xc81f, (_val)) 

/* SGMII MACSEC Control Bypass Register */
#define BSDK_RD_PHY84728_SGMII_DEV1_MACSEC_BYPASS_CTRLr(_pctrl, _val)      \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0xc8f0, (_val)) 
#define BSDK_WR_PHY84728_SGMII_DEV1_MACSEC_BYPASS_CTRLr(_pctrl, _val)      \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0xc8f0, (_val)) 
#define BSDK_MOD_PHY84728_SGMII_DEV1_MACSEC_BYPASS_CTRLr(_pctrl, _val, _mask) \
        BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0xc8f0,(_val), (_mask))

/* System Side Select Register */
#define BSDK_RD_PHY84728_SGMII_DEV1_SYS_PMB_SELr(_pctrl, _val)             \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0xc8ff, (_val)) 
#define BSDK_WR_PHY84728_SGMII_DEV1_SYS_PMB_SELr(_pctrl, _val)             \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0xc8ff, (_val)) 
#define BSDK_MOD_PHY84728_SGMII_DEV1_SYS_PMB_SELr(_pctrl, _val, _mask)     \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0xc8ff,          \
                                     (_val), (_mask))


/* MII Control Resister (Addr 0xffe0) */
#define BSDK_RD_PHY84728_SGMII_DEV1_MII_CTRLr(_pctrl, _val)                \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0xffe0, (_val))
#define BSDK_WR_PHY84728_SGMII_DEV1_MII_CTRLr(_pctrl, _val)                \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0xffe0, (_val))
#define BSDK_MOD_PHY84728_SGMII_DEV1_MII_CTRLr(_pctrl, _val, _mask)        \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0xffe0,          \
                               (_val), (_mask))

/* MII Status Resister (Addr 0xffe1) */
#define BSDK_RD_PHY84728_SGMII_DEV1_MII_STATr(_pctrl, _val)                \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0xffe1, (_val))
#define BSDK_WR_PHY84728_SGMII_DEV1_MII_STATr(_pctrl, _val)                \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0xffe1, (_val))
#define BSDK_MOD_PHY84728_SGMII_DEV1_MII_STATr(_pctrl, _val, _mask)        \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0xffe1,          \
                                     (_val), (_mask))

/* MII ID0 Resister (Addr 0xffe2) */
#define BSDK_RD_PHY84728_SGMII_DEV1_MII_ID0r(_pctrl, _val)                 \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0xffe2, (_val))
#define BSDK_WR_PHY84728_SGMII_DEV1_MII_ID0r(_pctrl, _val)                 \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0xffe2, (_val))
#define BSDK_MOD_PHY84728_SGMII_DEV1_MII_ID0r(_pctrl, _val, _mask)         \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0xffe2,          \
                                     (_val), (_mask))
/* MII ID1 Resister (Addr 0x0003) */
#define BSDK_RD_PHY84728_SGMII_DEV1_MII_ID1r(_pctrl, _val)                 \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0xffe3, (_val))
#define BSDK_WR_PHY84728_SGMII_DEV1_MII_ID1r(_pctrl, _val)                 \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0xffe3, (_val))
#define BSDK_MOD_PHY84728_SGMII_DEV1_MII_ID1r(_pctrl, _val, _mask)         \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0xffe3,          \
                                     (_val), (_mask))

/* Auto Neg Adv Resister (Addr 0xffe4) */
#define BSDK_RD_PHY84728_SGMII_DEV1_MII_ANAr(_pctrl, _val)                \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0xffe4, (_val))
#define BSDK_WR_PHY84728_SGMII_DEV1_MII_ANAr(_pctrl, _val)                \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0xffe4, (_val))
#define BSDK_MOD_PHY84728_SGMII_DEV1_MII_ANAr(_pctrl, _val, _mask)        \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0xffe4,         \
                                     (_val), (_mask))

/* Auto Neg Link Partner Ability Register (Addr 0xffe5) */
#define BSDK_RD_PHY84728_SGMII_DEV1_MII_ANPr(_pctrl, _val)                \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0xffe5, (_val))
#define BSDK_WR_PHY84728_SGMII_DEV1_MII_ANPr(_pctrl, _val)                \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0xffe5, (_val))
#define BSDK_MOD_PHY84728_SGMII_DEV1_MII_ANPr(_pctrl, _val, _mask)        \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0xffe5,         \
                                     (_val), (_mask))

/* Auto Neg Expansion Resister (Addr 0xffe6) */
#define BSDK_RD_PHY84728_SGMII_DEV1_MII_AN_EXPr(_pctrl, _val)             \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0xffe6, (_val))
#define BSDK_WR_PHY84728_SGMII_DEV1_MII_AN_EXPr(_pctrl, _val)             \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0xffe6, (_val))
#define BSDK_MOD_PHY84728_SGMII_DEV1_MII_AN_EXPr(_pctrl, _val, _mask)     \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0xffe6,        \
                                     (_val), (_mask))

/* Extended Status Resister (Addr 0xffef) */
#define BSDK_RD_PHY84728_SGMII_DEV1_MII_ESRr(_pctrl, _val)                \
            BSDK_PHY84728_REG_RD((_pctrl), 0x00, 0x0001, 0xffef, (_val))
#define BSDK_WR_PHY84728_SGMII_DEV1_MII_ESRr(_pctrl, _val)                \
            BSDK_PHY84728_REG_WR((_pctrl), 0x00, 0x0001, 0xffef, (_val))
#define BSDK_MOD_PHY84728_SGMII_DEV1_MII_ESRr(_pctrl, _val, _mask)        \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x00, 0x0001, 0xffef,        \
                                     (_val), (_mask))
...
/* 1000X Control1 Register */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_BASE1000X_CTRL1r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0x8300, (_val)) 
#define BSDK_WR_PHY84728_SYS_SGMII_DEV1_BASE1000X_CTRL1r(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x0001, 0x8300, (_val)) 
#define BSDK_MOD_PHY84728_SYS_SGMII_DEV1_BASE1000X_CTRL1r(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x0001, 0x8300,          \
                                     (_val), (_mask))

/* 1000X Control2 Register */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_BASE1000X_CTRL2r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0x8301, (_val)) 
#define BSDK_WR_PHY84728_SYS_SGMII_DEV1_BASE1000X_CTRL2r(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x0001, 0x8301, (_val)) 
#define BSDK_MOD_PHY84728_SYS_SGMII_DEV1_BASE1000X_CTRL2r(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x0001, 0x8301,          \
                                     (_val), (_mask))

/* 1000X Control3 Register */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_BASE1000X_CTRL3r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0x8302, (_val)) 
#define BSDK_WR_PHY84728_SYS_SGMII_DEV1_BASE1000X_CTRL3r(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x0001, 0x8302, (_val)) 
#define BSDK_MOD_PHY84728_SYS_SGMII_DEV1_BASE1000X_CTRL3r(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x0001, 0x8302,          \
                                     (_val), (_mask))

/* 1000X Control4 Register */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_BASE1000X_CTRL4r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0x8303, (_val)) 
#define BSDK_WR_PHY84728_SYS_SGMII_DEV1_BASE1000X_CTRL4r(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x0001, 0x8303, (_val)) 
#define BSDK_MOD_PHY84728_SYS_SGMII_DEV1_BASE1000X_CTRL4r(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x0001, 0x8303,          \
                                     (_val), (_mask))

/* 1000X Status1 Register */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_BASE1000X_STAT1r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0x8304, (_val)) 

/* 1000X Status2 Register */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_BASE1000X_STAT2r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0x8305, (_val)) 

/* 1000X Status3 Register */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_BASE1000X_STAT3r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0x8306, (_val)) 

/* Speed Link Detect Status Register */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_SPEED_LINK_DETECT_STATr(_pctrl, _val)  \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0xc81f, (_val)) 

/* MII Control Resister (Addr 0xffe0) */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_MII_CTRLr(_pctrl, _val)                \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0xffe0, (_val))
#define BSDK_WR_PHY84728_SYS_SGMII_DEV1_MII_CTRLr(_pctrl, _val)                \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x0001, 0xffe0, (_val))
#define BSDK_MOD_PHY84728_SYS_SGMII_DEV1_MII_CTRLr(_pctrl, _val, _mask)        \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x0001, 0xffe0,          \
                               (_val), (_mask))

/* MII Status Resister (Addr 0xffe1) */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_MII_STATr(_pctrl, _val)                \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0xffe1, (_val))
#define BSDK_WR_PHY84728_SYS_SGMII_DEV1_MII_STATr(_pctrl, _val)                \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x0001, 0xffe1, (_val))
#define BSDK_MOD_PHY84728_SYS_SGMII_DEV1_MII_STATr(_pctrl, _val, _mask)        \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x0001, 0xffe1,          \
                                     (_val), (_mask))

/* Auto Neg Adv Resister (Addr 0xffe4) */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_MII_ANAr(_pctrl, _val)                \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0xffe4, (_val))
#define BSDK_WR_PHY84728_SYS_SGMII_DEV1_MII_ANAr(_pctrl, _val)                \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x0001, 0xffe4, (_val))
#define BSDK_MOD_PHY84728_SYS_SGMII_DEV1_MII_ANAr(_pctrl, _val, _mask)        \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x0001, 0xffe4,         \
                                     (_val), (_mask))

/* Auto Neg Link Partner Ability Register (Addr 0xffe5) */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_MII_ANPr(_pctrl, _val)                \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0xffe5, (_val))
#define BSDK_WR_PHY84728_SYS_SGMII_DEV1_MII_ANPr(_pctrl, _val)                \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x0001, 0xffe5, (_val))
#define BSDK_MOD_PHY84728_SYS_SGMII_DEV1_MII_ANPr(_pctrl, _val, _mask)        \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x0001, 0xffe5,         \
                                     (_val), (_mask))

/* Auto Neg Expansion Resister (Addr 0xffe6) */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_MII_AN_EXPr(_pctrl, _val)             \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0xffe6, (_val))
#define BSDK_WR_PHY84728_SYS_SGMII_DEV1_MII_AN_EXPr(_pctrl, _val)             \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x0001, 0xffe6, (_val))
#define BSDK_MOD_PHY84728_SYS_SGMII_DEV1_MII_AN_EXPr(_pctrl, _val, _mask)     \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x0001, 0xffe6,        \
                                     (_val), (_mask))

/* Extended Status Resister (Addr 0xffef) */
#define BSDK_RD_PHY84728_SYS_SGMII_DEV1_MII_ESRr(_pctrl, _val)                \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0001, 0xffef, (_val))
#define BSDK_WR_PHY84728_SYS_SGMII_DEV1_MII_ESRr(_pctrl, _val)                \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x0001, 0xffef, (_val))
#define BSDK_MOD_PHY84728_SYS_SGMII_DEV1_MII_ESRr(_pctrl, _val, _mask)        \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x0001, 0xffef,        \
                                     (_val), (_mask))
...
/* 1000X Control1 Register */
#define BSDK_RD_PHY84728_XGXS_DEV7_AN_BASE1000X_CTRL1r(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0007, 0x8300, (_val)) 
#define BSDK_WR_PHY84728_XGXS_DEV7_AN_BASE1000X_CTRL1r(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x0007, 0x8300, (_val)) 
#define BSDK_MOD_PHY84728_XGXS_DEV7_AN_BASE1000X_CTRL1r(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x0007, 0x8300,         \
                                     (_val), (_mask))

/* XGXS control Register */
#define BSDK_RD_PHY84728_XGXS_CTRLr(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x4, 0x8000, (_val)) 
#define BSDK_WR_PHY84728_XGXS_CTRLr(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x4, 0x8000, (_val)) 
#define BSDK_MOD_PHY84728_XGXS_CTRLr(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x4, 0x8000,         \
                                     (_val), (_mask))

/* XGXS Lane status Register */
#define BSDK_RD_PHY84728_XGXS_DEV4_XS_LANE_STATr(_pctrl, _val)         \
            BSDK_PHY84728_REG_RD((_pctrl), 0x01, 0x0004, 0x18, (_val)) 
#define BSDK_WR_PHY84728_XGXS_DEV4_XS_LANE_STATr(_pctrl, _val)         \
            BSDK_PHY84728_REG_WR((_pctrl), 0x01, 0x0004, 0x18, (_val)) 
#define BSDK_MOD_PHY84728_XGXS_DEV4_XS_LANE_STATr(_pctrl, _val, _mask) \
            BSDK_PHY84728_REG_MOD((_pctrl), 0x01, 0x0004, 0x18,         \
                                     (_val), (_mask))
