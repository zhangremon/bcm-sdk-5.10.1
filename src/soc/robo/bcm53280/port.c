/*
 * $Id: port.c 1.30.2.1 Broadcom SDK $
...
static int
_drv_tb_portmask_config_get(int unit, int port, 
...
/* the port_mask table configuring interface to port driver services */
static int
_drv_tb_portmask_config_set(int unit, int port, 
        _drv_tb_pmask_config_type_t config_type, uint32 val)
{
    uint32  fld32_data;
    uint32  shift_cnt;
...
/* the port_mask table configuring interface to port driver services */
static int
_drv_tb_portmask_mask_get(int unit, int port, 
...
/* the port_mask table configuring interface to port driver services */
static int
_drv_tb_portmask_mask_set(int unit, int port, 
        _drv_tb_pmask_config_type_t mask_type, uint32 val)
{
    int rv;
    port_mask_entry_t   pmask_entry;
...
int
_drv_bcm53280_port_security_mode_set(int unit, uint32 port, uint32 mode, 
    uint32 value)
{
    ...
    switch (mode) {
        case DRV_PORT_PROP_SEC_MAC_MODE_NONE:
            ...
            SOC_IF_ERROR_RETURN(_drv_tb_portmask_config_get(unit, port, 
                    _TB_PMASK_CONFIG_TYPE_RAW_VALUE, &field_val32));

            field_val32 &= temp;
            SOC_IF_ERROR_RETURN(_drv_tb_portmask_config_set(unit, port, 
                    _TB_PMASK_CONFIG_TYPE_RAW_VALUE, field_val32));
            break;
...
int
_drv_bcm53280_port_security_mode_get(int unit, uint32 port, uint32 mode, 
    uint32 *prop_val)
{
    uint32  reg_value32 = 0;
    uint32  field_val32 = 0, temp = 0;
...
/*
 *  Function : drv_bcm53280_port_default_qos_config_set
 *
 *  Purpose :
 ...
 */
int 
_drv_bcm53280_port_default_qos_config_set(int unit, int port, int property, uint32 prop_val)
{
    uint64  reg_value64;
    int     temp = 0;
    ...
    switch (property) {
        ...
        case DRV_PORT_PROP_UNTAG_DEFAULT_TC:
            ...
            soc_DEF_PORT_QOS_CFGr_field_set
                (unit, (uint32 *)&reg_value64, TCf, (uint32 *)&temp);
        ...
        case DRV_PORT_PROP_DEFAULT_DROP_PRECEDENCE:
            ...
            soc_DEF_PORT_QOS_CFGr_field_set
                (unit, (uint32 *)&reg_value64, DPf, (uint32 *)&temp);
...
/*
 *  Function : drv_bcm53280_port_default_qos_config_get
 *
 *  Purpose :
 *      Set the port based default qos configuration.
 *
 ...
 */
int 
_drv_bcm53280_port_default_qos_config_get(int unit, int port, int property, uint32 *prop_val)
{
    uint64  reg_value64;
    uint32  temp = 0;
    ...
    switch (property) {
        ...
        case DRV_PORT_PROP_UNTAG_DEFAULT_TC:
            ...
            soc_DEF_PORT_QOS_CFGr_field_get
                (unit, (uint32 *)&reg_value64, TCf, &temp);
        ...
        case DRV_PORT_PROP_DEFAULT_DROP_PRECEDENCE:
            ...
            soc_DEF_PORT_QOS_CFGr_field_get
                (unit, (uint32 *)&reg_value64, DPf, &temp);
...
/*
 *  Function : drv_bcm53280_port_property_enable_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_port_property_enable_set(int unit, int port, 
...
/*
 *  Function : drv_bcm53280_port_property_enable_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_port_property_enable_get(int unit, int port, 
        int property, uint32 *enable)
{
    int     rv = SOC_E_NONE;
...
/*
 *  Function : drv_bcm53280_port_pri_mapop_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_port_pri_mapop_set(int unit, int port, int op_type, 
...
/*
 *  Function : drv_bcm53280_port_pri_mapop_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_port_pri_mapop_get(int unit, int port, int op_type, 
                uint32 pri_old, uint32 cfi_old, uint32 *pri_new, uint32 *cfi_new)
{
    pcp2dptc_entry_t  entry_pcp2dptc;
    dptc2pcp_entry_t  entry_dptc2pcp;
...
extern uint32 _drv_sample_rate_get(int unit, uint32 val);

 /*
 *  Function : drv_bcm53280_port_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_port_set(int unit, soc_pbmp_t bmp, 
        uint32 prop_type, uint32 prop_val)
{
    ...
    switch (prop_type) {
        ...
        case DRV_PORT_PROP_ENABLE_TXRX:
            soc_cm_debug(DK_PORT, 
                "drv_port_set: PROP_ENABLE_SET\n");
            PBMP_ITER(bmp, port) {
                rv = drv_bcm53280_port_property_enable_set(
        ...
        case DRV_PORT_PROP_EGRESS_ECN_REMARK:
            soc_cm_debug(DK_PORT, 
                "drv_port_set: PROP_EGRESS REMARKING\n");
            PBMP_ITER(bmp, port) {
                rv = drv_bcm53280_port_property_enable_set(
                    unit, port, prop_type, prop_val);
            }
        ...
        case DRV_PORT_PROP_IPG_GE:
            soc_cm_debug(DK_PORT, "drv_port_set: PROP_IPG_FE/GE\n");
        ...
        case DRV_PORT_PROP_SEC_MAC_MODE_NONE:
            soc_cm_debug(DK_PORT, 
                "drv_port_set: PROP_SEC_MODE_NONE\n");
            PBMP_ITER(bmp, port) {
                rv = _drv_bcm53280_port_security_mode_set(
        ...
        case DRV_PORT_PROP_SA_OVERLIMIT_CPUCOPY:
            soc_cm_debug(DK_PORT, 
                "drv_port_set: PORT PROPERTY : SA VIOLATION DROP or CPUCOPY\n");
            PBMP_ITER(bmp, port) {
                rv = drv_bcm53280_port_property_enable_set(
                    unit, port, prop_type, prop_val);
            }
        ...
        case DRV_PORT_PROP_L2_LEARN_LIMIT_PORT_ACTION_DROP:
            soc_cm_debug(DK_PORT, 
                "drv_port_set: PROP_L2_LEARN_LIMIT_PORT_ACTION_DROP\n");
            PBMP_ITER(bmp, port) {
                SOC_IF_ERROR_RETURN(drv_bcm53280_port_property_enable_set
        ...
        case DRV_PORT_PROP_L2_LEARN_LIMIT_PORT_ACTION_CPU:
            soc_cm_debug(DK_PORT, 
                "drv_port_set: PROP_L2_LEARN_LIMIT_PORT_ACTION_CPU\n");
            PBMP_ITER(bmp, port) {
                SOC_IF_ERROR_RETURN(drv_bcm53280_port_property_enable_set
                        (unit, port, 
        ...
        case DRV_PORT_PROP_L2_LEARN_LIMIT_PORT_ACTION_NONE:
            soc_cm_debug(DK_PORT, 
                "drv_port_set: PROP_L2_LEARN_LIMIT_PORT_ACTION_NONE\n");
            PBMP_ITER(bmp, port) {
                SOC_IF_ERROR_RETURN(drv_bcm53280_port_property_enable_set
                        (unit, port, 
        ...
        case DRV_PORT_PROP_SFLOW_INGRESS_RATE:
            ...
            soc_cm_debug(DK_PORT,"%s,current ing_sflow_en pbm=0x%x\n",
                    FUNCTION_NAME(), temp);
            if ((int)prop_val > 0){
            ...
            soc_cm_debug(DK_PORT,"%s,last ing_sflow_en pbm=0x%x\n",
            ...
            if (prop_val) {
                ...
                soc_cm_debug(DK_PORT,"%s,setting user rate=%d, trans_rate=%d\n",
                ...
                soc_cm_debug(DK_PORT,"%s, chip rate=%x\n",
                        FUNCTION_NAME(), temp);
            ...
            soc_cm_debug(DK_PORT,"%s, ingress sample rate=%d\n",
        ...
        case DRV_PORT_PROP_SFLOW_EGRESS_RATE:
            ...
            soc_cm_debug(DK_PORT,"%s, egress sample rate=%d\n",
        ...
        case DRV_PORT_PROP_UNTAG_DEFAULT_TC:
            soc_cm_debug(DK_PORT, 
                "drv_port_set: PROP_DEFAULT_QOS CONFIGURATION\n");
            PBMP_ITER(bmp, port) {
                rv = _drv_bcm53280_port_default_qos_config_set(
                    unit, port, prop_type, prop_val);
            }
            break;
        case DRV_PORT_PROP_PROFILE:
            soc_cm_debug(DK_PORT, 
                "drv_port_get: DRV_PORT_PROP_PROFILE\n");
            /* valid check */
            ...
            PBMP_ITER(bmp, port) {
                rv = REG_READ_DEF_PORT_QOS_CFGr(unit, port, (uint32 *)&reg64_value);
                temp = prop_val;
                rv |= soc_DEF_PORT_QOS_CFGr_field_set(unit, (uint32 *)&reg64_value,
                        PORT_PROFILEf, &temp);
                rv |= REG_WRITE_DEF_PORT_QOS_CFGr(unit, port, (uint32 *)&reg64_value);
                if (rv){
                    break;
                }
            }
...
/*
 *  Function : drv_bcm53280_port_get
 *
 *  Purpose :
 ...
 *
 */
int drv_bcm53280_port_get(int unit, int port, 
        uint32 prop_type, uint32 *prop_val)
{
    int  rv = SOC_E_NONE;
    ...
    switch (prop_type) {
        ...
        case DRV_PORT_PROP_ENABLE_TXRX:
            ...
            rv = drv_bcm53280_port_property_enable_get(
                unit, port, prop_type, prop_val);
            break;
        case DRV_PORT_PROP_EGRESS_PCP_REMARK:
        case DRV_PORT_PROP_EGRESS_CFI_REMARK:
        ...
        case DRV_PORT_PROP_EGRESS_ECN_REMARK:
            soc_cm_debug(DK_PORT, 
                "drv_port_get: PROP_EGRESS REMARKING\n");
            rv = drv_bcm53280_port_property_enable_get(
                unit, port, prop_type, prop_val);
            break;
        case DRV_PORT_PROP_IPG_FE:
        case DRV_PORT_PROP_IPG_GE:
            soc_cm_debug(DK_PORT, "drv_port_get: IPG FE/GE\n");
            SOC_IF_ERROR_RETURN(REG_READ_SWMODEr(unit, &reg32_value));
        ...
        case DRV_PORT_PROP_SEC_MAC_MODE_NONE:
            ...
            rv = _drv_bcm53280_port_security_mode_get(
                unit, port, prop_type, prop_val);
            break;
        case DRV_PORT_PROP_SEC_MAC_MODE_STATIC_ACCEPT:
        case DRV_PORT_PROP_SEC_MAC_MODE_STATIC_REJECT:
        ...
        case DRV_PORT_PROP_SA_OVERLIMIT_CPUCOPY:
            soc_cm_debug(DK_PORT, 
                "drv_port_get: PORT PROPERTY SA VIOLATION DROP or CPUCOPY\n");
            rv = drv_bcm53280_port_property_enable_get(
                unit, port, prop_type, prop_val);
            break;
        case DRV_PORT_PROP_L2_LEARN_LIMIT_PORT_ACTION_DROP:
            ...
            SOC_IF_ERROR_RETURN(drv_bcm53280_port_property_enable_get
                (unit, port, DRV_PORT_PROP_SA_OVERLIMIT_DROP, prop_val));
            break;
        case DRV_PORT_PROP_L2_LEARN_LIMIT_PORT_ACTION_CPU:
            soc_cm_debug(DK_PORT, 
                "drv_port_get: PROP_L2_LEARN_LIMIT_PORT_ACTION_CPU\n");
            SOC_IF_ERROR_RETURN(drv_bcm53280_port_property_enable_get
                (unit, port, DRV_PORT_PROP_SA_OVERLIMIT_CPUCOPY, prop_val));
            break;
        case DRV_PORT_PROP_L2_LEARN_LIMIT_PORT_ACTION_NONE:
            soc_cm_debug(DK_PORT, 
                "drv_port_get: PROP_L2_LEARN_LIMIT_PORT_ACTION_NONE\n");
        ...
        case DRV_PORT_PROP_DTAG_MODE:
            ...
            rv = drv_bcm53280_port_property_enable_get(unit, 0, prop_type, prop_val);
            break;
        case DRV_PORT_PROP_DTAG_ISP_PORT:
            soc_cm_debug(DK_PORT, "drv_port_get: PROP_DTAG_ISP_PORT\n");
            rv = drv_bcm53280_port_property_enable_get(unit, port, prop_type, prop_val);
            break;
        case DRV_PORT_PROP_DTAG_TPID:
        ...
        case DRV_PORT_PROP_MAX_FRAME_SZ:
            ...
            break;
        case DRV_PORT_PROP_INGRESS_VLAN_CHK:
            rv = _drv_tb_portmask_config_get(unit, port, 
                    _TB_PMASK_CONFIG_TYPE_NON_MEMBER_DROP, prop_val);
            break;
        case DRV_PORT_PROP_SFLOW_INGRESS_RATE:
            /* in TB's HW Spec. Ingress SFlow can be enabled/disabled 
        ...
        case DRV_PORT_PROP_UNTAG_DEFAULT_TC:
            soc_cm_debug(DK_PORT, 
                "drv_port_get: PROP_DEFAULT_QOS_CONFIGURATION\n");
            rv = _drv_bcm53280_port_default_qos_config_get(
                unit, port, prop_type, prop_val);
            break;
        case DRV_PORT_PROP_PROFILE:
            soc_cm_debug(DK_PORT, 
                "drv_port_get: DRV_PORT_PROP_PROFILE\n");
            rv = REG_READ_DEF_PORT_QOS_CFGr(unit, port, (uint32 *)&reg64_value);
            rv |= soc_DEF_PORT_QOS_CFGr_field_get(unit, (uint32 *)&reg64_value, 
                    PORT_PROFILEf, &temp);
            *prop_val = temp;
            break;
        default: 
 ...
 */
int 
drv_bcm53280_port_block_set(int unit, int port, uint32 block_type,
        soc_pbmp_t egress_pbmp)
{
    ...
    if (block_type & DRV_BLOCK_ALL) {
         ...
         */
        SOC_IF_ERROR_RETURN(_drv_tb_portmask_mask_set(unit, port, 
 ...
 */
int 
drv_bcm53280_port_block_get(int unit, int port, uint32 block_type, 
        soc_pbmp_t *egress_pbmp)
{
    ...
    if (block_type & DRV_BLOCK_ALL) {
         ...
         *  - L2/L3 DLF Mcast to constract DLF Mcast
         */
        SOC_IF_ERROR_RETURN(_drv_tb_portmask_mask_get(unit, port, 
                _TB_PMASK_MASK_TYPE_DLF_L2MCAST, &value));
        temp = value;
        SOC_IF_ERROR_RETURN(_drv_tb_portmask_mask_get(unit, port, 
                _TB_PMASK_MASK_TYPE_DLF_L3MCAST, &value));
