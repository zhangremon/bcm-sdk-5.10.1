...
#define DEFAULT_DP_VALID(val) \
        ((val) >= 0 && (val <= 3))

/* Number of TC */
#define _TB_TC_COUNT 16
#define _TB_RX_REASON_INVALID 0xffffffff
#define _TB_TC_INVALID 0xffffffff

typedef struct _tb_cosq_rx_reason_info_s 
{
    int unit;
    uint32 valid;
    uint32 reason_cosq[DRV_RX_REASON_COUNT];
    uint32 tc2cosq_en;
    uint32 tc2cosq_prio[_TB_TC_COUNT];

    struct _tb_cosq_rx_reason_info_s *next;
    
} _tb_cosq_rx_reason_info_t;

static _tb_cosq_rx_reason_info_t *_tb_rx_reason_info = NULL;

static int
_drv_bcm53280_rx_reason_info_update(int unit, _tb_cosq_rx_reason_info_t *reason_info) 
{
    uint32 reg_value;
    uint64 reg_value64;
    uint32 temp;
        ...
        switch ( i ) {
            case DRV_RX_REASON_SWITCHING:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, ARL_KNOWN_DA_TERMINf, &temp));
                break;
            case DRV_RX_REASON_EXCEPTION:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, ARL_UNKNOWN_DA_FLOODf, &temp));
                break;
            case DRV_RX_REASON_PROTO_TERM:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, ARL_8021_PROT_TRAPf, &temp));
                break;
            case DRV_RX_REASON_PROTO_SNOOP:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, ARL_APPL_PROT_SNOOPf, &temp));
                break;
            case DRV_RX_REASON_ARL_VALN_DIR_FWD:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, ARL_VLAN_DIR_FWDf, &temp));
                break;
            case DRV_RX_REASON_ARL_CFP_FWD:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, ARL_CFP_FWDf, &temp));
                break;
            case DRV_RX_REASON_ARL_LOOPBACK:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, ARL_LOOPBACKf, &temp));
                break;
            case DRV_RX_REASON_MIRRORING:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, MIRROR_COPYf, &temp));
                break;
            case DRV_RX_REASON_INGRESS_SFLOW:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, INGRESS_SFLOWf, &temp));
                break;
            case DRV_RX_REASON_EGRESS_SFLOW:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, EGRESS_SFLOWf, &temp));
                break;
            case DRV_RX_REASON_SA_MOVEMENT_EVENT:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, SA_MOVEMENT_EVENTf, &temp));
                break;
            case DRV_RX_REASON_SA_UNKNOWN_EVENT:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, SA_UNKNOWN_EVENTf, &temp));
                break;
            case DRV_RX_REASON_SA_OVER_LIMIT_EVENT:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, SA_OVER_LIMIT_EVENTf, &temp));
                break;
            case DRV_RX_REASON_INP_NON_MEMBER:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, INP_NON_MEMBERf, &temp));
                break;
            case DRV_RX_REASON_VLAN_UNKNOWN:
                SOC_IF_ERROR_RETURN(soc_QOS_REASON_CODEr_field_get
                    (unit, (uint32 *)&reg_value64, VLAN_UNKNOWNf, &temp));
                break;
            default:
                temp = _TB_RX_REASON_INVALID;
        }
        reason_info->reason_cosq[i] = temp;
    }

    /* TC2COS mapping */
    SOC_IF_ERROR_RETURN(REG_READ_TC2COS_MAPr(unit, (uint32 *)&reg_value64));
    for (i = 0; i < _TB_TC_COUNT; i++) { 
        switch ( i ) {        
            case 0:
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_0000_COSf, &temp));
                break;
            case 1:         
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_0001_COSf, &temp));
                break;
            case 2:         
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_0010_COSf, &temp));
                break;
            case 3:
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_0011_COSf, &temp));
                break;
            case 4:
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_0100_COSf, &temp));
                break;
            case 5:
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_0101_COSf, &temp));
                break;
            case 6:         
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_0110_COSf, &temp));
                break;
            case 7:
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_0111_COSf, &temp));
                break;
            case 8:
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_1000_COSf, &temp));
                break;
            case 9:         
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_1001_COSf, &temp));
                break;
            case 10:         
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_1010_COSf, &temp));
                break;
            case 11:
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_1011_COSf, &temp));
                break;
            case 12:
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_1100_COSf, &temp));
                break;
            case 13:
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_1101_COSf, &temp));
                break;
            case 14:         
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_1110_COSf, &temp));
                break;
            case 15:
                SOC_IF_ERROR_RETURN(soc_TC2COS_MAPr_field_get
                    (unit, (uint32 *)&reg_value64, TC_1111_COSf, &temp));
                break;
            default:
                temp = _TB_TC_INVALID;
        }
...
/*
 *  Function : drv_bcm53280_queue_mode_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_mode_set(int unit, soc_pbmp_t bmp, uint32 mode)
{
...
/*
 *  Function : drv_bcm53280_queue_mode_get
 *
 *  Purpose :
 ...
 */  
int 
drv_bcm53280_queue_mode_get(int unit, uint32 port, uint32 *mode)
{
    ...
    switch ( temp ) {
        ...
        case 5:
            ...
            SOC_IF_ERROR_RETURN(DRV_QUEUE_QOS_CONTROL_GET
                (unit, DRV_QOS_CTL_WDRR_GRANULARTTY, &val));
            if (val) {
...
/*
 *  Function : drv_bcm53280_queue_count_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_count_set(int unit, uint32 port_type, uint8 count)
{
    int  rv = SOC_E_NONE;
...
/*
 *  Function : drv_bcm53280_queue_count_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_count_get(int unit, uint32 port_type, uint8 *count)
{
    int  rv = SOC_E_NONE;
    uint32  max_numq;
...
/* set WRR weight */
/*
 *  Function : drv_bcm53280_queue_WRR_weight_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_WRR_weight_set(int unit, 
    ...
    switch ( queue ) {
        case 0:
            SOC_IF_ERROR_RETURN(soc_TXQ_WEIGHT_QUOTA_SZr_field_set
                (unit, (uint32 *)&reg_value64, TXQ0_WEIGHT_QUOTAf, &temp));
            break;
        case 1:
            SOC_IF_ERROR_RETURN(soc_TXQ_WEIGHT_QUOTA_SZr_field_set
                (unit, (uint32 *)&reg_value64, TXQ1_WEIGHT_QUOTAf, &temp));
            break;
        case 2:
            SOC_IF_ERROR_RETURN(soc_TXQ_WEIGHT_QUOTA_SZr_field_set
                (unit, (uint32 *)&reg_value64, TXQ2_WEIGHT_QUOTAf, &temp));
            break;
        case 3:
            SOC_IF_ERROR_RETURN(soc_TXQ_WEIGHT_QUOTA_SZr_field_set
                (unit, (uint32 *)&reg_value64, TXQ3_WEIGHT_QUOTAf, &temp));
            break;
        case 4:
            SOC_IF_ERROR_RETURN(soc_TXQ_WEIGHT_QUOTA_SZr_field_set
                (unit, (uint32 *)&reg_value64, TXQ4_WEIGHT_QUOTAf, &temp));
            break;
        case 5:
            SOC_IF_ERROR_RETURN(soc_TXQ_WEIGHT_QUOTA_SZr_field_set
                (unit, (uint32 *)&reg_value64, TXQ5_WEIGHT_QUOTAf, &temp));
            break;
        case 6:
            SOC_IF_ERROR_RETURN(soc_TXQ_WEIGHT_QUOTA_SZr_field_set
                (unit, (uint32 *)&reg_value64, TXQ6_WEIGHT_QUOTAf, &temp));
            break;
        case 7:
            SOC_IF_ERROR_RETURN(soc_TXQ_WEIGHT_QUOTA_SZr_field_set
                (unit, (uint32 *)&reg_value64, TXQ7_WEIGHT_QUOTAf, &temp));
            break;
        default:
            return SOC_E_PARAM;
            break;
...
/*
 *  Function : drv_bcm53280_queue_WRR_weight_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_WRR_weight_get(int unit, uint32 port_type, 
...
/*
 *  Function : drv_bcm53280_queue_prio_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_prio_set(int unit, uint32 port, uint8 prio, uint8 queue_n)
{
    uint64  reg_value64;
    uint32  temp;
    uint32 found;
    _tb_cosq_rx_reason_info_t *reason_info = NULL;
    ...
    SOC_IF_ERROR_RETURN(REG_WRITE_TC2COS_MAPr(unit, (uint32 *)&reg_value64));

    /* Update sw shadow */
    found = 0;
    reason_info = _tb_rx_reason_info;
    while (reason_info) {
...
/*
 *  Function : drv_bcm53280_queue_prio_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_prio_get(int unit, uint32 port, uint8 prio, uint8 *queue_n)
{
    uint64  reg_value64;
    uint32  temp;
    uint32 found;
...
/*
 *  Function : drv_bcm53280_queue_tos_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_tos_set(int unit, uint8 precedence, uint8 queue_n)
{
    return SOC_E_UNAVAIL;
}

/*
 *  Function : drv_bcm53280_queue_tos_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_tos_get(int unit, uint8 precedence, uint8 *queue_n)
{
    return SOC_E_UNAVAIL;
}

/*
 *  Function : drv_bcm53280_queue_dfsv_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_dfsv_set(int unit, uint8 code_point, uint8 queue_n)
{
    return SOC_E_UNAVAIL;
}

/*
 *  Function : drv_bcm53280_queue_dfsv_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_dfsv_get(int unit, uint8 code_point, uint8 *queue_n)
{
    return SOC_E_UNAVAIL;
}
...
/*
 *  Function : drv_bcm53280_queue_mapping_state_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_mapping_type_set(int unit, soc_pbmp_t bmp, 
    uint32 mapping_type, uint8 state)
{
    ...
    switch (mapping_type) {
        case DRV_QUEUE_MAP_NONE:
            ...
            SOC_IF_ERROR_RETURN(REG_READ_TRUST_S1P_CTLr(unit, &reg_value));
            ...
            SOC_IF_ERROR_RETURN(soc_TRUST_S1P_CTLr_field_set
                (unit, &reg_value, TRUST_S1Pf, &temp));
            SOC_IF_ERROR_RETURN(REG_WRITE_TRUST_S1P_CTLr(unit, &reg_value)); 
    
            /* Disable TRUST_C1P_CTLr */
            SOC_IF_ERROR_RETURN(REG_READ_TRUST_C1P_CTLr(unit, &reg_value));
            ...
            SOC_IF_ERROR_RETURN(soc_TRUST_C1P_CTLr_field_set
                (unit, &reg_value, TRUST_C1Pf, &temp));
            SOC_IF_ERROR_RETURN(REG_WRITE_TRUST_C1P_CTLr(unit, &reg_value));
    
            /* Disable TRUST_DSCP_CTLr */
            SOC_IF_ERROR_RETURN(REG_READ_TRUST_DSCP_CTLr(unit, &reg_value));
            ...
            SOC_IF_ERROR_RETURN(soc_TRUST_DSCP_CTLr_field_set
                (unit, &reg_value, QOS_TOS_DIFF_ENf, &temp));
            SOC_IF_ERROR_RETURN(REG_WRITE_TRUST_DSCP_CTLr(unit, &reg_value));
        ...
        case DRV_QUEUE_MAP_PORT:
            /* bcm5328x have no force port based priority solution :
...
/*
 *  Function : drv_bcm53280_queue_mapping_state_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_mapping_type_get(int unit, uint32 port, 
    uint32 mapping_type, uint8 *state)
{
    uint32  reg_value, temp;
    soc_pbmp_t  pbmp;
...
int 
drv_bcm53280_queue_port_prio_to_queue_set(int unit, uint8 port, 
...
int 
drv_bcm53280_queue_port_prio_to_queue_get(int unit, uint8 port, 
                                                uint8 prio, uint8 *queue_n)
{
    return SOC_E_UNAVAIL;
}
...
int 
drv_bcm53280_queue_port_dfsv_set(int unit, uint8 port, uint8 dscp, 
                                                uint8 prio, uint8 queue_n)
{
    return SOC_E_UNAVAIL;
}
...
int 
drv_bcm53280_queue_port_dfsv_get(int unit, uint8 port, uint8 dscp, 
                                                uint8 *prio, uint8 *queue_n)
{
    return SOC_E_UNAVAIL;
}
...
int 
drv_bcm53280_queue_prio_remap_set(int unit, uint32 port, 
...
int 
drv_bcm53280_queue_prio_remap_get(int unit, uint32 port, 
    uint8 pre_prio, uint8 *prio)
{
    return SOC_E_UNAVAIL;
}

static int _tb_dscp2tcdp_map_reg[] = {
...
static int _tb_dscp2tcdp_map_field[] = {
PRI_DSCP_000000f,
PRI_DSCP_000001f,
PRI_DSCP_000010f,
PRI_DSCP_000011f,
...
static int _tb_tcdp2dscp_map_reg[] = {
...
static int _tb_tcdp2dscp_map_field[] = {
DPTC_000000f,
DPTC_000001f,
DPTC_000010f,
DPTC_000011f,
...
/*
 *  Function : drv_bcm53280_queue_dfsv_remap_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_dfsv_remap_set(int unit, uint8 dscp, uint8 prio)
{
    uint64  reg_value64;
    uint32  temp;
    int rv;
    ...
    soc_cm_debug(DK_VERBOSE, 
        "drv_queue_dfsv_set: unit %d, dscp value = %d, {DP[1:0], TC[3:0]} = %d\n",
        unit, dscp, prio);

    if (SOC_IS_TB_AX(unit)){
        /* TB A0: DSCP2TCDP access from registers */
        rv = DRV_REG_READ(unit, 
                    DRV_REG_ADDR(unit, _tb_dscp2tcdp_map_reg[dscp / 8], 0 ,0),
                    (uint32 *)&reg_value64,
                    DRV_REG_LENGTH_GET(unit, _tb_dscp2tcdp_map_reg[dscp / 8]));
        ...
        /* 
          ...
          */
        rv = DRV_REG_FIELD_SET(unit, INDEX(DSCP2TC_DP_MAP0r), (uint32 *)&reg_value64, 
            _tb_dscp2tcdp_map_field[dscp%8], &temp);
        SOC_IF_ERROR_RETURN(rv);
...
/*
 *  Function : drv_bcm53280_queue_dfsv_remap_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_dfsv_remap_get(int unit, uint8 dscp, uint8 *prio)
{
    uint64  reg_value64;
    uint32  temp;
    int rv;
    ...
    if (SOC_IS_TB_AX(unit)){
        ...
        /* 
          ...
          */
        rv = DRV_REG_FIELD_GET(unit, INDEX(DSCP2TC_DP_MAP0r), (uint32 *)&reg_value64, 
            _tb_dscp2tcdp_map_field[dscp%8], &temp);
        SOC_IF_ERROR_RETURN(rv);
    
        *prio = temp;
        soc_cm_debug(DK_VERBOSE, 
            "drv_queue_dfsv_get: unit %d, dscp value = %d, {DP[1:0], TC[3:0]} = %d\n",
            unit, dscp, *prio);
        return SOC_E_NONE;
    } else {
        /* changed to memory access */
...
/*
 *  Function : drv_bcm53280_queue_dfsv_unmap_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_dfsv_unmap_set(int unit, uint8 prio, uint8 dscp)
{
    uint64  reg_value64;
    uint32  temp;
    int rv;
    ...
    /* The parameter prio means {DP[1:0], TC[3:0]} for TB */
    soc_cm_debug(DK_VERBOSE, 
        "drv_queue_dfsv_set: unit %d, {DP[1:0], TC[3:0]} = %d, dscp value = %d\n",
        unit, prio, dscp);

    if (SOC_IS_TB_AX(unit)){
        /* TB A0: TCDP2DSCP access from registers */
        rv = DRV_REG_READ(unit, 
                    DRV_REG_ADDR(unit, _tb_tcdp2dscp_map_reg[prio / 8], 0 ,0),
                    (uint32 *)&reg_value64,
                    DRV_REG_LENGTH_GET(unit, _tb_tcdp2dscp_map_reg[prio / 8]));
        SOC_IF_ERROR_RETURN(rv);
        ...
        /* 
          ...
          */
        rv = DRV_REG_FIELD_SET(unit, INDEX(TC_DP2DSCP_MAP0r), (uint32 *)&reg_value64, 
            _tb_tcdp2dscp_map_field[prio%8], &temp);
        SOC_IF_ERROR_RETURN(rv);
...
/*
 *  Function : drv_bcm53280_queue_dfsv_unmap_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_dfsv_unmap_get(int unit, uint8 prio, uint8 *dscp)
{
    uint64  reg_value64;
    uint32  temp;
    int rv;
    ...
    if (SOC_IS_TB_AX(unit)){
        ...
        /* 
          ...
          */
        rv = DRV_REG_FIELD_GET(unit, INDEX(TC_DP2DSCP_MAP0r), (uint32 *)&reg_value64, 
            _tb_tcdp2dscp_map_field[prio%8], &temp);
        SOC_IF_ERROR_RETURN(rv);

        *dscp = temp;
        soc_cm_debug(DK_VERBOSE, 
            "drv_queue_dfsv_get: unit %d, {DP[1:0], TC[3:0]} = %d, dscp value = %d\n",
            unit, prio, *dscp);
        return SOC_E_NONE;
    } else {
 ...
 */
int 
drv_bcm53280_queue_rx_reason_set(int unit, uint8 reason, uint32 queue)
{
    uint64  reg_value64;
    uint32  temp;
    uint32 found;
 ...
 */
int 
drv_bcm53280_queue_rx_reason_get(int unit, uint8 reason, uint32 *queue)
{
    uint64  reg_value64;
    uint32  temp;
    uint32 found;
...
/*
 *  Function : drv_bcm53280_queue_port_txq_pause_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_port_txq_pause_set(int unit, uint32 port, 
    uint8 queue_n, uint8 enable)
{
    ...
    soc_cm_debug(DK_VERBOSE, 
        "drv_queue_port_txq_pause_set: unit %d, port = %d, queue = %d, state = %d\n",
    ...
    /* 
      * TXQ_BACKPRESSURE_IMP_CTLr/TXQ_BACKPRESSURE_GE0_CTLr/TXQ_BACKPRESSURE_GE1_CTLr
...
/*
 *  Function : drv_bcm53280_queue_port_txq_pause_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_queue_port_txq_pause_get(int unit, uint32 port, 
    uint8 queue_n, uint8 *enable)
{
    uint32  reg_value;
    uint32  temp;
    ...
    soc_cm_debug(DK_VERBOSE, 
        "drv_queue_port_txq_pause_get: unit %d, port = %d, queue = %d, state = %d\n",
        unit, port, queue_n, *enable);
...
/*
 *  Function : drv_bcm53280_queue_qos_control_set
 *
 *  Purpose :
 *      Set the global qos control.
 *
 *  Parameters :
 *      unit        :   RoboSwitch unit number.
 ...
 */
int 
drv_bcm53280_queue_qos_control_set(int unit, uint32 type, uint32 state)
{
    uint32  reg_value, temp;
    uint32 found = 0;
    _tb_cosq_rx_reason_info_t *reason_info = NULL;
    _tb_cosq_rx_reason_info_t *reason_info_prev = NULL;

    soc_cm_debug(DK_VERBOSE, 
        "drv_queue_qos_control_set: unit %d, type = 0x%x, state = 0x%x\n",
        unit, type, state);
    ...
    switch (type) {
        ...
        case DRV_QOS_CTL_DP_VALUE_DLF:
            SOC_IF_ERROR_RETURN(REG_READ_DP_CTRLr(unit, &reg_value));
            /* this type value definition is :
             *  DP_CTRL[3:2] value of the unknown unicast/multicast packet (0~ 3)
             */
            if (!DEFAULT_DP_VALID((int)state)) {
                return SOC_E_PARAM;
            }
            temp = state;
            SOC_IF_ERROR_RETURN(soc_DP_CTRLr_field_set
                (unit, &reg_value, DLF_DPf, &temp));
            SOC_IF_ERROR_RETURN(REG_WRITE_DP_CTRLr(unit, &reg_value));
            break;
        ...
        case DRV_QOS_CTL_SW_SHADOW:
            if (state) {
                ...
                if (found) {
                    /* Update the information from register */
                    temp = _drv_bcm53280_rx_reason_info_update(unit, reason_info);
                    if (temp) {
                    ...
                    if ((reason_info = sal_alloc(sizeof (_tb_cosq_rx_reason_info_t), "reason_info_list")) == NULL) {
                    ...
                    reason_info->next = _tb_rx_reason_info;
                    _tb_rx_reason_info = reason_info;
                }
            } else {
                /* free the sw shadow */
                reason_info = _tb_rx_reason_info;
                while (reason_info) {
                    if (reason_info->unit == unit) {
                        ...
                        if (reason_info_prev) {
                            ...
                            _tb_rx_reason_info = reason_info->next;
                        }
...
/*
 *  Function : drv_bcm53280_queue_qos_control_get
 *
 *  Purpose :
 *      Get the global qos control.
 *
 *  Parameters :
 *      unit        :   RoboSwitch unit number.
 *      type   :   qos control type.
 ...
 */ 
int 
drv_bcm53280_queue_qos_control_get(int unit, uint32 type, uint32 *state)
{
    uint32  reg_value, temp;
    uint32 found;
    _tb_cosq_rx_reason_info_t *reason_info = NULL;
    ...
    soc_cm_debug(DK_VERBOSE, 
        "drv_queue_qos_control_get: unit %d, type = 0x%x, state = 0x%x\n",
        unit, type, *state);    
    return SOC_E_NONE;
}
