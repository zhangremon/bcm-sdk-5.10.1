...
int 
drv_bcm53280_dos_enable_set(int unit, uint32 type, uint32 param)
{
...
int 
drv_bcm53280_dos_enable_get(int unit, uint32 type, uint32 *param)
{
    uint32 reg_value = 0, temp = 0;
...
/*
 *  Function : drv_bcm53280_dos_event_bitmap_get
 *
 *  Purpose :
...
int 
drv_bcm53280_dos_event_bitmap_get(int unit, uint32 op, uint32 *event_bitmap)
{
    int rv = SOC_E_NONE;
    uint32  reg_value = 0, temp = 0;
    uint32  evt_bmp = 0;
