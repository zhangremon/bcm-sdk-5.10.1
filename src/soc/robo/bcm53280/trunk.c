...
#define TRUNK53280_HASH_FIELD_MACDA_VALUE  0x1
#define TRUNK53280_HASH_FIELD_MACSA_VALUE  0x2
#define TRUNK53280_HASH_FIELD_IP_MACDA_VALUE  0x4
#define TRUNK53280_HASH_FIELD_IP_MACSA_VALUE  0x8

#define TRUNK53280_HASH_FIELD_VALID_VALUE  (DRV_TRUNK_HASH_FIELD_MACDA | \
                                                                                 DRV_TRUNK_HASH_FIELD_MACSA | \
                                                                                 DRV_TRUNK_HASH_FIELD_IP_MACDA | \
                                                                                 DRV_TRUNK_HASH_FIELD_IP_MACSA)

static uint32  default_trunk_seed  = (TRUNK53280_HASH_FIELD_MACDA_VALUE |\
                                                          TRUNK53280_HASH_FIELD_MACSA_VALUE);
/*
 *  Function : _drv_bcm53280_trunk_enable_set
 *
 *  Purpose :
 ...
 */
int 
_drv_bcm53280_trunk_enable_set(int unit, uint32 enable)
{
...
/*
 *  Function : _drv_bcm53280_trunk_enable_get
 *
 *  Purpose :
 ...
 */
int 
_drv_bcm53280_trunk_enable_get(int unit, uint32 *enable)
{
    uint32  reg_value, temp;
...
/*
 *  Function : drv_bcm53280_trunk_set
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_trunk_set(int unit, int tid, soc_pbmp_t bmp, uint32 flag, 
    uint32 hash_op)
{
    uint32  reg_value, temp, enable;

    soc_cm_debug(DK_PORT, 
        "drv_bcm53280_trunk_set: unit = %d, trunk id = %d, bmp = %x %x, flag = %x\n",
    ...
    if (flag & DRV_TRUNK_FLAG_HASH_DEFAULT) {
        ...
        if (hash_op & DRV_TRUNK_HASH_FIELD_MACDA) {  /* DA */
            temp |= TRUNK53280_HASH_FIELD_MACDA_VALUE;
        }
        if (hash_op & DRV_TRUNK_HASH_FIELD_MACSA) {  /* SA */
            temp |= TRUNK53280_HASH_FIELD_MACSA_VALUE;
        }
        if (hash_op & DRV_TRUNK_HASH_FIELD_IP_MACDA) {  /* IP DA */
            temp |= TRUNK53280_HASH_FIELD_IP_MACDA_VALUE;
        }
        if (hash_op & DRV_TRUNK_HASH_FIELD_IP_MACSA) {  /* IP SA */
            temp |= TRUNK53280_HASH_FIELD_IP_MACSA_VALUE;
        }
    ...
    if (flag & DRV_TRUNK_FLAG_ENABLE) {
        _drv_bcm53280_trunk_enable_get(unit, &enable);
        if (!enable) {
            _drv_bcm53280_trunk_enable_set(unit, TRUE);
        }
...
/*
 *  Function : drv_bcm53280_trunk_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_trunk_get(int unit, int tid, soc_pbmp_t *bmp, uint32 flag, 
    uint32 *hash_op)
{
    uint32  reg_value, temp, enable;
    ...
    if (flag & DRV_TRUNK_FLAG_HASH_DEFAULT) {
        *hash_op = 0;
        if (default_trunk_seed & TRUNK53280_HASH_FIELD_MACDA_VALUE) {  /* DA */
            *hash_op |= DRV_TRUNK_HASH_FIELD_MACDA;
        }
        if (default_trunk_seed & TRUNK53280_HASH_FIELD_MACSA_VALUE) {  /* SA */
            *hash_op |= DRV_TRUNK_HASH_FIELD_MACSA;
        }
        if (default_trunk_seed & TRUNK53280_HASH_FIELD_IP_MACDA_VALUE) {  /* IP DA */
            *hash_op |= DRV_TRUNK_HASH_FIELD_IP_MACDA;
        }
        if (default_trunk_seed & TRUNK53280_HASH_FIELD_IP_MACSA_VALUE) {  /* IP SA */
        ...
        soc_cm_debug(DK_PORT, 
            "drv_bcm53280_trunk_get: unit = %d, trunk id = %d, value = 0x%x, flag = %x\n",
    ...
    soc_cm_debug(DK_PORT, 
        "drv_bcm53280_trunk_get: unit = %d, trunk id = %d, value = 0x%x 0x%x, flag = %x\n",
        unit, tid, SOC_PBMP_WORD_GET(*bmp, 0), SOC_PBMP_WORD_GET(*bmp, 1), flag);
...
/*
 *  Function : drv_bcm53280_trunk_hash_field_add
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_trunk_hash_field_add(int unit, uint32 field_type)
{
    uint32	 reg_value, temp;

    soc_cm_debug(DK_PORT, 
        "drv_bcm53280_trunk_hash_field_add: unit = %d, field type = %d\n",
        unit, field_type);

    /* check the valid trunk hash field types */
    if (field_type & ~TRUNK53280_HASH_FIELD_VALID_VALUE) {
        soc_cm_debug(DK_WARN, 
            "drv_bcm53280_trunk_hash_field_add:hash type=%d, is invalid!\n",
            field_type);
...
/*
 *  Function : drv_bcm53280_trunk_hash_field_remove
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_trunk_hash_field_remove(int unit, uint32 field_type)
{
    uint32  reg_value, temp;

    soc_cm_debug(DK_PORT, 
        "drv_bcm53280_trunk_hash_field_remove: unit = %d, field type = %d\n",
        unit, field_type);
