/*
 * $Id: mcast.c 1.7.64.1 Broadcom SDK $
 *
...
/*
 *  Function : drv_bcm53280_mcast_bmp_get
 *
 *  Purpose :
 ...
 */
int  
drv_bcm53280_mcast_bmp_get(int unit, uint32 *entry, soc_pbmp_t *bmp)
{
    int rv = SOC_E_NONE;
 ...
 /*
 *  Function : drv_bcm53280_mcast_bmp_set
 *
 *  Purpose :
 ...
 */
int  
drv_bcm53280_mcast_bmp_set(int unit, uint32 *entry, 
        soc_pbmp_t bmp, uint32 flag)
{
    ...
    if( flag == DRV_MCAST_INDEX_ADD) {
        ...
        if ((index == _TB_MCAST_PBMP_DUMMY_ID) && 
            ...
            for (loop = DRV_MAX_MCREP_MCAST_GROUP_NUM; 
