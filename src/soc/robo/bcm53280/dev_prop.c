/*
 * $Id: dev_prop.c 1.17 Broadcom SDK $
 *
...
/*
 *  Function : drv_bcm53280_dev_prop_get
 *
 *  Purpose :
 ...
 */
int 
drv_bcm53280_dev_prop_get(int unit, uint32 prop_type, uint32 *prop_val)
{
    ...
    switch (prop_type) {
        case DRV_DEV_PROP_MCAST_REP_NUM:
            *prop_val = DRV_MAX_MCREP_MCAST_GROUP_NUM;
            break;
        ...
        case DRV_DEV_PROP_CFP_UDFS_NUM:
            *prop_val = DRV_CFP_UDFS_NUM(unit);
            break;
        case DRV_DEV_PROP_CFP_RNG_NUM:
            *prop_val = DRV_CFP_RNG_NUM(unit);
            break;
        ...
        case DRV_DEV_PROP_IVM_TCAM_SIZE:
            ...
            if( (s != NULL) && (sal_strcmp(s, "bcm53280_fpga") == 0)){
                ...
                *prop_val = DRV_IVM_TCAM_SIZE(unit);
            }
            break;
        case DRV_DEV_PROP_EVM_TCAM_SIZE:
            ...
            if( (s != NULL) && (sal_strcmp(s, "bcm53280_fpga") == 0)){
                ...
                *prop_val = DRV_EVM_TCAM_SIZE(unit);
            }
            break;
        ...
        case DRV_DEV_PROP_PROFILE_NUM:
            *prop_val = DRV_PORT_MAX_PROFILE_NUM;
            break;
        case DRV_DEV_PROP_FLOW_ID_NUM:
            *prop_val = DRV_FLOW_ID_NUM;
            break;
        case DRV_DEV_PROP_VLAN_TRANSLATE_MODE_NUM:
            *prop_val = DRV_VLAN_TRANSLATE_MODE_MAX;
            break;
        ...
        case DRV_DEV_PROP_POWER_DOWN_SUPPORT_PBMP:
            *prop_val = DRV_POWER_DOWN_MODE_SUPPORT_PBMP;
            break;
        default:
            return SOC_E_PARAM;
    }
