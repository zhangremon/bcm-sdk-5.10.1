/*
 * $Id: vlan.c 1.5.122.2 Broadcom SDK $
 *
 ...
 */
int 
drv_bcm53118_vlan_prop_set(int unit, uint32 prop_type, uint32 prop_val)
{
 ...
 */
int 
drv_bcm53118_vlan_prop_get(int unit, uint32 prop_type, uint32 *prop_val)
{
 ...
 */
int 
drv_bcm53118_vlan_prop_port_enable_set(int unit, uint32 prop_type, 
                soc_pbmp_t bmp, uint32 val)
{
    ...
    case    DRV_VLAN_PROP_ISP_PORT :
        SOC_IF_ERROR_RETURN(
            REG_READ_ISP_SEL_PORTMAPr(unit,(uint32 *)&reg_value64));
        ...
        soc_ISP_SEL_PORTMAPr_field_set(unit, (uint32 *)&reg_value64, 
            ISP_PORTMAPf, &temp);
        SOC_IF_ERROR_RETURN(
            REG_WRITE_ISP_SEL_PORTMAPr(unit,(uint32 *)&reg_value64));
 ...
 */
int 
drv_bcm53118_vlan_prop_port_enable_get(int unit, uint32 prop_type, 
