/*
 * $Id: dev_prop.c 1.7 Broadcom SDK $
 *
 ...
 */
int 
drv_bcm53101_dev_prop_get(int unit, uint32 prop_type, uint32 *prop_val)
{
 ...
 */
int 
drv_bcm53101_dev_prop_set(int unit, uint32 prop_type, uint32 prop_val)
{
    int rv = SOC_E_NONE, i;
    uint32  reg_val = 0, temp = 0;
        ...
        case DRV_DEV_PROP_LOW_POWER_ENABLE:
            if (prop_val) {
                ...
                for (i=0; i < DEV_BCM53101_SINGAL_DETECTION_RETRY; i++) {
                    ...
                    if (reg_val & DRV_MAC_LOW_POWER_SUPPORT_PBMP) {
                ...
                temp = DRV_MAC_LOW_POWER_SUPPORT_PBMP;
                ...
                reg_val = DRV_MAC_LOW_POWER_SUPPORT_PBMP;
                SOC_IF_ERROR_RETURN(
