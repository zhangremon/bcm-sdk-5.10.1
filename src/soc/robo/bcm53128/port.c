...
int 
drv_bcm53128_port_cross_connect_set(int unit,uint32 port,soc_pbmp_t bmp)
{
    int rv = SOC_E_NONE;
    uint32 reg_value = 0;
    uint32 temp = 0;
    ...
    soc_cm_debug(DK_PORT, 
        "drv53128_port_cross_connect_set: unit=%d port = %d, bmp=%x\n",
...
int 
drv_bcm53128_port_cross_connect_get(int unit,uint32 port,soc_pbmp_t *bmp)
{
    int rv = SOC_E_NONE;
    uint32 reg_value = 0;
    uint32 temp = 0;
    ...
    soc_cm_debug(DK_PORT, 
        "drv53128_port_cross_connect_get: unit=%d port = %d\n",
        unit, port);
