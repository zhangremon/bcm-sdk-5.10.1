/*
 * $Id: robo_53128.h 1.5 Broadcom SDK $
 *
...
#ifndef _ROBO_53128_H
#define _ROBO_53128_H
...
#define DRV_AUTH_SUPPORT_PBMP       0x000001ff
#define DRV_RATE_CONTROL_SUPPORT_PBMP 0x0000001ff
#define DRV_VLAN_ENTRY_NUM  4095
#define DRV_BPDU_NUM    1
#define DRV_CFP_TCAM_SIZE 16
#define DRV_CFP_UDFS_NUM 0
#define DRV_AUTH_SEC_MODE (DRV_SECURITY_VIOLATION_NONE |\
                                        DRV_SECURITY_EAP_MODE_EXTEND |\
                                        DRV_SECURITY_EAP_MODE_SIMPLIFIED)

#define DRV_MAC_LOW_POWER_SUPPORT_PBMP 0x000000ff                                        

#define MIN_MII_PORT_STATE_PAGE 0x10
#define MAX_MII_PORT_STATE_PAGE 0x17
