 ...
 */
int
_drv53128_cfp_read(int unit, uint32 ram_type, 
 ...
 */
int
_drv53128_cfp_write(int unit, uint32 ram_type, 
                              uint32 index, drv_cfp_entry_t *entry)
{
    int rv = SOC_E_NONE;
    uint32 reg_val;
...
/*
 * Function: drv_bcm53128_cfp_init
 *
 * Purpose:
 ...
 */
int 
drv_bcm53128_cfp_init(int unit)
{
    int port, i, slice_id;
    pbmp_t pbm;
...
/*
 * Function: drv53128_cfp_action_get
 *
 * Purpose:
 ...
 */
int
drv_bcm53128_cfp_action_get(int unit, uint32* action, 
...
/*
 * Function: drv_bcm53128_cfp_action_set
 *
 * Purpose:
 ...
 */
int
drv_bcm53128_cfp_action_set(int unit, uint32 action, 
...
/*
 * Function: drv_bcm53128_cfp_control_get
 *
 * Purpose:
 ...
 */
int
drv_bcm53128_cfp_control_get(int unit, uint32 control_type, uint32 param1, 
            uint32 *param2)
{
    int rv = SOC_E_NONE;
...
/*
 * Function: drv_bcm53128_cfp_control_set
 *
 * Purpose:
 ...
 */
int
drv_bcm53128_cfp_control_set(int unit, uint32 control_type, uint32 param1, 
            uint32 param2)
{
    int rv = SOC_E_NONE, i;
    uint32  fld_val = 0, reg_val = 0;
...
/*
 * Function: drv_bcm53128_cfp_entry_read
 *
 * Purpose:
 ...
 */
int
drv_bcm53128_cfp_entry_read(int unit, uint32 index, uint32 ram_type, 
            drv_cfp_entry_t *entry)
{
    ...
    switch (ram_type) {
        case DRV_CFP_RAM_ALL:
            if ((rv = _drv53128_cfp_read(unit, DRV_CFP_RAM_TCAM, index, entry)) 
                != SOC_E_NONE) {
                soc_cm_debug(DK_ERR,
"drv_cfp_entry_read : failed to read TCAM with index = 0x%x, rv = %d. \n", 
            ...
            if ( (rv = _drv53128_cfp_read(unit, DRV_CFP_RAM_ACT, index, entry)) 
                != SOC_E_NONE) {
                soc_cm_debug(DK_ERR,
...
/*
 * Function: drv_bcm53128_cfp_entry_write
 *
 * Purpose:
 ...
 */
int
drv_bcm53128_cfp_entry_write(int unit, uint32 index, uint32 ram_type, 
            drv_cfp_entry_t *entry)
{
    int rv = SOC_E_NONE;
    ...
    switch (ram_type) {
        case DRV_CFP_RAM_ALL:
            if ((rv = _drv53128_cfp_write(unit, DRV_CFP_RAM_TCAM, index, entry)) 
                != SOC_E_NONE) {
                soc_cm_debug(DK_ERR,
    "drv_cfp_entry_write : failed to write TCAM with index = 0x%x, rv = %d. \n",
            ...
            if ((rv = _drv53128_cfp_write(unit, DRV_CFP_RAM_ACT, index, entry)) 
                != SOC_E_NONE) {
                soc_cm_debug(DK_ERR,
...
/*
 * Function: drv_bcm53128_cfp_field_get
 *
 * Purpose:
 ...
 */
int
drv_bcm53128_cfp_field_get(int unit, uint32 mem_type, uint32 field_type, 
...
/*
 * Function: drv_bcm53128_cfp_field_set
 *
 * Purpose:
 ...
 */
int
drv_bcm53128_cfp_field_set(int unit, uint32 mem_type, uint32 field_type, 
            drv_cfp_entry_t* entry, uint32* fld_val)
{
    int rv = SOC_E_NONE;
...
/*
 * Function: drv_bcm53128_cfp_slice_id_select
 *
 * Purpose:
 ...
 */
int
drv_bcm53128_cfp_slice_id_select(int unit, drv_cfp_entry_t *entry, uint32 *slice_id, uint32 flags)
{
    uint32 i, j;
    int match = TRUE;
...
/*
 * Function: drv_bcm53128_cfp_slice_to_qset
 *
 * Purpose:
 ...
 */
int
drv_bcm53128_cfp_slice_to_qset(int unit, uint32 slice_id, drv_cfp_entry_t *entry)
{
    uint32 i;
