...
int
_drv_bcm5398_sec_mac_set(int unit, uint32 bmp, uint32 *mac, int mcast)
{
    int rv = SOC_E_NONE;
    soc_pbmp_t      pbmp;
...
int
_drv_bcm5398_sec_mac_remove(int unit, uint32 bmp, uint32 *mac, int mcast)
{
    int rv = SOC_E_NONE;
    soc_pbmp_t      pbmp;
    uint32      port, temp, vid, prio;
...
int
_drv_bcm5398_sec_mac_clear(int unit, uint32 bmp)
{
    int rv = SOC_E_NONE;
...
int 
drv_bcm5398_mac_set(int unit, soc_pbmp_t pbmp, uint32 mac_type, uint8* mac, uint32 bpdu_idx)
{
    ...
    switch (mac_type) {
        ...
        case DRV_MAC_SECURITY_ADD:                                  
            rv = _drv_bcm5398_sec_mac_set(unit, SOC_PBMP_WORD_GET(pbmp, 0), (uint32 *)&mac_field, mcast);
            return rv;
        case DRV_MAC_SECURITY_REMOVE:            
            rv = _drv_bcm5398_sec_mac_remove(unit, SOC_PBMP_WORD_GET(pbmp, 0), (uint32 *)&mac_field, mcast);
            return rv;
        case DRV_MAC_SECURITY_CLEAR:            
            rv = _drv_bcm5398_sec_mac_clear(unit, SOC_PBMP_WORD_GET(pbmp, 0));
            return rv;
 ...
 */
int 
drv_bcm5398_mac_get(int unit, uint32 port, uint32 mac_type, 
