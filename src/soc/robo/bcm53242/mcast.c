/*
 * $Id: mcast.c 1.4.220.1 Broadcom SDK $
 *
...
/*
 *  Function : drv_bcm53242_mcast_bmp_get
 *
 *  Purpose :
 ...
 */
int  
drv_bcm53242_mcast_bmp_get(int unit, uint32 *entry, soc_pbmp_t *bmp)
{
 ...
 /*
 *  Function : drv_bcm53242_mcast_bmp_set
 *
 *  Purpose :
 ...
 */
int  
drv_bcm53242_mcast_bmp_set(int unit, uint32 *entry, soc_pbmp_t bmp, uint32 flag)
{
    int loop, mcindex = -1;
