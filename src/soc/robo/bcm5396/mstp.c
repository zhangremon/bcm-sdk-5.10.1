...
int mst_field[] = { SPT_STA_P0f, SPT_STA_P1f, SPT_STA_P2f, SPT_STA_P3f,
                    SPT_STA_P4f, SPT_STA_P5f, SPT_STA_P6f, SPT_STA_P7f,
                    SPT_STA_P8f ,SPT_STA_P9f, SPT_STA_P10f, SPT_STA_P11f,
                    SPT_STA_P12f, SPT_STA_P13f, SPT_STA_P14f, SPT_STA_P15f,
                    SPT_STA_P16f };
/*
 ...
 */
int 
drv_bcm5396_mstp_port_set(int unit, uint32 mstp_gid, uint32 port, uint32 port_state)
{
    int rv = SOC_E_NONE;
    uint32  temp;
    ...
    if (!soc_feature(unit, soc_feature_mstp)){
        ...
        (DRV_SERVICES(unit)->reg_field_set)
            (unit, MST_TBLr, (uint32 *)&reg_value, mst_field[port], &temp);  
 ...
 */
int 
drv_bcm5396_mstp_port_get(int unit, uint32 mstp_gid, uint32 port, uint32 *port_state)
{
    int rv = SOC_E_NONE;
    uint32  portstate;
    ...
    if (!soc_feature(unit, soc_feature_mstp)){
        ...
        (DRV_SERVICES(unit)->reg_field_get)
            (unit, MST_TBLr, (uint32 *)&reg_value, mst_field[port], &portstate); 
