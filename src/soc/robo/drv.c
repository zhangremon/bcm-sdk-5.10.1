/*
 * $Id: drv.c 1.114.2.8 Broadcom SDK $
...
soc_robo_info_config(int unit, soc_control_t *soc)
{
    ...
    case BCM5324_PHYID_LOW:
        robo->chip_type = SOC_ROBO_CHIP_5324;
    ...
    case BCM5396_DEVICE_ID:
        ...
        robo->arch_type = SOC_ROBO_ARCH_GEX;
        break;
    ...
    case BCM5398_DEVICE_ID:
        robo->chip_type = SOC_ROBO_CHIP_5398;
        robo->arch_type = SOC_ROBO_ARCH_GEX;
        break;
    case BCM5348_DEVICE_ID:
        robo->chip_type = SOC_ROBO_CHIP_5348;
        robo->arch_type = SOC_ROBO_ARCH_FEX;
        si->port_addr_max = 63;
        break;
    case BCM5397_DEVICE_ID:
        robo->chip_type = SOC_ROBO_CHIP_5397;
        robo->arch_type = SOC_ROBO_ARCH_GEX;
        break;
    case BCM5347_DEVICE_ID:
        robo->chip_type = SOC_ROBO_CHIP_5347;
        robo->arch_type = SOC_ROBO_ARCH_FEX;
        break;
    case BCM5395_DEVICE_ID:
        robo->chip_type = SOC_ROBO_CHIP_5395;
        robo->arch_type = SOC_ROBO_ARCH_GEX;
        si->num_cpu_cosq = 4;
        break;
