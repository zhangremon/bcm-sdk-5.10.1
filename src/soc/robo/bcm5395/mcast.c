/*
 * $Id: mcast.c 1.2.384.2 Broadcom SDK $
 *
 ...
 */
int  
drv_bcm5395_mcast_bmp_get(int unit, uint32 *entry, soc_pbmp_t *bmp)
{
    uint32	pbmp;
 ...
 */
int  
drv_bcm5395_mcast_bmp_set(int unit, uint32 *entry, soc_pbmp_t bmp, uint32 flag)
{
    uint32  temp;
    uint32  reg_value;
    uint32  fld_value = 0;
