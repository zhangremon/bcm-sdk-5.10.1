...
uint32 sram_size, sram_addr, i;
    ...
    WRITE_CMIC_CMC1_CCM_DMA_HOST1_MEM_START_ADDRr(unit, sram_addr + 0x100);
    WRITE_CMIC_CMC1_CCM_DMA_ENTRY_COUNTr(unit, (sram_size - 0x100) >> 2);
 ...
 */
{
    ...
    if (mcs_addr < 0x40000) {           /* If in TCM space */
