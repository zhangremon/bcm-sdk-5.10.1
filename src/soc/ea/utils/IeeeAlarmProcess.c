/*
 * $Id: IeeeAlarmProcess.c 1.1.2.2 Broadcom SDK $
...
#include <soc/ea/AlarmProcessCtc.h>
...
{
    OamEventErrSymPeriod *pEvent = NULL;
    ...
    pEvent = (OamEventErrSymPeriod *) pOamEventTlv;
...
IeeeEventErrFrame(uint8 pathId, uint8 linkId,OamEventTlv * pOamEventTlv)
{
    ...
    pEvent = (OamEventErrFrame *) pOamEventTlv;
...
IeeeEventErrFrPeriod(uint8 pathId, uint8 linkId,OamEventTlv * pOamEventTlv)
{
    ...
    pEvent = (OamEventErrFrPeriod *) pOamEventTlv;
...
{
    OamEventErrFrSecondsSum *pEvent;
    ...
    pEvent = (OamEventErrFrSecondsSum *) pOamEventTlv;
