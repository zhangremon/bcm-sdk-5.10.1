/*
 * $Id: CtcOamFwUpgradeApi.c 1.1.2.3 Broadcom SDK $
...
CtcExtFirmwareUpgradeFile(uint8 pathId, uint32 Len, uint8 * pLoadBuf)
{
    ...
    if (OK == retVal)
        do {
            ...
            ctcServerSession.currFilePos = (uint8 *) ((uint32)
                                                      ctcServerSession.
                                                      currFilePos +
                                                      ctcServerSession.
                                                      lastSend);
                                 ...
                                 uint8 activeFlag, uint8 * respCode)
{
    ...
    if (OK ==
        ...
        pOamCtcPayloadHead = (OamCtcPayloadHead *) ((uint32)
                                                    pMsgBuf +
