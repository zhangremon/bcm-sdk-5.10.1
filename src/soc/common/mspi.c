/*
 * $Id: mspi.c 1.5.2.5 Broadcom SDK $
...
int soc_mspi_select_device(int unit, int device) {
    uint32 rval, fval;
    int selval;
    ...
    if (SOC_IS_KATANA(unit)) {
        ...
        switch (device) {
            case MSPI_FLASH:
                soc_cm_print("MSPI: Selecting Flash\n");
                selval = 0;
                break;
            case MSPI_LIU:
/*                soc_cm_print("MSPI: Selecting LIU\n"); */
                selval = 1;
                break;
            case MSPI_DPLL:
                soc_cm_print("MSPI: Selecting DPLL\n");
                selval = 2;
                break;
            default:
                /* What Device? */
