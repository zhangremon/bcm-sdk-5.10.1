 ...
 *
 * $Id: mpls_cint.c 1.1.112.1 Broadcom SDK $
 *
...
int fp_pol_ler (int cos) {
    ...
    bcm_field_qset_add_udf (unit, qset_pol_ler, bcmFieldQualifySrcMac);
...
int fp_cosq_ler (int cos) {
    ...
    bcm_field_qset_add_udf (unit, qset_cos_ler, bcmFieldQualifyDstMac);
...
int fp_ctr_ler (int cos) {
    ...
    bcm_field_qset_add_udf (unit, qset_ctr_ler,  bcmFieldQualifySrcMac);
    ...
    bcm_field_counter_create    (unit, FP_LER_CTR_ENTRY);
    bcm_field_counter_set       (unit, FP_LER_CTR_ENTRY, 1, lerctr);
...
int fp_ler_sip (int cos) {
    ...
    bcm_field_qset_add_udf (unit, qset_cos_ler_sip, bcmFieldQualifySrcIp);
    bcm_field_qset_add_udf (unit, qset_cos_ler_sip, bcmFieldQualifyEtherType);
...
int fp_ler_smac (int cos) {
    ...
    bcm_field_qset_add_udf (unit, qset_cos_ler_smac, bcmFieldQualifySrcMac);
...
int fp_ctr_ip_smac (int cos) {
    ...
    bcm_field_qset_add_udf (unit, qset_ctr_ip_smac, bcmFieldQualifySrcMac);
    ...
    bcm_field_counter_create  (unit, FP_IP_CTR_SMAC_ENTRY);
...
int fp_pol_ip (int cos) {
    ...
    bcm_field_qset_add_udf (unit, qset_pol_ip, bcmFieldQualifySrcIp);
    ...
    bcm_field_counter_create       (unit, FP_IP_POL_ENTRY);
...
int fp_cos_l2 (int cos) {
    ...
    bcm_field_qset_add_udf (unit, qset_cos_l2, bcmFieldQualifyDstMac);
...
int fp_cos_pwe (int cos) {
    ...
    bcm_field_qset_add_udf (unit, qset_cos_pwe, bcmFieldQualifySrcMac);
