/*
 * $Id: acl_util.h 1.16 Broadcom SDK $
 ...
 */
#define ACL_DEBUG(flags, stuff) DIAG_DEBUG((flags) | DIAG_DBG_ACL, stuff)
#define ACL_OUT(stuff)          DIAG_DEBUG(DIAG_DBG_ACL, stuff)
#define ACL_WARN(stuff)         ACL_DEBUG(DIAG_DBG_WARN, stuff)
#define ACL_ERR(stuff)          ACL_DEBUG(DIAG_DBG_ERR, stuff)
#define ACL_VERB(stuff)         ACL_DEBUG(DIAG_DBG_VERBOSE, stuff)
#define ACL_VVERB(stuff)        ACL_DEBUG(DIAG_DBG_VVERBOSE, stuff)
