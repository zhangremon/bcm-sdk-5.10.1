...
/*
 * $Id: sbBm9600MemWrite.c 1.8 Broadcom SDK $
  ...
  sbZfFabBm9600XbXcfgRemapEntry_t  XbXcfgRemapRecord;
   ...
   uint dbuf[40];
    ...
    case BM9600_PLBWALLOCCFGBASE:
      ...
      sbZfFabBm9600BwAllocCfgBaseEntry_Unpack(&BwAllocCfgBaseRecord,(uint8_t *)dbuf,sizeof(dbuf));
      ...
      sbZfFabBm9600BwAllocCfgBaseEntry_Pack(&BwAllocCfgBaseRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWALLOCRATE:
      ...
      sbZfFabBm9600BwAllocRateEntry_Unpack(&BwAllocRateRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwAllocRateEntry_SetField(&BwAllocRateRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwAllocRateEntry_Pack(&BwAllocRateRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWFETCHDATA:
      ...
      sbZfFabBm9600BwFetchDataEntry_Unpack(&BwFetchDataRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwFetchDataEntry_SetField(&BwFetchDataRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwFetchDataEntry_Pack(&BwFetchDataRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWFETCHSUM:
      ...
      sbZfFabBm9600BwFetchSumEntry_Unpack(&BwFetchSumRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwFetchSumEntry_SetField(&BwFetchSumRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwFetchSumEntry_Pack(&BwFetchSumRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWFETCHVALID:
      ...
      sbZfFabBm9600BwFetchValidEntry_Unpack(&BwFetchValidRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwFetchValidEntry_SetField(&BwFetchValidRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwFetchValidEntry_Pack(&BwFetchValidRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWR0BAG:
      ...
      sbZfFabBm9600BwR0BagEntry_Unpack(&BwR0BagRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwR0BagEntry_SetField(&BwR0BagRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwR0BagEntry_Pack(&BwR0BagRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWR0BWP:
      ...
      sbZfFabBm9600BwR0BwpEntry_Unpack(&BwR0BwpRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwR0BwpEntry_SetField(&BwR0BwpRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwR0BwpEntry_Pack(&BwR0BwpRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWR0WDT:
      ...
      sbZfFabBm9600BwR0WdtEntry_Unpack(&BwR0WdtRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwR0WdtEntry_SetField(&BwR0WdtRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwR0WdtEntry_Pack(&BwR0WdtRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWR1BAG:
      ...
      sbZfFabBm9600BwR1BagEntry_Unpack(&BwR1BagRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwR1BagEntry_SetField(&BwR1BagRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwR1BagEntry_Pack(&BwR1BagRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWR1WCT0A:
      ...
      sbZfFabBm9600BwR1Wct0AEntry_Unpack(&BwR1Wct0ARecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwR1Wct0AEntry_SetField(&BwR1Wct0ARecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwR1Wct0AEntry_Pack(&BwR1Wct0ARecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWR1WCT0B:
      ...
      sbZfFabBm9600BwR1Wct0BEntry_Unpack(&BwR1Wct0BRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwR1Wct0BEntry_SetField(&BwR1Wct0BRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwR1Wct0BEntry_Pack(&BwR1Wct0BRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWR1WCT1A:
      ...
      sbZfFabBm9600BwR1Wct1AEntry_Unpack(&BwR1Wct1ARecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwR1Wct1AEntry_SetField(&BwR1Wct1ARecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwR1Wct1AEntry_Pack(&BwR1Wct1ARecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWR1WCT1B:
      ...
      sbZfFabBm9600BwR1Wct1BEntry_Unpack(&BwR1Wct1BRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwR1Wct1BEntry_SetField(&BwR1Wct1BRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwR1Wct1BEntry_Pack(&BwR1Wct1BRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWR1WCT2A:
      ...
      sbZfFabBm9600BwR1Wct2AEntry_Unpack(&BwR1Wct2ARecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwR1Wct2AEntry_SetField(&BwR1Wct2ARecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwR1Wct2AEntry_Pack(&BwR1Wct2ARecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWR1WCT2B:
      ...
      sbZfFabBm9600BwR1Wct2BEntry_Unpack(&BwR1Wct2BRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwR1Wct2BEntry_SetField(&BwR1Wct2BRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwR1Wct2BEntry_Pack(&BwR1Wct2BRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWR1WST:
      ...
      sbZfFabBm9600BwR1WstEntry_Unpack(&BwR1WstRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwR1WstEntry_SetField(&BwR1WstRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwR1WstEntry_Pack(&BwR1WstRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWWREDCFGBASE:
      ...
      sbZfFabBm9600BwWredCfgBaseEntry_Unpack(&BwWredCfgBaseRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwWredCfgBaseEntry_SetField(&BwWredCfgBaseRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwWredCfgBaseEntry_Pack(&BwWredCfgBaseRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWWREDDROPNPART1:
      ...
      sbZfFabBm9600BwWredDropNPart1Entry_Unpack(&BwWredDropNPart1Record,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwWredDropNPart1Entry_SetField(&BwWredDropNPart1Record, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwWredDropNPart1Entry_Pack(&BwWredDropNPart1Record,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLBWWREDDROPNPART2:
      ...
      sbZfFabBm9600BwWredDropNPart2Entry_Unpack(&BwWredDropNPart2Record,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600BwWredDropNPart2Entry_SetField(&BwWredDropNPart2Record, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600BwWredDropNPart2Entry_Pack(&BwWredDropNPart2Record,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLFOLINKSTATETABLE:
      status = soc_bm9600_FoLinkStateTableRead(unit, uAddress, (uint32 *)dbuf,
					       (uint32 *)&dbuf[1]);
      sbZfFabBm9600FoLinkStateTableEntry_Unpack(&FoLinkStateTableRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600FoLinkStateTableEntry_SetField(&FoLinkStateTableRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600FoLinkStateTableEntry_Pack(&FoLinkStateTableRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLINAESETPRI:
      status = soc_bm9600_InaEsetPriRead(unit, uAddress, instance, (uint32 *)dbuf,
					 ...
					 (uint32 *)&dbuf[3]);
      sbZfFabBm9600InaEsetPriEntry_Unpack(&InaEsetPriRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600InaEsetPriEntry_SetField(&InaEsetPriRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600InaEsetPriEntry_Pack(&InaEsetPriRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLINAHI1SELECTED_0:
      ...
      sbZfFabBm9600InaHi1Selected_0Entry_Unpack(&InaHi1Selected_0Record,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600InaHi1Selected_0Entry_SetField(&InaHi1Selected_0Record, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600InaHi1Selected_0Entry_Pack(&InaHi1Selected_0Record,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLINAHI1SELECTED_1:
      ...
      sbZfFabBm9600InaHi1Selected_1Entry_Unpack(&InaHi1Selected_1Record,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600InaHi1Selected_1Entry_SetField(&InaHi1Selected_1Record, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600InaHi1Selected_1Entry_Pack(&InaHi1Selected_1Record,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLINAHI2SELECTED_0:
      ...
      sbZfFabBm9600InaHi2Selected_0Entry_Unpack(&InaHi2Selected_0Record,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600InaHi2Selected_0Entry_SetField(&InaHi2Selected_0Record, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600InaHi2Selected_0Entry_Pack(&InaHi2Selected_0Record,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLINAHI2SELECTED_1:
      ...
      sbZfFabBm9600InaHi2Selected_1Entry_Unpack(&InaHi2Selected_1Record,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600InaHi2Selected_1Entry_SetField(&InaHi2Selected_1Record, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600InaHi2Selected_1Entry_Pack(&InaHi2Selected_1Record,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLINAHI3SELECTED_0:
      ...
      sbZfFabBm9600InaHi3Selected_0Entry_Unpack(&InaHi3Selected_0Record,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600InaHi3Selected_0Entry_SetField(&InaHi3Selected_0Record, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600InaHi3Selected_0Entry_Pack(&InaHi3Selected_0Record,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLINAHI3SELECTED_1:
      ...
      sbZfFabBm9600InaHi3Selected_1Entry_Unpack(&InaHi3Selected_1Record,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600InaHi3Selected_1Entry_SetField(&InaHi3Selected_1Record, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600InaHi3Selected_1Entry_Pack(&InaHi3Selected_1Record,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLINAHI4SELECTED_0:
      ...
      sbZfFabBm9600InaHi4Selected_0Entry_Unpack(&InaHi4Selected_0Record,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600InaHi4Selected_0Entry_SetField(&InaHi4Selected_0Record, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600InaHi4Selected_0Entry_Pack(&InaHi4Selected_0Record,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLINAHI4SELECTED_1:
      ...
      sbZfFabBm9600InaHi4Selected_1Entry_Unpack(&InaHi4Selected_1Record,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600InaHi4Selected_1Entry_SetField(&InaHi4Selected_1Record, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600InaHi4Selected_1Entry_Pack(&InaHi4Selected_1Record,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLINAPORTPRI:
      ...
      if (status == BM9600_STATUS_OK) {
          sbZfFabBm9600InaPortPriEntry_Unpack(&InaPortPriRecord,(uint8_t *)dbuf,sizeof(dbuf));
	  status = sbZfFabBm9600InaPortPriEntry_SetField(&InaPortPriRecord, fieldname, val);
	  if (status == BM9600_STATUS_OK) {
	      sbZfFabBm9600InaPortPriEntry_Pack(&InaPortPriRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLINARANDOMNUMGEN:
      ...
      sbZfFabBm9600InaRandomNumGenEntry_Unpack(&InaRandomNumGenRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600InaRandomNumGenEntry_SetField(&InaRandomNumGenRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600InaRandomNumGenEntry_Pack(&InaRandomNumGenRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLINASYSPORTMAP:
      ...
      sbZfFabBm9600InaSysportMapEntry_Unpack(&InaSysportMapRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600InaSysportMapEntry_SetField(&InaSysportMapRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600InaSysportMapEntry_Pack(&InaSysportMapRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLNMEGRESSRANKER:
      ...
      sbZfFabBm9600NmEgressRankerEntry_Unpack(&NmEgressRankerRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600NmEgressRankerEntry_SetField(&NmEgressRankerRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600NmEgressRankerEntry_Pack(&NmEgressRankerRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLNMFULLSTATUS:
      status = soc_bm9600_NmFullStatusRead(unit, uAddress,
                                          ...
                                          (uint32 *)&dbuf[8]);
      sbZfFabBm9600NmFullStatusEntry_Unpack(&NmFullStatusRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600NmFullStatusEntry_SetField(&NmFullStatusRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600NmFullStatusEntry_Pack(&NmFullStatusRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLNMEMT:
      status = soc_bm9600_NmEmtRead(unit, uAddress, (uint32 *)dbuf,
				    (uint32 *)&dbuf[1], (uint32 *)&dbuf[2]);
      sbZfFabBm9600NmEmtEntry_Unpack(&NmEmtRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600NmEmtEntry_SetField(&NmEmtRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600NmEmtEntry_Pack(&NmEmtRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLNMEMTDEBUGBANK0:
      status = soc_bm9600_NmEmtdebugbank0Read(unit, uAddress, (uint32 *)dbuf,
					      (uint32 *)&dbuf[1], (uint32 *)&dbuf[2]);
      sbZfFabBm9600NmEmtdebugbank0Entry_Unpack(&NmEmtdebugbank0Record,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600NmEmtdebugbank0Entry_SetField(&NmEmtdebugbank0Record, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600NmEmtdebugbank0Entry_Pack(&NmEmtdebugbank0Record,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLNMEMTDEBUGBANK1:
      status = soc_bm9600_NmEmtdebugbank1Read(unit, uAddress, (uint32 *)dbuf,
					      (uint32 *)&dbuf[1], (uint32 *)&dbuf[2]);
      sbZfFabBm9600NmEmtdebugbank1Entry_Unpack(&NmEmtdebugbank1Record,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600NmEmtdebugbank1Entry_SetField(&NmEmtdebugbank1Record, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600NmEmtdebugbank1Entry_Pack(&NmEmtdebugbank1Record,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLNMINGRESSRANKER:
      ...
      sbZfFabBm9600NmIngressRankerEntry_Unpack(&NmIngressRankerRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600NmIngressRankerEntry_SetField(&NmIngressRankerRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600NmIngressRankerEntry_Pack(&NmIngressRankerRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLNMPORTSETINFO:
      ...
      sbZfFabBm9600NmPortsetInfoEntry_Unpack(&NmPortsetInfoRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600NmPortsetInfoEntry_SetField(&NmPortsetInfoRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600NmPortsetInfoEntry_Pack(&NmPortsetInfoRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLNMPORTSETLINK:
      ...
      sbZfFabBm9600NmPortsetLinkEntry_Unpack(&NmPortsetLinkRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600NmPortsetLinkEntry_SetField(&NmPortsetLinkRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600NmPortsetLinkEntry_Pack(&NmPortsetLinkRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLNMRANDOMNUMGEN:
      ...
      sbZfFabBm9600NmRandomNumGenEntry_Unpack(&NmRandomNumGenRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600NmRandomNumGenEntry_SetField(&NmRandomNumGenRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600NmRandomNumGenEntry_Pack(&NmRandomNumGenRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLNMSYSPORTARRAY:
      status = soc_bm9600_NmSysportArrayRead(unit, uAddress, (uint32 *)dbuf,
					     ...
					     (uint32 *)&dbuf[5]);
      sbZfFabBm9600NmSysportArrayEntry_Unpack(&NmSysportArrayRecord,(uint8_t *)dbuf,sizeof(dbuf));
      status = sbZfFabBm9600NmSysportArrayEntry_SetField(&NmSysportArrayRecord, fieldname, val);
      if (status != BM9600_STATUS_OK) return BM9600_STATUS_BAD_FIELD;
      sbZfFabBm9600NmSysportArrayEntry_Pack(&NmSysportArrayRecord,(uint8_t *)dbuf,sizeof(dbuf));
    ...
    case BM9600_PLXBXCFGREMAP:
      status = soc_bm9600_XbXcfgRemapSelectRead(unit, uAddress, instance,
						(uint32 *)dbuf);
      if (status == BM9600_STATUS_OK) {
          sbZfFabBm9600XbXcfgRemapEntry_Unpack(&XbXcfgRemapRecord,(uint8_t *)dbuf,sizeof(dbuf));
	  status = sbZfFabBm9600XbXcfgRemapEntry_SetField(&XbXcfgRemapRecord, fieldname, val);
	  if (status == BM9600_STATUS_OK) {
	      sbZfFabBm9600XbXcfgRemapEntry_Pack(&XbXcfgRemapRecord,(uint8_t *)dbuf,sizeof(dbuf));
...
sbBm9600MemSetField(int unit, char *memFieldName, int addr, int val, int instance)
{
   ...
   /* memfield comes in as mem.field, so split memname and field name */
    ...
    if(memindex == -1) {
        printk("Error: unrecognized Bm9600 memory: %s\n",memname);
    ...
    switch(status) {
        case  BM9600_STATUS_BAD_READ:
           printk("Error Reading Bm9600 memory\n");
           break;
        case  BM9600_STATUS_BAD_WRITE:
           printk("Error Writing Bm9600 memory\n");
           break;
        case  BM9600_STATUS_BAD_FIELD:
           printk("Error: unrecognized field <%s> for this Bm9600 memory: %s\n",&memfield[3],memname);
           break;
    }
    if (status != BM9600_STATUS_OK) {
        status = CMD_USAGE;
