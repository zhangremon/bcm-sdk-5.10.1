/*
 * $Id: pcktwatch.c 1.54.178.1 Broadcom SDK $
 ...
 */
{
	...
	debugk(DK_VERBOSE, "PW-Daemon[%d]: Exiting\n", unit);
    }
...
{
#if defined(BCM_ESW_SUPPORT) || defined(BCM_SIRIUS_SUPPORT)
    dcb_t       *esw_dcb = pup->pup_esw_dv->dv_dcb;
#endif
#if defined(BCM_ROBO_SUPPORT)
    eth_dcb_t  *robo_dcb = pup->pup_robo_dv->dv_dcb;
#endif
    char        pfx[64];
