/*
 * $Id: test.c 1.84.2.1 Broadcom SDK $
 ...
 */
{
    ...
    case SOC_CHIP_BCM5650:      return(T5665);
    case SOC_CHIP_BCM5665:      return(T5665);
    case SOC_CHIP_BCM5670:      return(T5670);
    case SOC_CHIP_BCM5673:      return(T5673);
    case SOC_CHIP_BCM5674:      return(T5674);
    case SOC_CHIP_BCM5690:      return(T5690);
    case SOC_CHIP_BCM5695:      return(T5695);
    case SOC_CHIP_BCM5675:      return(T5675);
    case SOC_CHIP_BCM56601:     return(T56601);
    case SOC_CHIP_BCM56602:     return(T56601);
    ...
    case SOC_CHIP_BCM56680:     return(T56680);
 ...
 */
{
    if (status || (test->t_flags & T_F_ERROR)) {
        test->t_fail++;
        debugk(DK_TESTS, "Test %d (%s) Completed with error (%d)\n", 
        ...
        test->t_success++;
        debugk(DK_TESTS, "Test %d (%s) Completed successfully\n", 
               test->t_test, test->t_name);
    }
}
