/*
 * $Id: sysconf.c 1.37.50.2 Broadcom SDK $
...
sysconf_probe(void)
{
    ...
    /* 
     * Add any additional dummy/null devices as specified in the configuration. 
     *
     * extra_unit_min: minimum null unit number
     * extra_unit_max: maximum null unit number. 
     *
     * Each unit should have the following config settings:
     *  extra_unit.[unit]=1
     *  pci_override_dev.[unit]=<device id>
     *  pci_override_rev.[unit]=<revision id>
     *
     * TODO: This should really be done with BDE chaining instead. 
     */
