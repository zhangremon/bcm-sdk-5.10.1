/*
 * $Id: system_snake.c 1.38.52.1 Broadcom SDK $
 ...
 */
enum {
    SS_SYSID_LANCELOT,          /* System names table must match */
    SS_SYSID_MERLIN,
    SS_SYSID_HERCULYNX,
    SS_SYSID_GALAHAD,
    SS_SYSID_DRACO_B2B,
...
static const char *ss_sysid_str[SS_SYSID_NUM + 1] = {
    "lancelot",         /* SS_SYSID_LANCELOT */
    "merlin",           /* SS_SYSID_MERLIN */
    "herculynx",        /* SS_SYSID_HERCULYNX */
    "galahad",          /* SS_SYSID_GALAHAD */
    "draco_b2b",        /* SS_SYSID_DRACO_B2B */
    "draco_stk",        /* SS_SYSID_DRACO_STK */
    "lynxalot",         /* SS_SYSID_LYNXALOT  */
    "guenevere",        /* SS_SYSID_GUENEVERE  */
    "tucana",           /* SS_SYSID_TUCANA  */
    "firebolt",         /* SS_SYSID_FIREBOLT  */
    "easyrider",        /* SS_SYSID_EASYRIDER */
...
/*
 * Lancelot uses 12 snakes, one per GE port on 5690. 
 * For even port numbers they go counter-clockwise and for odd port 
 * numbers they go clockwise;
 */
STATIC system_snake_path_t lancelot_snake_cw  = {
    8, 
    153,
    1,
    { /*   u  sm  sp  dm  dp  flags */
        {  1,  0,  0, 10,  0, SS_SP_PATH | SS_DP_PATH | SS_DM_PATH },
        {  0, 10,  7, 10,  6, SS_SM_PATH | SS_DM_PATH },
        {  0, 10,  5, 10,  4, SS_SM_PATH | SS_DM_PATH },
        {  0, 10,  3, 10,  2, SS_SM_PATH | SS_DM_PATH },
        {  4, 10, 12,  3,  0, SS_SM_PATH | SS_DP_PATH },
        {  4,  3,  0,  2,  0, SS_SP_PATH | SS_DP_PATH },
        {  3,  2,  0,  1,  0, SS_SP_PATH | SS_DP_PATH },
        {  2,  1,  0,  0,  0, SS_SP_PATH | SS_DP_PATH },
    }
};

STATIC system_snake_path_t lancelot_snake_ccw = {
    8,
    153,
    1,
    { /*   u  sm  sp  dm  dp  flags */
        {  1,  0,  0,  1,  0, SS_SP_PATH | SS_DP_PATH },
        {  2,  1,  0,  2,  0, SS_SP_PATH | SS_DP_PATH },
        {  3,  2,  0,  3,  0, SS_SP_PATH | SS_DP_PATH },
        {  4,  3,  0, 10,  0, SS_SP_PATH | SS_DP_PATH | SS_DM_PATH },
        {  0, 10,  2, 10,  3, SS_SM_PATH | SS_DM_PATH },
        {  0, 10,  4, 10,  5, SS_SM_PATH | SS_DM_PATH },
        {  0, 10,  6, 10,  7, SS_SM_PATH | SS_DM_PATH },
        {  1, 10, 12,  0,  0, SS_SM_PATH | SS_DP_PATH },   
    }              
};

STATIC system_snake_list_t lancelot_snake_test[] = {
    {  0, &lancelot_snake_ccw },
    {  1, &lancelot_snake_cw },
    {  2, &lancelot_snake_ccw },
    {  3, &lancelot_snake_cw },
    {  4, &lancelot_snake_ccw },
    {  5, &lancelot_snake_cw },
    {  6, &lancelot_snake_ccw },
    {  7, &lancelot_snake_cw },
    {  8, &lancelot_snake_ccw },
    {  9, &lancelot_snake_cw },
    { 10, &lancelot_snake_ccw },
    { 11, &lancelot_snake_cw },
};

/*
 * Merlin uses 12 snakes, one per GE port on 5690.  
 * For even port numbers they go counter-clockwise and for odd port 
 * numbers they go clockwise
 */
STATIC system_snake_path_t merlin_snake_cw  = {
    5,
    480,
    1,
    { /*   u  sm  sp  dm  dp  flags */
        {  1,  0,  0, 10,  0, SS_SP_PATH | SS_DM_PATH | SS_DP_PATH },
        {  0, 10,  8, 10,  3, SS_SM_PATH | SS_DM_PATH },
        {  0, 10,  6, 10,  1, SS_SM_PATH | SS_DM_PATH },
        {  2, 10, 12,  1,  0, SS_SM_PATH | SS_DP_PATH },
        {  2,  1,  0,  0,  0, SS_SP_PATH | SS_DP_PATH },
    }
};

STATIC system_snake_path_t merlin_snake_ccw = {
    5,
    480,
    1,
    { /*   u  sm  sp  dm  dp  flags */
        {  1,  0,  0,  1,  0, SS_SP_PATH | SS_DP_PATH },
        {  2,  1,  0, 10,  0, SS_SP_PATH | SS_DM_PATH | SS_DP_PATH },
        {  0, 10,  1, 10,  6, SS_SM_PATH | SS_DM_PATH },
        {  0, 10,  3, 10,  8, SS_SM_PATH | SS_DM_PATH },
        {  1, 10, 12,  0,  0, SS_SM_PATH | SS_DP_PATH },   
    }              
};

STATIC system_snake_list_t merlin_snake_test[] = {
    {  0, &merlin_snake_ccw }, 
    {  1, &merlin_snake_cw  },
    {  2, &merlin_snake_ccw },
    {  3, &merlin_snake_cw  },
...
/*
 * Herculynx uses 1 snake, that traverses 10GE ports on all 5673s 
 * and correspondingly all HiGig ports on 5670
 */
STATIC system_snake_path_t herculynx_snake_ccw  = {
    8,
    20,
    1,
    { /*   u  sm  sp  dm  dp  flags */
        {  1,  0,  0,  1,      0,    SS_SP_PATH | SS_DP_PATH | SS_DP_NOEXT },
        {  2,  1,  0,  2,      0,    SS_SP_PATH | SS_DP_PATH | SS_DP_NOEXT },
        {  3,  2,  0,  3,      0,    SS_SP_PATH | SS_DP_PATH | SS_DP_NOEXT },
        {  4,  3,  0,  4,      0,    SS_SP_PATH | SS_DP_PATH | SS_DP_NOEXT },
        {  5,  4,  0,  5,      0,    SS_SP_PATH | SS_DP_PATH | SS_DP_NOEXT },
        {  6,  5,  0,  6,      0,    SS_SP_PATH | SS_DP_PATH | SS_DP_NOEXT },
        {  7,  6,  0,  7,      0,    SS_SP_PATH | SS_DP_PATH | SS_DP_NOEXT },
        {  8,  7,  0,  0,      0,    SS_SP_PATH | SS_DP_PATH | SS_DP_NOEXT },
    }
};

STATIC system_snake_list_t herculynx_snake_test[] = {
    { 0, &herculynx_snake_ccw }, 
};

/*
 * Both Galahad, Draco_b2b and drako_stk are the same from the snake 
 * test perspective. They use 12 snakes, (really just short loops), 
 * 1 per GE port on each 5690 
 */
STATIC system_snake_path_t draco_b2b_snake_cw = {
    2,
    480,
    0,
    { /*   u  sm  sp  dm  dp  flags */
...
STATIC system_snake_path_t draco_b2b_snake_ccw = {
    2,
    480,
    1,
    { /*   u  sm  sp  dm  dp  flags */
...
STATIC system_snake_list_t draco_b2b_snake_test[] = {
    {  0, &draco_b2b_snake_ccw },
    {  1, &draco_b2b_snake_cw },
    {  2, &draco_b2b_snake_ccw },
    {  3, &draco_b2b_snake_cw },
    {  4, &draco_b2b_snake_ccw },
    {  5, &draco_b2b_snake_cw },
    {  6, &draco_b2b_snake_ccw },
    {  7, &draco_b2b_snake_cw },
    {  8, &draco_b2b_snake_ccw },
    {  9, &draco_b2b_snake_cw },
    { 10, &draco_b2b_snake_ccw },
    { 11, &draco_b2b_snake_cw },
};

/* Lynxalot uses two types of snakes: 
 *   -- 12 snakes traverse GE ports on 5690s, 
 *      (plus HiGig ports 5 and 6 on 5670),the same way they do on Lancelot
 *   -- 1 snake traverses 10GE ports on 5673s, the same way as on Herculynx
 * Also, the 5670 unit number is 2 and not 0.
 */
STATIC system_snake_path_t lynxalot_ge_snake_cw = {
    7,
    153,
    3,
    { /*   u  sm  sp  dm  dp  flags */
        {  3,  2,  0, 10,  0, SS_SP_PATH | SS_DP_PATH | SS_DM_PATH },
        {  2, 10,  7, 10,  6, SS_SM_PATH | SS_DM_PATH },
        {  2, 10,  5, 10,  2, SS_SM_PATH | SS_DM_PATH },
        {  6, 10, 12,  5,  0, SS_SM_PATH | SS_DP_PATH },
        {  6,  5,  0,  4,  0, SS_SP_PATH | SS_DP_PATH },
        {  5,  4,  0,  3,  0, SS_SP_PATH | SS_DP_PATH },
        {  4,  3,  0,  2,  0, SS_SP_PATH | SS_DP_PATH },
    }
};

STATIC system_snake_path_t lynxalot_ge_snake_ccw = {
    7,
    153,
    3,
    { /*   u  sm  sp  dm  dp  flags */
        {  3,  2,  0,  3,  0, SS_SP_PATH | SS_DP_PATH },
        {  4,  3,  0,  4,  0, SS_SP_PATH | SS_DP_PATH },
        {  5,  4,  0,  5,  0, SS_SP_PATH | SS_DP_PATH },
        {  6,  5,  0, 10,  0, SS_SP_PATH | SS_DP_PATH | SS_DM_PATH },
        {  2, 10,  2, 10,  5, SS_SM_PATH | SS_DM_PATH },
        {  2, 10,  6, 10,  7, SS_SM_PATH | SS_DM_PATH },
        {  3, 10, 12,  2,  0, SS_SM_PATH | SS_DP_PATH },   
    }              
};

STATIC system_snake_path_t lynxalot_10ge_snake_ccw = {
    2,
    153,
    1,
    { /*   u  sm  sp  dm  dp  flags */
        {  0,  0,  0,  1,  0, SS_SP_PATH | SS_DP_PATH | SS_DP_NOEXT },
        {  1,  1,  0,  0,  0, SS_SP_PATH | SS_DP_PATH | SS_DP_NOEXT },
    }
};

STATIC system_snake_list_t lynxalot_snake_test[] = {
    {  0, &lynxalot_10ge_snake_ccw },
    {  0, &lynxalot_ge_snake_ccw   },
    {  1, &lynxalot_ge_snake_cw,   },
    {  2, &lynxalot_ge_snake_ccw   },
    {  3, &lynxalot_ge_snake_cw,   },
    {  4, &lynxalot_ge_snake_ccw   },
    {  5, &lynxalot_ge_snake_cw,   },
    {  6, &lynxalot_ge_snake_ccw   },
    {  7, &lynxalot_ge_snake_cw,   },
    {  8, &lynxalot_ge_snake_ccw   },
    {  9, &lynxalot_ge_snake_cw,   },
    { 10, &lynxalot_ge_snake_ccw   },
    { 11, &lynxalot_ge_snake_cw,   },
};

/* Guenevere is pretty much like Lynxalot. The difference is that
 * 1. The 5670 unit is number 0
 * 2. Only two 5695 units (1/2) are present; attached to hg0/hg1 respectively
 * 3. Two 5673 units (3/4) are attached to hg5/hg4
 * 4. hpic2 and hpic5 are unused
 */

STATIC system_snake_path_t guenevere_ge_snake_cw = {
    5,
    200,
    1,
    { /*   u  sm  sp  dm  dp  flags */
        {  1,  0,  0, 10,  0, SS_SP_PATH | SS_DP_PATH | SS_DM_PATH },
        {  0, 10,  1, 10,  4, SS_SM_PATH | SS_DM_PATH },
        {  0, 10,  5, 10,  2, SS_SM_PATH | SS_DM_PATH },
        {  2, 10, 12,  1,  0, SS_SM_PATH | SS_DP_PATH },
        {  2,  1,  0,  0,  0, SS_SP_PATH | SS_DP_PATH },
    }
};

STATIC system_snake_path_t guenevere_ge_snake_ccw = {
    5,
    200,
    1,
    { /*   u  sm  sp  dm  dp  flags */
        {  1,  0,  0,  1,  0, SS_SP_PATH | SS_DP_PATH },
        {  2,  1,  0, 10,  0, SS_SP_PATH | SS_DP_PATH | SS_DM_PATH },
        {  0, 10,  2, 10,  5, SS_SM_PATH | SS_DM_PATH },
        {  0, 10,  4, 10,  1, SS_SM_PATH | SS_DM_PATH },
        {  1, 10, 12,  0,  0, SS_SM_PATH | SS_DP_PATH },
    }
};

STATIC system_snake_path_t guenevere_10ge_snake_ccw = {
    2,
    200,
    4,
    { /*   u  sm  sp  dm  dp  flags */
        {  3,  2,  0,  3,  0, SS_SP_PATH | SS_DP_PATH | SS_DP_NOEXT },
        {  4,  3,  0,  2,  0, SS_SP_PATH | SS_DP_PATH | SS_DP_NOEXT },
    }
};

STATIC system_snake_path_t guenevere_10ge_snake_cw = {
    2,
    200,
    3,
    { /*   u  sm  sp  dm  dp  flags */
...
STATIC system_snake_list_t guenevere_snake_test[] = {
    {  0, &guenevere_10ge_snake_ccw },
    {  0, &guenevere_10ge_snake_cw  },
    {  0, &guenevere_ge_snake_ccw   },
    {  1, &guenevere_ge_snake_cw,   },
    {  2, &guenevere_ge_snake_ccw   },
    {  3, &guenevere_ge_snake_cw,   },
    {  4, &guenevere_ge_snake_ccw   },
    {  5, &guenevere_ge_snake_cw,   },
    {  6, &guenevere_ge_snake_ccw   },
    {  7, &guenevere_ge_snake_cw,   },
    {  8, &guenevere_ge_snake_ccw   },
    {  9, &guenevere_ge_snake_cw,   },
    { 10, &guenevere_ge_snake_ccw   },
    { 11, &guenevere_ge_snake_cw,   },
};

/* Tucana External -
 * This is a single-unit test for BCM5665 that only supports
 * External mode and does not test the Higig.
 * Use 'tr 39' for Tucana MAC and PHY snake tests.
 * 12 separate loops are set up:
 *      1) EPIC0 all ports -> GPIC0-3 all ports (counter-clockwise)
 *      2) EPIC0 all ports -> GPIC0-3 all ports (clockwise)
 *      ...
 *      11) EPIC5 all ports -> GPIC0-3 all ports (counter-clockwise)
 *      12) EPIC5 all ports -> GPIC0-3 all ports (clockwise)
 */
STATIC system_snake_path_t tucana_snake_epic0_ccw = {
    6,
    200,
    0,
    { /*   u  sm   sp  dm  dp  flags */
        {  0,  0,   1, 0,   2, SS_DP_NOEXT },
        {  0,  0,   3, 0,   4, SS_DP_NOEXT },
        {  0,  0,   5, 0,   6, SS_DP_NOEXT },
        {  0,  0,   7, 0,  24, SS_DP_NOEXT },
        {  0,  0,  25, 0,  26, SS_DP_NOEXT },
        {  0,  0,  27, 0,   0, SS_DP_NOEXT },
    }
};

STATIC system_snake_path_t tucana_snake_epic0_cw = {
    6,
    200,
    0,
    { /*   u  sm   sp  dm  dp  flags */
        {  0,  0,  26, 0,  25, SS_DP_NOEXT },
        {  0,  0,  24, 0,   7, SS_DP_NOEXT },
        {  0,  0,   6, 0,   5, SS_DP_NOEXT },
        {  0,  0,   4, 0,   3, SS_DP_NOEXT },
        {  0,  0,   2, 0,   1, SS_DP_NOEXT },
        {  0,  0,   0, 0,  27, SS_DP_NOEXT },
    }
};

STATIC system_snake_path_t tucana_snake_epic1_ccw = {
    6,
    200,
    0,
    { /*   u  sm   sp  dm  dp  flags */
        {  0,  0,   9, 0,  10, SS_DP_NOEXT },
        {  0,  0,  11, 0,  12, SS_DP_NOEXT },
        {  0,  0,  13, 0,  14, SS_DP_NOEXT },
        {  0,  0,  15, 0,  24, SS_DP_NOEXT },
        {  0,  0,  25, 0,  26, SS_DP_NOEXT },
        {  0,  0,  27, 0,   0, SS_DP_NOEXT },
    }
};

STATIC system_snake_path_t tucana_snake_epic1_cw = {
    6,
    200,
    0,
    { /*   u  sm   sp  dm  dp  flags */
        {  0,  0,  26, 0,  25, SS_DP_NOEXT },
        {  0,  0,  24, 0,  15, SS_DP_NOEXT },
        {  0,  0,  14, 0,  13, SS_DP_NOEXT },
        {  0,  0,  12, 0,  11, SS_DP_NOEXT },
        {  0,  0,  10, 0,   9, SS_DP_NOEXT },
        {  0,  0,   8, 0,  27, SS_DP_NOEXT },
    }
};

STATIC system_snake_path_t tucana_snake_epic2_ccw = {
    6,
    200,
    0,
    { /*   u  sm   sp  dm  dp  flags */
        {  0,  0,  17, 0,  18, SS_DP_NOEXT },
        {  0,  0,  19, 0,  20, SS_DP_NOEXT },
        {  0,  0,  21, 0,  22, SS_DP_NOEXT },
        {  0,  0,  23, 0,  24, SS_DP_NOEXT },
        {  0,  0,  25, 0,  26, SS_DP_NOEXT },
        {  0,  0,  27, 0,   0, SS_DP_NOEXT },
    }
};

STATIC system_snake_path_t tucana_snake_epic2_cw = {
    6,
    200,
    0,
    { /*   u  sm   sp  dm  dp  flags */
        {  0,  0,  26, 0,  25, SS_DP_NOEXT },
        {  0,  0,  24, 0,  23, SS_DP_NOEXT },
        {  0,  0,  22, 0,  21, SS_DP_NOEXT },
        {  0,  0,  20, 0,  19, SS_DP_NOEXT },
        {  0,  0,  18, 0,  17, SS_DP_NOEXT },
        {  0,  0,  16, 0,  24, SS_DP_NOEXT },
    }
};

STATIC system_snake_path_t tucana_snake_epic3_ccw = {
    6,
    200,
    0,
    { /*   u  sm   sp  dm  dp  flags */
        {  0,  1,   1, 1,   2, SS_DP_NOEXT },
        {  0,  1,   3, 1,   4, SS_DP_NOEXT },
        {  0,  1,   5, 1,   6, SS_DP_NOEXT },
        {  0,  1,   7, 0,  24, SS_DP_NOEXT },
        {  0,  0,  25, 0,  26, SS_DP_NOEXT },
        {  0,  0,  26, 0,  27, SS_DP_NOEXT },
    }
};

STATIC system_snake_path_t tucana_snake_epic3_cw = {
    6,
    200,
    0,
    { /*   u  sm   sp dm   dp  flags */
        {  0,  0,  26, 0,  25, SS_DP_NOEXT },
        {  0,  0,  24, 1,   7, SS_DP_NOEXT },
        {  0,  1,   6, 1,   5, SS_DP_NOEXT },
        {  0,  1,   4, 1,   3, SS_DP_NOEXT },
        {  0,  1,   2, 1,   1, SS_DP_NOEXT },
        {  0,  1,   0, 0,  27, SS_DP_NOEXT },
    }
};

STATIC system_snake_path_t tucana_snake_epic4_ccw = {
    6,
    200,
    0,
    { /*   u  sm   sp  dm  dp  flags */
        {  0,  1,   9, 1,  10, SS_DP_NOEXT },
        {  0,  1,  11, 1,  12, SS_DP_NOEXT },
        {  0,  1,  13, 1,  14, SS_DP_NOEXT },
        {  0,  1,  15, 0,  24, SS_DP_NOEXT },
        {  0,  0,  25, 0,  26, SS_DP_NOEXT },
        {  0,  0,  26, 0,  27, SS_DP_NOEXT },
    }
};

STATIC system_snake_path_t tucana_snake_epic4_cw = {
    6,
    200,
    0,
    { /*   u  sm   sp dm   dp  flags */
        {  0,  0,  26, 0,  25, SS_DP_NOEXT },
        {  0,  0,  24, 1,  15, SS_DP_NOEXT },
        {  0,  1,  14, 1,  13, SS_DP_NOEXT },
        {  0,  1,  12, 1,  11, SS_DP_NOEXT },
        {  0,  1,  10, 1,   9, SS_DP_NOEXT },
        {  0,  1,   0, 0,  27, SS_DP_NOEXT },
    }
};

STATIC system_snake_path_t tucana_snake_epic5_ccw = {
    6,
    200,
    0,
    { /*   u  sm   sp  dm  dp  flags */
        {  0,  1,  17, 1,  18, SS_DP_NOEXT },
        {  0,  1,  19, 1,  20, SS_DP_NOEXT },
        {  0,  1,  21, 1,  22, SS_DP_NOEXT },
        {  0,  1,  23, 0,  24, SS_DP_NOEXT },
        {  0,  0,  25, 0,  26, SS_DP_NOEXT },
        {  0,  0,  26, 0,  27, SS_DP_NOEXT },
    }
};

STATIC system_snake_path_t tucana_snake_epic5_cw = {
    6,
    200,
    0,
    { /*   u  sm   sp dm   dp  flags */
        {  0,  0,  26, 0,  25, SS_DP_NOEXT },
        {  0,  0,  24, 1,  23, SS_DP_NOEXT },
        {  0,  1,  22, 1,  21, SS_DP_NOEXT },
        {  0,  1,  20, 1,  19, SS_DP_NOEXT },
        {  0,  1,  18, 1,  17, SS_DP_NOEXT },
        {  0,  1,   0, 0,  27, SS_DP_NOEXT },
    }
};

STATIC system_snake_list_t tucana_snake_test[] = {
    {  24, &tucana_snake_epic0_ccw  },
    {  27, &tucana_snake_epic0_cw   },
    {  24, &tucana_snake_epic1_ccw  },
    {  27, &tucana_snake_epic1_cw   },
    {  24, &tucana_snake_epic2_ccw  },
    {  27, &tucana_snake_epic2_cw   },
    {  24, &tucana_snake_epic3_ccw  },
    {  27, &tucana_snake_epic3_cw   },
    {  24, &tucana_snake_epic4_ccw  },
    {  27, &tucana_snake_epic4_cw   },
    {  24, &tucana_snake_epic5_ccw  },
    {  27, &tucana_snake_epic5_cw   },
};
...
/*
 * Easyrider uses 12 snakes, one per GE port on 56601.
 * (higig port is skipped)
 */

STATIC system_snake_path_t easyrider_snake_cw = {
    1,
    480,
    0,
    { /*   u  sm  sp  dm  dp  flags */
...
STATIC system_snake_list_t easyrider_snake_test[] = {
    {   0, &easyrider_snake_cw },
    {   1, &easyrider_snake_cw },
    {   2, &easyrider_snake_cw },
    {   3, &easyrider_snake_cw },
    {   4, &easyrider_snake_cw },
    {   5, &easyrider_snake_cw },
    {   6, &easyrider_snake_cw },
    {   7, &easyrider_snake_cw },
    {   8, &easyrider_snake_cw },
    {   9, &easyrider_snake_cw },
    {  10, &easyrider_snake_cw },
    {  11, &easyrider_snake_cw },
    /* skip higig port */
};
...
STATIC system_snake_list_t *ss_snake_table[SS_SYSID_NUM] = {
    lancelot_snake_test,
    merlin_snake_test,
    herculynx_snake_test,
    draco_b2b_snake_test,
    draco_b2b_snake_test,
    draco_b2b_snake_test,
    lynxalot_snake_test,
    guenevere_snake_test,
    tucana_snake_test,
    firebolt_snake_test,
    easyrider_snake_test,
    fbpoe_snake_test,
    lmfb48_snake_test,
    felix48p_snake_test,
...
ss_tx_packet_fill(system_snake_opts_t *opts, int unit)
{
    ...
    for (snake = 0; snake < snake_num; snake++) {
        ...
        for (length = SS_PACKET_LENGTH_MIN; length <= SS_PACKET_LENGTH_MAX; 
            ...
            if (sysid == SS_SYSID_EASYRIDER) {
                int bypass_mcu = soc_property_get(unit, spn_BYPASS_MCU, 0);

                /* If running in bypass mode, limit packets to 300 bytes */
                if (bypass_mcu) {
                    pkt->pkt_data[0].len = 300;
                }
            }
...
cmd_ss(int unit, args_t *args)
{
    ...
    if (sysid == SS_SYSID_GALAHAD || 
        sysid == SS_SYSID_DRACO_B2B || 
        sysid == SS_SYSID_DRACO_STK ) {
        opts.got_herc = FALSE;
    } else {
        opts.got_herc = TRUE;
    }
    ...
    if ((sysid ==  SS_SYSID_FIREBOLT) || (sysid == SS_SYSID_EASYRIDER)) {
