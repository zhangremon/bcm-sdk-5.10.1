...
/*                 | Short Description                         */
    ...
    {"DiffServ",     bcmx_cmd_diffserv,   bcmx_cmd_diffserv_usage,
...
#ifdef BCM_FILTER_SUPPORT
    {"FILTER",       bcmx_cmd_filter,     bcmx_cmd_filter_usage,
                     "Display or change filter table information"},
#endif  /* BCM_FILTER_SUPPORT */
#ifdef  INCLUDE_L3
    ...
    {"METer",        bcmx_cmd_meter,       bcmx_cmd_meter_usage,
                     "Modify per port meters"},
