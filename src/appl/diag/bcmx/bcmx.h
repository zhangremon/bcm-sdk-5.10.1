/*
 * $Id: bcmx.h 1.12.318.1 Broadcom SDK $
...
extern cmd_result_t bcmx_cmd_filter(int unit, args_t *args);
extern char         bcmx_cmd_filter_usage[];
#endif
...
extern cmd_result_t bcmx_cmd_meter(int unit, args_t *args);
extern char         bcmx_cmd_meter_usage[];
...
#ifdef BCM_FILTER_SUPPORT
extern cmd_result_t bcmx_cmd_diffserv(int unit, args_t *args);
extern char         bcmx_cmd_diffserv_usage[];
#endif
