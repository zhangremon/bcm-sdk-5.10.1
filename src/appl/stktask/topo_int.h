/*
 * $Id: topo_int.h 1.11 Broadcom SDK $
...
#define TP_CPU_INFO(db_ref, idx) (TP_INFO(db_ref)->cpu_info[idx])
#define TP_CPU_TX_SP(db_ref, idx, dest) \
    (TP_CPU_INFO(db_ref, idx).cpu_2_stk_tx[dest])
#define TP_CPU_RX_SP(db_ref, idx, dest) \
    (TP_CPU_INFO(db_ref, idx).cpu_2_stk_rx[dest])
