/*
 * $Id: cint_datatypes.c 1.22 Broadcom SDK $
...
{
    __data_list_t* n = CINT_MALLOC(sizeof(*n)); 
...
{
    __function_list_t* n = CINT_MALLOC(sizeof(*n)); 
...
{
    __structure_list_t* n = CINT_MALLOC(sizeof(*n));
