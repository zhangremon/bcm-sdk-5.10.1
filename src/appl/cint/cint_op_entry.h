/* 
 * $Id: cint_op_entry.h 1.1 Broadcom SDK $
...
#error CINT_OPERATOR_LIST_ENTRY needs definition
    ...
    CINT_OPERATOR_LIST_ENTRY("-",  Positive,                CINT_OPERATOR_FLAGS_IUNARY)
    CINT_OPERATOR_LIST_ENTRY("+",  Negative,                CINT_OPERATOR_FLAGS_AUNARY)
