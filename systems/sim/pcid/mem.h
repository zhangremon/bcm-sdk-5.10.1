...
extern int soc_internal_l2_tr_entry_ins(pcid_info_t *pcid_info, uint8 banks,
                                        l2x_entry_t *entry,
                                        uint32 *result);
extern int soc_internal_l2_tr_entry_del(pcid_info_t *pcid_info, uint8 banks,
                                        l2x_entry_t *entry,
                                        uint32 *result);
extern int soc_internal_l2_tr_entry_lkup(pcid_info_t * pcid_info, uint8 banks,
                                         l2x_entry_t *entry_lookup,
                                         uint32 *result);
