...
soc_datum_reg_read(pcid_info_t *pcid_info, soc_regaddrinfo_t ainfo,
                   ...
                   uint32 *data)
{
    return _soc_datum_read(pcid_info, TRUE, selectors, addr, 2, data);
                    ...
                    uint32 *data)
{
    ...
    rv = _soc_datum_write(pcid_info, TRUE, selectors, addr, 2, data);
    ...
    if (SOC_E_NOT_FOUND == rv) {
        ...
        rv = _soc_datum_add(pcid_info, TRUE, selectors, addr, 2, data);
    }
