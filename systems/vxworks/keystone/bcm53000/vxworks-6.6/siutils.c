...
#ifndef	BCMDONGLEHOST
/* XXX PR51591, hack to workaround 4322A0 init clock problem
 *  1) fix LDO bug
 *  2) request ALP avail on PMU
 *  3) wait for ALP to be available
 * Return: TRUE if WAR applied or WAR not needed for the chip
 *         FALSE if ALP never come up
 */
bool
