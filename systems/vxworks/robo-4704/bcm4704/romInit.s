/* $Id: romInit.s 1.4.462.1 Broadcom SDK $
...
/* Add the SDRAM NCDL probing codes in CFE to this file 05/31/2005 */
...
1:	lb t1,5(t0) ; \
	...
	.extern	_edata	0		/* start of bss section */
...
sdr_got_ncdl:
	 ...
	 *
	 * Uses a1, t7, t8, t9 (here and by calling memc_sb_core_reset)
	 */
sdr_do_init:
 ...
 */
	 ...
	 */
#define PHYS_TO_K1(pa)	_KSEG1ADDR(pa)	 
szmem:
	li	t0,PHYS_TO_K1(0)
	li	t2,0xaa55beef
	sw	t2,0(t0)
...
bad_mem:
	...
	/* Special memc_sb_core_reset that makes sure the first time
	 * clock is enabled, address line 6 is in the state specified
	 * by a1.
	 *
	 * a0:	Core pointer
...
h0:	add	t8,ra,24		# This is (h1 - h0)
	...
	/* Set reset while enabling the clock */
	li	t8,0x30001 	#(M_SBTS_FC | M_SBTS_CE | M_SBTS_RS)
...
cont:
	...
	/* Clear reset */
	li	t8, 0x30000 	#(M_SBTS_FC | M_SBTS_CE)
...
/* comment out the original codes for SDR SDRAM */
/*	
memc_init:
	li	t0,MEMC_SDR_INIT
	li	t1,MEMC_SDR_MODE
