 ...
 * All Rights Reserved.
 * $Id: sysSerial.c 1.3 Broadcom SDK $
 */
...
#include "vx_osl.h"
	...
	uint32 orig_n, orig_sb, idx, baud_base;
	void *sbh;
	...
	if ((cc = (chipcregs_t *) sb_setcore(sbh, SB_CC, 0))) {
		...
		if (pll == PLL_TYPE1) {
			...
			W_REG(&cc->uart_clkdiv, ((R_REG(&cc->uart_clkdiv) & ~CLKD_UART) | div));
		} else {
