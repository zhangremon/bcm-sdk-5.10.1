/* $Id: sysLib.c 1.14.64.1 Broadcom SDK $
...
/*
 * GNATS 11465: the system reboot randomly while accessing to PCI host
 * For ROBO no needs to enable PCI.
 */
#if 0
...
static UINT _bcm5836_find_mem_size(void)
{
...
char *sysPhysMemTop (void)
{
    ...
    if (memTop == NULL)
    {
        memSize = _bcm5836_find_mem_size();
    }
