...
/* $Id: mbz.h 1.2.482.1 Broadcom SDK $
...
/* Board IDs */
#define SYS_REVID_GET()      (* (volatile UINT8 *) MBZ_BOARDID_ADDR_ASM)
#define SYS_SLOTID_GET()  (* (volatile UINT8 *) (MBZ_PLDREG_BASE + 0x2))
...
/* Using the watchdog to achieve system reboot */
#define SYS_HARD_RESET()   \
    { *(volatile uint32 *)(0xb8000080) = 0x1; \
               }
