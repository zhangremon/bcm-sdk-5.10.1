/*
 * $Id: lkm.h 1.16.6.1 Broadcom SDK $
...
#if 0
/* Seems to dead code. gcc 4.3.2 (WR 3.0) complains use of
 * static "local_irq_save_ptr" in inline function.
 * if zeroing, to watch any build failures. If none, will remove
 * this code section.
 */
/* This is not available on X86 */
