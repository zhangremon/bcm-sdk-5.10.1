/*
 * $Id: linux-uk-proxy.h 1.8 Broadcom SDK $
...
/* Kernel API */
extern int linux_uk_proxy_service_create(const char* service, unsigned int q_size, unsigned int flags); 
extern int linux_uk_proxy_send(const char* service, void* data, unsigned int len); 
extern int linux_uk_proxy_recv(const char* service, void* data, unsigned int* len); 
