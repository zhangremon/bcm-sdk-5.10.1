/*
 * $Id: bcm-net.c 1.27.32.2 Broadcom SDK $
 ...
 */
static int 
bnet_proc_read(char *page, char **start, off_t off,
               int count, int *eof, void *data)
{
    char *ptr = page; 
    bcm_port_t port = (bcm_port_t)PTR_TO_INT(data);
...
bnet_proc_init(void)
{
    ...
    PBMP_ITER(pbm, port) {
        ...
        create_proc_read_entry(scratch, 0, stats_root, bnet_proc_read, INT_TO_PTR(port));
    }
