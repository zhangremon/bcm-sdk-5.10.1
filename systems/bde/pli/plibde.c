/*
 * $Id: plibde.c 1.20.4.1 Broadcom SDK $
...
#define PLI_PCI_MBAR0		0x01000000	/* Arbitrary value */
#else
#define PLI_PCI_MBAR0		0x00000000	/* Arbitrary value */
#endif
...
static plibde_dev_t _devices[MAX_DEVICES];
