/*
 * $Id: linux-user-bde.h 1.14 Broadcom SDK $
...
#define LUBDE_I2C_READ_REG		_IO(LUBDE_MAGIC, 15)
#define LUBDE_I2C_WRITE_REG		_IO(LUBDE_MAGIC, 16)
#define LUBDE_I2C_READ_INTR_REG		_IO(LUBDE_MAGIC, 17)
#define LUBDE_I2C_READ_ARA		_IO(LUBDE_MAGIC, 18)
